                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> Not only does the changeling know whether or not the subject is cheating, she also knows how.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "Subject is a known cheater"
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "Changeling is a known cheater"
                            },
                            {
                                "Modifier": "-3",
                                "Situation": "Changeling is cheating or has cheated during the same game in which she uses this power"
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> As per success, save the character may use the Contract again without having to play another game with the subject.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+2",
                                "Situation": "Game played was directly applicable to the current circumstances (i.e. when in war against a general the character played chess against or in a fight with an Ogre the character once arm-wrestled)"
                            },
                            {
                                "Modifier": "-2",
                                "Situation": "The subject cheated during the game without the character’s knowledge"
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The character’s phantasmal partner performs actions before they occur on the battlefield, granting the character a +3 bonus on all rolls for determining tactics to use in the real conflict that the game represents.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+3",
                                "Situation": "Commander of the enemy faction or team is also using this Contract and using the same game to represent the conflict"
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "Character has played the game against the leader of the enemy group"
                            },
                            {
                                "Modifier": "-2",
                                "Situation": "Character has never personally met the leader of the enemy group"
                            },
                            {
                                "Modifier": "-5",
                                "Situation": "Character is playing a game with which she is unfamiliar"
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> As above, save the followers react with exceptional speed and coordination, as if an extension of their commander’s will. Characters under the user’s command gain a bonus of +2 to all actions for the remainder of the scene (regardless of the length of the effect).",
                    {
                        "Suggested Modifiers": [
                            ...
                            {
                                "Modifier": "+2",
                                "Situation": "Character chooses a game particularly appropriate to the conflict at hand"
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "Character has played the game against the leader of the enemy group"
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> As success, save the subject doesn’t realize that a Contract was used.",
                    {
                        "Suggested Modifiers": [
                            ...
                            {
                                "Modifier": "-3",
                                "Situation": "Subject suspects that character will attempt to cheat in some way"
                            },
                            {
                                "Modifier": "-5",
                                "Situation": "Character is playing a game with which she is unfamiliar"
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> As with an ordinary success, but the achievement of the exceptional success yields information about the location of features known to be in the Hedge.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "The changeling has never witnessed the local Hedge before, as with visiting a new freehold or otherwise finding the “Hedge-scape” vastly different than what she may have expected."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> No additional effect.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "The changeling isn’t in the immediate physical vicinity of the subject."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling knows the subject at least superficially, having exchanged words or introductions with him at least once."
                            },
                            {
                                "Modifier": "+3",
                                "Situation": "The changeling has a close, personal relationship with the dreamer."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> As with a normal success, but the object remains permanently in reality. In addition, the changeling may, at any time, banish the dream-item back beyond the wall of dreams.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-2",
                                "Situation": "The changeling attempts to draw something from a dream that has seems too fantastical to exist in the real world (a gemstone made from crystallized starlight, the feathers of Pegasus)."
                            },
                            {
                                "Modifier": "-2",
                                "Situation": "The changeling attempts to draw forth a very specific idea, appearance or item, such as the exact likeness of a dream-tormentor, or the locket the dreamer had when she was five years old that held her parents’ photographs."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> As with a standard success (and the extra successes are their own benefit), but with the additional reward of being deposited exactly where he wishes to be. If any changelings understand exactly how this works, they aren’t telling, and those dream-travelers who enjoy the luxury of the exceptional success describe the phenomena as if the stuff of dreams itself carries them exactly where they want to be and then recedes like an unseen ether.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-3",
                                "Situation": "The changeling is rushed or fleeing and thus doesn’t have time to gently part the veil of sleep (jeopardizing the slumber of the dreamer and the function of the Contract therefore)."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling personally knows the dreamer at the beginning point of the journey."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The dreamer at the point of entry is having particularly noteworthy dreams (whether of a pleasant or terrifying variety)."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The object is also cleaned of all dirt and stains, and becomes more resistant to age, lasting three times as long as normal under normal use.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "The changeling stole the object."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The object was a gift to the changeling."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The object can remain frozen in time until the sun next rises or sets.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "The object has not been moved in the last scene."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The object is in motion when the changeling uses this clause."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> Beyond the advantages gained by rolling multiple successes, no special bonus is gained.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "The changeling can either not see the object clearly or can see only a portion of the object, such as a gun in a holster."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling touches the object."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Success:</b> The character can change the rate that time passes for her and her companions while they are in the Hedge. She must use this clause when she enters the Hedge, and the altered time rate affects her and any companions who enter the Hedge with her. She can cause time to pass either faster or slower in the Hedge, with the degree of difference based on how many successes she rolls.",
                    {
                        "Time table": [
                            {
                                "Successes": "1 success",
                                "Time Differential": "x2"
                            },
                            {
                                "Successes": "2 successes",
                                "Time Differential": "x3."
                            },
                            {
                                "Successes": "3 successes",
                                "Time Differential": "x4"
                            },
                            {
                                "Successes": "4 successes",
                                "Time Differential": "x5"
                            },
                            {
                                "Successes": "5 successes",
                                "Time Differential": "x6"
                            }
                        ]
                    },
                    ...
                    "<b>Exceptional Success:</b> Beyond the advantages gained by rolling multiple successes, no special bonus is gained.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-3",
                                "Situation": "The changeling has a working timepiece on her person."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "Any of the changeling’s companions has a working timepiece on his person."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The changeling cannot see any portion of the sky (looking through a window counts) when using this Contract."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling enters the Hedge at sunrise or sunset."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "The number of successes determines how far into the future the changeling can send the person or object. The changeling can determine down to the second precisely how far in the future she wishes to send the target, as long as this time is less than the maximum allowed by the number of successes she rolls.",
                    {
                        "Time table": [
                            {
                                "Successes": "1 success",
                                "Future Time": "One turn"
                            },
                            {
                                "Successes": "2 successes",
                                "Future Time": "One minute."
                            },
                            {
                                "Successes": "3 successes",
                                "Future Time": "One hour"
                            },
                            {
                                "Successes": "4 successes",
                                "Future Time": "One day"
                    ...
                    "<b>Exceptional Success:</b> Beyond the advantages gained by rolling multiple successes, no special bonus is gained.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "The object is less than a year old."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The target would be considered “old” or “antique” by the average person."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Clarity Breaking Point Level:</b> 2",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling knows at least one of the subject’s Derangements"
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The subject currently has a Derangement active (cumulative, +1 per active Derangement)"
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> As with a standard success, though the changeling may choose the exact array of features this Contract grants her, so long as they’re congruous with the seeming she chose.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-2",
                                "Situation": "The character has never seen a member of the seeming in question in person, and instead relies on descriptions or legends of the seeming."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The changeling has so mastered this particular expression of the other character’s physical aspect that she doesn’t have to roll to re-attain this particular feature if he invokes this Contract at a later time. He must still pay the cost as normal, though.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-2",
                                "Situation": "The character has never actually seen the feature in question, as with, “Well, she has a birthmark the color and shape of a wine stain just above her bellybutton.”"
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The character is also able to have some sense of what event triggered the person’s derangement.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-2",
                                "Situation": "The changeling is observing people through a window or live video link."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling talks to the people she is observing."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The increased or additional derangement that the target suffers lasts until the sun next rises or sets, whichever comes first. Also, if the target already suffers from a severe derangement, the character can choose which new severe derangement the target gains.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-2",
                                "Situation": "The target actively attempts to avoid the changeling’s gaze."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling touches the target while gazing at him."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The changeling induces an extreme derangement such as Schizophrenia, Multiple Personality or Fugue in the target. The changeling can also precisely determine the nature of the target’s derangement, such as the particular triggers for Hysteria or the nature of the other personality or personalities for Multiple Personality.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "The changeling only casually brushes against the target when using this clause."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling addresses the target by his full name."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> If the character wishes, she can inflict the related severe derangement upon the crowd.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "The crowd is passive and well controlled (for example, the audience at a lecture)."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The crowd is already loud and emotional (for example, the audience at a rock concert)."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The insanity manifests a number of times equal to the changeling’s Wyrd. In each of these cases, the trigger remains the same, but instead of merely occurring once and vanishing forever, the insanity recurs the next several times the target is exposed to the same trigger. The target appears perfectly sane in between these episodes, and this Contract ceases to affect the target after 28 days.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "The target does not know the changeling’s name."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The target is highly emotional when the changeling uses this Contract."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The changeling also gains a general understanding of all of the other major traumatic events that occurred to the target.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "The changeling cannot see the target clearly or only catches a brief glimpse of the target."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling touches the target."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The character’s knowledge of the future is exceptionally clear and she can apply the 8 again quality to both rolls.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "The changeling has already used this clause at least once during the last scene."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling can glimpse herself in a mirror or other reflective surface when using the Contract."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The character gains more details about the upcoming problem. If the character has no upcoming dramatic events coming up, an exceptional success reveals any events that the target hopes for or fears, and how these possible events might be made to occur if changes were made in the target’s future.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-2",
                                "Situation": "The changeling is viewing his own future."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The target is a sworn enemy of the changeling."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The target is a relative of the changeling."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> In addition to generally knowing what will occur in the next turn, the changeling noticed a host of small details that allow her to act more effectively during this turn. During the turn being replayed, the changeling gains the rote quality to any action she performs.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "The changeling was blindfolded or otherwise had trouble seeing the events that occurred during the turn that will be replayed."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling was injured during the turn that will be replayed."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> No additional effect occurs.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-2",
                                "Situation": "The fate named is particularly extreme or unlikely."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The fate is especially likely or minor."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> For all intents and purposes, the character was never there. He’s impossible to track by the method of determining where he may have moved.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-2",
                                "Situation": "The environment is especially susceptible to retaining marks of passage, such as sticky mud, a new snowdrift or wet cement."
                            },
                            {
                                "Modifier": "+2",
                                "Situation": "The environment is notably resistant to holding marks of passage, as with deep water, Astroturf or hardwood floors."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The bonus is increased to +5.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "The environment lacks shadows longer than the height of a man."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The environment consists solely of natural or artificial light, such as a park playground or a windowless warehouse."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> As with a normal success, only the changeling can terminate the temporary blindness at any point of her choosing before the end of the scene.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "The changeling can see her target but not her target’s face."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The subject wears glasses or contact lenses (or needs to), or otherwise has some mechanical vision correction or visual impediment."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The changeling arrives as her destination, where she briefly remains as insubstantial as mist. In this invisible and intangible state, the changeling is free to spend a second moving to a location where she wishes to appear. She can only appear in locations that are also within the fog, and can only move a distance up to her Speed in yards, but can appear facing any direction.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-2",
                                "Situation": "The day is bright and sunny"
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "Visibility is less than 10 yards"
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> As with a normal success, only the invisibility remains active for the duration of the scene.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-2",
                                "Situation": "The character attempts to vanish from plain sight, using the power when he’s the subject of attention of onlooking characters."
                            },
                            {
                                "Modifier": "—",
                                "Situation": "The character invokes the Contract when he’s among others but not necessarily the focus of anyone’s attentions."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The character is unobserved by any other individuals when he invokes the Contract."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> As per success, and the weapon’s damage is converted to lethal.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+3",
                                "Situation": "Contract is used as part of a formal Hedge duel"
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "Contract is used in the Hedge (does not stack with Hedge duel bonus)"
                            },
                            {
                                "Modifier": "-2",
                                "Situation": "Contract is used against a changeling benefiting from Armor of the Elements’ Fury"
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> Additional successes are their own reward.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+2",
                                "Situation": "Contract is used on thorns summoned forth by another clause of this Contract"
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "Contract is used in the Hedge"
                            },
                            {
                                "Modifier": "-2",
                                "Situation": "Contract is used on thorns summoned forth by another changeling or fae creature"
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> As per success, save that characters moving through the trail find their Speed reduced to 1 and all Athletics dice pools reduced to a chance roll.",
                    {
                        "Suggested Modifiers": [
                            ...
                            {
                                "Modifier": "-1",
                                "Situation": "Contract is used in an urban area"
                            },
                            {
                                "Modifier": "-3",
                                "Situation": "Contract is used in a locale entirely inappropriate for the growth of brambles, such as inside a wellkept science laboratory."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> Additional successes are their own reward.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+3",
                                "Situation": "Contract is used in a rural area or forest"
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "Contract is used in the Hedge"
                            ...
                            {
                                "Modifier": "-5",
                                "Situation": "Contract is used in an area unsuited to plant growth"
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> As per success, save the walls automatically benefit from the effects of Briarpath and Leechweed.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+5",
                                "Situation": "Contract is used within an already extant hedge maze"
                            },
                            {
                                "Modifier": "+3",
                                "Situation": "Contract is used in a rural area or forest"
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The illusion lasts for a day and a night.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "The changeling is in his enemy’s territory."
                            },
                            {
                                "Modifier": "+2",
                                "Situation": "The door leads into territory that the changeling owns."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> Anyone accompanying the character is affected by the clause’s benefits.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "The changeling has never set foot inside the location before."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling has visited the location before as an invited guest."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The changeling can choose to conceal the claw marks if he so chooses, making the burrow appear more natural or human-made.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-4",
                                "Situation": "Reinforced concrete"
                            },
                            {
                                "Modifier": "-2",
                                "Situation": "Stone or concrete"
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "Packed earth"
                            },
                            {
                                "Modifier": "+2",
                                "Situation": "Soft earth or sand"
                            }
                        ]
                    }
                ],
            ...
            },
            {
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> No additional effect.",
                    {
                        "Affected size": [
                            {
                                "Building Size": "Trailer, basement-sized burrow",
                                "Number of Successes Needed": "5"
                            },
                            {
                                "Building Size": "Two-story house, small cavern",
                                "Number of Successes Needed": "10"
                            },
                            {
                                "Building Size": "McMansion",
                                "Number of Successes Needed": "15"
                            },
                            {
                                "Building Size": "Strip mall",
                                "Number of Successes Needed": "20"
                            },
                            {
                                "Building Size": "Skyscraper",
                                "Number of Successes Needed": "40"
                            }
                        ]
                    },
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-3",
                                "Situation": "Nobody resides within the building."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The building was designed as a residence."
                            },
                            {
                                "Modifier": "+2",
                                "Situation": "At least one family calls the building home."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The animal feels affection and loyalty toward the character. The animal is actively helpful and volunteers information unasked if it considers that information important (so far as its intelligence allows).",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "The character imitates the animal’s sounds and body language."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The animal is frightened or hurt."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The character gains an additional +1 die to all Perception rolls for the scene.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling is touching an animal of the correct type."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling is wearing a mask or other large image (such as a painting on the back of a jacket of an animal of the correct type)."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The environment is one that the animal would find uncomfortable and unnatural, such as a jungle animal in winter snow."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The character retains an empathic bond with the animal, allowing him to roughly sense its location and emotional and physical condition. For the next full day, the character can spend one point of Glamour to communicate for one scene with the animal at any distance.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling offers the animal appropriate foodstuffs."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The animal is frightened or injured."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The character’s enhanced movement lasts until the sun next sets or rises, whichever comes first.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling wears a mask of the animal or a large garment made from its skin."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The clause is invoked someplace the animal is never naturally found."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The character can remain transformed until the sun next rises. If she has taken the form of an animal with a smaller Size than her own, she retains her full Health as if her Size had not changed.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "In the animal’s natural habitat"
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "Inside a well-lit building closed off from the outside world"
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> Beyond the advantages gained by rolling multiple successes, no special bonus is gained.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "The character is wearing delicate clothing that can be easily ruined by dirt or water."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The character is dressed in clothing designed for use in the wilderness."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> Increase the maximum penalty suffered by the target by an additional -1. If the target currently previously had no negative modifiers due to hostile environmental conditions, this clause imposes a total penalty of -2.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "The target spent the last night sleeping outdoors or in a tent."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The target complained about some natural phenomena, such as mosquitoes or the weather, a minute or less before the changeling used this Contract."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> Beyond the advantages gained by rolling multiple successes, no special bonus is gained.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-2",
                                "Situation": "The character is indoors but in a large space with many plants."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The weather is calm and clear."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The character is in a park, a dirty street or some other environment that is not carefully managed or regularly cleaned."
                            },
                            {
                                "Modifier": "+2",
                                "Situation": "The character is in a forest, construction site or some other complex outdoor environment."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "As long as the character succeeds, the weather arrives, but the number of successes affects how rapidly the weather arrives and how long it lasts.",
                    {
                        "Weather changes": [
                            {
                                "Successes": "1",
                                "Time to Arrive": "Three Hours",
                                "Duration": "One Hour"
                            },
                            {
                                "Successes": "2",
                                "Time to Arrive": "One Hours",
                    ...
                    "<b>Exceptional Success:</b> Beyond the advantages gained by rolling multiple successes, no special bonus is gained.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1 to -3",
                                "Situation": "The current weather is significantly different from the desired weather. Calling heavy rain on a sunny, cloudless day would have a -3 penalty."
                            },
                            {
                                "Modifier": "+1 to +3",
                                "Situation": "The current weather is similar to the desired weather. Changing a drizzle to light rain would gain a +3 bonus."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The affected area extends 100 yards around the character.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-2",
                                "Situation": "The area around the changeling is partially enclosed."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The area around the changeling is particularly clean or otherwise devoid of debris."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The clause is used in brush, woods, a construction site or anywhere else that is filled with debris and intrinsically difficult or dangerous to move through."
                            },
                            {
                                "Modifier": "+2",
                                "Situation": "The clause is used during a storm or other extreme environmental conditions."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The penalty to rolls to resist fear is equal to the changeling’s Wyrd +2.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "The surroundings are dark and spooky."
                            },
                            {
                                "Modifier": "+2",
                                "Situation": "The target or targets are already somewhat afraid."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The targets are vigilant and expecting trouble."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The surroundings are brightly lit and not conducive to fear."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The Contract affects everyone in range that the changeling does not protect, including people who come within range later. The changeling does not have to be in physical contact with those she wishes to spare from the Contract’s effects.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "Total environmental modifiers to perception are no more than -1."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "Total environmental modifiers to perception are -3 or higher."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> When the targets wake up, they remain groggy for another full scene, suffering a -2 dice penalty to Speed, Defense and all actions.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+2",
                                "Situation": "The target is deeply asleep."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The target is taking a nap and is not planning to sleep for more than a short time."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The character moves so swiftly and easily that she adds +1 to her Defense when using this clause.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "The surface the character is attempting to climb is rough, with many handholds and footholds."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The surface the character is attempting to climb is smooth and polished, with few handholds or footholds."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The character is barefoot."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> Round down when halving the target’s new Speed, Defense, Initiative, Strength and Dexterity pools.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling touches the target’s bare skin."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The target is wearing actual armor, and the changeling did not touch his skin."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The character can sense the element at a range of Wyrd x 25 yards.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-2",
                                "Situation": "The character’s senses are either restrained with blindfolds or similar items or overwhelmed with loud noises, bright flashing lights, intense smells or other distractions."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The character speaks to the element and asks it questions at the volume of a normal conversation."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> In addition to being able to reply to questions about events up to five days in the past, the element is helpful and talkative, possibly offering potentially useful information without being asked or volunteering details about a situation that the character might not have otherwise asked about.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "The character is brusque and hurried when asking her questions."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The character chats with the element before using the Contract and is friendly and polite."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The servitor remains active for a number of hours equal to the changeling’s Wyrd.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-2",
                                "Situation": "The changeling asks the elemental being to do something that will harm or diminish itself."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling asks the elemental being to do something that will allow it to increase, such as asking a fire to spread."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The elemental ally remains aware and intelligent for an entire month, although the element can still remain animate for only one scene.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-2",
                                "Situation": "The changeling asks the element to do something that stands a good chance of harming or destroying the element."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling has previously used this Contract on the same manifestation of the element, without causing any harm to the element after animation."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The character can maintain this effect until the sun next rises or sets (whichever comes first) and can summon or dismiss the element during this time without ending the Contract.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "A large amount of the element is present when the Contract is invoked. For ubiquitous elements such as air, the element must be particularly vigorous, for example, a gale wind."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "None of the element is present when the Contract is invoked."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                        ...
                        "Controlled Element": [
                            {
                                "Successes": "1 success",
                                "Mass": "20 lb.",
                                "Volume (liquid)": "Milk jug",
                                "Area (gas or intangible)": "5-sq. yard area"
                            },
                            {
                                "Successes": "2 successes",
                                "Mass": "50 lb.",
                                "Volume (liquid)": "Gas tank",
                                "Area (gas or intangible)": "10-sq. yard area"
                            },
                            {
                                "Successes": "3 successes",
                                "Mass": "200 lb.",
                                "Volume (liquid)": "Bathtub",
                                "Area (gas or intangible)": "15-sq. yard area"
                            },
                            {
                                "Successes": "4 successes",
                                "Mass": "500 lb.",
                                "Volume (liquid)": "Average Jacuzzi",
                                "Area (gas or intangible)": "20-sq. yard area"
                            },
                            {
                                "Successes": "5+ successes",
                                "Mass": "2000 lb.",
                                "Volume (liquid)": "Large hot tub",
                                "Area (gas or intangible)": "30-sq. yard area"
                            }
                        ]
                    },
                    ...
                    "<b>Exceptional Success:</b> No additional bonuses.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "Large amounts of the element are present."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "Little of the element is present."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> No additional advantage.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling calls the element with verbal entreaties and large, obvious gestures."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The changeling uses neither words nor gestures to call the element."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The character can remain in elemental form until the sun next rises or sets (whichever comes first), unless forced out of this form by damage to it. He can also end the effects at will.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling is in the presence of large amounts of the element."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "Little or none of the element is present."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The reflection that is revealed is significantly sharper and clearer than it originally was. A dirty puddle still won’t reveal an image as clear as a clean mirror; however, the image from a smudged mirror, a relatively clean piece of glass, or a flat and relatively shiny sheet of metal will be as clear as a well polished mirror, and the image from a muddy puddle will be a clear as one from a still, clean puddle. The reflected image will show up on film if photographed.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling owns the reflecting surface or at least the land on which it rests."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The reflecting surface has been thoroughly cleaned, reshaped or otherwise significantly altered within the past month."
                            }
                        ]
                    },
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The changeling can see through any reflective surface his face has been reflected in as if it were a perfectly clear piece of glass. Even a murky puddle can be used to its surroundings with perfect clarity.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+2",
                                "Situation": "The changeling stands within a few feet of the reflective surface he wishes to look out of and stare into it for several minutes."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling looks into and out of reflective surfaces that are of the same type and dimensions, such as two mirrors or two puddles of the same Size."
                            },
                            {
                                "Modifier": "-2",
                                "Situation": "The changeling’s reflection in the reflective surface he wishes to look out of is blurred or only seen at a distance of more than five yards away."
                            }
                        ]
                    },
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The changeling can see through the reflective surface as well as reach through it.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling is able to spend at least a minute running both of her bare hands over the reflective surface she wishes to reach out of."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The reflective surface is especially shiny and reflective, like a mirror"
                            },
                            {
                                "Modifier": "-2",
                                "Situation": "The reflective surface is especially dim or dull, like poorly polished metal, or a muddy puddle."
                            }
                        ]
                    },
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The changeling can step back and forth through the reflective surface for a number of turns equal to his Wyrd without spending more Glamour.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling owns the reflective surface out of which he is attempting to step."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "Either reflective surface is anything other than highly reflective, like a mirror, a still pool of clear water, or a flat sheet of well-polished metal."
                            },
                            {
                                "Modifier": "-3",
                                "Situation": "The changeling is only reflected in the surface he wishes to exit at a significant distance or in some way obscures his appearance, such as a reflection through smoke or fog."
                            }
                        ]
                    },
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The reflection of the object remains solid and substantial until the next time the Sun rises or sets.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-2",
                                "Situation": "The reflection is not perfectly clear and undistorted"
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The person or object is currently being reflected in the surface"
                            }
                        ]
                    },
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The character can jump twice as far and climb twice as fast as normal for the duration of this scene.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "The character is running or jumping."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The character moves at a normal walking pace."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> In addition to removing all restraints on the character, the door of any room the character is locked into automatically unlocks.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "The character has previously struggled against these bonds."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "Since she was bound, the character has remained calm and not attempted to struggle or free herself by force or dexterity."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> If the changeling wishes, she can spend an additional point of Glamour and take along one other individual, as long as she holds this person’s hand while walking through the door or window. The changeling cannot take along more than one person in this fashion.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "The changeling has no idea what is on the other side of the barrier."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling can clearly see what is on the other side of the barrier."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The Defense bonus lasts for the scene.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-3",
                                "Situation": "The changeling is wearing armor."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The changeling is ill dressed."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling is especially well dressed."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The changeling can pick up small objects (anything small enough to fit into her closed hand) while remaining intangible. The object becomes intangible once her hand closes around it. This may allow her to retrieve small objects from locked boxes.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "The changeling is intent on attacking someone."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling is being pursued and is not attempting to fight back."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> In addition to the above effects, the target is firmly convinced of the changeling’s importance and will argue with anyone who claims otherwise. In his certainty, the target gains +1 die to all rolls to convince others of the changeling’s importance.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling is dressed appropriately for the position she claims."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The changeling is dressed inappropriately for the position she claims."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The changeling delivers an inhumanly excellent performance, adding a number of automatic successes equal to her Wyrd to her next Expression and Persuasion roll, as well as adding the usual bonus dice to all other Expression and Persuasion rolls for the next scene.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1 to +2",
                                "Situation": "The changeling is wearing an unusually fine costume, or using especially well-made instruments or other accoutrements."
                            },
                            {
                                "Modifier": "-1 to -2",
                                "Situation": "The changeling is dressed in an unassuming fashion without special props or accoutrements."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> This effect lasts until the sun next rises or sets (whichever comes first).",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1 to +2",
                                "Situation": "The character is wearing exquisite and expensive clothing."
                            },
                            {
                                "Modifier": "-1 to -2",
                                "Situation": "The character is wearing shabby or cheaply made clothing."
                            },
                            {
                                "Modifier": "-2",
                                "Situation": "The character is wearing a visible weapon."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> All who roll fewer successes than the changeling must either flee or cower helplessly until the awe ceases. Those who roll as many or more successes are at a -2 dice penalty to all actions.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1 to +2",
                                "Situation": "The changeling’s clothing, accoutrements or weapons are especially flamboyant and impressive."
                            },
                            {
                                "Modifier": "-1 to -2",
                                "Situation": "The changeling’s clothing, accoutrements or weapons are bland, shoddy or ill kept."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The performance so completely touches the audience’s hearts that they follow any simple and not obviously foolish or suicidal suggestion that the changeling makes about how to react to the story.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1 to +2",
                                "Situation": "The changeling is wearing or using unusually fine costumes, instruments or other accoutrements."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The character has three or more dots in Presence."
                            },
                            {
                                "Modifier": "+2",
                                "Situation": "The targets are an audience expecting and eager to see a speech or performance."
                            },
                            {
                                "Modifier": "-1 to -2",
                                "Situation": "The changeling is dressed in an unassuming fashion and without special props or accoutrements."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The changeling also gains the 8 again quality for the next action he takes using a Strength- based dice pool.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "The character yells, grunts or boasts loudly about her great strength."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The character acts calm, restrained and sedate."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> No benefit other than that gained from 5+ successes.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "The character attacks the target without taking time to think about it."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The character has carefully studied the target to determine the best way to destroy it."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> Along with bonuses already provided, the character gains the 9 again quality to all appropriate Strength rolls for the scene.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "The character is dressed in a way that shows off his muscles and physique."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The character is dressed in a way that hides his physique."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> Other than more levels of damage being downgraded, no special bonuses.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "The character eats continuously for three or more hours."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The only food and drink available are relatively low-calorie fare."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The available food is especially rich, hardy and abundant."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> No benefit other than that gained from 5+ successes.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling is heavily armed or wearing armor."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The changeling is unarmored and using only improvised weapons."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The character also automatically learns of any hidden compartments or spaces within the object she is examining.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "The character is distracted and not concentrating entirely on the object. Burglars who keep an ear out for guards or the owners of a house they are breaking into suffer this penalty."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The character examines the object for at least five minutes."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The bonus lasts for the entire scene.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-2",
                                "Situation": "The character refrains from even whispering to the device."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The character speaks to the device in a normal conversational volume."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The character can clearly see and hear a greater number of the events surrounding the object or device as it was used or handled. Her vision includes people who were not in physical contact with the object, up to a radius of five yards from the object.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-2",
                                "Situation": "The character does not touch the objects with both hands."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The character polishes, cleans or performs minor maintenance on the various objects."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The changeling can control the device for an entire scene, causing the device to operate as he desires, within the limits of this clause.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-3",
                                "Situation": "The character uses only gestures to direct the object to do what he wants."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The character can see only part of the device, such as being able to see only the grip of a pistol in a holster."
                            },
                            {
                                "Modifier": "+1 to +5",
                                "Situation": "The character gains an additional +1 to this roll for every success he rolls on a Manipulation + Persuasion roll to convince the device to do what he wants. The character must spend at least half a minute convincing the device to act as he wishes and must speak audibly to gain this bonus."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The object remains animated until the sun next rises or sets (whichever comes first), and the changeling can order the object to change actions without needing to roll. As long as the object is within Wyrd x 5 yards away and the changeling can see or hear it clearly, it will instantly obey the changeling.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-2",
                                "Situation": "The character asks the object to do something that will harm or destroy it."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The character asks the object to perform its normal and expected function."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The repair occurs as an ordinary success, except that the repair is as durable and functional as if performed using the correct parts and tools.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "No necessary parts or tools are present."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "All necessary tools are present.The character asks the object to perform its normal and expected function."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling does not personally know the object’s owner or primary user."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> By casually touching the device for a turn, the changeling damages it such that it requires major repairs to be used. These repairs require an extended action, with one roll made every 10 minutes. The number of successes needed to complete the repairs is equal to the number of successes rolled + the changeling’s Wyrd.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "The device is especially well built."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The device is flimsy or ill maintained."
                            },
                            {
                                "Modifier": "+2",
                                "Situation": "The character can touch the device for more than a minute."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> If this Contract is used to bless an object, the object gains the listed bonus for all die rolls made using it until the sun next rises or sets (whichever comes first). If the changeling expended one point of Willpower and used Promise Leaves when performing this Contract, the item gains a permanent bonus equal to half of the changeling’s Wyrd (round up). Alternately, if the changeling uses this Contract to bless a Crafts, Medicine or Computer roll action, she automatically adds an additional +2 dice bonus to the roll or rolls involved.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+2",
                                "Situation": "Taking at least one minute per roll on the extended task."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "Using substandard tools to make a repair roll."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The changeling’s glance causes the vehicle, weapon or other device to need minor repairs or adjustments before it can be used again. These repairs require 10 successes on an extended action, with one roll being attempted once every minute. Repair rolls suffer the changeling’s successes as a penalty.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-2",
                                "Situation": "The changeling cannot see the device or weapon clearly."
                            },
                            {
                                "Modifier": "+2",
                                "Situation": "The changeling touches the device while performing this Contract."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The device functions until the next sunrise. If the changeling also expends one point of Willpower and uses the power of an item from the Hedge to further bless the item, then the item is built sturdily enough to last indefinitely.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-3",
                                "Situation": "The materials are both poor quality and relatively sparse."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The materials are either poor quality or relatively sparse."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The materials are abundant or high quality."
                            },
                            {
                                "Modifier": "+3",
                                "Situation": "The materials are abundant and largely high quality."
                            },
                            {
                                "Modifier": "+2",
                                "Situation": "A wide selection of tools is available."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "Few tools are available."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The change to the image is permanent.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "The image is larger than the changeling."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The changeling is affecting a broadcast image."
                            },
                            {
                                "Modifier": "-1 to -5",
                                "Situation": "-1 per six seconds of moving footage being altered."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling touches the photograph, poster, DVD or videotape."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The object remains in its new form until the sun next rises.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "The changeling does not have a chance to spend at least a minute examining the object before using this Contract upon it."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The changes are especially minor, such as changing the name and address on an ID card."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The character can determine the exact features of the object, such as the name and picture on the passport, the particular model of cell phone or pistol or what sort of ammunition the pistol carries. However, the object still lacks small details such as serial numbers and is no more valuable.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "The changeling is removing the object from a drawer, bag or other object that she has never opened before."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling is removing the object from either her clothing or from a piece of furniture in her home."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The change remains for one full scene.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1 to -3",
                                "Situation": "The change is either large enough that a careful observer might have noticed it before, or unlikely enough that its presence is surprising."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The change is minor and completely expected, such as a room having an additional electrical outlet."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The gateway into the Hedge remains open for half an hour, allowing the characters to come and go as they please during this time. At the end of this time, the entrance vanishes and cannot be reopened except by using this clause again in the mortal world.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-2",
                                "Situation": "The character visited this location in the Hedge only once and hurried through it so rapidly that she was unable to gain a clear impression of it."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The character has visited the location in question several times and knows it well."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The subject gains +1 Stamina for the duration of the scene.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "Each point of fatigue penalty the subject suffers"
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "Each point of damage from deprivation the subject suffers"
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The character makes exceptional progress toward her goal.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "Extensive cloud cover"
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "Exceedingly clear day"
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The target object experiences up to a full year’s worth of growth (as much between one season and one year as the changeling desires). The full cycle of the year is visible and may provide fruit or other benefits.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "Object fits entirely in the palm of the hand (peach pit, mayfly grub)."
                            },
                            {
                                "Modifier": "—",
                                "Situation": "Object is approximately Size 1."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "Each point by which the target object/creature is greater in Size than 1."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "Each additional object (affecting a group of seeds or a small group of ants)."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The plants fight for the character for the rest of the scene, and all new growth remains afterward.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "Bountiful plant life (rainforest)"
                            },
                            {
                                "Modifier": "—",
                                "Situation": "Moderate plant life (rural area)"
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "Weak plant life (city trees)"
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "Controlled plant life (city park)"
                            },
                            {
                                "Modifier": "-3",
                                "Situation": "Sparse plant life (city street with occasional fenced-in trees)"
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> Exceptional success at Cupid’s Eye provides the character with two desires of the targeted level, or the knowledge that there is only one desire at that level.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "The character has a pledge with the subject."
                            },
                            {
                                "Modifier": "—",
                                "Situation": "The character discerns a desire currently in the forefront of the subject’s mind."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The character learns a desire not currently concerning the subject."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The character learns a specific kind of desire (sexual, employment, etc.)."
                            },
                            {
                                "Modifier": "-2",
                                "Situation": "The character discovers a desire the subject recognizes but generally keeps hidden."
                            },
                            {
                                "Modifier": "-3",
                                "Situation": "The character finds a desire the subject hides even from himself."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The change is instead permanent. The inflicted desires remain until the character chooses to release them, and they may then become natural.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "The character changes a momentary desire."
                            },
                            {
                                "Modifier": "—",
                                "Situation": "The character changes a long-term desire."
                            },
                            {
                                "Modifier": "—",
                                "Situation": "The character changes a desire to something similar (e.g., lust for one man to lust for another)."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The character changes a desire concealed from others."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The character changes a desire moderately (e.g., from wanting a cat to wanting a Nintendo)."
                            },
                            {
                                "Modifier": "-2",
                                "Situation": "The character changes a desire the subject conceals from himself."
                            },
                            {
                                "Modifier": "-2",
                                "Situation": "The character changes a desire significantly (e.g., a desire for the Nobel Prize becomes the desire for a family)."
                            },
                            {
                                "Modifier": "-5",
                                "Situation": "The character eliminates a desire or creates one from scratch."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The deception lasts as long as the changeling would like to maintain it.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "The character knows the subject’s current desire(s)."
                            },
                            {
                                "Modifier": "—",
                                "Situation": "The character approaches the subject “blind.”"
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The character makes significant progress toward creating the object.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "Exceptionally appropriate materials"
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "Exceptionally inappropriate materials"
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "Object is exceptional (per point of equipment bonus above normal)"
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "One-hour duration"
                            },
                            {
                                "Modifier": "-2",
                                "Situation": "One-day duration"
                            },
                            {
                                "Modifier": "-3",
                                "Situation": "Two-day duration"
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The character rolls many more successes than the subject and makes great headway.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "The character knows what the target’s greatest desires are."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "Five-minute duration"
                            },
                            {
                                "Modifier": "—",
                                "Situation": "One scene’s duration"
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "One-hour duration"
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The crowd is so completely affected that their attitude and demeanor as a group is moved entirely in the direction that the changeling desired.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "The character has successfully performed Cupid’s Eye (Fleeting Spring •) upon a  member of the crowd and uncovered desires of the kind that he is attempting to spark. (Cumulative bonus)"
                            },
                            {
                                "Modifier": "-3",
                                "Situation": "The crowd is actively gathered for a reason which directly opposes the desired reaction (i.e. inspiring violence in a peace rally, or turning a loyal gathering of changelings against the leader they have gathered to protect)."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The effects last for a full day. With the point of Willpower, the area around the character remains comfortably warm no matter what (i.e., heated air will not be lost when doors are opened).",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "Every 20 degrees below zero or above 120 degrees Fahrenheit."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The space to be heated is Size 10."
                            },
                            {
                                "Modifier": "-2",
                                "Situation": "The space to be heated is Size 20."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The character also increases his Stamina by one for the rest of the scene.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "The sun is in the sky and clearly visible."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "It is after dark."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> Subjects of this clause rationalize the change of focus and anger to themselves after the fact. (“He was on her side,” “I knew he was talking trash about me,” etc.)",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+3",
                                "Situation": "The subject redirects anger onto the character."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The subject has no reason to be angry at new target."
                            },
                            {
                                "Modifier": "-2",
                                "Situation": "The subject likes or is loyal to new target."
                            },
                            {
                                "Modifier": "-3",
                                "Situation": "The subject redirects anger off the character."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The character is at +2 dice bonus when using other Fleeting Summer clauses on the subject for the rest of the scene, and +1 die bonus when using Friendless Tongue on the subject for the rest of the month.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "The subject is easily roused to anger."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The subject has “issues” with her current focus."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The subject is extremely unlikely to become angry at her current focus under normal circumstances."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> Combat ends. Even if the people involved cannot resolve their differences, they refuse to use violent means of interacting with one another for the rest of the scene. The character may not use this Contract again for the rest of the scene.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "A significant fraction of combatants fight reluctantly."
                            },
                            {
                                "Modifier": "-",
                                "Situation": "Two people are targeted."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "Four people are targeted."
                            },
                            {
                                "Modifier": "-2",
                                "Situation": "Eight people are targeted."
                            },
                            {
                                "Modifier": "-3",
                                "Situation": "Twelve people are targeted."
                            },
                            {
                                "Modifier": "-4",
                                "Situation": "Twenty people are targeted."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The bonus to Physical rolls rises to +4.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "The character is expected to fight."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The character is up against losing odds."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The character’s opponent is (perceived as) inferior."
                            }
                        ]
                    }
                ],
        ...
        "FullDescription": [
            ...
            "Any of the clauses within this contract are subject to the same set of potential modifiers.",
            {
                "Suggested Modifiers": [
                    {
                        "Modifier": "+2",
                        "Situation": "Performed during summer"
                    },
                    {
                        "Modifier": "+1",
                        "Situation": "Sun is at its apex in the sky (between 11AM — 1PM)"
                    },
                    {
                        "Modifier": "-1",
                        "Situation": "Performed at night"
                    },
                    {
                        "Modifier": "-2",
                        "Situation": "Performed during winter"
                    }
                ]
            },
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> If the character achieves an exceptional success on the extended roll (gaining five successes in total beyond what was necessary to activate the clause), she may add a stipulation to the clause that allows for those with dots in Mantle (Summer) to remain unaffected by the Scorched Earth effects.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "Meditative Mind Merit"
                            },
                            {
                                "Modifier": "-1",
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The entire plant is affected, even when the character could only target a portion.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "Within a month (either way) of the plant’s natural harvest season"
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The month opposite the plant’s natural harvest season"
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The character can completely kill a plant. She may also choose to make the plant act as though it were Winter for a full year and a day, recovering only when Spring comes after that time.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "Plant is not overly robust or well cared for."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "Plant is remarkably robust and well cared for."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The character makes excellent progress.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "Already cloudy and cold"
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "Not cloudy at all"
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "Completely unseasonal"
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The character learns two fears of the targeted level, if there are two such fears to be had.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "The character has a pledge with the target."
                            },
                            {
                                "Modifier": "-",
                                "Situation": "The character discerns a fear currently in the forefront of the target’s mind."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The character learns a fear not currently concerning the target."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The character learns a specific kind of fear (i.e., Halloween monsters, school-related, etc.)."
                            },
                            {
                                "Modifier": "-2",
                                "Situation": "The character discovers a fear the target recognizes but generally keeps hidden."
                            },
                            {
                                "Modifier": "-3",
                                "Situation": "The character finds a fear the target hides even from herself."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The character’s seed bears a rich harvest. Add the character’s Wyrd rating to the number of turns the subjects must flee or cower",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "Spooky ambiance (graveyard, skeletal orchard)"
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "Every five people in crowd/at party not subject to the Contract"
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "Comfortable, safe ambiance (lit dining hall, kindly dean’s office)"
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The protection lasts until the next sunrise.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "The character invokes the clause in a supportive environment (i.e., surrounded by friends, in a comfortable sanctum or under the reassuring sun)."
                            },
                            {
                                "Modifier": "-1 to -3",
                                "Situation": "The character invokes the clause when she is already nervous (i.e., surrounded by zombies, in a vampire’s haven or lost in a misty graveyard at night)."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The protection lasts until the next sunrise.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "The character’s allies are in a supportive environment (i.e., surrounded by friends, in a comfortable sanctum or under the reassuring sun)."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "Each point of dice penalty to rolls that would cause supernatural fear (to a maximum of the character’s Wyrd)."
                            },
                            {
                                "Modifier": "-1 to -3",
                                "Situation": "The character’s allies are already nervous (i.e., surrounded by zombies, in a vampire’s haven or lost in a misty graveyard at night)."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The subject of this Contract loses a point of Willpower and loses access to his Defense until the end of the next turn.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "The character has been building up the subject’s fear."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The locale has appropriate ambiance (e.g., abandoned school for the fear of a teacher)."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "Someone has been bolstering the subject against this fear."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The locale is unsupportive of the fear’s appearance (e.g., Freddy Krueger at a sunny picnic)."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The cooling lasts as long as the character desires before returning to normal.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "Every 20 degrees Fahrenheit of cooling."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The room is Size 20."
                            },
                            {
                                "Modifier": "-2",
                                "Situation": "The room is Size 40."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The character may instantly return the frozen liquid to its original liquid form, as long as he chooses to do so within the same scene.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "Liquid is already near its freezing point"
                            },
                            {
                                "Modifier": "-",
                                "Situation": "The area of a bathtub"
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The area of a driveway"
                            },
                            {
                                "Modifier": "-2",
                                "Situation": "The area of a swimming pool"
                            },
                            {
                                "Modifier": "-3",
                                "Situation": "The area of a parking lot"
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The field lasts the entire scene, or until the changeling falls unconscious or dies.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+2",
                                "Situation": "Already quite cold"
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "Already chilly"
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "Warm day"
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> If the subject is not currently sad but was within the last hour, the character finds out the cause of that and why it ended.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "The emotion is evident."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The subject is hard to see."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The character may, if he so desires, cause the subject to remain blissfully ignorant for a full hour.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "Minor or distant sorrow (goldfish died, weeping over the state of the world)"
                            },
                            {
                                "Modifier": "-2",
                                "Situation": "Deeply personal tragedy (entire branch of the family dead in accident)"
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The character may also choose to trigger another such event (which may or may not be a different memory) at a set time within the next 24 hours.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "The subject has a doleful personality."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The subject is naturally upbeat."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "Something good just happened to the subject."
                            },
                            {
                                "Modifier": "-3",
                                "Situation": "The subject has no genuinely sad memories (a truly innocent child, for instance)."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The subject’s positive emotions remain deadened until the changeling releases them.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "The subject is already sad."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The subject is experiencing positive emotions currently."
                            },
                            {
                                "Modifier": "-2",
                                "Situation": "The subject’s positive emotions are notably strong."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The subject’s emotion so overwhelms her that she loses her Defense for the Contract’s duration.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+2",
                                "Situation": "The subject’s sorrow is already great."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The subject’s sorrow is strong."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The subject’s sorrow is quite minor."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The character learns two motivations of the specified action or statement or that only a single motivation exists for it.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-",
                                "Situation": "The statement or action is currently happening or just happened in the last turn."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The specified statement or action is not currently pertinent to the situation at hand (ie: is not being discussed, was not recently witnessed, a similar situation is not happening, etc.)"
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling was present for the statement or action."
                            },
                            {
                                "Modifier": "-3",
                                "Situation": "The changeling was not present, but only heard about it second hand."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The motives for the specified action or statement are something the targeted individual is actively hiding or considers a secret."
                            },
                            {
                                "Modifier": "-3",
                                "Situation": "The targeted individual is not, himself, aware of his motivations for the specified action or statement."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> As with a normal success, but the targets’ bonuses last for 24 hours.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "At least half the targeted group is Dusk Court."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling has bested at least one of the target group in combat within the last 24 hours."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> As with a normal success, but the target’s penalty curse lasts for 24 hours.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling is wielding an axe."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling and his target have already exchanged blows within the last 24 hours."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The target’s allies in the immediate area outnumber the changeling’s allies in the immediate area (+1 for each ally over to a maximum of +5)"
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The changeling’s allies in the immediate area outnumber the target’s allies in the immediate area (-1 for each ally over to a maximum of -5)"
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The Contract is nullified, and none of the previously-mentioned tests can be made to determine where the dispelling came from. This does not stop others from assuming the Lost is guilty, if they are aware of her ability to cancel Contracts, nor does it protect her action from being sensed by other abilities or Contracts (such as Wyrd’s Eye.)",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "The Lost who activated the targeted Contract is of a higher Wyrd than the changeling attempting to cancel it (-1 per level higher)"
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling has witnessed the specific Contract she is attempting to nullify being activated"
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling spends additional Glamour into her efforts (beyond the required 2, +1 modifier per extra Glamour spent up to a maximum of 3)"
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> Any roll the character gives the rote quality to also gains the 8 again quality. In any chance roll, the target must roll the chance die twice and take the worse of the two rolls.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "The character is using the roll to cause someone else to come to harm."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The character is using this Contract in advance of the roll being made."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> A chance roll becomes a normal roll at the character’s full dice pool, with an added bonus equal to the character’s Wyrd. A normal, non-chance roll gains a total of 10 successes for normal and extended actions.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "The changeling cannot clearly see the character making the roll."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling is fighting a duel or other prearranged battle."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The curse continues to affect the target for three full days.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-2",
                                "Situation": "The changeling does not know the target’s name."
                            },
                            {
                                "Modifier": "+2",
                                "Situation": "The changeling is touching the target."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The pursuers or attackers are distracted for one hour, and after this time, the pursuers lose all interest in pursuing the characters. If the pursuers either have an excellent reason to continue to pursuit or are compelled to do so, perhaps because the characters are wanted fugitives, the pursuit continues but becomes desultory and is regarded as a relatively low priority. However, if the characters attack their pursuers or otherwise call negative attention to themselves, the effects of this Contract instantly end and pursuing the characters again becomes an important priority.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-2",
                                "Situation": "The changeling or one of her companions has already caused at least one of the pursuers or attacks to suffer at least one point of aggravated damage."
                            },
                            {
                                "Modifier": "+2",
                                "Situation": "The changeling and one of her companions have done no damage to any of the attackers or pursuers during the pursuit or attack."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The power of the ritual is sufficient that it prevents anyone outside of the immediate vicinity of the changeling and the fetch from hearing or seeing anything out of the ordinary, including any sounds of struggle or cries for help. Also, the rescued victim may or may not remember what happened, but is not traumatized by the event.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "The changeling is being paid to save the target."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The target is a blood relative of the changeling."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The target does not fall un- conscious and also heals all wounds twice as fast as normal for the next week.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "The changeling is using this Contract on himself."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The target was injured within the last five minutes or has just noticed symptoms of her illness."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The changeling loses a dot of Willpower, and the target becomes seven years younger. The target cannot become more than physically younger than 20 years old and ages normally.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "The changeling is being paid for the use of this Contract."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The Contract is being used without the target’s knowledge."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The relationship formed with the target is especially close and lasting. A target who disliked the character becomes the character’s friend or ally, and a target who already liked the character, then the relationship is no closer, but it is considerably more durable, and the character would need to ignore or mistreat the target for several weeks to cause the target’s affection for them to begin to fade.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-2",
                                "Situation": "The changeling secretly hates the target and is using this Contract as a way to harm her."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling honestly likes the target."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The target’s belief in the opinion she has been given is especially strong and tenacious, and so the level of proof necessary to dissuade the target of it is especially high. In effect, this belief becomes one of the target’s core beliefs and is very difficult to change.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-2",
                                "Situation": "The character is able to talk to the target about this opinion for less than 30 seconds."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The character is able to talk to the target about this opinion for more than five minutes."
                            }
                        ]
                    }
                ],
                ...
                "Roll Results": [
                    ...
                    "<b>Exceptional Success:</b> The target dies instantly, and only powerful magic can save his life. No amount of mundane medical treatment will save the character.",
                    {
                        "Suggested Modifiers": [
                            {
                                "Modifier": "-1",
                                "Situation": "The target is a supernatural being."
                            },
                            {
                                "Modifier": "-1",
                                "Situation": "The changeling cannot clearly see the target’s face."
                            },
                            {
                                "Modifier": "+1",
                                "Situation": "The changeling is touching the target."
        ...
        "Roll Results": [
            ...
            "<b>Exceptional Success:</b> Beyond greatly reducing the penalties to ranged attacks, no further bonus is gained.",
            {
                "Suggested Modifiers": [
                    {
                        "Modifier": "+1",
                        "Situation": "The character is using a weapon she has owned for at least a month that serves as her primary ranged weapon."
                    },
                    {
                        "Modifier": "-1",
                        "Situation": "The character is using a weapon she has never used before."
                    }
                ]
            }
        ],
        ...
        "Roll Results": [
            ...
            "<b>Exceptional Success:</b> The character can also tell truth from falsehood in recorded media such as television shows or in print.",
            {
                "Suggested Modifiers": [
                    {
                        "Modifier": "-1",
                        "Situation": "The character has told a lie within the last scene."
                    },
                    {
                        "Modifier": "+1",
                        "Situation": "The character is acting as a judge or is otherwise charged with determining the truth of statements or events."
                    }
                ]
            }
        ],
        ...
        "Roll Results": [
            ...
            "<b>Exceptional Success:</b> The character makes an unusually accurate guess, winning $50 at the lottery, guessing the next two turns that someone fleeing will make.",
            {
                "Suggested Modifiers": [
                    {
                        "Modifier": "+1",
                        "Situation": "Taking a few minutes to carefully examine the situation"
                    },
                    {
                        "Modifier": "-1",
                        "Situation": "Making an instant guess"
                    }
                ]
            }
        ],
        ...
        "Roll Results": [
            ...
            "<b>Exceptional Success:</b> Instead of merely acting once, the Contract remains active for a number of attacks equal to the character’s Wyrd.",
            {
                "Suggested Modifiers": [
                    {
                        "Modifier": "-1",
                        "Situation": "The character has already used this Contract once within the last day."
                    },
                    {
                        "Modifier": "+2",
                        "Situation": "The character offers the guardian a goblin fruit as payment."
                    }
                ]
            }
        ],
        ...
        "Roll Results": [
            ...
            "<b>Exceptional Success:</b> The character manages to extract enough dream-stuff to augment two tokens, though each still requires a successful Dexterity + Crafts roll to complete.",
            {
                "Suggested Modifiers": [
                    {
                        "Modifier": "+1",
                        "Situation": "The object pulled from dreams is Size 3 or larger."
                    },
                    {
                        "Modifier": "+2",
                        "Situation": "The object pulled from dreams came from a target that is currently asleep."
                    },
                    {
                        "Modifier": "-1",
                        "Situation": "The object pulled from dreams is Size 1."
                    },
                    {
                        "Modifier": "-2",
                        "Situation": "The object pulled from dreams comes from a source not wholly human."
                    }
                ]
            }
        ],
        ...
        "Roll Results": [
            ...
            "<b>Exceptional Success:</b> Beyond the advantages gained by rolling multiple successes, no special bonus is gained.",
            {
                "Suggested Modifiers": [
                    {
                        "Modifier": "+1",
                        "Situation": "The subject of the divination is present."
                    },
                    {
                        "Modifier": "-1",
                        "Situation": "The changeling knows the target moderately well (such as a co-worker), or has visited him regularly."
                    },
                    {
                        "Modifier": "-2",
                        "Situation": "The changeling has encountered the person, place or object several times."
                    },
                    {
                        "Modifier": "-4",
                        "Situation": "The changeling has only encountered the target once."
                    }
                ]
            }
        ],
        ...
        "Roll Results": [
            ...
            "<b>Exceptional Success:</b> The desired door shows no trace of having been opened by the character, and any cameras or recording equipment associated with the door do not record the character’s presence.",
            {
                "Suggested Modifiers": [
                    {
                        "Modifier": "-1 to -3",
                        "Situation": "Especially complex or secure locks"
                    },
                    {
                        "Modifier": "+1",
                        "Situation": "Carrying an article of clothing or a photograph of someone who regularly unlocks the door"
                    }
                ]
            }
        ],
        ...
        "Roll Results": [
            ...
            "<b>Exceptional Success:</b> As an ordinary success, except that the Mask lasts until the next sunrise and witnesses do not gain a Wits + Composure roll to recognize the changeling’s involvement.",
            {
                "Suggested Modifiers": [
                    {
                        "Modifier": "-3",
                        "Situation": "Disguising an object of no inherent value as something of great worth (a pebble on a string for a diamond necklace)"
                    },
                    {
                        "Modifier": "-2",
                        "Situation": "Disguising an object of no inherent worth as something of moderate worth (dry leaves for $20 bills)"
                    },
                    {
                        "Modifier": "-1",
                        "Situation": "Disguising multiple similar objects (a handful of bottle caps into a handful of Spanish doubloons)"
                    },
                    {
                        "Modifier": "-1",
                        "Situation": "Disguising an object of moderate worth as something of great worth (semiprecious necklace for diamond necklace)"
                    },
                    {
                        "Modifier": "-",
                        "Situation": "Disguising an object of minor value as one of moderate value ($5 bill for $20 bill)"
                    }
                ]
            }
        ],
        ...
        "Roll Results": [
            ...
            "<b>Exceptional Success:</b> As above, but any damage suffered during the dream is considered bashing rather than lethal damage.",
            {
                "Suggested Modifiers": [
                    {
                        "Modifier": "+1",
                        "Situation": "The dreamer is personally known to the changeling"
                    },
                    {
                        "Modifier": "+2",
                        "Situation": "The dreamer shares a dream pledge or task with the changeling"
                    },
                    {
                        "Modifier": "-1",
                        "Situation": "The dreamer is a complete stranger to the changeling"
                    },
                    {
                        "Modifier": "-2",
                        "Situation": "The Contract is used on the same dreamer for successive nights"
                    }
                ]
            }
        ],
        ...
        "Roll Results": [
            ...
            "<b>Exceptional Success:</b> The character can cause the target to forget the incident and any conversations or other events that caused the target to think or talk about this incident.",
            {
                "Suggested Modifiers": [
                    {
                        "Modifier": "-1",
                        "Situation": "The character is attempting to cause the target to forget events that were of deep personal importance to the target."
                    },
                    {
                        "Modifier": "+1",
                        "Situation": "Forgetting the events in question will make the target happier."
                    }
                ]
            }
        ],
        ...
        "Roll Results": [
            ...
            "<b>Exceptional Success:</b> Regardless of severity, the target’s injuries are completely healed.",
            {
                "Suggested Modifiers": [
                    {
                        "Modifier": "+2",
                        "Situation": "The target literally saved the changeling’s life, sustaining the injury."
                    },
                    {
                        "Modifier": "+1",
                        "Situation": "The changeling injured the target."
                    },
                    {
                        "Modifier": "-1",
                        "Situation": "The changeling is only slightly acquainted with the target."
                    },
                    {
                        "Modifier": "-3",
                        "Situation": "The changeling has never encountered the target before."
                    }
                ]
            }
        ],
        ...
        "Roll Results": [
            ...
            "<b>Exceptional Success:</b> The attack fails to strike the character but is rolled anyway to determine the number of successes to be added to the next attack.",
            {
                "Suggested Modifiers": [
                    {
                        "Modifier": "+2",
                        "Situation": "The attack being blocked would incapacitate or kill the character."
                    },
                    {
                        "Modifier": "+1",
                        "Situation": "The character is already injured."
                    },
                    {
                        "Modifier": "-1",
                        "Situation": "The character is wearing armor."
                    }
                ]
            }
        ],
        ...
        "Roll Results": [
            ...
            "<b>Exceptional Success:</b> As per success, save that the length of the effect becomes the number of successes the changeling rolled multiplied by her Wyrd in hours and can be ended at will.",
            {
                "Suggested Modifiers": [
                    {
                        "Modifier": "+3",
                        "Situation": "Changeling has some personal effect of the subject (hair, fingernail clipping, underwear, etc.); if the character has such an item, the below penalty does not apply"
                    },
                    {
                        "Modifier": "-1 to -5",
                        "Situation": "Familiarity with the subject, ranging from intimate friend or lover (-1) to casual acquaintance (-3) to someone seen once or twice from a distance (-5)"
                    },
                    {
                        "Modifier": "-10",
                        "Situation": "Subject is a complete stranger, but the character has some image of her available for reference. If the character doesn’t know what the subject looks like, she can’t attempt to use this Contract."
                    }
                ]
            }
        ],
        ...
        "Roll Results": [
            ...
            "<b>Exceptional Success:</b> Both people swearing the oath must make an exceptional success on the Resolve + Composure roll needed to break the oath in order to do so; an ordinary success does not allow either party to break the oath. Also, even if the character does roll an exceptional success, he still suffers a number of disasters equal to the changeling’s Wyrd, where an important roll becomes a change roll.",
            {
                "Suggested Modifiers": [
                    {
                        "Modifier": "-1",
                        "Situation": "The other party is swearing the oath under duress."
                    },
                    {
                        "Modifier": "+1",
                        "Situation": "The changeling and the other party swear the same oath."
                    }
                ]
            }
        ],
        ...
        "Roll Results": [
            ...
            "<b>Exceptional Success:</b> The guesser can make a one in 100,000 guess, potentially winning as much as $5,000.",
            {
                "Suggested Modifiers": [
                    {
                        "Modifier": "+1",
                        "Situation": "The character has at least two or three minutes to consider her guess."
                    },
                    {
                        "Modifier": "-1",
                        "Situation": "The character has only a few moments to make her guess."
                    }
                ]
            }
        ],
        ...
        "Roll Results": [
            ...
            "<b>Exceptional Success:</b> The hunting party arrives the turn after the character performs this Contract.",
            {
                "Suggested Modifiers": [
                    {
                        "Modifier": "+1",
                        "Situation": "The changeling yells loudly for the hunt to come."
                    },
                    {
                        "Modifier": "-1",
                        "Situation": "The changeling performs this Contract while deliberately hidden."
                    }
                ]
            }
        ],
        ...
        "Roll Results": [
            ...
            "<b>Exceptional Success:</b> The crowd becomes exceptionally violent, starting fires, causing massive property destruction, and attacking with murderous violence anyone who is an obvious target. The crowd is also motivated enough to march as far as a mile or two to gain access to an obvious target. If there are other people nearby who would have any chance of joining this riot, they will, and the riot can easily spread.",
            {
                "Suggested Modifiers": [
                    {
                        "Modifier": "-3",
                        "Situation": "The crowd is peaceful and subdued, and a riot is exceptionally unlikely"
                    },
                    {
                        "Modifier": "-1",
                        "Situation": "There is no clear target for the crowd’s negative feelings"
                    },
                    {
                        "Modifier": "+1",
                        "Situation": "An obvious target for the crowd’s negative feelings is nearby"
                    },
                    {
                        "Modifier": "+3",
                        "Situation": "The crowd is already angry and could potentially riot without incitement"
                    }
                ]
            }
        ],
        ...
        "Roll Results": [
            ...
            "<b>Exceptional Success:</b> Additional successes are their own reward.",
            {
                "Suggested Modifiers": [
                    {
                        "Modifier": "-2",
                        "Situation": "The subject is undead (vampire, zombie, promethean, etc.)"
                    },
                    {
                        "Modifier": "-3",
                        "Situation": "The weather is rainy or the subject’s skin is otherwise particularly wet"
                    },
                    {
                        "Modifier": "-5",
                        "Situation": "The subject is a normally-ephemeral entity, such as a ghost or spirit; this penalty applies even when such an entity is manifested"
                    }
                ]
            }
        ],
        ...
        "Roll Results": [
            ...
            "<b>Exceptional Success:</b> For the next scene, the target cannot be affected by any supernatural protections, even those placed on him by other characters.",
            {
                "Suggested Modifiers": [
                    ...
                    {
                        "Modifier": "+2",
                        "Situation": "The changeling knows the target’s true name and shouts it when performing this Contract."
                    }
                ]
            }
        ],
        ...
        "Roll Results": [
            ...
            "<b>Exceptional Success:</b> If the creator rolls 10 or more successes, the ward lasts for an additional month without further expenditure on the part of the changeling.",
            {
                "Suggested Modifiers": [
                    {
                        "Modifier": "-2",
                        "Situation": "Ward is set anywhere aside from the Hedge or Arcadia"
                    }
                ]
            }
        ],
        ...
        "Roll Results": [
            ...
            "<b>Exceptional Success:</b> In addition to the escape, the character’s captors or pursuers cannot find any trace of how she escaped or where she went. These traces are still visible to the new enemy that finds her location.",
            {
                "Suggested Modifiers": [
                    {
                        "Modifier": "+3",
                        "Situation": "The changeling is escaping pursuit instead of capture."
                    },
                    {
                        "Modifier": "+1 to +2",
                        "Situation": "The changeling is poorly guarded or in a flimsy prison."
                    },
                    {
                        "Modifier": "-1 to -2",
                        "Situation": "The changeling is well guarded or in a well- built cell."
                    },
                    {
                        "Modifier": "-4",
                        "Situation": "The changeling is imprisoned in a way almost impossible to escape from."
                    }
                ]
            }
        ],
        ...
        "Roll Results": [
            ...
            "<b>Exceptional Success:</b> With an exceptional success, instead of following the Gentry, the dreaming changeling can shift his point of view and explore the Domain or area of the Hedge the Gentry is currently in. If the True Fae leaves that Domain or the Hedge, the dream shifts its focus back to the True Fae.",
            {
                "Suggested Modifiers": [
                    {
                        "Modifier": "+1",
                        "Situation": "The changeling uses both the name and a Title of the targeted True Fae"
                    },
                    {
                        "Modifier": "+2",
                        "Situation": "The changeling uses the Contract to target his Keeper"
                    },
                    {
                        "Modifier": "-1",
                        "Situation": "The targeted Gentry isn’t in Arcadia or the Hedge"
                    },
                    {
                        "Modifier": "-2",
                        "Situation": "The changeling is currently sharing his dream with other changelings"
                    }
                ]
            }
        ],
        ...
        "Roll Results": [
            ...
            "<b>Exceptional Success:</b> The machines are badly damaged and the needed repairs require an extended action, with one roll being attempted every 10 minutes for each machine. The number of successes needed to complete the repairs is equal to the number of successes rolled by the changeling + the changeling’s Wyrd.",
            {
                "Suggested Modifiers": [
                    {
                        "Modifier": "-1",
                        "Situation": "The changeling wears armor to protect against the damage"
                    },
                    {
                        "Modifier": "+1",
                        "Situation": "The character makes a loud speech about why the machines need to be destroyed as they use this Contract"
                    }
                ]
            }
        ],
...
const flattenRankedContractData = (data) => data.flatMap(({ Ranks = [], ...parent }) => [
    parent,
    ...Ranks
]);

const universalContractFlatData = flattenRankedContractData(universalContractData);
const beastlyContractsFlatData = flattenRankedContractData(beastlyContractsData);
const darklingContractsFlatData = flattenRankedContractData(darklingContractsData);
const elementalContractsFlatData = flattenRankedContractData(elementalContractsData);
const fairestContractsFlatData = flattenRankedContractData(fairestContractsData);
const ogreishContractsFlatData = flattenRankedContractData(ogreishContractsData);
const wizenedContractsFlatData = flattenRankedContractData(wizenedContractsData);

const springCourtContractsFlatData = flattenRankedContractData(springCourtContractsData);
const summerCourtContractsFlatData = flattenRankedContractData(summerCourtContractsData);
const autumnCourtContractsFlatData = flattenRankedContractData(autumnCourtContractsData);
const winterCourtContractsFlatData = flattenRankedContractData(winterCourtContractsData);
const minorCourtContractFlatData = flattenRankedContractData(minorCourtContractData);
const goblinContractFlatData = flattenRankedContractData(goblinContractData);
const unclassifiedGoblinContractFlatData = unclassifiedGoblinContractData;

const allContracts = [
    ...filtreArrayOfObjects(universalContractFlatData, "Name", ["N/A", "•", "••", "•••", "••••", "•••••"]),
    ...filtreArrayOfObjects(beastlyContractsFlatData, "Name", ["N/A", "•", "••", "•••", "••••", "•••••"]),
    ...filtreArrayOfObjects(darklingContractsFlatData, "Name", ["N/A", "•", "••", "•••", "••••", "•••••"]),
    ...filtreArrayOfObjects(elementalContractsFlatData, "Name", ["N/A", "•", "••", "•••", "••••", "•••••"]),
    ...filtreArrayOfObjects(fairestContractsFlatData, "Name", ["N/A", "•", "••", "•••", "••••", "•••••"]),
    ...filtreArrayOfObjects(ogreishContractsFlatData, "Name", ["N/A", "•", "••", "•••", "••••", "•••••"]),
    ...filtreArrayOfObjects(wizenedContractsFlatData, "Name", ["N/A", "•", "••", "•••", "••••", "•••••"]),
    ...filtreArrayOfObjects(springCourtContractsFlatData, "Name", ["N/A", "•", "••", "•••", "••••", "•••••"]),
    ...filtreArrayOfObjects(summerCourtContractsFlatData, "Name", ["N/A", "•", "••", "•••", "••••", "•••••"]),
    ...filtreArrayOfObjects(autumnCourtContractsFlatData, "Name", ["N/A", "•", "••", "•••", "••••", "•••••"]),
    ...filtreArrayOfObjects(winterCourtContractsFlatData, "Name", ["N/A", "•", "••", "•••", "••••", "•••••"]),
    ...filtreArrayOfObjects(minorCourtContractFlatData, "Name", ["N/A", "•", "••", "•••", "••••", "•••••", "Directional Court Contracts", "Auroral Court Contracts"]),
    ...filtreArrayOfObjects(goblinContractFlatData, "Name", ["N/A", "•", "••", "•••", "••••", "•••••"]),
    ...filtreArrayOfObjects(unclassifiedGoblinContractFlatData, "Name", ["N/A", "•", "••", "•••", "••••", "•••••"])
];

export {
    universalContractData, universalContractFlatData, beastlyContractsData, beastlyContractsFlatData,
    darklingContractsData, darklingContractsFlatData, elementalContractsData, elementalContractsFlatData,
    fairestContractsData, fairestContractsFlatData, ogreishContractsData, ogreishContractsFlatData,
    wizenedContractsData, wizenedContractsFlatData, springCourtContractsData, springCourtContractsFlatData,
    summerCourtContractsData, summerCourtContractsFlatData, autumnCourtContractsData, autumnCourtContractsFlatData,
    winterCourtContractsData, winterCourtContractsFlatData, minorCourtContractData, minorCourtContractFlatData,
    goblinContractData, goblinContractFlatData, unclassifiedGoblinContractData, unclassifiedGoblinContractFlatData, allContracts
}
