const dreadPowersData = [
        ...
        "Effect": [
            ...
            "This Dread Power only works once per scene.",
            {
                ...
                content: [
                    ...
                    " The power source doesn't absorb properly. The monster is shocked and pained, and denied her Defense for the remainder of the scene.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    ...
                    " The monster absorbs the power, and can maintain the effect for a number of turns equal to her successes.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    ...
                    " The monster absorbs the power and channels it efficiently. She regenerates all bashing damage each turn, and regains a number of lethal damage equal to her Absorb Energy dots as long as she remains in contact with the energy source.",
                ],
            }
    ...
    },
    {
        ...
        "Effect": [
            ...
            "The monster must maintain line of sight with the target, and cannot do anything but move up to its Speed whilst concentrating. If concentration is broken, or line of sight is blocked, the power ends and the victim is released. Otherwise, the power lasts a number of turns equal to dots in Agonize.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The Dread Power cannot be activated for the rest of the story.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Failure:" },
                    " The monster fails to inflict pain on the target, but may spend another Willpower next turn and try again.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Success:" },
                    " The target suffers virtual wound penalties equal to successes rolled (to a maximum of -3). The target cannot be knocked unconscious by this power, but remains conscious, in sheer agony for the rest of the scene. The target can still apply Defense to an attack, but doing anything else is nigh impossible. Each turn, the target may attempt a Resolve + Stamina roll to break free; success ends the Dread Power.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " The target must make a Resolve + Composure roll to be able to do anything other than stand and scream.",
                ],
            },
    ...
    },
    {
        ...
        "Effect": [
            ...
            "Use of this power requires eye contact. The vampire acts almost as a hypnotist, asking questions and drawing out memories—memories she soon replaces with her own recalculated recollections.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The attempt fails: the vampire cannot use any Dread Powers upon that victim for the next 24 hours. Also, if the victim has a derangement, the vampire now suffers from that derangement without the possibility of controlling it for the remainder of the scene.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Failure:" },
                    " The vampire fails to access the victim’s memories.",
                ],
            },
            {
                type: 'paragraph',
            ...
            {
                'Suggested Modifiers': [
                    { Modifier: "+2", Situation: "Victim is a blood-addicted servant of the vampire (see Thralls to the Blood)" },
    ...
    },
    {
        ...
        "Effect": [
            ...
            "Note that any vampires possessing this Dread Power can also communicate roughly with a creature without necessitating a roll. The two creatures communicate in vague turns of emotion and broken thoughts alongside yips, chirps, growls or however the animal might normally communicate with its brethren. Simple messages are easier to convey and understand than more complex ones.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The animal either attacks the vampire or does the opposite of the vampire’s command.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Success:" },
                    " The animal obeys its orders to the best of its ability.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " The animal develops a strong affection (some might say obsession) with the vampire.",
                ],
            }
        ],
        "Book": "NS 170"
    },
    {
        ...
        "Effect": [
            "This power works to summon animals. A vampire using this power is an eerie sight; crouching, hissing or howling into the night as a horde of beasts flock to him. The vampire can only choose one type of animal to summon: rats, for instance, or cockroaches. The summoning act is usually an attempt to communicate with that type of animal—a vampire calling to wolves might howl, while calling owls might necessitate bird-like shrieks.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The vampire summons the animals desired… and on arrival they turn on him, attacking. Rats bite. Birds stab at the eyes with jabbing beaks. Insects swarm and sting.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Failure:" },
                    " The vampire fails to summon any beasts.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " Any Animal Ken rolls to communicate with or command the creatures gain +2 dice.",
                ],
            }
        ],
        "Book": "NS 170"
    ...
    },
    {
        ...
        "Effect": [
            ...
            "Additional Willpower can be spent and additional rolls can be made to increase the area and potency of the space.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The cloud fails to create, and the monster is unable to use it for the remainder of the scene.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Success:" },
                    " The monster creates the cloud. Allocate successes to Size and potency of the effect.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " The cloud blocks out one additional sense of your choice.",
                ],
            }
        ],
        "Book": "HMR 145"
    },
    {
        ...
        "Effect": [
            ...
            "When taking dots of this Dread Power, assign each dot to one of two effects: direct damage or extended damage. You can mix and match the effects as you see fit. Additionally, you can ignore Defense or armor for one dot each.",
            {
                ...
                content: [
                    "• ",
                    { type: 'bold', text: "Direct Damage:" },
                    " For direct damage, add the dot as a direct damage rating for the attack. For example, a three dot lightning bolt might be a three damage weapon on a successful attack.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    "• ",
                    { type: 'bold', text: "Extended Damage:" },
                    " For extended damage, the attack will cause one dot of damage per turn after a successful attack, for twice the devoted dots in turns. For example, a fireball with four dots might cause one point of fire damage per turn for eight turns.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    "• ",
                    { type: 'bold', text: "Balancing Effects:" },
                    " For each different effect, determine appropriately whether armor or Defense applies. If armor does not apply, it costs one dot. If Defense does not normally apply — like against firearms attacks — it costs one dot.",
                ],
            },
            "The dice roll represents the attack roll for the blast. The attack can hit anything within the monster’s direct line of sight. If using distance modifiers for combat, its range is 15/30/45.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The attack fizzles, and cannot be used for the rest of the scene.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Success:" },
                    " The attack hits. It causes damage per its successes, and its damage rating.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " In this power’s case, these attacks can cause an appropriate Condition to the victim. For example, fire may burn, ice may freeze, and electricity may shock.",
                ],
            },
        ],
        "Book": "HMR 146"
    ...
    },
    {
        ...
        "Effect": [
            ...
            "Roll Results",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The blood flows, but not with the monster’s control. The monster takes lethal damage equal to the Dread Power dots.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Success:" },
                    " The monster controls his blood for the scene.",
                ],
            },
            {
                type: 'paragraph',
        ...
        "Effect": [
            {
                type: 'paragraph',
                content: [
                    "For the remainder of the scene, the monster can climb on all fours up impossible to climb surfaces such as walls, ceilings, windows and the like. The monster moves as if she were walking or running on normal ground (see ",
                    { type: 'italic', text: "Speed" },
                    ", p. 95, World of Darkness Rulebook).",
                ],
            },
        ],
        "Book": "BbBB 5"
    },
    {
        ...
        "Effect": [
            ...
            "Also, a monster can only have one instance of Cloak of Authority active at any given time. Using Cloak of Authority on the same group multiple times in the same month levies a cumulative -2 penalty on the monster.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " Not only does the Cloak of Authority not take, but the monster cannot gain any Social Merits with the desired group, as they reject her whole cloth.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Failure:" },
                    " The organization is not impressed.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Success:" },
                    " Success awards the Social Merits for one day.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " As a success, but the Merits last up to a month.",
                ],
            },
        ],
        "Book": "HMR 146"
    },
    {
        ...
        "Effect": [
            "The monster spends 1 Willpower and glances at the target to activate this power. A successful attack overwhelms the target with vertigo and confusion.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The monster can’t use the power again for the rest of the scene.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Failure:" },
                    " The power fails to activate, but the monster may try again if it spends more Willpower the following turn.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Success:" },
                    " The target is struck by a wave of mental confusion and vertigo, which overwhelms all higher thought processes. The target loses the 10-again quality on Mental rolls, and 1s rolled subtract from any successes gained. This includes perception rolls and dice pools based on Resolve. This confusion lasts until the end of the scene.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " The effect lasts until the following sunrise or sunset, whichever comes first.",
                ],
            },
            {
                'Suggested Modifiers': [
    ...
    },
    {
        ...
        "Effect": [
            ...
            "The most insidious use of this Dread Power is its application as a tool of brainwashing and conditioning. By judiciously applying emotional pressure to the victims—bursts of despair and self-doubt, followed by waves of emotional fulfillment and a sense of joy and of being loved, as well as love for the vampire—the vampire can secure long-term loyalty from his herd of followers, bypassing the need to gain their trust the hard way.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The victim sees right through the vampire’s manipulations. The vampire can’t affect the victim with this Dread Power for the rest of the night.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Failure:" },
                    " The vampire fails to affect the victim.",
                ],
            },
            {
                type: 'paragraph',
            ...
            "Used for conditioning purposes, successes rolled for this Dread Power are added to the vampire’s extended action rolls to brainwash the victim.",
            {
                ...
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " The emotion is inhumanly intense, causing the victim strain: any attempts to perform an action contrary to the emotion felt (i.e saying kind words while angry) suffer a -2 penalty.",
                ],
            },
        ],
        "Book": "NS 171"
    },
    {
        ...
        "FullCost": "3 Willpower",
        "Action": "Instant",
        "DicePool": "Wits + Occult + Willpower (or Potency – see Night Stalkers, pp. 157-158)",
        "Effect": [
    ...
    },
    {
        ...
        "Effect": [
            ...
            "The victim suffers a Persistent Doubtful Condition. It causes a penalty equal to the monster’s Curse of Failings dots to any actions the victim takes with five or fewer dice (this limitation applies after all modifiers). Any such rolls that fail are automatically considered dramatic failures, offering the character a Beat. The effect eventually fades after a week per dot of the monster’s Curse of Failings. If it fades, the character does not earn a Beat. The character can resolve it by learning a risky or harmful lesson in the present that offers a new perspective on a past failing.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The curse falls on the monster, instead of the victim.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Success:" },
                    " The victim suffers the Condition.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " Not only does the curse take, but the Condition will not fade over time. It must be resolved, or it persists.",
                ],
            },
        ],
        "Book": "HMR 147"
    },
    {
        ...
        "Effect": [
            ...
            "Once active, the victim suffers a Vocalization Condition. This distraction removes the 10-again quality from the victim’s rolls until resolved. To resolve the Condition, the victim must roll a chance die on a meaningful action, reflecting the voices building to a crescendo. Alternatively, the voices vanish after one day per dot of Curse of Words the monster possesses.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The voices do not take, and the victim is now immune to this Dread Power going forward. The monster cannot use the power on the victim ever again.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " The Condition lasts for double the time without resolution. Ignore the first success on any of the victim’s rolls until resolved.",
                ],
            },
        ],
        "Book": "HMR 147"
    ...
    },
    {
        ...
        "Effect": [
            ...
            "After a Dark Gate has been established, it remains in effect until somehow dispelled, or until the monster revokes it. A monster may establish a number of Dark Gates equal to his Dark Gate Dread Power dots.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The gate refuses to take. The given portal will never take a Dark Gate from the monster.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Success:" },
                    " Successes are added to the total.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " With an Exceptional Success, the created gate can be passed through with a reflexive action instead of an instant action.",
                ],
            },
        ],
        "Book": "HMR 147"
    ...
    },
    {
        ...
        "Effect": [
            ...
            "Magical items subtract any relevant dot ratings from the monster’s dice pool to activate Degredation.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The object rejects the monster’s efforts, and the monster takes 3 lethal damage from the strain.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Success:" },
                    " Successes remove Durability then Structure.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " Ignore the object’s Durability; apply successes directly to its Structure.",
                ],
            },
        ],
        "Book": "HMR 148"
    ...
    },
    {
        ...
        "Effect": [
            ...
            "For each success on the activation roll, you may ask one yes or no question about the victim’s subconscious. This should be answered within the narrative of the dream. Because of the yes/no nature of the questions, Dream Seeing works best of the monster knows the victim beforehand.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The power fails. For the following week, the monster has harrowing dreams that feature the would-be victim prominently.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Success:" },
                    " The monster perceives the victim’s dreams. Each success allows for a yes/no question, as detailed above.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " In addition to the yes/no questions, the victim’s player must reveal any Persistent Conditions his character suffers.",
                ],
            },
        ],
        "Book": "HMR 148"
    },
    {
        ...
        "Effect": [
            ...
            "An exceptional success causes a Persistent Condition. This should be resolved through long-term, meaningful actions in the story, like group therapy or psychiatric counseling. Additionally, if the monster dies, the victim should be released from the effects.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The power fails. The dream also features an image of the monster, in whatever forms – any and all – the victim might be familiar with. He knows that she had somehow invaded his mind.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Success:" },
                    " The monster can shape the victim’s dream as she sees fit. Work with the victim’s player to create an appropriate Condition.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " The Dread Power succeeds. Additionally, the Condition is Persistent.",
                ],
            },
        ],
        "Book": "HMR 148"
    },
    {
        ...
        "Effect": [
            ...
            "Leaving the dream requires an instant action to accomplish.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The power fails. The monster is ejected from the dream, with a health track full of bashing damage.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Success:" },
                    " The monster vanishes from the material world, and finds herself in the victim’s dreams. She can interact with the dream space in the same way she interacts with the real world, and may use her Dread Powers.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " Halve any damage the monster takes from the dream back into reality.",
                ],
            },
        ],
        "Book": "HMR 149"
    },
    {
        ...
        "Effect": [
            ...
            "Everyone within ten yards per success suffers the Earthquake Tilt (The God-Machine Chronicle, p. 208). The Tilt causes one damage per turn at one or two dots of Earthquake, two at three or four dots, and three at five dots. The monster is immune to her own Earthquake effects.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The power fails. The Earth rejects the monster’s efforts, and the monster suffers the Earthquake Tilt for three turns.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Success:" },
                    " The monster creates an earthquake, which lasts one turn per success.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " Additional successes are their own benefit.",
                ],
            },
        ],
        "Book": "HMR 149"
    },
    {
        ...
        "Effect": [
            ...
            "This power transfixes the victim with a flood of undiluted pleasure.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " Surprise is lost. The Dread Power does the opposite of its intended effect and causes horror and fright in the victim. The monster cannot succeed on Social rolls with that individual until the next sunrise or sunset, whichever comes first.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Failure:" },
                    " The monster fails to infl ict Ecstasy on the target.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Success:" },
                    " The target is transfixed with Ecstasy and cannot act for the rest of the scene, unless she is attacked violently (a vampire’s bite can be done without intimating attack). She must attempt a Resolve + Composure roll each turn to break free at a penalty of the dots in Ecstasy.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " As above, except that the victim must roll Resolve + Composure penalized by the dots in Ecstasy to avoid becoming addicted to the power (she gains the “Addiction” Flaw; see the World of Darkness Rulebook, p. 218).",
                ],
            },
            {
                'Suggested Modifiers': [
    ...
    },
    {
        ...
        "Effect": [
            ...
            "This causes an Emboldened Condition that gives a -2 (or -5 with Exceptional Success) to all the victims’ Resolve + Composure rolls to resist impulse or temptation.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The cloud not only fails, but the monster suffers the effects of success herself.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " Additional successes add the stronger version of the Emboldened Condition mentioned above.",
                ],
            },
        ],
        "Book": "HMR 150"
    },
    {
        ...
        "Effect": [
            ...
            "All Perception rolls and Wits + Composure rolls to react to surprise gain +1 bonus dice per dot of Enhanced Senses.",
            {
                ...
                content: [
                    { type: 'bold', text: "Drawback:" },
                    " Loud sounds, bright lights and pungent odors stun the vampire when this power is active, inhibiting her actions as long as the stimuli remain; in such an environment all her actions, including Initiative and reacting to surprise, are penalized by -1 per dot in Enhanced Senses.",
                ],
            },
        ],
        "Book": "NS 171"
    },
    {
        ...
        "Effect": [
            ...
            "This Dread Power allows a monster to learn a victim’s Vice. Once successful, the monster knows the victim’s Vice. If the victim has multiple Vices, the monster identifies each.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The monster reveals her own Vice to the victim.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Success:" },
                    " The victim’s Vice is revealed. When the monster acts on that Vice, she enjoys a +1 bonus on any relevant rolls. On any social maneuver (see The God-Machine Chronicle, p. 188), ignore the first two Doors.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " The victim’s Vice is revealed. When the monster acts on that Vice, she enjoys a +3 bonus on any relevant rolls. On any social maneuverm ignore the first three Doors.",
                ],
            }
        ],
        "Book": "HMR 150"
    },
    {
        ...
        "Effect": [
            ...
            "Successful use of this Dread Power adds the monster’s successes to her Defense for the turn, and allows her to reflexively move her Speed, plus her Flicker and Flash dots. If she uses Flicker and Flash reflexively before an attack roll is made, she might move out of its range and avoid it altogether. She can only activate Flicker and Flash a number of times equal to her dots in a turn. However, take the highest rolled successes to modify her Defense; the effect is not cumulative.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The monster stumbles. She takes the Knocked Down Tilt (see The God-Machine Chronicle, p. 211) and loses her Defense for the turn.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Success:" },
                    " The monster can move up to her Speed plus her Flicker and Flash dots, and her successes add to her Defense for the turn.",
                ],
            },
            {
                type: 'paragraph',
    ...
    },
    {
        ...
        "Effect": [
            ...
            "The divinations are revealed in the form of imagery and arcane symbols, so clarity often leaves something to be desired. The monster, or any subject clued in on the visions, can attempt to draw clarity from the images. This requires an Intelligence + Investigation roll. Once interpreted, they offer the Informed Condition (The God-Machine Chronicle, p. 182).",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The information is tainted and the divination backfires. Instead of obtaining answers about a specific subject, the divination will reflect a negative truth about the monster’s past, present, or future. If revealed to outsiders, this revelation could offer clues about a weakness or vulnerability.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Failure:" },
                    " The power fails. Fate offers no answers.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Success:" },
                    " The monster receives answers to her questions.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " The answers given are so clear they don’t require further interpretation. They provided the Informed Condition with no further effort.",
                ],
            },
        ],
        "Book": "HMR 150"
    },
    {
        ...
        "Effect": [
            ...
            "When the target emerges from his wild fury, he is likely to feel great remorse and confusion over his actions. The target is likely to have to make a degeneration roll if he was induced into a frenzy amongst a crowd of people, for example, but gains +2 to that roll (as some part of him recognizes his distance from the atrocity).",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The subject cannot be affected by this power from any source for the rest of the night.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Success:" },
                    " The power triggers as described above. The target remains in a frenzy for a number of turns equal to the monster’s Resolve + Composure score.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " In addition to the above, the target also loses 1 Willpower point.",
                ],
            },
            {
                'Suggested Modifiers': [
    ...
    },
    {
        ...
        "Effect": [
            ...
            "This Dread Power allows the monster to control electronic and mechanical devices. She can only use them as they are intended, but she can use them remotely, and without standard controls.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The power fails to work, and the device behaves erratically in the worst way possible, as if it was possessed.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Success:" },
                    " The monster can control the device for the remainder of the scene. For any turn she intends to change the device’s functionality, she must concentrate to turn it on or to turn it off.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " She can change the device’s functionality as a reflexive action.",
                ],
            },
        ],
        "Book": "HMR 151"
    },
    {
        ...
        "Effect": [
            ...
            "At one dot, the creature produces enough water to keep a person healthy. At three, a family and their crops are safe. At five dots, the monster can keep an entire farming community nourished, even in a desert.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The power fails, and instead of water, a spring of bodily fluids comes forth. This may be blood, urine, semen, or whatever would seem worst in the moment.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Success:" },
                    " Water flows forth. For every success, the water will gush from that location for one full day.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " With an exceptional success, the monster can produce water in that spot for a full month.",
                ],
            },
        ],
        "Book": "HMR 151"
    ...
    },
    {
        ...
        "Effect": [
            ...
            "Unless it’s somehow dispelled, the haunting lasts until the monster ends it. A monster may only have one such haunted zone at once.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The power fails. The selected grounds are forever immune to the monster’s haunting. From that point forward, all Dread Powers by that monster in that zone suffer -5 to activate.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Failure:" },
                    " The monster accumulates no successes.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Success:" },
                    " Successes are added toward the monster’s total.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " With an exceptional success, the monster also gains an ongoing +1 to all Dread Power usage on the haunted zone.",
                ],
            },
        ],
        "Book": "HMR 151"
    },
    {
        ...
        "Effect": [
            ...
            "That suggestion could be simple, such as “Take your clothes off,” or complex, such as “Go to Riley’s bar, wait until you see a brunette in a blue dress and ask her if she’s a Libra.” A suggestion can’t overtly involve violence, such as “jump in front of that bus” or “shoot at those cops.”",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The target sees right through the trick, and can’t be hypnotized again by this monster for the rest of the scene.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Failure:" },
                    " The creature may try again next turn.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Success:" },
                    " The target obeys to the best of her ability.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " The target goes so far as to believe the suggestions are her own idea in the first place.",
                ],
            },
        ],
        "Book": "HTV 279"
    },
    {
        ...
        "Effect": [
            "At three dots, the creature in question can ignore bashing damage; it just fails to harm the fiend. At five dots, this is increased to being able to ignore lethal damage as well, meaning the creature only takes damage from aggravated sources. This Dread Power can manifest in different ways for different creatures: one reptilian thing might simply possess thick lizard skin, while a rampaging demon may be surrounded by some bleak miasma that seems to absorb certain attacks.",
            {
                ...
                content: [
                    { type: 'bold', text: "Drawback:" },
                    " Taking this Dread Power, however, confers upon the creature a vulnerability. In much the same way a werewolf takes aggravated damage from silver, the creature suffers aggravated damage from sources or weapons made of a relatively common element (water, fire, gold, oak and so on).",
                ],
            },
        ],
        "Book": "BbBB 6"
    },
    {
        ...
        "Effect": [
            "The monster projects an aura about her, making her the center of attention to everyone affected in range of the effect. The wave expands outwards at a rate of yards per turn equal to the monster’s Presence in a hemisphere centered on the fiend. This lasts for one scene. Everyone caught in the area has the chance of being affected.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The monster’s attempt to sway the crowd fails utterly. She may not attempt to use this power on the same crowd at any time during the course of the night.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Failure:" },
                    " The monster’s attempt fails to activate. She might try again in the following turn with the expenditure of another Willpower point.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Success:" },
                    " The effect expands outwards as described above. As a result, the monster gains a number of bonus dice to Social rolls equal to successes rolled, though this bonus only applies to those affected by Impress.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " All affected also lose a Willpower point.",
                ],
            },
            {
                'Suggested Modifiers': [
    ...
    },
    {
        ...
        "Effect": [
            ...
            "The effect emulates a drug from The World of Darkness Rulebook, but as a Condition that lasts for one full night. Alternatively, create a custom Condition to reflect the monster’s specific Inebriate. It should offer a situational penalty equal to the monster’s dots in Inebriate. If it comes into play, its Toxicity is equal to the monster’s Inebriate dots.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The power fails, and the victim remains immune to the monster’s Inebriate power.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Success:" },
                    " The monster affects the victim if his successes exceed hers. The Inebriate takes hold.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " Not only does the Inebriate take effect, the victim also gains the Addicted Condition (The God-Machine Chronicle, p. 181) pertaining to the drug in question.",
                ],
            },
        ],
        "Book": "HMR 152"
    },
    {
        ...
        "Effect": [
            "The Inhabit Dread Power represents a monster’s ability to manipulate the location to which it is tied. The monster must be tied to a location for the power to work.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The monster is unable to use Inhabit for the remainder of the scene.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Failure:" },
                    " No aspects of the location are manipulated.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Success:" },
                    " Each success rolled allows one normal, working aspect of the location to be manipulated. Examples include opening or closing all of the doors in a building, turning all the lights on or off, activating all of the fire alarms or sprinklers, using climate control to raise or lowed a building’s temperature or throttling the phone lines or Internet connections.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " No effect Beyond additional successes.",
                ],
            },
            {
                'Suggested Modifiers': [
    ...
    },
    {
        ...
        "Effect": [
            "The target is faced with her own past. This Dread Power assaults the target’s mind with visions dredged up from the darkest part of the target’s own mind. Like Dement, this attack erodes the target’s moral core; unlike Dement, this is a straightforward assault on her Morality and sanity.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The target not only fails to suffer any extreme visions of moral decay, but seems suddenly bolstered and righteous, gaining +1 to any rolls made against the creature.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Failure:" },
                    " The guilt fails to fall upon the target.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " The target also gains a mild derangement of the Storyteller’s choice.",
                ],
            },
        ],
        "Book": "HTV 280"
    },
    {
        ...
        "Effect": [
            ...
            "By spending a point of Willpower, the monster can drag things through the space, from one part to another. When incorporating objects, this action should employ a portal of sorts; for example, a monster might reach into a closet, through a window on the other side of the building, and drag a person through. This necessitates an additional activation roll, requiring a Willpower point and successes equal to the object or person’s Size. Pulling things through the territory only takes a turn per roll, though.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The land rejects her. For every accumulated success thus far, she takes one bashing damage. The power cannot be used on the same space again.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Failure:" },
                    " The monster fails to garner any successes.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Success:" },
                    " Successes are added to the monster’s total. If the required successes are achieved, the monster is attuned to the land.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " Additional successes get the monster closer to the required total faster.",
                ],
            },
        ],
        "Book": "HMR 152"
    },
    {
        ...
        "Effect": [
            "The monster gathers ambient shadows around her, slipping out of sight. Successes add to the creature’s Dexterity + Stealth dice pool. She can move at a Speed up to twice the number of dots in Lurker in Darkness, or her own Speed, whichever is lower. She can take no other action whilst concealed.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The monster draws all eyes toward itself.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Failure:" },
                    " The shadows fail to gather at the creature’s behest.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Success:" },
                    " The effect expands outwards as described above. The monster can only be seen by those actively looking for it with a Wits + Investigation roll. This roll is contested against the successes earned on Lurker in Darkness’ activation.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " Those looking for the monster suffer a -2 penalty to the Wits + Investigation roll.",
                ],
            },
            {
                'Suggested Modifiers': [
    ...
    },
    {
        ...
        "Effect": [
            ...
            "The Merit lasts as many days as the roll had successes and the mortal suffers an Ensorcelled Condition for its duration. During this time, the monster achieves exceptional success on any roll against the mortal with three successes, and the mortal does not get 10-again on any roll against the monster. Defying the monster becomes a breaking point with a -2 penalty. At any time, the mortal can buy the Merit at half cost, rounded down. This makes the Condition Persistent. The Persistent Condition can then only be resolved with the monster’s destruction.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The magic backfires, and the monster receives the Ensorcelled Condition that was previously directed toward the mortal.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Success:" },
                    " The mortal gains the Merit and the Condition. Both last a number of days equal to the successes rolled.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " With an exceptional success, the Ensorcelled Condition becomes Persistent, and so does the Merit. The mortal does not need to purchase the Merit.",
                ],
            },
        ],
        "Book": "HMR 153"
    ...
    },
    {
        ...
        "Effect": [
            ...
            "If the victim achieves successes greater than the monster’s dots in The Oldest Temptation before the monster succeeds, the power does not take effect.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The monster fails to tempt his victim. The human becomes resistant to the Dread Power in the future, and gains the Inspired Condition with respect to destroying the monster.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Success:" },
                    " Successes are added to the monster’s total.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " Successes are added to the monster’s total. If the result of this roll achieves success, the resulting Condition is stronger.",
                ],
            },
        ],
        "Book": "HMR 155"
    ...
    },
    {
        ...
        "Effect": [
            ...
            "Alternatively, without using this rule (or in situations where the monster isn’t using this Power against players’ characters) add the monster’s Reap dots as an additional weapon modifier on any successful attack. Then, ignore any armor the victim might be wearing. He causes lethal damage, regardless of the source of the attack.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " Not only does the monster fail to kill his target, he reveals a flaw his opponents can exploit. Any harm he suffers for the remainder of the scene increases by two levels.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Failure:" },
                    " The monster fails to kill his intended victims.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Success:" },
                    " Pending which rules are used, the monster either kills a number of targets equal to his successes, or gains an additional weapon modifier on any successful attack.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " Additional successes kill additional targets. If you’re not using Down and Dirty Combat, the monster also ignores a victim’s Defense in addition to her armor.",
                ],
            },
        ],
        "Book": "HMR 153"
    },
    {
        ...
        "Effect": [
            ...
            "When witnesses attempt to take an action that counteracts the effects of this Power, they suffer the monster’s Revelation dots on any roll; add the monster’s Revelation dots to any contested rolls that would cause the mortal to betray the reaction. For example, a fearsome ghost with four dots of Revelation, that creates a Revelation of terror, causes a -4 to any roll to stand up to the specter. Additionally, witnesses would add +4 to any roll that would force the witness to stand up to the apparition, such as a vampire’s hypnotic command.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The monster fails to cause the desired reaction; witnesses see the monster for what it is, and gains Willpower any time they defy the would-be response.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Failure:" },
                    " The monster fails to evoke the desired reaction.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Success:" },
                    " The reaction takes. Witnesses suffer the monster’s Revelation dots from any roll to defy the desired reaction.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " The reaction takes. Additionally, the witness must spend Willpower to even attempt to defy the reaction. This Willpower does not add additional dice to his roll.",
                ],
            },
        ],
        "Book": "HMR 153"
    },
    {
        ...
        "Effect": [
            ...
            "Revivify can only be activated when the monster is effectively dead — that is incapacitated — with a health track full of lethal damage. It must be used within one day of death for each dot of the Dread Power. The monster spends Willpower and a permanent dot of Stamina (or Resistance, if using disembodied traits). If successful, the monster rises from death, slightly less injured. Each success on the dice roll removes two bashing damage, or one lethal damage.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The monster not only stays dead, but cannot attempt to use Revivify ever again. Death is permanent.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Failure:" },
                    " The monster does not rise, but loses both the Willpower and dot of Stamina. If he still has Stamina and Willpower remaining, he can attempt again.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Success:" },
                    " The monster rises, provided his entire health track isn’t full of aggravated damage. Successes heal two bashing or one lethal damage each.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " The monster rises fully healed of all damage, aggravated or otherwise.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Note:" },
                    " The monster cannot use this power if it only has a single dot of Stamina. At that point, the monster is permanently destroyed. If his health track is completely full of aggravated damage, the monster can only resurrect with an exceptional success on the activation roll.",
                ],
            },
        ],
        "Book": "HMR 155"
    },
    {
        ...
        "Effect": [
            "The creature is able to take over a human corpse as its host, effectively becoming one of the shambling dead. Bodiless spirits aren’t the only creatures who possess this power: any awful monster of the night can mystically transfer its soul to a corpse for a time, provided it has this Dread Power. During this time, if the monster has a body of its own, its body lies dormant (as if comatose).",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The creature transfers its senses into the corpse… and then finds it can’t animate the corpse. It lies trapped in the body for a full 24-hour period.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Failure:" },
                    " The creature cannot forge a mystical connection with the corpse.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " As above, but the creature retains his Speed.",
                ],
            },
        ],
        "Book": "HTV 280"
    },
    {
        ...
        "Effect": [
            ...
            "Dispelling the façade can be done through illusion-piercing Endowments, but must exceed the monster’s successes. Careful investigation and research can pierce the illusion in time, but any of the victim’s mundane efforts suffer the monster’s Scapegoating dots as a penalty to the roll.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The monster fails in his effort, and draws undue attention to himself. All humans within eyeshot immediately know that they’re looking upon an evil entity or force.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Failure:" },
                    " The monster fails to create a scapegoat.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Success:" },
                    " The monster creates the scapegoat. Any efforts to discern the monster’s true nature or dispel the victim’s façade must achieve more successes than the monster’s. Until the effect is dispelled, any attempt to harm the monster is considered a breaking point with a -2 penalty to the roll.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " The monster creates the scapegoat. As above, but harming the monster is considered a breaking point at -4.",
                ],
            },
        ],
        "Book": "HMR 156"
    },
    {
        ...
        "Effect": [
            "The target passes out for a number of turns equal to 10 minus her Resolve score. Use of this ability necessitates eye contact.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The monster can’t use this power on a target again for the rest of the night. The target even feels like she’s hopped up on double espressos, and may go without sleep if she chooses.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Failure:" },
                    " The effect fails to catch. The creature may try again in the next turn, spending another Willpower to do so.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " The target cannot spend the Willpower to prevent slumber. In addition, she can only be awakened via injury to her person.",
                ],
            },
        ],
        "Book": "HTV 281"
    ...
    },
    {
        ...
        "Effect": [
            ...
            "Each version of this Dread Power has a different way to abolish the effect. With an extended Intelligence + Occult roll, characters will be able to uncover an esoteric method for ending the effect. It should be a challenging but reasonable solution, like finding a rare herb or uncovering a secret piece of the monster’s history. A monster may only have one such bound victim at a time.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The monster fails, and the victim can instantly sap one Willpower from the monster. If he wishes, he can turn the Dread Power back on the monster, creating a reverse bond that allows him to suck Willpower.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Failure:" },
                    " The monster fails to establish the bond.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " The monster creates the bond, and any research efforts to solve the bond suffer a -3 penalty.",
                ],
            },
        ],
        "Book": "HMR 156"
    },
    {
        ...
        "Effect": [
            ...
            "When making an attack, the monster may use Stealthy Attack before the attack roll to prevent the victim from realizing she’s suffered any damage. Stealthy Attack also hides the aftereffects of a strike, so if the monster has some kind of debilitating touch or disease-causing blow, the subject will remain unaware of the power until its symptoms manifest. The monster doesn’t realize a Stealthy Attack roll has failed until it performs its attack—it can’t choose to halt or change the attack if this roll fails.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The monster’s attempt to conceal its strike fails, and the victim automatically notices the attack. The victim gains a +2 bonus to Defense against the attack as a result of seeing the strike coming.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Failure:" },
                    " The monster fails to conceal its attack.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " The attack is concealed, and gains a +2 bonus to the attack roll.",
                ],
            },
        ],
        "Book": "Spf 8"
    ...
    },
    {
        ...
        "Effect": [
            ...
            "The tempest’s duration will either last for one hour per dot of the Dread Power. The monster can end the storm prematurely.", 
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The tempest comes in full force, but the monster is affected just like everyone else. Additionally, the storm follows the monster, centering on him at all times. The storm lasts the scene; the monster cannot end it prematurely.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " Additional successes speed the tempest’s arrival.",
                ],
            },
        ],
        "Book": "HMR 154"
    },
    {
        ...
        "Effect": [
            "The monster attacks with some kind of tendril: whips of shadow or blood, spectral limbs, life-choking vines, or even briny tentacles. These tendrils can be used to attack and do lethal damage with a Dexterity + Brawl roll. Alternatively, the monster can make the same Dexterity + Brawl roll at a -3 penalty, performing a targeted attack against the subject’s mouth. Upon success, the tendrils force themselves into the victim’s mouth and throat. The target must make Stamina rolls for suffocation, as per “Holding Breath” in the World of Darkness Rulebook, p. 49. The tendrils manifest for up to one scene.",
            {
                ...
                content: [
                    { type: 'bold', text: "Drawback:" },
                    " Manifesting these tendrils requires intense concentration: the creature’s Defense is at -1 while they are active. The tendrils can also be attacked directly (-3 to the attack in addition to the monster’s now-diminished Defense): a single lethal level done against them disperses them.",
                ],
            },
        ],
        "Book": "HTV 282"
    },
    {
        ...
        "Effect": [
            "The monster spends an action engaging the target in eye contact and activates this power, making this roll. If the attack succeeds, the target flees the scene as quickly as possible, via the nearest available escape route. She will not stop running until she reaches a location she considers to be safe.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The target is unimpressed by the monster’s attempt to frighten her. In fact, it emboldens the target, and she may gain a point of Willpower.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Failure:" },
                    " The monster fails to frighten the target, but may spend another Willpower in the next turn and try again.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Success:" },
                    " The result for success is described above. If the target cannot escape (or spends a point of Willpower to remain), she suffers a penalty to all rolls equal to the creature’s dots in Terrify. This effect lasts for one scene.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " The effect so terrifies the target that she also loses one Willpower point.",
                ],
            },
        ],
        "Book": "HTV 282"
    ...
    },
    {
        ...
        "Effect": [
            ...
            "As a rule of thumb, most commonly-found substances like water, rocks, or soil should be one dot Availability. Twodots reflect most industrially-processed substances, high end manufactured alloys are three dot, and gold and other precious metals are often four dots. Diamond, alongside other high-or-controlled cost substances, are five dots when attempting to transmute anything but the tiniest quantities.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The object not only remains the same, but the monster’s body partly transforms into the desired substance. This causes 3 lethal damage to the monster.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Success:" },
                    " The object changes composition from one inorganic material to another.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " The object changes to a perfect elemental example of the target substance. Add +2 to its Durability and Structure (if relevant), and +1 to its Availability value.",
                ],
            },
        ],
        "Book": "HMR 157"
    },
    {
        ...
        "Effect": [
            ...
            "When the effect does take hold, the victim’s player may take a Beat to make the change permanent.",
            {
                ...
                content: [
                    { type: 'bold', text: "Dramatic Failure:" },
                    " The monster fails to change the target’s Vice. As a result, the would-be victim now has a new Virtue: destroying the monster. This effect lasts as long as the monster lives.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Failure:" },
                    " The monster fails to change the Vice.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Success:" },
                    " The monster succeeds in changing the victim’s Vice. For one Willpower, the change lasts one night per dot of Twist Desires. For five Willpower, it lasts a week per dot.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Exceptional Success:" },
                    " As above. However, the victim can make the one Willpower effect permanent for a Beat. With the five Willpower effect, the victim can also choose to allow the monster to change her Virtue for a second Beat.",
                ],
            },
        ],
        "Book": "HMR 157"
