        ...
        "LongDescription": [
            ...
            "Each aspect of the Haven Merit has a limit of 5. In other words, Haven Location, Haven Size and Haven Security may not rise above 5 (to a maximum of 15 points spent on this Merit).",
            {
                ...
                content: [
                    ...
                    " It’s possible for the Haven Merit to be shared among characters in a close-knit group. They might simply be devoted to one another and willing to pool what they have, or perhaps their mutual reliance on an individual or trust could bring them together to share what they have in common.",
                ],
            },
    ...
    },
    {
        ...
        "LongDescription": [
            ...
            "Each aspect of the Lair Merit has a limit of three dots. In other words, Lair Size and Lair Security may not rise above 3 (to a maximum of six dots on this Merit, total).",
            {
                ...
                content: [
                    { type: 'bold', text: "Special:" },
                    " It’s possible for the Lair Merit to be shared among characters in a close-knit group. They might be devoted to one another and willing to pool what they have, or perhaps their mutual reliance on an individual or trust could bring them together to share what they have in common.",
                ],
            },
    ...
    },
    {
        ...
        "LongDescription": [
            ...
            "A safehouse might be a storage shed that the hunter rents out and uses as a weapons locker, an apartment that is rigged to set the building on fire if he flicks a switch, or a mansion belonging to his organization that is woefully lacking in security. In game terms, dots spent on the Safehouse Merit need to be distributed among four categories: Size, Cache, Secrecy and Traps. Thus, the storage shed might have no dots of Size or Traps, but several of Secrecy. The apartment doesn’t hold much in the way of Cache (as the owner is afraid to leave anything there), but has a high Traps rating. The mansion has five dots in Size and probably a few in Traps and/or Cache, but none in Secrecy.",
            {
                type: 'paragraph',
                content: [
                    { type: 'italic', text: "Safehouse Size" },
                    " is perhaps the simplest defining characteristic, governing the amount of raw space the safehouse encompasses.",
                ],
            },
            {
                'Size Examples': [
            ...
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'italic', text: "Safehouse Cache" },
            ...
            "Equipment doesn’t have to be stored in a cache, of course — a large safehouse can have entire rooms devoted to storage. Equipment that is stored in a cache, however, is effectively hidden from anything but a devoted (or supernatural) search. Mundane interlopers receive a -5 modifier to any attempt to find a cache (on a dramatic failure, the searcher finds and triggers a trap, instead, if the safehouse has any). If the players wish, this modifier can instead apply to attempts to access the Cache. The gun safe might be in plain view, but it’s not at all easy to crack open without the proper combination.",
            {
                type: 'paragraph',
                content: [
                    { type: 'italic', text: "Safehouse Secrecy" },
            ...
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'italic', text: "Safehouse Traps" },
            ...
            "Any intruder receives a Wits + Composure roll to notice a trap before it activates:",
            {
                ...
                content: [
                    ...
                    " The intruder activates the trap and suffers all relevant damage. In addition, roll (the rating of the trap in question + 2) and apply any successes as additional damage (type as appropriate to the trap).",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    ...
                    " The intruder activates the trap and suffers all relevant damage.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    ...
                    " The character notices the trap and can try to disarm it (Wits + Crafts minus the dots allocated to that trap, failure sets off the trap, dramatic failure doubles the damage) or just leave it be.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    ...
                    " The intruder notices the trap and can attempt to disarm it (Wits + Crafts, no penalty for the trap rating).",
                ],
            },
            {
                'Suggested Modifiers': [
    ...
    },
    {
        ...
        "LongDescription": [
            ...
            "Each aspect of the Sanctum Merit has a limit of 5. In other words, Sanctum Size and Sanctum Security may not rise above 5 (to a maximum of 10 points dots on this Merit, total).",
            {
                ...
                content: [
                    { type: 'bold', text: "Special:" },
                    " It’s possible for the Sanctum Merit to be shared among characters in a close-knit group. They might simply be devoted to one another and willing to pool what they have, or perhaps their mutual reliance on an individual or trust could bring them together to share what they have in common.",
                ],
            },
        ...
        "LongDescription": [
            ...
            "A sanctum’s Size describes how many bodies can be comfortably sequestered inside the sanctum. Generally, you can fit two guardians per room. Any more than that and morale might be less than desired, giving the guardians a chance to simply break and run if the action gets too heavy.",
            {
                ...
                content: [
                    ...
                    " Guardian Retainers will only defend the sanctum, not perform errands like other Retainers; this is the price for their willingness to die defending the sanctum.",
                ],
            },
        ],
    ...
    },
    {
        ...
        "LongDescription": [
            ...
            "The player or Storyteller creates the ghost, distributing its Attribute dots among its Power, Finesse and Resistance traits, and choosing its Numina.",
            {
                ...
                content: [
                    { type: 'bold', text: "Drawback:" },
                    " Ghosts can be controlled by other mages using the Death Arcanum. They can also be driven out by an exorcism, which even a Sleeper can perform. (See “Exorcisms,” p. 214, in the World of Darkness Rulebook.) If that happens, all dots in this Merit are lost.",
                ],
            },
        ],
    ...
    },
    {
        ...
        "LongDescription": [
            ...
            "Mages who study applicable rotes in a scriptorium pay half the usual experience cost: only one point per dot of the highest Arcanum. Rotes that aren’t covered by the Scriptorium’s Subjects or Depth require the usual experience cost.",
            {
                ...
                content: [
                    { type: 'bold', text: "Drawback:" },
                    " A scriptorium isn’t for the uneducated. An Awakened scholar needs academic training in order to make efficient use of the scriptorium’s resources. This mandates Academics dots equal to the highest Arcanum rank in the rote she wishes to research. Without these research skills, the student pays the normal price for the rote.",
                ],
            },
            "A mage who invests experience in a scriptorium cannot add Subject Arcana that he does not know and can’t raise its depth higher than his highest Arcanum rank. This limitation doesn’t apply to the mage’s starting Merit dots because these might represent a gift from another mage with different abilities.",
            {
                ...
                content: [
                    { type: 'bold', text: "Special:" },
                    " Similar to other collective Merits, several characters can combine dots to share a Scriptorium. This may not raise the Scriptorium’s Subjects or Depth to more than five dots. Again, some legendary Athenaea might hold exceptions to this rule.",
                ],
            },
        ],
    ...
    },
    {
        ...
        "LongDescription": [
            ...
            "Possible Workshop Specialties include (but are not limited to) Calligraphy, Woodcrafting, Blacksmithing, Mechanics, Painting, Goblin Fruit Farming and the like. Token Making is not an acceptable Specialty. Because of the diverse nature of tokens, each falls under the Craft Specialty of the particular item, so a Biting Grotesque would be under Sculpting, while a Blood Pennon would be under Sewing.",
            {
                ...
                content: [
                    { type: 'bold', text: "Special:" },
                    " Characters who share a Hollow can also share Workshop dots, with each contributing to a particular equipment area. These characters each receive the full benefits of the Workshops. It may happen that the crafters suffer a falling-out, in which case one or more might be asked to forfeit their Workshop privileges by the others. Those who are banned lose whatever dots they contributed, unless an agreement is worked out to split the equipment, allowing outcasts to take their tools and materials with them. Shared Workshops should be marked with an asterisk (*) on your character sheet. See the description of the Hollow Merit for details on how to allocate dots.",
                ],
            },
        ],
    ...
    },
    {
        ...
        "LongDescription": [
            ...
            "Hollows moving through the Hedge ignore trods or other established paths; the walls of the Hedge part before the Hollow and close behind it. Furthermore, Hollows avoid other entities in the Hedge, instantly leaving pursuers behind (often by slipping through a Hedge wall that seals behind it) and circumventing any other individuals or obstacles along the way. A Hollow cannot be used as a weapon to ram other entities, nor can it be crashed into other Hollows. Space within the Hedge is subjective enough that even if another Hollow exists precisely where the character’s Hollow is traveling, it can set up a comfortable distance away.",
            {
                ...
                content: [
                    { type: 'bold', text: "Special:" },
                    " Like other aspects of the Hollow Merit, the cost for Mobile Hollow can be split amongst different characters as described on p. 96 of Changeling: The Lost. If the Hollow is shared, the Wyrd prerequisite changes. Instead of being a flat Wyrd 3, the sum of the characters’ Wyrd ratings must equal 6 or more.",
                ],
            },
        ],
    ...
    },
    {
        ...
        "LongDescription": [
            ...
            "Creating or Eliminating: Geologic structures of this magnitude cannot be casually created or destroyed. Portions of a ridge might be destroyed with high explosives or heavy machinery.",
            {
                ...
                content: [
                    { type: 'bold', text: "Benefits (free-form):" },
                    " +2 to Wits dice pools to detect approaching people or spirits; +2 to Stealth dice pools to hide from those coming up from lower ground. Cliffs and ridges are usually steep enough that they cannot be climbed without special equipment.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Problems and Hooks:" },
                    " Native American tribes in the southwestern United States sometimes built their cities into cliffs or ravines; in those regions, Uratha may have to deal with spirits that expect to be dealt with according to ancient human tradition.",
                ],
            },
        ],
        "Description": ""
    },
    {
        ...
        "LongDescription": [
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Problems and Hooks:" },
                    " See p. 181 of the World of Darkness Rulebook, “Temperature Extremes,” for the effects of extreme heat. Deserts make good hiding places for refugees and runaways of both the spirit and fleshy persuasions.",
                ],
            },
        ],
        "Description": ""
    },
    {
        ...
        "LongDescription": [
            "In human-inhabited areas, almost all land that can be farmed is being farmed or has been farmed. This territory feature refers specifically to treeless land that is no longer being farmed or, much more rarely, treeless land that has never been farmed.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " After driving off the farmers and farmspirits associated with a farm in your territory, wait a few seasons, and what was once a farm should have returned to a fallow state. Eliminating farm-spirits and attracting spirits of the wild plain can speed up this process to take less than a season.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Eliminating:" },
                    " Encourage farming or real estate development.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Resonance:" },
                    " The wild or wilderness, loss of control, rebirth",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Problems and Hooks:" },
                    " Depending on the local mortal population density, such an area may not last long; it may be bought and turned into farmland, housing or a shopping mall. Werewolves who wish to prevent this may have to buy it on their own (typically at least a Resources •••• activity) or otherwise prevent others from buying it.",
                ],
            },
        ],
        "Description": ""
    },
    {
        ...
        "LongDescription": [
            "A factory farm is a large farm containing scores if not hundreds of animals of a small number of species. The animals are kept in relatively confined spaces and are either grown to a certain size and then slaughtered, or kept around for their breeding or (egg or milk) production capabilities.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " Factory farms require a more considerable investment to create. Depending on size, most require from three to four dots in Resources to start up.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Benefits (free-form):" },
                    " Well — there’s the effectively free food for hungry wolf types. There’s an intense concentration of a single type of animal-spirit. These benefits are offset by the brutal drawbacks.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Resonance:" },
                    " Mechanization, slaughter, abundance",
                ],
            },
            {
                type: 'paragraph',
    ...
    },
    {
        ...
        "LongDescription": [
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Eliminating:" },
                    " A pack that wants to eliminate a functional farm in a hurry may burn its fields, slaughter its animals and destroy its irrigation. None of these require dice rolls unless they take place while (for instance) angry farmers attempt to kill the werewolves.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Resonance:" },
                    " Food, fertility, slaughter, peace or pacification",
                ],
            },
            {
                type: 'paragraph',
    ...
    },
    {
        ...
        "LongDescription": [
            ...
            "Typically, such lands are represented by the “Cold” descriptor (see below), but a pack may control a large temperate territory with some area beyond the arctic circle.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " The cold temperatures necessary to create such a landscape are beyond the resources of most Uratha. The invocation of a powerful spirit of the winter may be enough to temporarily create an area of this sort.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Eliminating:" },
                    " Global climate change is already elimi- nating some southern glaciers; otherwise, without magical assistance, artificially warming an area sufficiently to eliminate this feature is impossible.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Benefits (free-form):" },
                    " Water is always easy to find, so Survival rolls to avoid thirst always succeed. A werewolf familiar with a patch of cold terrain in her pack’s territory receives +1 die on rolls to resist temperature extremes; +2 dice to summon spirits of cold or winter; –2 dice to sum- mon spirits of summer or heat.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Problems and Hooks:" },
                    " Regular rolls are necessary while outdoors, to withstand the cold of this region — see p. 181 of the World of Darkness Rulebook, “Temperature Extremes,” for details. Wildlife is relatively scarce; Uratha hunting for food need eight successes rather than five to find enough food for a person for a day.",
                ],
            },
        ],
        "Description": ""
    },
    {
        ...
        "LongDescription": [
            ...
            "Some homeless humans may make a home out of a dump; the food found there may not be much good, but scavenging recyclables and burnables can help a desperate human eke out a few more days.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " In the World of Darkness, getting a given site established as a trash heap doesn’t take a lot of work. All you need is some unloved land, a lot of junk and time.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Problems and Hooks:" },
                    " For an interesting twist on the garbage dump, consider a garbage scow drifting from port to port, looking for a place to dump its “cargo.”",
                ],
            },
    ...
    },
    {
        ...
        "LongDescription": [
            "Mountains are pinnacles of the local terrain — a “proper” mountain peak is more than 2,000 feet above sea level. Mountains are rarely useful for agriculture. Their steep sides prevent local humans from doing anything useful on the surface, but humans dig into mountains to extract their mineral wealth.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " Geographic features of this magnitude cannot be created through the actions of mere Uratha.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Eliminating:" },
                    " See “Creating.” But, as some coal-mining companies have learned, destroying a mountaintop is easier than mining by burrowing into the mountain itself.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Resonance:" },
                    " Earth, vision or perspective, defense",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                items: [
                    [
                        "A rival pack learns that the necessary materials for a particular fetish or ritual can only be found on or in this mountain.",
                    ],
                    [
                        "A national mining company buys the mountain’s land and begins operations in the area, with the intention of deep-mining the pack’s mountain (or of shearing the mountain’s peak off and processing the tillings).",
                    ],
                ],
            },
        ],
    ...
    },
    {
        ...
        "LongDescription": [
            "This territory element really refers to the shallows near the coast, as well as some lands immediately bordering the sea. No werewolf pack would bother to claim all of a large body of water as the pack’s territory — the packmembers couldn’t possibly patrol the entire thing, and many large bodies of water serve as home to powerful and alien spirits. Werewolves stick to territory that suits them better.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " Without serious tectonic activity, a pack cannot create an oceanfront or major body of water. Some exceptionally powerful packs (or spirits) may be able to enact such things, but they are beyond the scope of this supplement.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Eliminating:" },
                    " See “Creating,” except to note that erosion may change the local waterfront beyond recognition, and characters can certainly use skill to speed that process.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Benefits (free-form):" },
                    " Once out of sight of land, the Gauntlet in and above the ocean thins dramatically, usually imposing a modifier of +0 or even +1. The sea allows a savvy pack to travel without alerting those on land — a pack may travel on the water to elude mortal authorities or other packs, or to lay ambushes for unsuspecting foes. A waterfront probably includes a beach, which can help an exhausted werewolf recover from recent strain (+1 dice to Meditation pools to recover Willpower).",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Problems and Hooks:" },
                    " Werewolves do not patrol the deep sea; not even the wolf-spirits they claim descent from range there. Certain factors make the Shadow of the ocean particularly hostile and alien for air-breathers.",
                ],
            },
            {
                type: 'list',
    ...
    },
    {
        ...
        "LongDescription": [
            "A pond, lake or lakefront is a standing body of water, fed by streams, rivers and/or springs. No pack will have a truly huge lake to itself (such as the freshwater seas that are the American Great Lakes), but may claim a share of lakefront and the lake out to a certain distance.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " Ponds and lakes can be created by damming rivers (with many potential ramifications). Ponds larger than about an acre are otherwise very difficult to create without magical assistance and/or heavy equipment.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Eliminating:" },
                    " Ponds and lakes can be drained. This is likely to enrage local water-spirits — even if the Uratha aren’t responsible for the destruction, they will have to deal with the implications of it.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                items: [
                    [
                        "One particular lake may not be a lake at all — instead, it is a reservoir created by damming up a large river. The process of that damming flooded an entire village. The villagers were given a chance to evacuate their belongings — but it may not have gone entirely smoothly. Now the lake has begun to suffer a rash of unnatural events. What was left behind when the flood came?",
                    ],
                    [
                        "A powerful artifact rests in the hands of an equally powerful spirit at the heart of the pond. The spirit has the respect of its fellows and uses the pond as a sort of “court” locally. The spirit is not willing to give the artifact up, and is powerful enough that the pack can’t simply destroy the spirit. How do the werewolves reach détente with the spirit?",
                    ],
                ],
            },
        ],
    ...
    },
    {
        ...
        "LongDescription": [
            ...
            },
            {
                ...
                items: [
                    [
                        "A river is a great place to dump a body. The body of a well-known local human floats downriver and into the pack’s territory, or the body of the leader of a local Uratha pack floats downriver — and he shows signs that he was killed by werewolves’ teeth and claws, and attacked from behind.",
                    ],
                    [
                        "A riverboat casino that passes through the characters’ territory regularly plays host to all sorts of unsavory entities that might prey on elderly and/or desperate humans who frequent the casino.",
                    ],
                    [
                        "Spirit refugees flee a catastrophe downriver, such as a toxic spill. The pack downriver should have known the spill was coming; their negligence has driven these terrified and rampaging spirits into your pack’s territory. Now you must deal with those spirits as well as the (lazy? negligent?) neighboring pack.",
                    ],
                ],
            },
        ],
    ...
    },
    {
        ...
        "LongDescription": [
            "Springs have great mythical power: they represent spontaneous creation, the eruption of life from sterility.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " Springs usually occur naturally; a pack might bring one into existence by digging down to a highpressure point in the local water table (an Intelligence + Science roll would help a werewolf find a good site for such a thing). Mystically skilled werewolves may be able to lure and bind water-spirits to an area with the appropriate rituals.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Eliminating:" },
                    " Without outright destroying a spring, werewolves or their enemies might choose to pollute it by contaminating the local water table. This might generate polluted or corrupt spirits, poison the local spirits or destroy them entirely.",
                ],
            },
            {
                type: 'paragraph',
    ...
    },
    {
        ...
        "LongDescription": [
            "A stream is a small stretch of running water, usually wet year-round. It is shallow enough to wade through and rarely more than a few yards across.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " A stream may come from a spring (see above) or may just represent natural water runoff in the area. Construction equipment might be used to dig a ravine to accumulate water runoff. An earth-spirit might be convinced to move things around to allow a stream through a given area, but anyone trying to persuade an earth-spirit of such a thing will be at -3 or more dice on her Social pools to do so, given earth’s natural suspicion of water’s erosive qualities.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Eliminating:" },
                    " As with “creating,” construction equipment or earth-spirits can be harnessed to eliminate or move a stream. When water falls, it has to go somewhere, so it is easier to move a stream than destroy it entirely.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Problems and Hooks:" },
                    " Construction or irrigation upstream dry up the creek. Water-spirits become enraged, and the peaceful nature of the stream evaporates.",
                ],
            },
        ],
        "Description": ""
    },
    {
        ...
        "LongDescription": [
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Resonance:" },
                    " Water, fertility, mystery, the hidden or unknown",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                items: [
                    [
                        "Things that would otherwise remain hidden for a long time lurk in a swamp. A spirit that previous inhabit- ants bound becomes unbound through the activities of Uratha (and isn’t happy about its long imprisonment).",
                    ],
                    [
                        "A serial killer uses the swamp as his base of opera- tions. The police cannot easily search the swamp for him, but the pack can (the pack’s motivation to do so is up to the Storyteller and players). The killer compulsively col- lects silver jewelry from his victims, and is covered in the stuff. This makes him more dangerous to the Uratha than he might otherwise realize.",
                    ],
                ],
            },
        ],
    ...
    },
    {
        ...
        "LongDescription": [
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Eliminating:" },
                    " Surprisingly, fire won’t reliably destroy a naturally grown forest. Tree species native to dry areas frequently “expect” fires to occur and are adapted to them; most forests actually benefit from infrequent forest fires.",
                ],
            },
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Problems and Hooks:" },
                    " As with fallow prairie (above), woods won’t last long in the face of concerted human attempts to expand into them. It typically takes Resources •••• or exceptional bureaucratic delaying tactics (typically involving Contacts and Politics rolls) to prevent such rezoning and expansion.",
                ],
            },
...
const urbanTerritoryData = [
    {
        ...
        "LongDescription": [
            "This aspect may refer to housing projects of the sort that have yet to fall out of favor in the World of Darkness. It might refer to ordinary working-class apartment buildings, or to wealthy high-rise slivers in a city’s rich core.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " Building an apartment building is typically a Resources •••• or greater task requiring dozens of workers and heavy machinery. Converting an abandoned building into squatter housing, by contrast, is just a matter of moving in and locking the door.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Eliminating:" },
                    " See sidebar, “Destroying a Building.”",
                ],
            },
            {
                type: 'paragraph',
    ...
    },
    {
        ...
        "LongDescription": [
            "These stores are large hardware or electronics and technology stores. They are typically stand-alone buildings and occupy thousands of square feet of suburbia.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " Only the rarest werewolf has the Resources and Status necessary to open a chain store in her territory.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Eliminating:" },
                    " See the “Destroying a Building” sidebar. Driving one of these stores out of business through crime and violence is probably easier than blowing the building sky-high.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Problems and Hooks:" },
                    " Werewolves who regularly pilfer the inventory of big box stores may find themselves wanted, caught on video or even pursued by the police. Theft doesn’t cause the spiritual complications tied to Harmony, but can cause complications for a pack that wishes to go about its business unmolested.",
                ],
            },
        ],
        "Description": ""
    },
    {
        ...
        "LongDescription": [
            "A bar or nightclub is a location serving alcohol and playing live or canned music. Some bars serve a full menu of food; others have nothing more than bar snacks, or no food at all. Most jurisdictions keep children under the legal drinking age (21 in the United States, 19 in Canada) from entering bars at all.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " A corner bar is easy to open. Financially, it represents a few months’ worth of Resources ••• investment. Bureaucratically, opening a corner bar requires a few months’ worth of weekly rolls to accumulate 15 successes to get the proper permits.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Eliminating:" },
                    " See “Destroying a Building,” above. In many jurisdictions, enough violence in the area around a club can get it shut down as a “nuisance bar.” Avoiding that fate requires regular Resources •• bribes and/or good Politics and Bureaucracy rolls.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Benefits (free-form):" },
                    " Packmembers who succeed in a Socialize roll can treat any bar in their territory as though they had the Barfly Merit (they can enter the bar without difficulty, regardless of the sort of establishment it might be). Clubs are excellent places to meet Contacts — subtract 1 experience point from the cost of buying or raising the Contacts Merit. Drunken patrons are easily seduced; werewolves receive +1 die to seduction attempts while in a bar.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Resonance:" },
                    " Passion, intoxication, music, lust",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                items: [
                    [
                        "Predatory spirits of lust haunt a local bar, looking to Ride or Urge young people in the area.",
                    ],
                    [
                        "Drug dealing or other criminal activity happens quite openly at a particular tavern. The pack may have no moral objection to this activity, but it does attract gang activity and, later, the police.",
                    ],
                ],
            },
        ],
    ...
    },
    {
        ...
        "LongDescription": [
            "A factory feature represents a manufacturing facility of some kind. It may make ordinary widgets, cars, specialty equipment, chemicals or just about anything else. Generally speaking, the larger the factory’s output, the larger the facility must be (many automakers’ facilities fill dozens of acres). Factories employ dozens or hundreds of people.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " As with many of the features in this section, a pack of Uratha cannot create a factory so much as try to attract one to its territory, or reinvigorate one that has fallen on hard times.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Eliminating:" },
                    " See “Destroying a Building,” above.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Problems and Hooks:" },
                    " Soul-deadening, repetitive, robot-driven work begins to scour much of the Essence from the Shadow around a factory; the pack’s ritualists realize that a Barren may soon erupt if something isn’t done.",
                ],
            },
        ],
        "Description": ""
    },
    {
        ...
        "LongDescription": [
            "Humans own houses all over the world. Certain territories might contain no houses at all — downtown commercial districts, for instance, or deep wilderness. This aspect generally refers to tracts of housing, be they suburban neighborhoods, city enclaves or housing developments; not every territory with a house within its borders would qualify as having “housing” as a feature.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " A house requires several months’ investment of Resources ••• or more, to represent the labor of a house-building crew. A tract of homes costs more but is typically built by a developer as an investment.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                items: [
                    [
                        "A housing development may be more trouble than it is worth; when a pack has a consistent set of neighbors who expect to see them mowing the lawn, sending children off to school and so on, the packmembers will have trouble concealing that they are “strange” and may even inadvertently trigger the Lunacy in neighbors during times of stress.",
                    ],
                    [
                        "As endless television dramas suggest, suburbia is a more complex place than its surface suggests. Some of the most clichéd “movie of the week” stories have new resonance in an animistic world. The alcoholic, the wifebeater and the teenage drug addict all push resonance into the spirit world — and the pack must deal with the impact of that resonance, whatever form it takes.",
                    ],
                ],
            },
        ],
    ...
    },
    {
        ...
        "LongDescription": [
            "A mall is a collection of stores and restaurants all sharing a common structure. They may all be indoors, under a common roof or they may just be one long building subdivided into individual shops, with a large common parking lot. A strip mall may be as small as just four shops; the largest indoor shopping malls have more than 100 stores, and even contain small amusement parks inside.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " Malls are large and expensive; as with many of the other features in this section, an investment of Resources •••• or more, plus difficult rolls in Politics, Bureaucracy and Finance are necessary to build one.",
                ],
            },
            {
                type: 'paragraph',
    ...
    },
    {
        ...
        "LongDescription": [
            "These buildings are local centers of knowledge and learning.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " A pack may have a library of its own if it owns a house or other building in which the pack can house the library. Thousands of books, scrolls and other writings are needed to truly represent the kind of library that Uratha need.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Problems and Hooks:" },
                    " Museums and libraries often draw the attention of humans who have some suspicions of the unseen world and seek to learn more. The werewolves may have to figure out a way to scare the humans away from unsafe knowledge without instead invoking the mortals’ curiosity.",
                ],
            },
        ],
        "Description": ""
    },
    {
        ...
        "LongDescription": [
            "Small office buildings may be just one story, or they may be “office park” type buildings with up to five stories. Larger buildings than that are rarely found outside of downtown commercial districts — but, in even a medium-sized city, those buildings can reach 30 stories or more. Small office buildings may house just one company’s operations; large buildings can house dozens or hundreds of companies.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " Office buildings typically require an investment of at least Resources •••• and good Finance and Bureaucracy rolls. Skyscrapers require even more resources — amounts in the tens of millions of dollars or more.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Eliminating:" },
                    " See “Destroying a Building,” above. If a resident business is put out of operations with its building left intact, a new one will come along eventually to replace it.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Resonance:" },
                    " Labor, greed, wind (in the case of skyscrapers)",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                items: [
                    [
                        "Really large skyscrapers may be contested by two or more packs of Uratha (imagine running battles through nighttime offices and firefights up and down elevator shafts).",
                    ],
                    [
                        "As the local business climate gets worse and repeated layoffs occur, the level of despair in the headquarters of a major local business reaches truly epic levels. A rash of suicides among desperate employees opens a Wound in the spirit world around the office park.",
                    ],
                ],
            },
        ],
    ...
    },
    {
        ...
        "LongDescription": [
            "A “park” is a pretty broad designation, as it could in theory refer to a national park like Yellowstone just as easily as the playground on the corner. A large national or state park is better represented by a number of rural features (above); this feature refers to a park that can be thought of as a single entity. A park is a natural recreation area and may include hiking trails, picnic areas and playground equipment.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " Small parks can be created by the simple expedient of buying a plot of land (Resources ••• or more), clearing it and declaring it a park (which may require a permit best gotten with Politics or Bureaucracy rolls).",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Eliminating:" },
                    " Buy the park and build something on it, or destroy or pollute whatever structures are already present there.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                items: [
                    [
                        "Local college students begin using the park as a shortcut between their classes and nearby cheap housing. However, gangs begin preying on those students as they cross through the deepest woods in the park, mugging them or worse.",
                    ],
                    [
                        "An infestation of wilderness-spirits in the park exercise their powers to spread vegetation and wild animals outside of the park’s boundaries.",
                    ],
                ],
            },
        ],
    ...
    },
    {
        ...
        "LongDescription": [
            "Schooling varies throughout the world; in the United States, students remain in school until graduation at age 18. A school may either be open for free to the general public or a private school requiring tuition payments.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " Schools are generally only built in response to population pressure; causing a new school to be built is therefore a complex political proposition.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Resonance:" },
                    " Learning, wisdom, youth, conformity, tension",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                items: [
                    [
                        "Several Uratha cubs who are classmates at a local school all go through the First Change in rapid succession. A locus in the school seems to be the catalyst for this; did some unknown spiritual force draw all members of the pack to the school prior to their First Change? And if so, to what end?",
                    ],
                    [
                        "A member of the pack has a school-aged child with strong wolf blood. The stresses of school life have begun to wear on this child, who has inherited some of his parent’s near-supernatural temper. The werewolf must help his child adjust to ordinary human society.",
                    ],
                    [
                        "A local religious school has the best educational reputation of any school in the area. A packmember’s mate enrolls their child at that school regardless of the werewolf’s wishes. The character must deal with his child’s possible indoctrination into a belief system at odds with his own.",
                    ],
                ],
            },
        ],
    ...
    },
    {
        ...
        "LongDescription": [
            "This feature can represent any kind of small shop — from a small restaurant or coffee shop to a pet store or clothing store. A shop might sit as part of a shopping center, or may be part of a downtown shopping district in a small town or large city.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " Find — or be — an entrepreneur. Unlike some of the larger establishments described in this section, a small craft store or restaurant can be opened with a Resources ••• investment.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Eliminating:" },
                    " See “Destroying a Building,” above. Small shop owners typically survive on very small margins, as well; it doesn’t take much of a loss of business to close their doors forever.",
                ],
            },
            {
                type: 'paragraph',
    ...
    },
    {
        ...
        "LongDescription": [
            ...
            "Additionally, as thousands of humans pass through an area, it is easy to pick pockets, beg for loose change or otherwise earn a dishonest living from them. Packmembers receive +2 dice to Larceny or Subterfuge rolls to take advantage of fans on the way to or from a game.",
            {
                ...
                content: [
                    { type: 'bold', text: "Resonance:" },
                    " Passion, greed, victory, loyalty, aggression",
                ],
            },
            {
                type: 'paragraph',
    ...
    },
    {
        ...
        "LongDescription": [
            "Theaters show plays, musical theater, opera, symphonic concerts and even rock shows. Theaters typically seat from 100 to 2,000 patrons.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " Small community theaters are not terribly difficult to organize, though finding a permanent place for them to perform can be hard. Success on a Politics roll can bring together a community theater; good Resources and/or Status are necessary to find a permanent place to perform.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Eliminating:" },
                    " See “Destroying a Building,” above. A theater company or symphony can be driven out of business relatively easily; these organizations operate on razor-thin margins, and one financial disaster (dramatic failure on a Finance roll, or an especially bad show) can spell doom.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Resonance:" },
                    " Passion, ambition, tragedy, laughter",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Problems and Hooks:" },
                    " Theaters can draw an interesting crowd of performers and patrons, including potential supernatural entities.",
                ],
            },
        ],
        "Description": ""
...
const generalTerritoryData = [
    {
        ...
        "LongDescription": [
            "A cemetery is an area where the dead are buried. This may be a traditional graveyard, with rows of headstones side by side every eight feet, or it could be unusual — such as the crypts of New Orleans. Cemeteries are often, though not always, associated with churches. Certainly, vandalism in a cemetery will have the local religious population up in arms.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " Find a big plot of land (Resources ••••); get the appropriate permits and clearances (Politics and/or Bureaucracy).",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Eliminating:" },
                    " Cemeteries are expensive to eliminate; hundreds of underground caskets must be excavated and moved to a new location before any development can be done.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                items: [
                    [
                        "The 200-year-old cemetery is located on a bluff adjacent to a lake; erosion has begun to eat away at certain graves, revealing tombs and possibly upsetting the dead.",
                    ],
                    [
                        "An unethical corporation releases a chemical that causes the dead to begin clawing their way to the surface, hungry for human flesh.",
                    ],
                    [
                        "Death-obsessed vampires are especially fond of cemeteries; one or more local vampires may make their homes in one the cemetery’s crypts.",
                    ],
                ],
            },
        ],
    ...
    },
    {
        ...
        "LongDescription": [
            ...
            "A church gives human spiritual life a physical center and often provides meaning to mortals in the area. A church may also provide services for the poor or disenfranchised. The flow of Essence in the area is disrupted by the church’s presence: either the faith of the church draws the Essence in, or the church diverts or reflects the Essence in some way. This could have many effects (see below).",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " Depending on the scale of the church involved, creating a new church can be as simple as renting a building and beginning to hold services. The founder may have to be ordained, depending on the faith.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Resonance:" },
                    " Faith, belonging or home, passion, music, fervor",
                ],
            },
            {
                type: 'paragraph',
    ...
    },
    {
        ...
        "LongDescription": [
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Eliminating:" },
                    " A “law and order” campaign by local police, or even by a sufficiently motivated pack of Uratha acting as vigilantes, can eliminate the worst crime in such a district. However, without significant investment, such a district may well be transformed from a poor-and-dangerous neighborhood into a poor neighborhood. And, given that poverty and crime tend to encourage one another, the pack will have to work hard to keep the area “clean.”",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Resonance:" },
                    " Desperation, poverty, greed, opportunity, violence",
                ],
            },
            {
                type: 'paragraph',
    ...
    },
    {
        ...
        "LongDescription": [
            "Empty warehouses, sports arenas, shopping malls and the like all arise after the businesses that previously occupied the buildings vanish.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " Take nearly any of the buildings listed above, and drive the business away without destroying the building.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Eliminating:" },
                    " Destroy the building (see “Destroying a Building,” above) or use Politics and Status to attract a new business to the site.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                items: [
                    [
                        "The city has suffered a large drop in population and grown poorer in recent decades. Dozens of homes and businesses now stand empty, even in formerly “good” neighborhoods. Squatters and drug users infest these buildings. How the pack chooses to deal with this is up to them.",
                    ],
                    [
                        "The Stanhope Building on a busy and prosperous corner in the city should, by all rights, be home to successful businesses. Three restaurants, two shops and a nightclub have all opened and closed in the building during the last 18 months. It stands empty. Is this simply a function of economics? Rumors persist of a string of old murders in the building in the 1980s. Is something older and darker going on?",
                    ],
                ],
            },
        ],
    ...
    },
    {
        ...
        "LongDescription": [
            "A highway is a high-speed road for motor vehicles with few or no crossing roads. Highways can spell disaster both for motorists and for wildlife, as “road kill” numbers increase every autumn.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " A decent investment of Resources and Status, combined with some means of influencing a member of Congress, may get a highway paved through your community as part of the next federal transportation bill.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Eliminating:" },
                    " Highways are rarely shut down permanently; once they are put in place, budgetary allowances are made to cover their continuing maintenance. Even major interruptions of service such as earthquakes won’t shut down a major highway forever.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                items: [
                    [
                        "A pack of the Pure has begun to use the local highways to move in and out of its inner-city territory. If the Uratha can catch the Pure packmembers while on the road, the Uratha may be able to do real damage to their foes.",
                    ],
                    [
                        "Beings unknown have taken up an ambush site on a bluff high above a local highway, and attack passersby — including local werewolves. The pack must find the attackers and bring them to whatever form of justice seems most appropriate.",
                    ],
                ],
            },
        ],
    ...
    },
    {
        ...
        "LongDescription": [
            "A hospital feature is any major medical center containing facilities for scores of doctors and support personnel, as well as rooms for short, medium and long-term recuperation. Some hospitals have helipads for use by emergency medical helicopters; nearly all hospitals have emergency rooms and facilities for ambulances.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " A hospital is a mortal institution; most hospitals in the World of Darkness are part of large medical corporations. Influencing such a large organization would be a long-term, complex effort. However, smaller medical centers could be opened up by influencing individual doctors;a pack may choose to get involved in reopening a recently closed hospital through raising funds or other means.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Eliminating:" },
                    " If a hospital is owned by a large medical corporation, the easiest way to get the hospital shut down is to increase the hospital’s operating costs to the point where the hospital is no longer a profitable arm of the corporation. This can usually be accomplished through violent and/or supernatural means. If the hospital is an independent entity, or part of a charitable organization, this will be much harder (see the sidebar on p. 18).",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Problems and Hooks:" },
                    " A hospital in a pack’s territory requires regular attention. A Storyteller can look to the preferred hospital medical drama of the year and rip story ideas from it without much trouble.",
                ],
            },
            {
                type: 'list',
                ...
                items: [
                    [
                        "So much pain, death, disease and madness occurs in hospitals in the World of Darkness that even the ideal hospital is constantly at risk of infestation by dangerous spirits. A pack could expect to work almost as an exterminator in such a place, coming in on a regular basis to deal with whatever semi-natural thing has taken up residence since the last visit.",
                    ],
                    [
                        "Similarly, so many humans die in hospitals that the places are practically breeding grounds for ghosts. The boundary between the living and the dead isn’t exactly part of werewolves’ usual responsibilities, but Uratha may find that their territories are easier to manage if the most dangerous ghosts are out of the way.",
                    ],
                    [
                        "A hospital in the inner city may suffer from gangrelated crime (a rash of shootings, or theft of medical supplies). A pack that wants to keep its territory safe could easily get involved in protecting the hospital from this mortal threat.",
                    ],
                ],
            },
        ],
    ...
    },
    {
        ...
        "LongDescription": [
            ...
            },
            {
                ...
                items: [
                    [
                        "Eagle-spirits resent humans’ violation of the birds’ domain above an Air Force base, and either cause a crash or threaten to do so if the local Uratha can’t “keep the monkeys down where they belong.” Or perhaps sky-spirits resent the unnatural way that supersonic flight disrupts the sky, and get involved in the same manner.",
                    ],
                    [
                        "In an era of cost-cutting, a base is threatened with “realignment” (elimination). If the pack wants to keep the base around, the pack must get involved in human politics; if, on the other hand, the characters would like to use the base’s land for their own ends, the pack must keep the local “Save Our Base” movement from gaining too much traction.",
                    ],
                    [
                        "If the game takes place in a country where a war is going on, the pack may find itself on the receiving end of an invasion, as a temporary or permanent military base is built within the characters’ territory. Do they drive the base out, or take advantage of it? Such a base will attract new spirits, threatening the local balance of power in the Hisil.",
                    ],
                    [
                        "In the World of Darkness, many military bases contain prisons full of alleged “enemy combatants” and “terrorists” who are neither of those things. Perhaps one of these prisoners is a relative, Contact, Ally or Mentor of a member of the pack. Do the Uratha dare to break in and rescue their loved one?",
                    ],
                    [
    ...
    },
    {
        ...
        "LongDescription": [
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Resonance:" },
                    " Learning, wisdom, calcification, youth",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Problems and Hooks:" },
                    " Thousands of young humans spend time in these self-contained cities. Each of them has a story.",
                ],
            },
            {
                type: 'list',
                ...
                items: [
                    [
                        "A professor of ancient and primitive myths has begun to discover a common thread in them — the presence of wolf-men or wolf-spirits that hunt and are hunted by other spirits. He begins working on further research into this, and encounters the pack as part of that research.",
                    ],
                ],
            },
        ],
    ...
    },
    {
        ...
        "LongDescription": [
            "Utilities represent the nervous and circulatory systems of human communities. Utilities bring water, power, communications and heat to various buildings, and take away waste. Players and Storytellers don’t have to represent ordinary power or gas lines through the “utilities” feature — instead, elements of this type represent noteworthy facilities: a water treatment plant, water tower, power plant, telecommunications switching statement, major sewer juncture, gas depot and so on.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " These facilities represent enormous investments of both money and political clout. Characters without high Resources and Status, as well as high Bureaucracy and Politics scores, would be unable to even begin such a thing.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Resonance:" },
                    " Health, safety, pollution, as well as water, electricity or fire, as appropriate to the facility",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                items: [
                    [
                        "A powerful spirit of lightning has become tainted by a Wound or one of the Maeljin. She lairs in a local power plant, and her taint has begun to infect the power supply to nearby homes. Humans who rely heavily on electricity in their everyday lives (which is to say, most of them) slowly become more cruel; a few gruesome deaths by electrocution occur.",
                    ],
                    [
                        "Spirits of waste or decay become enraged by the work of a water-treatment facility and use spirit abilities to prevent certain substances from being entirely removed from the city’s water supply. Those substances might be drugs, bacteria or anything else the Storyteller deems appropriate.",
                    ],
                ],
            },
        ],
...
const supernaturalTerritoryData = [
    {
        ...
        "LongDescription": [
            ...
            },
            {
                ...
                items: [
                    [
                        "Truly desperate spirits may hide in a Barren. This is a losing decision in the long run, as the spirit cannot regain Essence while in the Barren, but if the spirit is on the run from more powerful entities, such a wasteland may be the spirit’s only alternative.",
                    ],
                    [
                        "A human who has somehow crossed over into Shadow may inadvertently find that a Barren is one of the few safe places around — as few spirits enter the area, and those that do so have a hard time harming the human.",
                    ],
                ],
            },
        ],
    ...
    },
    {
        ...
        "LongDescription": [
            ...
            "Primal places, catalyst sites draw on the core of the spirit world. They represent simple spirit concepts — fire, stone, death and so on. A spirit that spends too much time at a catalyst site finds its nature tugged toward the catalyst site’s nature. A bear-spirit making its lair near a “death” catalyst site might find itself a ghost bear within a month. A hawk-spirit that regularly hunts in a “fire” site may be consumed and reborn as something more akin to a phoenix.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " Catalyst sites only happen naturally and cannot be brought into being deliberately. Uratha may encourage the creation of a catalyst site by repeatedly summoning a particular kind of spirit in a thin Gauntlet area or by attempting to tamper with the resonance of Essence flows.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Eliminating:" },
                    " Eliminating a catalyst site requires an extinguishing or disruption of the core of the catalyst and the raising of the local Gauntlet. This may be done with the help of local Azlu (not likely), or through other means as determined by the Storyteller.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Resonance:" },
                    " As appropriate to the catalyst",
                ],
            },
            {
                type: 'paragraph',
    ...
    },
    {
        ...
        "LongDescription": [
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Eliminating:" },
                    " Glades can lose their power if they become the sites of great violence. Although a single battle or act of bloodshed probably won’t undo a glade’s power, repeated violent acts or extended ritual acts of cruelty can undo the glade’s harmony. Most werewolves with a glade in their territory are careful to keep the battle lines well away from the place.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Problems and Hooks:" },
                    " A wounded and desperate pack of rival Uratha makes camp in a glade ‘belonging’ to the characters’ pack without permission or notification. Does the pack honor the nature of the glade, or defend its territory?",
                ],
            },
        ],
    ...
    },
    {
        ...
        "LongDescription": [
            "A locus is a center and fountain of spiritual energy (or “Essence”). Loci also represent “crossing points” between the spirit world and physical world. For more detail on loci, see pp. 260-264 of Werewolf: The Forsaken.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " Uratha must invest 150 points of appropriately resonant Essence into an object to increase that object’s locus rating by one point. That Essence must remain undisturbed for a full week. For more information, see Werewolf: The Forsaken, p. 262.",
                ],
            },
            {
                type: 'paragraph',
    ...
    },
    {
        ...
        "LongDescription": [
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Eliminating:" },
                    " The bleak resonance of the shoal must be countered with action and Essence tinged with enthusiasm. Just as healing a Barren or Wound, this is a process that requires great effort over an extended period of time.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Benefits (free-form):" },
                    " There are no benefits to having a shoal in your territory. An attempt to leave a shoal requires a Resolve + Composure roll (any wound penalties apply); failure prevents departure, and each subsequent roll suffers a cumulative -1 penalty.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Resonance:" },
                    " Depression, sloth, introspection, paralysis",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                items: [
                    [
                        "A packmate or mentor goes missing; she was last seen wounded near an area known to be a shoal. The pack must find her before anything else does.",
                    ],
                    [
                        "Some spirits are rumored to be immune to the taint of the shoal. These predators wait for passersby to become overwhelmed by listlessness, and then attack. The trapped person or werewolf can defend himself, but cannot flee.",
                    ],
                ],
            },
        ],
    ...
    },
    {
        ...
        "LongDescription": [
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Eliminating:" },
                    " Rites that raise the Gauntlet, such as Fortify the Border Marches, can temporarily seal a verge. No rite seems to be able to permanently remove a verge from existence, as the rift between worlds may yet return when the time becomes right once more.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Benefits (free-form):" },
                    " A verge provides instant access to and from the spirit world, which makes a verge a painless way to step sideways. Of course, this benefit is available only on nights when the verge manifests, which is a considerably limiting factor.",
                ],
            },
            {
                type: 'paragraph',
    ...
    },
    {
        ...
        "LongDescription": [
            ...
            "Typically a window is bounded by physical phenomenon — one may arise between two trees or through a particular doorway. Windows are only visible from a specific angle — that doorway may look perfectly ordinary from outside the house but open onto a terrifying spirit world wasteland when viewed from within. A window does not allow passage through the Gauntlet; a window only allows vision (and possibly other senses) to operate through it. Windows function in both directions through the Gauntlet — those in the Hisil can also use a window to see the physical realm.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " There are no known ways to deliberately create a spirit window, though it’s rumored that accidental use of certain Gifts, rites or Numina might cause such a thing to come into being. Windows mostly arise spontaneously, and are a phenomenon few werewolves can properly explain.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Eliminating:" },
                    " Spirit windows are fragile and temporary things. If the local Gauntlet increases or decreases for any reason, the window is eliminated.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Benefits (free-form):" },
                    " Other than the obvious benefit for Uratha, spirits tend to congregate near windows, hoping for a glimpse of the paradise of the physical world.",
                ],
            },
            {
                type: 'paragraph',
    ...
    },
    {
        ...
        "LongDescription": [
            "To an observer in the spirit world, a Wound seems like a street corner in Hell. A Wound vomits forth extremely negative Essence; a Wound is a site where the spirit wilds themselves are damaged. Wounds are full of violent, diseased, corrupt spirits that gnaw on the vile Essence belched forth from the site, and then fight among themselves or assault travelers.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " Thankfully, Wounds are not easy to create. They erupt only in the spirit wilds’ echo of a location where true horror occurred — plague, natural disaster or genocide or other mortal atrocity.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Benefits (free-form):" },
                    " Only Bale Hounds would consider owning a territory that includes a Wound to be “beneficial.” All Harmony rolls and rolls to resist Death Rage are at –2 dice while within a Wound. All injuries suffered within a Wound do one additional point of Health or Corpus damage.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Resonance:" },
                    " Cruelty, slaughter, pain, despair, fear — almost any negative emotion",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Problems and Hooks:" },
                    " The existence of a Wound within a pack’s territory is a major problem and is likely to drive the core of the chronicle’s storyline.",
                ],
            },
        ],
...
const descriptorsTerritoryData = [
    {
        ...
        "LongDescription": [
            "This descriptor represents a location within the pack’s territory where all of the Uratha of the pack know that they can get the drop on enemies wandering through. It is up to players to define and describe why a given location is a good ambush site. It may be a blind alley, a “killing field” empty lot with no cover anywhere or a twisted junkyard maze.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " Werewolves with a good sense of tactics should be able to create an ambush site with a few hours’ preparation. Most rolls to set up an ambush site are based on Intelligence, but Storytellers might choose to combine Intelligence with Crafts, Athletics, Firearms, Stealth or Survival.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Eliminating:" },
                    " Some ambush sites are easy to demolish — if your foes have set up an ambush by creating lots of cover, destroy the cover with whatever is handy. Other sites can’t be destroyed short of building demolition (usually based on Intelligence + Science — see the World of Darkness Rulebook, p. 178).",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Benefits (free-form):" },
                    " An ambush site is designed for letting the pack claim the element of surprise. A good ambush site also provides partial concealment or better (-2 to opponents’ dice pools to attack) and cover (see the World of Darkness Rulebook, pp. 162-164).",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Problems and Hooks:" },
                    " The value of a good defensive fortification is evident to other packs, and such a feature might quickly become contested. In addition, if the pack makes a habit of bushwhacking victims there, the amount of blood shed may draw the wrong sort of spirits or taint the local resonance.",
                ],
            },
        ],
        "Description": ""
    },
    {
        ...
        "LongDescription": [
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Benefits (free-form):" },
                    " Uratha who cultivate an arcane area or otherwise retain friendly relations with local mages receive a -1 experience point cost to purchase or improve wizardly Contacts. Many mages are attracted to centers of learning; Uratha of a more scholarly bent may find arcane areas to their liking.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Resonance:" },
                    " Learning (not necessarily wisdom), secrets, mystery, change",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                items: [
                    [
                        "Mages who summon spirits from the Shadow are in direct violation of werewolves’ edict to patrol and protect the Border Marches. Few mages are aware of the laws of Father Wolf, but powerful human shamans have posed problems for Uratha since before the Fall. Keeping such beings in check is an important task for dutiful Uratha.",
                    ],
                    [
                        "A wizard creates a powerful artificial person — a robot, or animated statue or column of sentient muscle and sinew. This creature seems to be truly sentient, and, for whatever reason, it is immune to most magic. Magical contacts approach the pack for help; an aggressive pack will find that most Gifts don’t work against the artificial person. If the werewolves wish to destroy it, they’ll have to get down to tooth and claw.",
                    ],
                    [
                        "In order to power a mighty spell, mages who live nearby need body parts from a werewolf — whether living or dead. There are plenty of ways this could go: Wizards might begin to hunt the Uratha (a nice play on the game’s “hunt or be hunted” theme). Sufficiently sympathetic mages might ask for (or offer to buy) blood, fur or claws. Or the mages might go after nearby Pure Ones.",
                    ],
                ],
            },
        ],
    ...
    },
    {
        ...
        "LongDescription": [
            "A contested element is one that is directly and actively fought over by the players’ pack and another pack of Uratha. Werewolves must use caution in any conflict, for their Rage may get the best of them, and yet the People may not slay the People without grievous repercussions.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " A pack can easily create a border region by raiding another pack’s territory — the border region then comes out of the other pack’s territory and is considered contested. The opposite side of that coin is that a rival pack may contest a particularly lucrative area within the pack’s territory.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Eliminating:" },
                    " The two packs must reach a concord of some kind — either through violence and submission, or through diplomacy (our money is on the former).",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Benefits (free-form):" },
                    " The only real benefit of contested territory is the possibility of expanding the pack’s territory even farther by handing their rivals a particularly sound defeat.",
                ],
            },
            {
                type: 'paragraph',
    ...
    },
    {
        ...
        "LongDescription": [
            ...
            "Ley lines tend to run along natural paths — where possible they flow along with rivers or streams, along strong wind currents or even mineral veins underground. If no such obvious path exists, Essence may flow along human-made paths, roads or even along with power or sewage lines.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " Essence currents tend to arise spontaneously. Some Uratha study the ebb and flow of Essence and attempt to direct it using methods similar to the practice of feng shui.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Eliminating:" },
                    " An Essence current is destroyed if the locus at either end is destroyed or tapped of all its Essence (even temporarily). Unruly spirits may choose to dam, disrupt or otherwise interfere with its flow.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Benefits (free-form):" },
                    " Ley lines can be used to drain negative Essence from the local area, by connecting a powerful local locus to a weak remote one. The negative Essence doesn’t vanish forever, of course — it is simply leached away to a place that is someone else’s problem. Essence currents can also be used to support a nearby locus, by aligning it to a powerful remote locus.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Resonance:" },
                    " Based on the loci at either end",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Problems and Hooks:" },
                    " A pack’s rivals and enemies can use an Essence current in the same way that the Uratha who control it can. Additionally, if the pack’s foes control one end of the current or the other, they can effectively stop up the current.",
                ],
            },
        ],
        "Description": ""
    },
    {
        ...
        "LongDescription": [
            ...
            "Although ghosts have many things in common with spirits, ghosts are not spirits, and werewolves have fewer means overall to deal with ghosts than with spirits.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " Haunted areas are most likely to arise in locations commonly associated with death — be they the sites of a murder or suicide, a cemetery or even a church or other memorial site. Uratha sometimes inadvertently create a haunted area by killing humans and creating ghosts.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Eliminating:" },
                    " A haunted area can be eliminated by destroying the ghosts in it, or by helping them let go of the mortal world. This activity depends heavily on the ghost’s nature; a werewolf is well-advised to do some research into local history to discover what may be the events surrounding a ghost’s mortal life.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Benefits (free-form):" },
                    " The dead are inherently unnerving to humans; decrease humans’ effective Willpower by 1 for purposes of Lunacy while the human remains in a haunted area. Ghosts see and hear a lot of things that mortals miss, as ghosts lurk invisibly near areas that were important to them in life. A ghost may be willing to part with useful information in return for a treasured reminder of the living world.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Problems and Hooks:" },
                    " Some ghosts are openly hostile, and even those who aren’t may make life difficult for the werewolves nearby. A haunted area may also gain a measure of notoriety (see below).",
                ],
            },
        ],
    ...
    },
    {
        ...
        "LongDescription": [
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Eliminating:" },
                    " Stay away. Destroy any wayward spirits. Create fake evidence that explains the weird stuff away (swamp gas!).",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Problems and Hooks:" },
                    " Notoriety may be what draws the pack to claim a section of territory as the pack’s own in the first place. Local urban legend may lead a pack to a potential locus or to supernatural activity that needs to be quelled for the good of the area.",
                ],
            },
            {
                type: 'list',
                ...
                items: [
                    [
                        "Something — other than the pack — is hunting local monster-hunters and freaks. Is it the Pure Ones? Vampires? Rogue spirits?",
                    ],
                    [
                        "A local monster-hunter gets a sequence of photographs of one packmember shifting all the way through the sequence from Dalu to Urhan. The next time she sees that packmember, she attempts to blackmail him, extort information from him or beg him for help.",
                    ],
                ],
            },
        ],
    ...
    },
    {
        ...
        "LongDescription": [
            "This feature gets a lot of attention from the local media. A media center may be a hub of local politics or sports, or be frequented by celebrities. Events that transpire in such an area are much more likely to get attention from local media — for better or worse.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " Attracting the attention of local media can be achieved in a number of ways, though the most effective is to study the local media for patterns of what they find most newsworthy and then arrange for such news to happen.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Benefits (free-form):" },
                    " -1 experience point cost to buy media-related Contacts (as newspeople are always lurking around somewhere). Werewolves looking to publicize local goings-on can do so with +2 dice to their pool by taking advantage of a media center.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Problems and Hooks:" },
                    " The primary fear that Uratha must have regarding a media center is that of exposure. A pack of werewolves ripping one of the hithimu limb from limb in the background of a television report on the local sports team could be disastrous.",
                ],
            },
        ],
        "Description": ""
    },
    {
        ...
        "LongDescription": [
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Eliminating:" },
                    " Easy — violate the neutrality of the ground, by claiming it as your own. Nearby packs will probably respond poorly to that, but you knew that when you took this job.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Benefits (free-form):" },
                    " Neutral ground is designated as such by local elders. As a result, violating neutral ground with violence against another werewolf is a minor (level 8) Harmony sin by virtue of violating an elder’s edict. Neutral ground does give packs a comfortable buffer, and a chance to get to know one another and share news about local supernatural activity. -1 experience point cost discount to take an Uratha Storyteller character as a Contact, so long as both packs hold true to the neutrality of the nearby neutral ground.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                items: [
                    [
                        "Neutral ground sometimes suffers the tragedy of the commons, as members of any pack feel that they can do as they please in neutral territory without repercussions.",
                    ],
                    [
                        "Neutral ground is most often used for negotiations or other meetings between rival packs. Some packs even party together in such areas.",
                    ],
                ],
            },
        ],
    ...
    },
    {
        ...
        "LongDescription": [
            "An occluded area is one through which it is exceptionally difficult to track prey. There are numerous strange smells, sounds and frequent piles of debris that serve to hide prey and make it more difficult for a predator to keep tabs on his quarry. This could represent anything from a stretch of wilderness with many small streams that break up scent trails to the mess, stink and noise of a stockyard.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " Uratha who want good hiding places or escape routes may create their own mazes — perhaps in a junkyard or thick forest. This is mostly a matter of physical labor; perhaps a good week of labor is required to build such a site.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Eliminating:" },
                    " Only hard physical labor should clean up an occluded site.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Benefits (free-form):" },
                    " +2 dice to all Stealth rolls to those who are familiar with the occluded site.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                items: [
                    [
                        "A rival pack discovers the occluded area and spends enough time surveying it that they can take advantage of it; that rival pack begins to use the occluded area as a staging ground for their own activities within the pack’s territory.",
                    ],
                ],
            },
        ],
    ...
    },
    {
        ...
        "LongDescription": [
            "In game terms, a poor area is one where the average member of the population has a lower-than-average Resources. Most people in a poor area have no more than one dot in Resources; many have zero dots of Resources and lead truly desperate lives.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " The causes of poverty are complex beyond the ability of this sourcebook to trace. Widespread crime, violence and destruction can lead to increased poverty in a neighborhood, as those with the resources to leave do so, leaving only the poor behind.",
                ],
            },
            {
                type: 'paragraph',
    ...
    },
    {
        ...
        "LongDescription": [
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Problems and Hooks:" },
                    " Even a single Pure is a major problem. It is up to the Storyteller to determine the pack’s motivations and activities. While the Pure may not be actively expanding into the players’ pack’s territory, they won’t want to hold hands and sing “Kumbaya” either. However, if the troupe’s pack spends all its time worrying about (and attending to) the Pure’s activities, the rest of the pack’s territory will begin to fall apart.",
                ],
            },
        ],
        "Description": ""
    },
    {
        ...
        "LongDescription": [
            "A rich area in the pack’s territory is one where the average Resources is higher than normal. When applied to a given feature in the territory, 'rich' simply means that feature is especially ‘ritzy.’ A rich shop might be a highclass clothing store or expensive restaurant. A rich apartment building might be a secure, downtown high-rise.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " Money attracts money. Persuade a few wealthy people to begin frequenting (or live in) an area, and more are likely to come. Politics, Bureaucracy and Finance rolls may come in handy to help control zoning and taxation in appropriate ways.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Eliminating:" },
                    " Increase the level of violence and crime in an area to drive rich people elsewhere.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Benefits (free-form):" },
                    " Money tends to attract money. To purchase the fourth or fifth dot in the Resources Merit, the cost is -1 experience point.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Problems and Hooks:" },
                    " • Rich areas are more secure than poor ones. Police presence is greater, and private security is much more prevalent. -1 die to all Larceny pools in a rich area.",
                ],
            },
        ],
        "Description": ""
    },
    {
        ...
        "LongDescription": [
            ...
            "Werewolves and vampires can coexist in the World of Darkness; some even live as allies or lovers. This is rare, though. Uratha and vampires are both predators, and although they hunt different things, each has a tendency to challenge the other’s activities in common territory. Uratha may choose to designate part of their territory as fair game for the local bloodsuckers, or otherwise come to accord with them.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " Vampires are attracted to places where humans are both active and blind at night. A pack that wishes to attract vampires to an area, therefore, must attract nightlife.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Benefits (free-form):" },
                    " Werewolves who remain on civil terms with local blood-drinkers can buy vampiric Contacts at -1 experience point. Areas that attract vampires tend to have plenty of humans around, which may make it easier for werewolves to find a human on short notice for whatever purpose.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                items: [
                    [
                        "A feud between local vampires spreads to include the pack, as one of the vampires offers local werewolves a bounty on members of a vampire gang known as the “Dragons.” Even if the players’ pack ignores the offer, other local packs may get involved on opposite sides of the feud.",
                    ],
                    [
                        "A packmember’s teenage child is attacked by what appear to be vampires, leaving bloody wounds on the teen’s neck. If there is a “treaty” of sorts between the Uratha and vampires, surely this shatters it. But which vampires attacked her?",
                    ],
                ],
            },
        ],
    ...
    },
    {
        ...
        "LongDescription": [
            "Virgin territory is land that humans have never set foot in — or, at least, land that humans have left no mark on.",
            {
                ...
                content: [
                    { type: 'bold', text: "Creating:" },
                    " Either a place is virgin or it isn’t; the mark of humanity cannot be scrubbed from an area.",
                ],
            },
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Eliminating:" },
                    " Easy. Invite a group of humans out to the 'special place in the woods' that you know about.",
                ],
            },
            {
                type: 'paragraph',
            ...
            },
            {
                ...
                content: [
                    { type: 'bold', text: "Problems and Hooks:" },
                    " Uratha who wish to preserve a virgin stretch of wilderness have to work at it. Curious and lost humans might accidentally happen across the area — although in the modern day they would have to work hard to find a site that no human had ever visited before.",
                ],
            },
        ],
        "Description": ""
    ...
    },
    {
        ...
        "LongDescription": [
            "This descriptor applies to any region that generally experiences low rainfall. The area doesn’t have to be a desert — the plains of western North America can be quite dry without being a desert.",
            {
                ...
                content: [
                    { type: 'bold', text: "Effects:" },
                    " -1 die to summon spirits of water; +1 die to summon spirits of wind or fire. -1 die to Survival rolls generally, as water is hard to find (except for tracking and similar uses of the skill).",
                ],
            },
        ],
        "Description": ""
    },
    {
        ...
        "LongDescription": [
            "This descriptor refers to any region that is above 5,000 feet in altitude. The air is thin here; nights are colder and days hotter than lands lower down.",
            {
                ...
                content: [
                    { type: 'bold', text: "Effects:" },
                    " -1 die from all Stamina rolls until the character becomes acclimated to the local oxygen levels, a process that takes 20 successes accumulated over daily Stamina + Athletics rolls.",
                ],
            },
        ],
        "Description": ""
    },
    {
        ...
        "LongDescription": [
            "This applies to tropical or subtropical regions — technically, tropical areas are within 23 degrees of the equator, but the group is welcome to define certain parts of the United States (for instance) as being effectively tropical. These are hot regions — sometimes deadly in the summer and only mild in the winter.",
            {
                ...
                content: [
                    { type: 'bold', text: "Effects:" },
                    " -1 die to summon spirits of snow, cold or winter; +1 die to summon spirits of heat and fire. -1 die to Survival pools during summer; +1 die to Survival pools during winter.",
                ],
            },
        ],
        "Description": ""
    },
    {
        ...
        "LongDescription": [
            "This descriptor refers to any region that experiences regular heavy rainfall, such as coastal tropical areas or ocean islands. The region may suffer a monsoon season, or may simply be generally rainy.",
            {
                ...
                content: [
                    { type: 'bold', text: "Effects:" },
                    " +1 die to summon spirits of water; -1 die to summon spirits of fire. +1 die to Survival dice pools if they pertain to tracking footprints, unless it has rained since the prints were made (in which case -4 dice).",
                ],
            },
        ],
        "Description": ""
    ...
    },
    {
        ...
        "LongDescription": [
            ...
            "The following Domain Merits are each purchased or defined separately.",
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Domain Location (• to •••••)" },
                ],
            },
            {
                type: 'paragraph',
            ...
            "This Merit is its own drawback. Better feeding grounds attract trespassers who often bring trouble with them. The lord of a domain with a good Location has to protect it.",
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Domain Quality: Interactive (• to •••••)" },
                ],
            },
            {
                type: 'paragraph',
            ...
            "Thus, with two dots in this Merit, the Domain can have a +1, -1, +2 or -2 ratings in Access, Information, and Prestige. An Attribute does not have to be rated to the maximum possible modifier, but no Attribute’s modifier can exceed the dots in this Merit. So, with Domain Quality: Interactive •• the Domain could have Access -2, Information +1 and Prestige +2.",
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Domain Quality: Reactive (• to •••••)" },
                ],
            },
            {
                type: 'paragraph',
            ...
            "This Merit, therefore, doesn’t necessarily limit the number of dots that local havens can have in Haven Size. The Storyteller has the right to set a limit in order to reflect the nature of the domain’s neighborhood, but it’s not essential. Regardless of limits imposed by the domain, the lord of the land always has the right to limit the size of local havens. It’s his right to decide how much of his land another Kindred receives. Some lords cite the Masquerade when forcing their tenants into smaller havens, but the fact is that lordly fiat is all the justification they need.",
            {
                type: 'paragraph',
                content: [
                    { type: 'bold', text: "Domain Security (• to •••••)" },
                ],
            },
