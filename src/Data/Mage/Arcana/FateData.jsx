const fateOneData = [
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Success allows the mage to examine anyone in sensory range to determine the interconnections they might have with each other (or even with things and institutions, such as corporate brands or fashions). On each turn following the casting of this spell (so long as the mage continues to concentrate), an extended Wits + Empathy + Fate roll can be made for the mage to scrutinize people. Each success yields some information, with more successes yielding more powerful connections. The mage cannot tell exactly what the connections mean, just their intensity. See 'Sympathetic Range,' p. 114, for details on what each degree of connection means."
            },
            {
                "type": "table",
                "headers": [
                ...
                "rows": [
                    [
                        "1 success",
                        "The caste can identify Unknown and Described connection between people and/or things. The caster can also detect an oathbreaker, one who was violeted an oath or geas"
                    ],
                    [
                        "2 successes",
            ...
            {
                "type": "paragraph",
                "text": "If the target has any form of supernatural occlusion (such as the Occultation Merit) that would hinder the mage’s perception, the caster’s dice pool is modified by the dots or Potency of that protection."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "At any time within the spell’s Duration, the mage can spend time “aiming” any action, reducing dice-pool penalties turn by turn (as an instant action per turn) on a one-for-one basis, to a maximum of three dice worth of penalties. This effect can negate only penalties, however, and may not result in any kind of bonus to dice pools."
            },
            {
                "type": "paragraph",
                "text": "Example: Zeno wants to drive his motorcycle up a ramp and jump over a fence. The Storyteller deems that because of the torrential downpour, there is a –3 dice penalty. Zeno had earlier cast Quantum Flux, allowing him to mitigate deleterious factors such as the heavy rain. He sets his bike in motion, and spends the next three turns “aiming” his jump, mystically accounting for all the problems the rain might cause him and so reducing the –3 penalty by one die per turn. When he’s ready to jump, he suffers no penalties for the rain."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The mage uses Life 1 to get a lock on a living creature or Matter 1 for an object. Each success reduces one die of ranged combat penalties normally due to the target’s distance (range penalties), position (such as being prone), size (for very small targets) or environmental factors such as darkness, snow or anything else that doesn’t directly work upon the mage herself or serve to physically shield the target (the spell does not eliminate cover penalties). It can even apply to penalties for aiming at specific targets, such as an enemy’s hand or the object he holds."
            },
            {
                "type": "paragraph",
                "text": "The spell is applied to the next roll the caster makes against the target onto which he has locked. If the target leaves his direct sight before he makes his shot, he loses the lock and must cast this spell again to achieve the same effect."
            },
            {
                "type": "paragraph",
                "text": "This spell cannot be cast in combination with the Space 1 “Spatial Map” spell (p. 233); only one spell (the one with the highest Potency) takes precedence."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "This spell is cast immediately after the mage scores an exceptional success. The Storyteller may rule that exceptional successes at attempts of little relevance to the ongoing narrative do not qualify; only events of significant import or risk generate sufficient resonance to activate this effect. Also disqualified are actions in which an exceptional success provides no particular additional benefit, above that of an ordinary success."
            },
            {
                "type": "paragraph",
                "text": "The exceptional success is downgraded to a standard simple success, and the mage adds one to a pool of points known as the Sacrifice Fortune pool."
            },
            {
                "type": "paragraph",
                "text": "The mage may at any subsequent time relinquish control over a finishing spell, by paying seven points from his Sacrifice Fortune pool."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneAlta": [
            {
                "type": "paragraph",
                "text": "The mage gains cryptic guidance from meaningful exercises of apparently random chance."
            },
            {
                "type": "paragraph",
            ...
            {
                "type": "paragraph",
                "text": "Whether a television program, snippet of song lyric, address or street encounter is used, the result of the random input suggests a course of action or an answer to a thorny question."
            }
        ],
        "Practice": "Knowing",
        "Action": "Instant",
...
const fateTwoData = [
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Successfully casting of this spell enables a mage to swear an oath (see Mage: The Awakening, pp. 153-4) that persists even after her death. In effect, she instantaneously arises as a revenant (Mage: The Awakening, pp. 143-4) with a driving passion to see the oath fulfilled. Depending upon the Duration assigned to the spell (which may be set with Fate to trigger only in the event of the willworker’s demise), the reanimated mage may be free to pursue her vow for quite some time. If the Potency of this spell is overcome by another mage’s efforts, then it might be nullified (potentially destroying the revenant), the oath altered, or otherwise manipulated, so those Awakened who learn this spell and who ever have cause to employ it are well advised to cast it in ritual form, with as great a Potency as can reasonably be managed."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneAlta": [
            {
                "type": "paragraph",
                "text": "The mage picks up a telephone and dials a number, and the telephone nearest the person he wishes to contact starts ringing. If this spell is used on a telephone that remembers the numbers dialed, it is a good way to find out someone’s cell phone number."
            },
            {
                "type": "paragraph",
                "text": "The ultimate target is under no compulsion to pick up the telephone, although most people do, and the telephone connection is completely mundane, so if the mage and target do not share a common language the spell is of little use. There is also no guarantee that the target will be the closest person to the phone — only that the phone closest to the target will ring — thus he may not answer."
            },
            {
                "type": "paragraph",
                "text": "This is not sympathetic magic, as the target is the phone system, which is being manipulated, not the remote person who will hear the telephone ring."
            }
        ],
        "Practice": "Ruling",
        "Action": "Instant",
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "One use of the spell allows only one phone call. It is, however, almost impossible for repeated use of this spell to become improbable. The caster is simply making a number of phone calls."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Success works similar to The Evil Eye (see Mage: The Awakening, p. 151): subtracting dice equal to the caster’s Fate dots from the subject’s dice pool for the next action taken. Each additional success affects an additional dice roll. The effect begins immediately before the action (and therefore die roll) that triggers it."
            },
            {
                "type": "paragraph",
                "text": "Example: A hit man takes aim at a target, unaware that the mark is actually a mage protected by Fate’s Justice. The Storyteller rolls for the spell, and it is successful, affecting the assassin’s next two dice rolls and subtracting three dice (equal to the caster’s Fate dots). This causes the intended shot to miss, and also makes the hit man fail his Athletics roll as he attempts to scramble down from the rooftop before he’s discovered..."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "If the target is unwilling, he may contest with a reflexive Resolve + Gnosis roll."
            }
        ],
    ...
    },
    {
        ...
        "RoteDescrizione": [
            {
                "type": "paragraph",
                "text": "Guardians use this spell to seek out those dedicated people (or unlucky individuals) who have been touched by the supernatural. Simply seeing them is just the start. A Guardian must perform additional investigation to determine the target’s name and other information. Inquiries with the local Cultors usually follow, making sure the fellow hasn’t already been taken into the Labyrinth."
            },
            {
                "type": "paragraph",
                "text": "Subjects found through the use of this spell (when they aren’t already involved in the Labyrinth) often get visits from strangers in black, corporate men from mysterious companies and others who wish to interview them about their experiences. Some Guardians of the Veil simply activate this spell and spend time wandering the streets, the equivalent of a police car patrolling for suspicious activity."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneAlta": [
            {
                "type": "paragraph",
                "text": "The mage creates a shift of destiny, effectively generating turns of good or bad luck. These small manipulations of fortune almost always take the form of totally plausible situations, such as a parched mage finding that last quarter she needs on the sidewalk so she can buy a drink, or a sudden, stiff crosswind that turns a crack sniper’s fatal shot into a serious wound. Big shifts, such as finding $1000 at the convenience store’s front door or a piano falling on the sniper are simply too implausible to easily happen at this level of mastery. The mage simply requests some small jolt in the desired direction and allows destiny to make the decision as to how it comes about, meaning the mage should be on her toes, ready for anything in the event that her requested outcome happens in an extremely unexpected manner."
            },
            {
                "type": "paragraph",
                "text": "A wish for “a new car,” for example, yields one up, but the mage gets it under circumstances that cause longterm possession to be undesirable (the car is stolen or haunted) or under which long-term possession is unhelpful (the car is faulty and quickly ends up collecting dust in a garage)."
            },
            {
                "type": "paragraph",
    ...
    },
    {
        ...
        "DescrizioneAlta": [
            {
                "type": "paragraph",
                "text": "Akin to both Fate 1 “Sybil’s Sight” and Death 1 “Grim Sight,” but more powerful than either, Sniffing the Winds of Fate gives the caster a sense of the subject’s ultimate destiny — grand or humble, good or ill — and how near the subject is to that fate. The “bigger picture,” or ultimate outcome of the subject’s life, whether for good or ill, is revealed by a golden aura or a gray shroud around her, the intensity of which reveals the magnitude of the net effect she is destined to have on the world. A true saint is seen wreathed in a near-blinding radiance, while a cannibalistic serial killer who targets children would be shrouded by a deep leaden gloom. A mage can use this spell to read inanimate objects as well as living creatures to determine how pervasive the effects of entropy are on its structure and its ultimate fate, allowing the mage to determine whether a building is likely to stand for several more decades, fall into a lengthy state of disrepair before falling down (or being renovated)."
            },
            {
                "type": "paragraph",
                "text": "This spell reveals what might be considered the subject’s default fate — what will happen if destiny is allowed to run its course. With extraordinary action, the destiny revealed by this spell may be altered, at which point the spell may be used again at a later time to discern the subject’s new destiny."
            },
            {
                "type": "paragraph",
                "text": "This spell does sense, among other things, if the subject possesses the Destiny Merit, and a general sense of how strong the Merit is in that individual."
            }
        ],
        "Practice": "Unveiling",
        "Action": "Instant",
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Success causes a number of dice to be removed from the subject’s dice pool for the next action he takes (i.e., the next action for which dice need to be rolled). One die is subtracted per Fate dot the caster possesses. Each extra success on the spellcasting affects one additional roll. For example, if the caster rolls three successes, he affects the next three rolls made for the target."
            },
            {
                "type": "paragraph",
                "text": "Some mages prefer to cast the Evil Eye as a prepared spell with a conditional trigger. This approach allows them to delay the onset of the curse until the target performs a specified action (perhaps repeating the same insult that inspired the caster to impose this spell) or certain conditions are in place. The mage needs Time 2 or higher as a conjunctional Arcanum. See 'Prepared Spell,' p. 260, and 'Conditional Trigger,' above, for complete rules."
            },
            {
                "type": "paragraph",
                "text": "(Note: The Fate 5 'Break the Chains' spell, p. 159, can dispel the Evil Eye.)"
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "More a roleplaying issue than anything else, this spell moves out of the realm of dice rolls and into that of manipulating the story. The mage effectively chooses some small thing that he wishes to see come to pass and makes it so through his magic. A Storyteller may levy dice penalties for highly improbable results (such as a pierced, tattooed, and leather-garbed punk making a great impression at a black-tie affair). Generally speaking, favorable results of this spell do not last longer than the spell’s Duration (unless the mage has subsequently taken non-magical steps to that effect)."
            },
            {
                "type": "paragraph",
                "text": "Unfavorable side effects can haunt a mage for quite some time. These are usually reversals of the exact same fortune the spell provided. Using this spell repeatedly against the woman in the bar might lead to an unfortunate encounter with her jealous ex-Mafia boyfriend, for example."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The spell affects actions undertaken by any and all characters within its area of effect, centered on a targeted spot:"
            },
            {
                "type": "table",
                "headers": [
            ...
            {
                "type": "paragraph",
                "text": "Within the Zone of Extremity, all failures become dramatic failures. All standard successes are treated as exceptional successes. This effect applies only to mundane actions, not spellcasting."
            },
            {
                "type": "paragraph",
                "text": "With Fate 3 and a cost of one Mana during casting, the default Duration becomes prolonged (one scene)."
            }
        ],
...
const fateThreeData = [
    ...
    },
    {
        ...
        "DescrizioneAlta": [
            {
                "type": "paragraph",
                "text": "This spell further enchants a cursed item of any kind. When any owner other than the original worker of this spell attempts to dispose of it, a chain of coincidences conspires to return it."
            },
            {
                "type": "paragraph",
                "text": "A smashed ceramic statue might be laboriously glued together by a building superintendent and returned with an expectation of gratitude. A DVD thrown out of a car window is found by the owner’s best friend and given to him as a gift."
            },
            {
                "type": "paragraph",
                "text": "When no possible further coincidence could possibly explain the item’s return, it makes one final reappearance, shiny and new, after which point its owner is able to destroy or dispose of it. However, if that last disposal then opens up another possible coincidental return, the cycle continues."
            }
        ],
        "Practice": "Weaving",
        "Action": "Extended",
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The willworker must add five successes to the target number for each other spell or enchantment, including other curses, worked into the item."
            },
            {
                "type": "paragraph",
                "text": "Certain later manifestations of the Bad Penny risk triggering Disbelief, which can then act to dispel the curse, if the Sleeper accumulates enough Resolve + Composure successes to exceed the Potency of the original Bad Penny spell."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The number of successes required for this spell depends on what the mage wishes the target to avoid:"
            },
            {
                "type": "table",
                "headers": [
            ...
            {
                "type": "paragraph",
                "text": "If the spell succeeds, the target is protected from the specified danger for the duration of the spell (one hour or one scene, unless additional Duration factors are included in the spell). This spell does not function on other mages, as they take on entirely too much responsibility for their own destinies for such manipulation."
            },
            {
                "type": "paragraph",
                "text": "Anyone with an active Blessing spell stands out to Fate 1 “The Sybil’s Sight.”"
            },
            {
                "type": "paragraph",
                "text": "Once the specified danger has been avoided, the spell ends, regardless of how much Duration remains. All such protections take the form of coincidence and happenstance that remove the target from harm’s way, rather than making harm actually miss the target. If the target seeks out danger of the appropriate type, the spell still protects him once, but offers no further benefit. For instance, a Blessed target enters a burning building. The floor gives way under the weight of a couch before the character steps on it (thus avoiding injury or death for the target). If the person continues on into the house, though, the spell no longer aids him."
            },
            {
                "type": "paragraph",
                "text": "If the target is nursing a death wish or is hell-bent on getting into trouble, then he can (unconsciously) contest the magic with a Composure roll."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The Potency of this spell cannot exceed the caster’s total Fate dots. To weave the curse into the item, she must spend one Mana and add five successes to the target number of the spell."
            },
            {
                "type": "paragraph",
                "text": "Whenever the user touches or makes use of the cursed item, the possibility of ill luck arises. (For this reason, it is essential that the mage installing the curse get rid of the item as soon as possible afterwards; until it changes hands, she counts as its owner.) The Storyteller rolls a single die; on a result of one, the curse activates, and the victim suffers a penalty to his next die roll equal to the Potency of the curse."
            },
            {
                "type": "paragraph",
                "text": "In some cases, the Storyteller may have to determine precisely which activities qualify as use of an item. In the case of an art object, for example, a roll may be required whenever the owner takes a moment to admire it."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "If the spell is successful, the rival suffers the following effects:"
            },
            {
                "type": "list",
                "items": [
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Those who are attuned to prophecy must overcome the Potency of this spell in order to see through the lie."
            },
            {
                "type": "paragraph",
                "text": "If this spell is cast upon an unwilling mage, a reflexive, contested Composure + Gnosis roll may be made to resist."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            ...
            {
                "type": "paragraph",
                "text": "On a success, the item can still be used during the current turn, but at a dice penalty equal to the number of Misfortune successes."
            },
            {
                "type": "paragraph",
                "text": "On an exceptional success, a random curse permanently instills itself in the item. The Storyteller chooses an appropriate curse given the narrative circumstances, or rolls one die and consults the following chart, adding one to the result for each curse already instilled in the item. See p. 136 for details on the curses."
            },
            {
                "type": "table",
                "headers": [
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "On the turn after casting, the targeted object receives an equipment dice bonus equal to the spell’s successes, up to a maximum of the caster’s Fate dots. (This is in addition to the item’s normal equipment modifier.) In addition, a suit of armor’s protection can be increased by one point per success (to a maximum of the caster’s Fate dots)."
            },
            {
                "type": "paragraph",
                "text": "As a roleplaying consideration, lucky objects tend to benefit those who own them (a lucky jacket is snagged by some tree roots as a mage slides on some loose rocks down a steep hill). Sometimes a lucky object does not even need to be used by its owner to bring fortune to bear upon him."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "On the turn after casting, the targeted object is subject to an equipment dice penalty equal to the spell’s successes, up to a maximum of the caster’s Fate dots. In addition, a suit of armor’s protection can be decreased by one point per success (even down to zero points)."
            },
            {
                "type": "paragraph",
                "text": "As a roleplaying consideration, unlucky objects tend to cause their owners harm (an unlucky carving knife cuts a chef’s hand, putting him out of action for weeks). Sometimes (as in the case of the cursed paperweight, above) an unlucky object need not even be used by its owner to bring ill fortune upon him."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The spell’s Potency contends against all other mages’ attempts to perceive or alter the target’s destiny."
            },
            {
                "type": "paragraph",
                "text": "If this spell is cast upon an unwilling mage, a reflexive, contested Composure + Gnosis roll is made to resist."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The Storyteller responds by providing an answer based on the current, relevant dice pools of the targets. He doesn’t reveal the target’s game traits, only that a target would be the best or worst based upon those traits. For instance, if the mage is facing off against three marksmen, this spell usually reveals the shooters with the highest and lowest dice pools, but would not reveal that the worst shooter had a Dexterity + Firearms pool of 6. If the best and worst in the group are equally competent, the spell reveals this as well. Special circumstances affect the result. These include equipment bonuses, wound penalties and magic; the caster isn’t privy to this information."
            },
            {
                "type": "paragraph",
                "text": "The spell reveals only relative competence based upon what might happen in the immediate future, so a gunman suffering temporary blindness would be considered worse than one who is usually an inferior shooter even if the blind marksman is due to recover his vision."
            },
            {
                "type": "paragraph",
                "text": "For each additional level of Potency the mage can expand her understanding of the hierarchy of competence to add the next best or next worst targets, up to the limits of the spell’s Potency or the number of targets, whichever is less/fewer. This spell can be combined with another to specifically target the best or worst member of a group. For example, it could be combined with “Call Lightning” to direct the spell at the target most likely to survive electrocution, or the one least likely to successfully counter the spell."
            },
            {
                "type": "paragraph",
                "text": "This listing describes the instant version of the spell, but in ages past, mages cast extended ritual versions to find the weak and strong points in entire Consilii and battle formations."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneAlta": [
            {
                "type": "paragraph",
                "text": "Fate is used as an instrument of both justice and punishment. This spell braids the fates of two subjects together, such that the fate of one becomes the fate of the other. Whatever befalls one subject affects the other and vice versa."
            },
            {
                "type": "paragraph",
                "text": "In times past, this spell was used as a means of parley between willworkers, to ensure both parties honored a truce. This spell still sees some use in that regard, but is more a means of threatening an enemy and ensuring their cooperation."
            }
        ],
        "Practice": "Weaving",
        "Action": "Instant",
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The mage gains the 8-again quality (reroll results of 8, 9 and 10) on one future dice roll per success achieved in the spellcasting roll. The player can choose which of his rolls are affected by this superlative luck, and they can involve any action or task. This effect lasts for one scene (unless additional Duration factors are added during casting), after which time any unused luck rolls are lost."
            },
            {
                "type": "paragraph",
                "text": "Note that this spell does not affect a chance die, should a mage’s dice pool be reduced to one. Only a result of 10 is a success."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Each success assigned to this spell’s Potency increases by one the number of successes required to manipulate the caster’s destiny with the Fate Arcanum — the tides of fortune that surround her are simply too convoluted to easily navigate, full of conflicting emotions and compulsions, and occluded by random patches of magical concealment."
            },
            {
                "type": "paragraph",
                "text": "Note, however, that other Fate magics in the area work normally, including those that might indirectly target the caster, such as being caught within the area of a “Swarm of Locusts” spell. This spell effectively defends the caster against certain Fate-based effects that are “under the radar” of the Unfettered Fate 4 effect, such as Monkey’s Paw and Alter Oaths."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "By casting this spell, a mage can reconstruct the Final Name of someone already dead. In order to properly reconstruct the Name, the mage must acquire Known or better sympathetic connections to at least 10 objects or individuals who had sympathetic connections to the deceased. Possessing the objects in question or the Final Names of the individuals is also adequate. For every connection less than ten, the mage suffers a –1 penalty to her casting pool. If she has no connections at all, she cannot cast the spell."
            },
            {
                "type": "paragraph",
                "text": "Successes rolled on the spellcasting pool determine the maximum “age” (that is, time since death) of the Final Name the mage can restore, using the Prolonged Duration chart. If the mage attempts to recreate the Final Name of someone who has been dead longer than the indicated Duration, the spell fails."
            },
            {
                "type": "paragraph",
                "text": "If the mage has Death •••, she may use the Advanced Prolongation chart to determine the maximum age of the Final Name. “Indefinite” Duration means that the mage can restore the Final Name of any deceased individual, as long as the mage has the appropriate sympathetic resonances."
            }
        ],
...
const fateFourData = [
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Assuming another person’s Final Name confers the following benefits:"
            },
            {
                "type": "list",
                "items": [
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The caster’s successes must exceed the Potency of the bond being severed. In the case of a ghost, successes must exceed its Resistance dots. For a fetish, use the Potency of the spell that created the item (see the Spirit 4 “Create Fetish” spell, p. 252). In the case of a familiar, successes must exceed its owner’s Gnosis dots."
            },
            {
                "type": "paragraph",
                "text": "Both the release of a trapped soul and the release of a bound spirit or ghost are lasting, though the mage-familiar bond returns to normal at the end of the scene (the caster can increase this Duration as per a prolonged spell). In the case of freed souls, the soul does not automatically return from whence it came. It must be restored to its rightful owner using the Spirit 3 “Restore Lost Soul” spell, p. 250."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            ...
            {
                "type": "paragraph",
                "text": "This spell can target items within the Shadow Realm, although without a Spirit 3 component the item cannot cross the Gauntlet. It arrives just on the other side of the Gauntlet, probably brought by means of a hapless spirit."
            },
            {
                "type": "paragraph",
                "text": "Using this kind of magic for selfish or greedy ends, especially when a mage does so repeatedly, almost always leads to bad twists of fortune, often involving one or more of the objects the mage tries to acquire."
            },
            {
                "type": "paragraph",
                "text": "As with any spell targeting an unseen subject, the mage needs a Space Arcanum sympathetic connection to reach out and grasp the object’s strands of fate to draw them to him. The strength of this connection determines if there are penalties on the spellcasting roll (see p. 114)."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The mage gains the rote quality (reroll failed dice once) on one future dice roll per success achieved on the casting roll. The player can choose which of his rolls are affected by this altered probability, and they can include any action or task, although he must decide before the dice are rolled. This effect lasts for one scene (unless additional Duration factors are added during casting), after which time any unused Probable Cause re-rolls are lost."
            },
            {
                "type": "paragraph",
                "text": "Note that this spell does allow the player to re-roll a failure on a chance die. This spell cannot be “stacked” with “Exceptional Luck” (p. 151) or “Superlative Luck” (p. 156); only the most potent spell takes effect."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Successes must exceed the Potency of the oath to be severed, unless the caster targets one of his own oaths, in which case one success is enough."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The mage casting the spell may be the recipient, the donor, or a bystander. If either party is unwilling and aware of the spell, it may be contested by Resolve + Gnosis."
            },
            {
                "type": "paragraph",
                "text": "Each success on the spell transfers one dot of the Destiny Merit from the donor to the recipient. At the end of the scene, the Merit transfers back to the donor, but if the recipient has used any destiny dice within that chapter, the donor may not use them until they refresh as per the Destiny Merit rules."
            },
            {
                "type": "paragraph",
                "text": "The Destiny’s bane also transfers for the duration of the spell — the donor also keeps the bane unless all her Destiny Merit dots have been lost to the spell."
            },
            {
                "type": "paragraph",
                "text": "The caster must touch both targets for the spell to take effect. With Fate 5, the spell can be cast at range."
            }
        ],
...
const fateFiveData = [
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Successes must exceed the geas’s Potency."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Each success on the spellcasting roll can be used to add one die to the target’s dice pool for any action that might foster the fruition of the fate declared by the caster. Conversely, one dice penalty per success can be levied against rolls that might help prevent a subject’s new destiny. The Storyteller determines when modifiers penalize an action, but they’re often employed whenever the target tries to deny the fate that the spellcaster has imposed."
            },
            {
                "type": "paragraph",
                "text": "The effect lasts for one scene. If sufficient Duration is not assigned to the spell, the being may not have long enough to see the action through. For example, rendering a person destined to buy a given used car in her hometown makes that fate likely (but not necessarily) to come to pass rather quickly, while giving a dog a destiny to kill a prominent recluse 2000 miles away may result in a fate that takes years to come to fruition."
            },
            {
                "type": "paragraph",
                "text": "If a mage attempts to influence another artificially created destiny, she must overcome the Potency of the spell used by the mage who originally imposed the artificial fortune."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "While in direct confrontation with a doom or while acting within or being targeted by the parameters of a doom (being struck in the wounded leg or getting in trouble with a woman’s large boyfriend while hitting on her in a club), any damage dice suffered by the subject are increased by the spell’s successes. The damage type does not change (sources of bashing damage still cause bashing damage, they just cause more than they normally would)."
            },
            {
                "type": "paragraph",
                "text": "Meeting a doom does not guarantee that the mage will suffer damage; it only worsens any damage that might happen to be inflicted. For example, a mage who enters a sanctum that is his doom has no more chance than usual of coming to harm, but should he accidentally fall down the stairs (or be pushed), his odds of suffering a lot of damage increase."
            },
            {
                "type": "paragraph",
                "text": "In the case of a place made into a doom, the default area affected is of one yard radius or five-cubic yards of volume."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            ...
            {
                "type": "paragraph",
                "text": "Example: Arethusa retreats to a sacred grove. The area around an old oak tree acts as her godsend (created with a three-success spell in a three-yard radius around the tree). Later, still within the Duration of the Forge Godsend spell, an enemy enters the grove and attacks Arethusa with a spell while she sits under the tree. Her godsend’s three successes are subtracted from any damage the spell might inflict, so long as she is within the godsend tree’s radius."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Note that, unlike the powers of the Mind Arcanum, this spell does not compel a target to perform a task. It instead sets up terrible repercussions if he doesn’t perform it."
            },
            {
                "type": "paragraph",
                "text": "Those who violate the terms of a Geas (failing to actively work toward fulfilling the Geas counts as violating it) during the spell’s Duration suffer the effects of the “Great Curse,” below, until such time as the Geas would normally expire."
            },
            {
                "type": "paragraph",
                "text": "Geas has the potential for greater longevity than most prolonged five dot spells. When increasing Duration factors during casting, the mage uses the advanced prolongation factors chart, even if he does not have six dots in Fate:"
            },
            {
                "type": "table",
                "headers": [
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The spell is like the “Evil Eye” spell, except that it affects all rolls made while the magic is in effect. This spell cannot be combined with the Evil Eye; only the most potent spell takes effect."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            ...
            {
                "type": "paragraph",
                "text": "The chaos seething in the area is beyond the caster’s control and might adversely affect him or his allies. Depending on the description of the effect, the Storyteller might levy a –1 to –2 dice penalty on any rolls made that are not directly involved in dealing with the chaos."
            },
            {
                "type": "paragraph",
                "text": "This spell cannot be cast a second time within the same area (or in adjacent areas) for the next 24 hours."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            ...
            {
                "type": "paragraph",
                "text": "This spell is always cast with a conditional Duration. (See p. 150 of Mage: The Awakening.) The condition is this: If one lover betrays the other, the spell’s effects immediately end and each party becomes unable to regain Willpower by any method while the other lives. This is, of course, a fairly easy situation to remedy..."
            }
        ],
...
export { fateOneData, fateTwoData, fateThreeData, fateFourData, fateFiveData };
