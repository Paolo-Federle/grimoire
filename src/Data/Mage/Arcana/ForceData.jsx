const forceOneData = [
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Successes determine the degree to which the light can be altered. For instance, with one success, a light beam can be diverted in a 90-degree direction, while two successes can turn it again by 90 degrees."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "A Wits + Science roll is made to enable the mage to pick out and identify the type of signal she is receiving. To break a code, an additional Wits + Occult or Computer may be necessary, while an Intelligence + Language roll can determine if the signal contains a message."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "See “Resonance,” pp. 277-280, for rules on scrutinizing magic with this spell. When scrutinizing energetic phenomena (like the electromagnetic spectrum), the more invisible that energy is to the naked eye, the more dice penalties the mage suffers."
            },
            {
                "type": "table",
                "headers": [
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "A Wits + Composure roll is made for the mage to discern high-frequency sounds (a dog whistle) or low-frequency sounds (the rumble of a distant herd of elephants). Sounds that are very high or low on the scale from the normal human range of hearing might impose dice penalties."
            }
        ],
...
const forceTwoData = [
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Banishers who make use of this spell often take the time to learn how the police (or other emergency services) communicate in the area. This spell might be used as a last resort, summoning the police to scatter combatants if things go wrong, or it might be part of the Banisher’s plan all along."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Free Council Rote: Open Circuit Television"
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Each success either increases or decreases the temperature in a one-yard radius of the targeted spot by up to 10 degrees Fahrenheit. For example, four successes allow the caster to reduce the average room temperature of 72 degrees down to freezing (32 degrees)."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Each success doubles the light’s candescence or diminishes it by half."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Each success doubles the sound’s volume or diminishes it by half. The effect covers any sound source emanating from within a targeted spot of one-yard radius. For example, if cast upon a podium, anyone standing within that one-yard spot speaks louder than he would when standing outside it."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "If the target is unwilling, a reflexive and contested Resolve + Gnosis roll is made to resist."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The mage reduces the friction in a given area according to her successes:"
            },
            {
                "type": "table",
                "headers": [
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": [
                    "The mage does not directly attack a person or object with this spell; he instead manipulates an existing electrical current, redirecting it toward the target of his choice. The damage inflicted depends entirely on the electrical current. See “Electrocution,” pp. 177-178 of the ",
                    {
                        "type": "bold",
                        "text": "World of Darkness Rulebook"
                    },
                    " for guidelines. The raw power of the current is not altered in any way at this level. This spell usually causes the power source to shut down (a circuit breaker engages) or short out in following turn (although Duration factors can be increased to prevent this termination for additional turns)."
                ]
            },
            {
                "type": "paragraph",
                "text": "A simple success allows the electricity to affect one target. (The mage can arc the electricity to any target within five yards of the source per dot of Forces; a mage with Forces 2 can affect a target 10 yards away.) Excess successes affect additional adjacent targets next to one another (this is an exception to the normal rule that disallows aimed spells to affect multiple targets). Targets must each be within three yards in either direction of each other."
            },
            {
                "type": "table",
                "headers": [
            ...
            {
                "type": "paragraph",
                "text": "The source itself, however, limits the total number that can be affected:"
            },
            {
                "type": "table",
                "headers": [
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": [
                    "The mage does not directly attack a person or object with this spell; he instead manipulates an existing fire, moving it or directing it toward the target of his choice. The damage inflicted depends entirely on the size and heat of the fire. See “Fire,” p. 180 of the ",
                    {
                        "type": "bold",
                        "text": "World of Darkness Rulebook"
                    },
                    " for guidelines. This spell usually causes the fire to exhaust its fuel in the following turn, although if targets are wearing highly flammable clothing, they might catch fire and continue to burn each turn until the fire is put out."
                ]
            },
            {
                "type": "paragraph",
                "text": "A single success allows the fire to affect one target. (The mage can send the fire at any target within three yards of its origin per dot of Forces; a mage with Forces 2 can affect a target six yards away.) Excess successes affect additional adjacent targets next to one another (this is an exception to the normal rule that disallows aimed spells to affect multiple targets). Targets must each be within three yards in either direction of each other."
            },
            {
                "type": "table",
                "headers": [
            ...
            {
                "type": "paragraph",
                "text": "The size of the source itself, however, limits the total number that can be affected:"
            },
            {
                "type": "table",
                "headers": [
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The mage casting this spell becomes resistant to electrical shock. With Forces 3, it can be cast on others. The spell reduces the automatic damage inflicted by electricity by two points per dot of Forces of the caster. In addition, she automatically succeeds on the Strength roll to pull away."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "If the object is moved, it is not invisible (it can be seen) while it is moving."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Bashing damage is converted to lethal. Attacks that already inflict lethal damage are unaffected. The spell affects one future attack roll per success. The player can choose which of his attack rolls are affected, but he must choose before he rolls the dice for each attack. This effect lasts for one scene (unless additional Duration factors are added during casting), after which time any unused Kinetic Blows are lost."
            },
            {
                "type": "paragraph",
                "text": "With Forces 3, the mage can use this spell with ranged-weapon attacks such as thrown rocks."
            }
        ],
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": [
                    "If the player succeeds on the casting roll, the target suffers a Knockdown effect (see p. 168 of the ",
                    {
                        "type": "bold",
                        "text": "World of Darkness Rulebook"
                    },
                    "). The target still gets the reflexive Dexterity + Athletics roll to keep his feet, but subtracts the spell’s Potency from the dice pool."
                ]
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The mage gains one point of armor per dot he possesses in the Forces Arcanum. By spending one Mana, the Duration can be made to last for one day. Most mages cast such a shielding spell at the beginning of the day as part of their morning rituals. Successes are used to combat attempts to dispel the shield."
            },
            {
                "type": "paragraph",
                "text": "Note that this magical armor does not apply against an opponent’s attempts to achieve a grappling hold on the mage (the Fate, Mind, Space and Time Arcana provide shielding spells to do that). Nor does it apply against a grappling opponent’s attempts to overpower the mage. The spell does, however, protect against attempts to inflict damage upon the caster (subtract the armor points from any overpower roll that intends to damage the mage or attack him with a drawn weapon)."
            },
            {
                "type": "paragraph",
                "text": [
                    "In addition, the mage gains +1 die per Forces dot on rolls to resist being knocked down from applications of kinetic force, such as a hurtling wrestler or a stiff wind along a canyon edge (including attacks that cause the knockdown effect; see p. 168 of the ",
                    {
                        "type": "bold",
                        "text": "World of Darkness Rulebook"
                    },
...
const forceThreeData = [
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The mage does not directly attack a person or object with this spell; he instead calls and directs a bolt of lightning toward the target of his choice. The bolt inflicts three points of bashing damage plus one per success (two successes therefore inflict five points of bashing damage). The target must be somewhere that lightning could reasonably strike."
            },
            {
                "type": "paragraph",
                "text": "Successive uses of this spell within the same scene against the same target (or even other nearby targets) might be considered Improbable by Sleeper witnesses (see “Improbable Magic,” p. 112). A third strike (and each successive strike thereafter) in the same turn is vulgar."
            }
        ],
        ...
        "DescrizioneAlta": [
            {
                "type": "paragraph",
                "text": [
                    "Similar to Transmission (see ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    ", p. 167), except the mage can send a complex audiovisual transmission."
                ]
            }
        ],
        "Practice": "Ruling",
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Each success can send a single line of power in a new direction, or divert it elsewhere. If the mage attempts to diminish the power, each success brings it down by one degree. For example, one success reduces a main line to a junction box. Two successes takes a junction box down to an industrial socket. Three successes reduces an industrial socket to a regular wall socket."
            }
        ],
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": [
                    "When fueling a fire, successes are allocated between size and heat, with each success either doubling the fire’s size or adding one point to its heat damage. See “Fire” on p. 180 of the ",
                    {
                        "type": "bold",
                        "text": "World of Darkness Rulebook"
                    },
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Once cast, the spell provides the 8 again advantage to Dexterity + Athletics rolls to maintain balance, making it easy for a well-trained mage to run across tightropes or jump from one narrow post to another. The mage also adds her Forces dots in feet for every success scored whenever she succeeds at a Strength + Athletics roll. For example, if she scores 4 successes to make a standing broad jump and has Forces 3, she jumps 20 feet (2 per success as usual, + 3 per success using the spell)."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Shock victims suffer bashing damage equal to the number of Mana spent during item creation."
            },
            {
                "type": "paragraph",
                "text": "If Sleepers witness the same device delivering repeated shocks, Disbelief might come into play, unless the device is connected to a power source at the time, offering a plausible excuse for its effect."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Successes determine the created light’s intensity (in a directional 30 degree arc)."
            },
            {
                "type": "table",
                "headers": [
            ...
            {
                "type": "paragraph",
                "text": "Conversely, one success is usually enough to extinguish a light, unless it’s a light created by this spell or other magic, in which case the magic’s Potency must be exceeded by this spell."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Divide successes between the number of future attacks this spell benefits, and its primary effect, adding dice to any Brawl or Weaponry-based attack. Each success devoted to this advantage adds a die to the mage’s attack dice pool. There’s a limit: no attack can have a combined spell + weapon damage dice bonus of more than 5, or 1 higher than the weapon’s damage bonus if the mage already wields a 5 damage weapon."
            },
            {
                "type": "paragraph",
                "text": "If the mage would gain a combined bonus 1 higher than this, he instead gains the 9 again advantage. (If the weapon provides 9 again already, this becomes 8 again.) If the mage would gain a combined 3 higher than the limit, he gets the 8 again advantage — the maximum benefit the spell can provide."
            },
            {
                "type": "paragraph",
                "text": "For example, if Zeno casts this spell while using a sword that inflicts 2 damage and scores 4 successes, the sword + spell adds 5 dice to the attack, which benefits from the 9 again advantage. If Zeno had cast the spell to augment an unarmed attack it would add 4 dice."
            },
            {
                "type": "paragraph",
                "text": "This spell can’t enhance ranged attacks of any kind."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "One success is enough to hide the mage from sight, while excess successes act to occlude her from spells used to see or locate her (compare spell Potencies). Although the mage’s physical form is invisible, her aura can still be seen by those with the ability to perceive auras (Mind 1 “Aura Perception,” p. 205, or Prime 1 “Supernal Vision,” p. 221). Also, while the mage is invisible to a vampire’s heightened senses from the Auspex Discipline, the vampire might still sense the mage’s presence through his heightened smell or hearing."
            },
            {
                "type": "paragraph",
                "text": "She must maintain concentration as an instant action (which means she cannot cast other spells while maintaining invisibility). She also cannot make quick movements (she can’t move more than half her Speed), or gain her Defense while concentrating. If she does either, she can be seen as a prominent blur or refraction of light, allowing others to freely target her (as if she were barely concealed, with a –1 dice penalty) on the turn in which she moves and before she acts again on the following turn."
            },
            {
                "type": "paragraph",
                "text": [
                    "Others can try to pinpoint an invisible person through hearing or smell (assuming they have advanced olfactory senses). See the rules for “Fighting Blind,” pp. 166-167 of the ",
                    {
                        "type": "bold",
                        "text": "World of Darkness Rulebook"
                    },
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Once cast, this spell acts like the spell “Magic Shield,” providing 1 point of armor per dot of the caster’s Prime Arcanum. In addition, the spell strikes the source of the magical attack with a bolt of kinetic energy, inflicting 1 point of bashing damage per success. However, the same energy that shields the mage is used in the attack, like a sort of “point defense” against the spell that blows through to hit the enemy caster as well. Reduce the number of successes calculated for the attack by the armor rating provided by the spell. For example, if the caster scores 8 successes and has Prime 3, the counterattack is only treated as if it had 5 successes. The caster may voluntarily reduce the armor protection granted by the spell to increase its counteroffensive ability. The counterattack does not use one of the caster’s actions. If the spell came from an artifact or imbued item, the kinetic energy strikes that instead."
            },
            {
                "type": "paragraph",
                "text": "By spending 1 Mana, the caster can make the spell last 1 day. However, once the spell delivers its counterattack it is expended, whether the caster spent Mana or not. It must be cast again."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Successes determine the sound’s volume."
            },
            {
                "type": "table",
                "headers": [
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": [
                    "The mage must declare before casting whether successes apply to the force’s Strength (its lifting ability) or Dexterity (its fine manipulation ability). The lesser Attribute has a default score of 1 dot. The caster can also raise either Attribute by choosing to suffer a –1 dice penalty on the spellcasting roll per dot to be raised. She could, for example, choose to put a lot of Strength and very little Dexterity into a spell intended to lift an extremely heavy object straight up (see “Lifting/Moving Objects,” pp. 47-48 of the ",
                    {
                        "type": "bold",
                        "text": "World of Darkness Rulebook"
                    },
                    "), or she could grant very little Strength and a lot of Dexterity to a spell cast to use a set of lock picks from a distance (roll the Telekinesis Dexterity + caster’s Larceny Skill)."
                ]
            },
            {
                "type": "paragraph",
                "text": "The object cannot be moved beyond the mage’s sight (unless he uses Space 2 to scry it). The mage can move the item at a Speed per turn equal to his Gnosis + Forces."
            },
            {
                "type": "paragraph",
                "text": "The mage must concentrate for each turn. See “Concentration,” p. 119. With Forces 4, he can cast the spell with a default Duration of one scene (in which case, when he is not actively manipulating the object, it stays where he left it, even levitating in the air)."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Each success inflicts one point of bashing damage. With Forces 4, this damage can be lethal. With Forces 5, one Mana can be spent to make the damage aggravated, by tearing apart the target’s cellular structure. This version of Telekinetic Strike actually causes air to ripple in an unnatural fashion, warning a target about the threat. The target is allowed his Defense against the caster’s aiming roll."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Although the casting is an instant action, the mage can cast this spell at any point in the Initiative roster, even before he could normally act, although that is his action for the turn."
            },
            {
                "type": "paragraph",
                "text": "The mage can turn the projectile up, down, right, left, or even back the way it came. The degree to which the projectile’s course is altered depends on the number of successes rolled:"
            },
            {
                "type": "table",
                "headers": [
...
const forceFourData = [
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": [
                    "This spell allows the mage to trap a current weather condition in a pocket or a bag (whether a natural weather condition, or one he has already created), to be kept for later. Fate 2 allows the spell to keep the weather safe as long as the bag is clasped shut, for a base of one scene (see the sidebar on “Conditional Duration,” ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    ", p. 150). When the bag is opened, the weather floods out, covering the immediate vicinity."
                ]
            },
            {
                "type": "paragraph",
                "text": "With Forces 4, the mage can trap weather conditions that aren’t disastrous in the bag. With Forces 5, the Aeolian can trap dangerous weather, such as windstorms."
            },
            {
                "type": "paragraph",
                "text": "The spell only works outdoors. If the bag is opened indoors, the weather inside the bag escapes through cracks in the door or window, and affects the area immediately around the building in which the owner of the bag is standing."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The target, not the mage, must concentrate to maintain the effect."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "A Mana point can be spent to boost Speed for a turn. The caster can do so as many times as he wishes while the spell’s scene-long Duration is still active (assuming he has enough Mana). The mage’s Speed increases by itself again for each success on the spellcasting roll. Characters who run double this figure, as well. Assuming the spell has four successes and a mage has a Speed of 12, he has an effective speed of 48. If he runs, his Speed is 96 — almost 65 miles per hour!"
            },
            {
                "type": "paragraph",
                "text": "If any Sleeper witnesses the mage running faster than a normal human, Disbelief is invoked."
            }
        ],
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": [
                    "The mage casts this spell in an area around him self. If the mage or anyone or anything within this area is attacked either physically or with magic, the spell activates. Once activated, the spell protects everything within a small radius (see ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    ", p. 118) around the mage from harm by slowing down fast-moving objects, damping fires and harmlessly grounding dangerous amounts of electricity. If the mage notices any such danger, she can reflexively spend one point of Mana. Then, for the next turn, nothing in the area can move faster than a brisk walk (Speed 10), and levels of temperature and electricity remain safe for everyone inside this area. However, this spell is only useful on small to moderate-sized threats. Even if a 20-foot-high, 10 foot-thick stone wall fell on someone fairly slowly, it would still (slowly) crush them. Also, once this turn ends, this protection instantly fades, unless the mage spends another point of Mana. The mage can continue spending Mana until she either runs out or the people inside the area cease being in immediate danger."
                ]
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            ...
            {
                "type": "paragraph",
                "text": "For turning autofire from the same gun, use the following special Target factors chart:"
            },
            {
                "type": "table",
                "headers": [
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The mage channels a nearly solid beam of blinding white light at the target. This brightly glowing ray almost seems to have a certain weight to it, moving with about the same velocity as a thrown projectile. Each success inflicts one point of lethal damage and removes one point of Essence from any creature that has a Corpus score. Lost points of Essence are simply destroyed. With Forces 5, the mage may spend a point of Mana to inflict aggravated damage with this spell."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The spell takes effect in the turn following casting."
            },
            {
                "type": "paragraph",
                "text": "Since the mage does not transform into another form of life, she is in no danger of losing herself to an alien mindset. Instead, she becomes a being of fire. Planes of force within her new shape allow her to maintain whatever Physical Attributes she possessed before the change."
            },
            {
                "type": "paragraph",
                "text": "The successes rolled for this spell are rolled as dice of lethal damage against anyone or anything not somehow fireproofed that makes physical contact with the mage (including her clothes and equipment). Likewise, the mage’s hand-to-hand attacks cause lethal fire damage, to which the spell’s successes are added as an equipment bonus."
            },
            {
                "type": "paragraph",
                "text": "By adding Matter 4 to the casting, the mage can cause all of her normal equipment (such as clothing or, say, a knife) to change into fire with her, although they retain only simple mechanical properties. Firearms thus altered, however, do not function for the duration of the spell."
            },
            {
                "type": "paragraph",
                "text": "With Forces 5, the caster can spend one Mana to inflict aggravated damage with this magic."
            }
        ],
        ...
        "DescrizioneMiddle": [
            {
                ...
                "text": [
                    ...
                    ", p. 180 — each success adds one level to the intensity of the fire)."
                ]
            },
            {
                "type": "paragraph",
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "This spell causes the area around a targeted spot (which can be anywhere within sensory perception) to catch fire."
            },
            {
                "type": "table",
                "headers": [
            ...
            },
            {
                "type": "paragraph",
                "text": [
                    "Fire causes automatic lethal damage to everyone within its radius per turn of exposure (see the ",
                    {
                        "type": "bold",
                        "text": "World of Darkness Rulebook"
                    },
                    ", p. 180). The heat of the fire is roughly equal to that of a candle. The mage can increase this heat (and the damage it inflicts) by raising the Potency of the spell during casting:"
                ]
            },
            {
                "type": "table",
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The subject suffers one Health wound of lethal damage per every three yards (rounding down) that she moves in a turn. At the Storyteller’s discretion, one additional wound might be caused by a strong wind. Note that a person sitting in a moving vehicle does not suffer this damage unless he’s exposed to open air, such as in a convertible. (If he’s next to an open window, he suffers half damage, rounded down.) Non-magical armor provides only half its normal protection, unless the subject’s body is more than 95% covered by armor."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Using this spell on a magnetized object, each success on the spell can increase or decrease the magnet’s Strength by one. An object reduced to Strength 0 is still mildly magnetic, but probably not strong enough to support the object’s own weight. One additional success can then reduce a Strength 0 magnet to a completely nonmagnetized state."
            },
            {
                "type": "paragraph",
                "text": "This spell can also be cast on objects that are not magnetized but can naturally be magnets. The first success then gives the object magnetic Strength 0, and additional successes allow the mage to increase that Strength."
            },
            {
                "type": "paragraph",
                "text": "Objects generally return to their old state of magnetization once the spell ends. With Forces 5 and the expenditure of a point of Mana, the mage may make the change in Strength lasting as long as the material can naturally hold that Strength of magnetization. Any object can be permanently made non-magnetic; most magnetic materials have a maximum Strength they can hold, generally 2 or 3. Such a material increased to Strength 5 would naturally weaken to its maximum magnetic Strength after the spell’s normal Duration expired."
            },
            {
                "type": "paragraph",
                "text": "This spell may also be used to reverse a magnet’s polarization, but the mage must use successes to make the magnet completely non-magnetized before she can apply any toward strengthening the reverse polarization."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Each success inflicts one level of lethal damage due to radiation burns. Invisible Fire ignores armor not specifically shielded against radiation or magic. Anyone with the protection of Stay the Invisible Fires is immune. One point of Mana can be spent to make the damage aggravated."
            }
        ],
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": [
                    "This spell causes damage based on target proximity from point of origin (the caster). All targets within a one-yard radius of the mage suffer one point of lethal Health damage per success on the casting roll. All targets outside the one-yard radius, but within three yards of the mage, suffer one point of bashing Health damage per success on the casting roll. Damage dealt is considered Resistant Damage (see p. 124 of ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    "), and in the case of multiple targets, subtract the highest Stamina present from the casting roll. It is possible to exclude friendly targets from Kinetic Ripple by including Fate 2 in the spellcasting (see p. 154 of ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Success allows the mage to levitate and travel in any direction with a maximum Speed equal to her Gnosis +1 per success (she cannot double this as she could by running on the ground). She must maintain concentration as an instant action (no further rolls are required). She is not very maneuverable, however. She cannot make quick movements to dodge obstacles and does not gain her Defense against any attacks that can reach her."
            },
            {
                "type": "paragraph",
                "text": [
                    "If she is attacked or startled, a reflexive Resolve + Composure roll must be made to maintain concentration. If it fails, she falls (see “Falling,” p. 179 of the ",
                    {
                        "type": "bold",
                        "text": "World of Darkness Rulebook"
                    },
                    "), although she can resume concentration as an instant action anytime within a number of turns equal to her Forces dots, halting her plummet instantly, assuming she doesn’t hit the ground before then. She’d have to fall from an extreme height — such as from skydiving — to allow her any time to regain concentration. (Note: This is an exception to the normal rules for losing concentration with a spell)."
                ]
            },
            {
                "type": "paragraph",
                "text": "This spell instantly invokes Disbelief in Sleeper witnesses, which immediately works to unravel the magic."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneAlta": [
            {
                "type": "paragraph",
                "text": "The mage uses Forces to cut a target off from three of his senses: speaking, hearing and seeing. The target’s voice and hearing capabilities are dampened through a silencing of all sound around the mouth and ears."
            },
            {
                "type": "paragraph",
                "text": "Sight is removed by diminishing all light that reaches the target’s eyes. The addition of Life can stimulate the subject’s biological fear responses (increased heartbeat, sweat, hyperventilating). The addition of Mind can emotionally urge the subject to feel whatever the caster desires during this time of deprivation."
            }
        ],
        "Practice": "Unraveling",
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Each success inflicts one Health wound of lethal damage. With Forces 5, one Mana can be spent to make the damage aggravated (although the target is allowed his Defense against the aiming roll made for the caster)."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Electricity, for example, can be transformed into sound. (As with the “Sound Mastery” spell, p. 170, however, a separate Skill roll might be required to generate exacting sounds. The mage could easily get screams or gunfire, but it’s harder to get a specific person screaming or the telltale sound of a certain model of gun.) Light could be changed into heat, meaning that a blindingly bright room could become pitch-black and searingly hot."
            },
            {
                "type": "paragraph",
                "text": "The existing energy is transformed, but it is not increased or diminished unless cast in combination with a spell that allows that effect. Use the chart below as a general guideline for transforming one form of energy into another:"
            },
            {
                "type": "table",
                "headers": [
            ...
            {
                "type": "paragraph",
                "text": "Note: sunlight cannot be transformed (nor can another energy be transformed into sunlight) at this level."
            }
        ],
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": [
                    "This spell implants the Forces 4 rote “Thunderbolt” (see ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    ", p. 173) in a Sleeper. A Sleeper subject is procured by the caster, who proceeds to cast the “Thunderbolt” spell. At the very last moment, the mage channels the energy of the spell into the Sleeper, rather than at the Sleeper. This type of casting requires concentration and slows the spell from an instant action to a special type of extended action."
                ]
            },
            {
                "type": "paragraph",
                "text": "The mage has a window of three turns in which to properly complete the spell, or the thunderbolt will be discharged targeting the Sleeper. The extended roll requires five successes."
            },
            {
                "type": "paragraph",
                "text": "Once the spell has been set in the target, the mage weaves Fate and Time into the spell so it remains dormant until the Sleeper is in the presence of magic. The very next time a spell is cast within sensory range of the Sleeper, the “Thunderbolt” spell is discharged, targeting the source of the magic. The spell released in this way from a Sleeper requires no roll to hit. Damage caused by the spell is equal to the caster’s Gnosis + 3."
            },
            {
                "type": "paragraph",
                "text": [
                    "Changing the primary Arcanum of the spell could produce a variety of different effects. Cast with Matter 4, for example, the spell could incorporate the “Transmute Air” spell (see p. 202 of ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    ") to transmute the air breathed out by the Sleeper carrier into sarin gas."
                ]
            },
            {
                "type": "paragraph",
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "A simple success lifts the target into the air. The spell’s Strength is equal to its successes. The mage can move the living creature at a Speed per turn equal to his Gnosis plus any successes allocated for this purpose. The target cannot be moved beyond the mage’s sight (unless he uses Space 2 to scry it)."
            },
            {
                "type": "paragraph",
                "text": "Each turn, the victim can attempt to struggle free from the telekinetic grip. It takes an instant action and a Strength + Athletics or Brawl roll, penalized by the spell’s assigned Strength."
            },
            {
                "type": "paragraph",
                "text": "With Forces 5, this spell can have a default Duration of prolonged (one scene), in which case when the caster is not actively manipulating the target, the target stays where the caster left him, even if he levitates in the air (although the target can try to break the hold as described above)."
            }
        ],
        ...
        "RoteDescrizione": [
            {
                "type": "paragraph",
                "text": [
                    "The Adamantine Arrow often uses this rote to freeze enemies in place, or to lift them high and then drop them (see “Falling,” p. 179 of the ",
                    {
                        "type": "bold",
                        "text": "World of Darkness Rulebook"
                    },
                    "). It lacks honor, but so do many Arrow enemies."
                ]
            }
        ],
...
const forceFiveData = [
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Creating a tornado in the American Midwest in the summer might impose a -1 dice penalty (depending upon current prevailing weather), while doing so in northern Alaska probably imposes a – 5 dice penalty, regardless of the season."
            },
            {
                "type": "paragraph",
                "text": "Long-term weather effects (storms, monsoons) take about five minutes after casting to grow into force, and dissipate as soon as the spell’s Duration expires. Short-term effects arise immediately and disappear immediately when the spell expires."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The target, not the mage, can spend a Mana point to boost his Speed for a turn, as per the rules for the “Burst of Speed” spell. If the target has no Mana, he cannot gain the benefit of this spell."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The target, not the mage, must concentrate to maintain the spell."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "A simple success affects gravity in a one-yard radius. Excess successes spread the energy over a larger area."
            },
            {
                "type": "table",
                "headers": [
            ...
            },
            {
                "type": "paragraph",
                "text": [
                    "Characters who fall into objects take damage normally. See “Falling,” p. 179 of the ",
                    {
                        "type": "bold",
                        "text": "World of Darkness Rulebook"
                    },
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The spell’s successes determine the area of direct sunlight; anything outside the area might be illuminated indirectly by the glow, but isn’t otherwise affected."
            },
            {
                "type": "table",
                "headers": [
            ...
            {
                "type": "paragraph",
                "text": "Needless to say, this spell is especially deadly to vampires. Within the radius affected, the sunlight is “direct” (three points of aggravated damage per turn). Outside the immediate radius (within double the radius’ area), the sunlight is “faint” (one point of aggravated damage per turn)."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "One success is sufficient to ruin every electrical device within the spell’s radius (destroying the Structures of all electronic components). (Certain military devices specifically made to resist EMP are immune)."
            },
            {
                "type": "paragraph",
                "text": "A simple success affects a one-yard radius. Excess successes spread the pulse over a larger area."
            },
            {
                "type": "paragraph",
                "text": "The effect is lasting, although devices can be repaired."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The intensity of the radioactive source can levy dice penalties. A small amount of uranium might impose no penalty, while a cooling rod from an active nuclear plant might levy a –3 penalty."
            },
            {
                "type": "paragraph",
                "text": "A simple success affects radiation in a 1 yard radius. Excess successes extinguish radiation over a larger radius."
            },
            {
                "type": "table",
                "headers": [
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "A simple success gives gravity a Strength of 1 and affects a five-square yard area. Excess successes are allocated between the Strength of the gravity and the area affected."
            },
            {
                "type": "paragraph",
                "text": "Each point of Strength subtracts three points from the Speed of anyone or anything within the volume affected. Those affected also suffer a –1 dice penalty to jumping rolls per Strength. Additionally, if the gravity’s Strength exceeds a person’s Strength, all Physical dice pools are at –1 dice per excess Strength. Flying creatures (including those using Forces spells to fly or that are lifted telekinetically) are subject to a reflexive Strength + Athletics roll each turn. Failure in any roll forces them toward the ground at a rate of Speed per turn equal to the gravity’s Strength."
            },
            {
                "type": "table",
                "headers": [
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Any object affected by this spell temporarily becomes a magnet. It begins with a Strength of zero; the object is mildly magnetic, but it cannot provide effective resistance against a creature that wants to move the object and may not be able to magnetically support its own weight. The Strength is increased by one per additional success."
            },
            {
                "type": "paragraph",
                "text": "Note that some objects, even when strongly magnetized, cannot effectively use their Strength in all situations. Magnetizing a sheet of paper to Strength 5 may make it impossible to remove from the fridge, but the sheet will still rip if you slap it over the door to the fridge and the freezer and only open one of them."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "A simple success decreases gravity within a five-cubic yard volume. Successes are allocated between the Potency of the gravity and the volume affected."
            },
            {
                "type": "paragraph",
                "text": "Each point of Potency adds one to the Speed of anyone or anything within the area of effect. This sudden ease of motion might come as a surprise to a person affected. If more than five points are added to Speed, a reflexive Dexterity + Athletics roll is made for the subject to control her sudden vault. Also, every Potency point of the spell doubles a person’s jumping distance per success. For example, under a spell with Potency 1, a character jumps two feet with a vertical leap and four feet with a standing broad jump. Flying creatures (including those using Forces spells to fly or to be lifted telekinetically) add one point to their flight Speeds when going straight upward."
            },
            {
                "type": "table",
                "headers": [
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The spell’s successes determine the radius. Anything outside that area is not affected."
            },
            {
                "type": "table",
                "headers": [
            ...
            {
                "type": "paragraph",
                "text": "Living beings cannot spend time in the area without suffering the adverse effects of radiation poisoning. For every 30 minutes a person is exposed, increase the radiation’s Potency by one. Once it exceeds the creature or person’s Stamina, he suffers symptoms of poisoning."
            },
            {
                "type": "paragraph",
                "text": [
                    ...
                    " Weakness. The victim suffers –1 to all Physical dice pools."
                ]
            },
            {
                "type": "paragraph",
                "text": [
                    ...
                    " Nausea. If the victim moves more than half his Speed in a turn, a reflexive Stamina + Composure roll is required to avoid vomiting for that turn. While vomiting, the victim cannot take any other action, although he still gains his Defense."
                ]
            },
            {
                "type": "paragraph",
            ...
            },
            {
                ...
                "text": [
                    ...
                    " Skin burns. The victim suffers one point of bashing damage this turn and per successive 10 minutes of exposure. This damage does not heal as long as the victim is still exposed."
                ]
            },
            {
                "type": "paragraph",
                "text": [
                    ...
                    " Fainting. A reflexive Stamina + Resolve roll is made for the victim to avoid falling unconscious for a number of minutes equal to any radiation damage he has already suffered. Any new damage he suffers due to exposure while unconscious adds to this time. Once he awakens, the roll must be made again each turn if he is still exposed."
                ]
            },
            {
                "type": "paragraph",
                "text": "Ongoing exposure continues to inflict damage until a victim is dead of aggravated wounds."
            }
        ],
