const lifeOneData = [
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": [
                    "Spellcasting successes are added as bonus dice to rolls for overcoming a drug, or allow a mage to ignore an equal amount of points of poison damage. See “Drugs,” pp. 176-177, and “Poisons and Toxins,” pp. 180-181 of the ",
                    {
                        "type": "bold",
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": [
                    "Each spellcasting success allows the mage to go an additional six-hour period without sleep with no need for a Stamina + Resolve roll (see the ",
                    {
                        "type": "bold",
                        "text": "World of Darkness Rulebook"
                    },
                    ", p. 180). The mage suffers none of the penalties for missed sleep during this time. The maximum this spell can put off the need for sleep is a number of days equal to the lower of the mage’s Stamina or Resolve, after which the spell no longer works."
                ]
            },
            {
                "type": "paragraph",
                "text": "Once the spell ends, the mage suffers all the effects of any missed sleep and must make it up (an additional hour’s sleep per six-hour period forgone using this spell)."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Obscure or rare diseases or conditions might levy a dice penalty to the roll (the rare hemorrhagic Ebola virus might be –3). The time per roll is one turn, and the target number depends on the condition of the subject. Only one success is needed to examine a perfectly healthy specimen, but a small cancerous tumor might need five or more successes to detect. The Storyteller should make the roll, so that the player doesn’t know when his character misses a telling sign of illness."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "See “Resonance,” pp. 277-280, for rules on scrutinizing magic with this spell."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            ...
            {
                "type": "paragraph",
                "text": "Successes are also used to pierce any supernatural occlusion a living creature may possess (such as a person under the effects of the Death 3 “Suppress Own Life” spell, p. 142)."
            }
        ],
...
const lifeTwoData = [
        ...
        "DescrizioneMiddle": [
            ...
            },
            {
                ...
                "text": [
                    ...
                    " — Each success allows the mage slow down his breathing so that he needs only half as much oxygen as normal, without hindering his physical activity."
                ]
            },
            {
                "type": "paragraph",
                "text": [
                    ...
                    " — Each success adds one to the mage’s Initiative."
                ]
            },
            {
                "type": "paragraph",
                "text": [
                    ...
                    " — The mage efficiently regulates his metabolism and body’s energy use, so that he requires less food than normal. Each success allows him to double the amount of time he can go before needing to check for deprivation or fatigue."
                ]
            },
            {
                "type": "paragraph",
    ...
    },
    {
        ...
        "DescrizioneAlta": [
            {
                "type": "paragraph",
                "text": "With the right magic, no mage need ever go hungry, no matter how inhospitable the terrain he might find himself in. With this spell, a magician can turn the handfuls of creepy-crawlies and otherwise inedible plant matter he might find around him into plain and yet nutritious and easily stored blocks of food matter. The food created is tasty, but just as with any food, too much of it can get boring."
            },
            {
                "type": "paragraph",
                "text": "The spell requires base life matter to be available and in hand. In a forest, the mage might be able to find tree leaves, slugs, snails, beetles, worms and the like. In the desert, cacti, beetles and scorpions might fit the bill. On the open sea, the mage may have to scoop up algae and plankton."
            }
        ],
        "Practice": "Ruling",
        "Action": "Instant",
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The mage needs to kill the animals (or pick the plant matter) he’s going to use as ingredients before he casts this spell. Successes are allocated to Potency: each point of Potency creates enough food for one meal for one person."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The mage can affect either a single target or all targets within a defined area."
            },
            {
                "type": "table",
                "headers": [
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "If Sleepers are present, the spontaneous disappearance of bloodstains and other obvious evidence can strain credulity and provoke Disbelief. The willworker can prevent this by making a show of cleaning up the evidence by mundane means immediately before casting this spell. This can be cast as a Life-only spell, in which case only organic evidence is eliminated, or as a Matter-only spell, wherein only inorganic evidence vanishes."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "As with 'Self-Healing,' p. 183, but the mage can cast this spell upon nonhuman life. At this level, the mage must touch the target. With Life 3, he can cast this spell at sensory range."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneAlta": [
            ...
            {
                "type": "paragraph",
                "text": "This protection usually means increased tissue resilience when cast covertly, which might be noticed with a medical doctor’s examination, assuming the doctor has examined the mage before without the spell’s effect and can note the disparity."
            }
        ],
        "Practice": "Shielding",
        "Action": "Instant",
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "As the Life 1 'Cleanse the Body' spell, p. 180, except that this version can be cast upon others. At this level, the mage must touch the target. With Life 3, he can cast this spell at sensory range."
            }
        ],
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": [
                    "The mage chooses a single Physical Skill when this spell is cast. For each success on the spellcasting roll, that use of the skill is considered a rote action Ability (see the ",
                    {
                        "type": "bold",
                        "text": "World of Darkness Rulebook"
                    },
                    ", p. 134), allowing his player to reroll any dice that result in failures on non-magical uses of the skill. At Life 3, the mage may grant this ability to others by touch."
                ]
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The rarity and virulence of the disease determines the target number required for overcoming it. A common cold might require three successes while Ebola might require 10 or more. Note that this spell provides no clues whatsoever toward providing a mundane antidote or cure for the disease."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Banishers don’t always have time to rest and eat in between battles, and sometimes it behooves them to keep hammering on their enemies, regardless of how many days of pursuit and aggression it takes. This spell allows a Banisher to force his body to generate the energy it needs to simulate a nutritious meal and eight hours of healthy sleep. Casting this spell removes the effects of fatigue and hunger deprivation, and allows the mage to regain one point of Willpower as though he had slept for a full night."
            },
            {
                "type": "paragraph",
                "text": "Casting this spell repeatedly over a series of days, though, is difficult. Whenever the Banisher uses this spell, he is creating nutrients from his own body. Most people have enough body fat for this to work, but casting this spell does force the mage’s body to feast on itself. Over a period of time, the mage runs the risk of losing too much body mass and suffering malnutrition (which this spell can’t cure)."
            },
            {
                "type": "paragraph",
                "text": "In game terms, if a mage uses this spell for a number of consecutive days in excess of his Stamina, he suffers one point of lethal damage per day. So, if a mage with Stamina 2 uses this spell continuously, he suffers one point of lethal damage on the third day, a second on the fourth day and so on. This damage can’t be healed magically, but if the mage starts eating normally again, it heals at a rate of one point per day."
            },
            {
                "type": "paragraph",
                "text": "At Life 3, the mage can cast this spell on others. If the subject is unwilling for whatever reason, subtract her Stamina from the mage’s dice pool."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The rote is cast on food and drink gathered in the Dreamtime and will affect enough material to provide the caster with one meal. Too much time spent in the Anima Mundi without consuming food and drink will lead to deprivation. (See p. 175 of World of Darkness.)"
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "One feature can be transferred per success. This could be used to create an earthworm with chitinous armor, or a dragonfly with photosynthetic skin."
            },
            {
                "type": "paragraph",
                "text": "At this level, the mage must touch the target. With Life 3, he can cast this spell at sensory range."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            ...
            {
                "type": "paragraph",
                "text": "If the caster wants to change a life form (such as a tree) into an insect swarm, the size of an insect swarm depends on the Size of the life form that was transformed."
            },
            {
                "type": "table",
                "headers": [
            ...
            {
                "type": "paragraph",
                "text": "*Add x2 radius per five additional points of size"
            },
            {
                "type": "paragraph",
                "text": "To direct the swarm, the mage can cast the “Control Base Life” spell, p. 182."
            }
        ],
...
const lifeThreeData = [
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "As with the Life 2 “Self-Purging” spell, p. 183. At this level, the mage must touch the target."
            },
            {
                "type": "paragraph",
                "text": "With Life 4, he can cast this spell at sensory range."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "One success is sufficient to induce a desired, normal instinctual response in an animal. If, however, the animal is dead-set on a given activity (such as fleeing a mage who has violated its territory or attacking a vastly superior foe), a +1 or greater dice bonus might be added to its contesting roll."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "A time interval passes between each serious animal attack, as determined by the amount of Mana spent during item creation."
            },
            {
                "type": "table",
                "headers": [
            ...
            {
                "type": "paragraph",
                "text": "The item creator must also add five to the spell’s target number per point of Mana spent."
            },
            {
                "type": "paragraph",
                "text": "Item owners may suffer additional inconsequential animal attacks between intervals, most often from small creatures such as swallows or gerbils, who are incapable of inflicting measurable damage. Dogs may strain at their leashes but fail to escape from their masters to attack. Note that under some circumstances, for example, while the owner is behind the wheel of a speeding car, even a swarm of small animals could pose a serious risk to life and limb."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The mage can lower one dot per success, up to a maximum amount equal to his Life dots. If cast upon a base or median life form, he must spend one Mana and the target’s Stamina is subtracted from the spellcasting dice pool (resistance is reflexive)."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "With one success, a single target’s vocal apparatus is silenced;  extra successes allow multiple targets to be affected."
            },
            {
                "type": "table",
                "headers": [
            ...
            {
                "type": "paragraph",
                "text": "Those affected by the spell can still eat, breathe and swallow normally. Note that most animals and people will experience some distress upon finding they can’t use their voice. Because the spell draws on the Life Arcanum, the spell won’t function on nonliving beings such as spirits, ghosts, vampires or the walking dead."
            },
            {
                "type": "paragraph",
                "text": "If the mage also has Mind 3, he may prevent the target from speaking about a specific topic or articulating a specific word or phrase. The target can talk normally unless he tries to utter the specified words, or speak about the forbidden topic, even obliquely."
            }
        ],
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": [
                    "For the duration of this spell, the caster uses the greater of his Dexterity or Wits to calculate his Defense, like an animal (see the ",
                    {
                        "type": "bold",
                        "text": "World of Darkness Rulebook"
                    },
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": [
                    "This rote functions properly only in areas with abundant plant life. Areas with less than optimum conditions impose a penalty on the casting roll from –1 (mild drought) to –5 (near desert). If no flora exists in the area, the spell will simply not function. Each success on the casting roll reduces the target’s Speed by 2. When this spell is cast as an extended spell, the flora slowing the target continues to creep up his body attempting to hold him in place. Treat this as a Grapple attack (see p. 157 of the ",
                    {
                        "type": "bold",
                        "text": "World of Darkness Rulebook"
                    },
                    ") with total successes on the extended roll acting as the Strength of the attack. If the target breaks the grapple, all successes are lost. If the total number of successes to grapple the target is ever greater than twice his Size, the target is considered Immobilized (see p. 157 of the ",
                    {
                        "type": "bold",
                        "text": "World of Darkness Rulebook"
                    },
                    "). Casting Gaia’s Hold as an extended spell costs one Mana."
                ]
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The Banisher must touch her target to use this spell (at Life 4, she can cast Induce Vertigo at sensory range). Subtract the target’s Stamina from the spell roll. The spell affects the target’s inner ear, causing him to become dizzy, nauseated and disoriented. The target’s player must make a Stamina + Resolve roll each turn that this spell affects him. Failure means that the target falls down and cannot rise or take any action until the player makes the roll successfully."
            },
            {
                "type": "paragraph",
                "text": [
                    "During that time, the Banisher (or anyone else, for that matter) can perform a killing blow to the target (see p. 168 of the ",
                    {
                        "type": "bold",
                        "text": "World of Darkness Rulebook"
                    },
                    "). Even if the player succeeds on the Stamina + Resolve roll, the character suffers a –3 penalty to all actions while the spell is in effect. A mage with Life 2 can cast a covert Ruling spell to cancel this effect (Life 3 to affect others)."
                ]
            },
            {
                "type": "paragraph",
                "text": "Normally, this spell is transitory in Duration, though the Banisher can use Duration Factors to extend it. At Life 5, the spell can be cast with a prolonged Duration."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Successes accrued in the casting of this spell (as well as successes accrued to resist) are treated precisely like successes gained in the interrogation process (see The World of Darkness, pp. 81-2). At the Storyteller’s discretion, Inflict Agony may be used to supplement other applications of the Intimidation Skill. Also, a Storyteller may choose to allow a character with the Iron Stamina Merit (The World of Darkness, p. 113) to add her dots in that Merit as an equipment bonus to her roll to contest this spell."
            },
            {
                "type": "paragraph",
                "text": "At Life 3, this spell requires touch. With Life 4, it may be cast at sensory range and, at Life 5, it may be cast sympathetically. The use of this spell on an unwilling subject requires a check to resist degeneration when cast by any character with a Wisdom of 4 or greater (roll three dice)."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The mage must first grab hold of the target, with a roll of Strength or Dexterity + Brawl – the target’s Defense. If successful, he can cast this spell as an instant action in the following turn. With Life 4, he can cast this at targets in sensory range."
            },
            {
                "type": "paragraph",
                "text": "While afflicted by this spell, the subject’s Dexterity is reduced by the number of successes the mage’s player attained on the roll. This impacts all traits that depend on Dexterity, including Defense. A subject whose Dexterity is brought down to zero (or less) is unable to maintain enough coordination to stay standing, and falls over into a twitching mass."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "One feature can be transferred per success. At this level, the mage must touch the target. With Life 4, he can cast this spell at sensory range."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            ...
            {
                "type": "paragraph",
                "text": "At this level, the mage must touch the target. With Life 4, he can cast this spell at sensory range."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Successes determine the number of objects (coins, staves) that are transformed, and the size of the swarm created."
            },
            {
                "type": "table",
                "headers": [
...
const lifeFourData = [
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "After casting this spell, the Arrow may, for the remainder of the scene, reflexively, spend points of Mana on a one-for-one basis to heal levels of bashing or lethal damage, though bashing damage must be healed in preference to lethal if the mage is currently suffering from both, as the body attempts to cope with less elaborate hurts before tackling deeper wounds. The willworker is limited by the amount of Mana he might normally spend in a turn including those points of Mana spent for other reasons, such as in the casting of spells according to his Gnosis."
            },
            {
                "type": "paragraph",
                "text": [
                    "This spell is subject to Disbelief and Unraveling (see ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    ", p. 274) if used to heal lethal damage in front of Sleepers, and has no effect at all on aggravated damage."
                ]
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "As per “Enfeeblement,” p. 189. The mage’s successes can be allocated among the target’s Physical Attributes in any combination. The total that each Attribute can be lowered is still limited by the mage’s total Life dots."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Naturally, this spell works best on an unconscious target (which cannot normally resist). Make a reflexive and contested Resolve roll for creatures that resist consciously."
            }
        ],
        ...
        "RoteDescrizione": [
            {
                "type": "paragraph",
                "text": [
                    "The mage must follow the fugitive, who needs to be within line of sight (unless Space 2 is added to the casting). As she travels, she repeats a prayer similar to the following: ",
                    {
                        "type": "italic",
                        "text": "Peter, Paul and all the Apostles, be my witness to God’s power which binds all rogues, thieves, murderers and fugitives who seek to hide from justice. In particular, let Thy power find"
                    },
                    " [name of fugitive or some other form of specific identification, such as “the man who robbed the Big Ivy branch bank last night”] ",
                    {
                        "type": "italic",
                        "text": "and bind him with fetters of guilt. Let him not step forward. Let him not step backward. Let him breathe but not speak until such time as he is released by me."
                    }
                ]
            },
            {
                "type": "paragraph",
                "text": "The mage must say this prayer (or whichever one she uses) three times. When she comes in sight of the fugitive, she must point her hand and clench it into a fist. As her hand tightens, the muscles of the fugitive will tighten until he cannot move."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneAlta": [
            {
                "type": "paragraph",
                "text": [
                    "Using a combination of emotional suggestions similar to the Mind 2 “Emotional Urging” spell (",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    ", pp. 207–208), barely perceptible telepathic messages and precise physiological control identical to that provided by the Life 4 “Trigger the Lizard Brain” spell (",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    ", p. 191), the caster can evoke a particular, visceral emotional response in the target. For example, by combining emotions such as greed with physiological reactions normally associated desire and interest, an otherwise honest official might be persuaded to accept a bribe."
                ]
            }
        ],
        "Practice": "Weaving",
        ...
        "RoteDescrizione": [
            {
                "type": "paragraph",
                "text": "This is one of the Guardians’ most subtle and powerful tools. While the Guardians remain in the shadows, they make individual Sleepers seem far more or less credible than they otherwise would. The Guardians also carefully manipulate the reactions of important people to various ideas and pieces of information. In addition to allowing the Guardians to cause important people to dismiss all evidence of an incident of vulgar magic, this rote is also regularly used to render those determined to uncover the truth about mages and magic harmless by making them appear to be raving lunatics or harmless and unstable crackpots."
            },
            {
                "type": "paragraph",
                "text": "Guardians who work closely with the Labyrinth are particularly fond of this rote, because it allows them to make and break the people who lead the various cults and other organizations that make up this complex morass. Leaders whom the Guardians deem unsuitable appear weak or insane, while people the Guardians support seem unusually confident and eloquent. There are rumors that some Guardians have used this rote to do far more than depose minor cult leaders. Although many such charges are exaggerations, a few Guardians have used this rote to change the course of national elections during political speeches and debates, causing one candidate to appear far more sensible and suitable than the others. Naturally, the Guardians deny all such uses of this rote."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "As with self-degradation for Life 3 “Degrading the Form,” p. 186, but turned on another. The mage can lower one dot per success up to a maximum amount equal to his Life dots."
            },
            {
                "type": "paragraph",
                "text": "The mage must first grab hold of or touch the target; roll Strength or Dexterity + Brawl – the target’s Defense. If that’s successful, the mage can cast this spell as an instant action in the following turn. (With Life 5, he can cast it at sensory range as an instant action. He needs Life 6 before he can add Space 2 for a sympathetic casting.)"
            },
            {
                "type": "paragraph",
                "text": "Note: Lowering Strength or Dexterity also lowers the target’s Speed and Initiative, and might affect Defense, while lowering Stamina also lowers Health."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The mage must touch the target."
            },
            {
                "type": "paragraph",
                "text": "With Life 5, he can cast this spell at sensory range."
            },
            {
                "type": "paragraph",
                "text": "The target can choose to resist; subtract its Resolve dots from the spellcasting dice pool."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Each success inflicts one point of lethal damage to a single life form. With Life 5, the caster can inflict aggravated wounds by spending one Mana."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            ...
            {
                "type": "paragraph",
                "text": "With Life 5, he can cast this spell at sensory range. The target can choose to contest with a reflexive Composure + Gnosis roll."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The mage suffers dice penalties for Sizes significantly smaller than his own. To reduce oneself to Size 2 (cat-sized) is –1 dice, while Size 1 (rat-sized) is –2 dice, and Size 0 (ant-sized) is –3 dice."
            },
            {
                "type": "paragraph",
                "text": "In addition, increasing one’s Size can also levy dice penalties:"
            },
            {
                "type": "table",
                "headers": [
        ...
        "DescrizioneMiddle": [
            {
                ...
                "text": [
                    ...
                    ", p.134) ability on any Physical Skill. This may not be used to augment magical uses of the Skill (such as rote activation). At Life 5, the mage may grant this ability to others by touch."
                ]
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "As per the Life 3 “Honing the Form” spell, p. 186, but the mage can now divide his successes between his Physical Attributes in any combination he prefers. The total that each Attribute can be boosted is still limited by the mage’s total Life dots."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The spell’s target number is equal to the number of days the mage’s real body has gone without nourishment. The spell makes up for lack of food and water. Air, too, though if the spell has to provide oxygen, the mage has immediate problems to worry about."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "At this level, the mage must touch the target. With Life 5, he can cast this spell at sensory range."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "This rote enables the elevation of a base life form into a higher evolutionary state. Without other magics, such altered creatures have only the most basic instinctual programming of the life forms into which they’re changed. A planarian changed into a cat does not possess the cat’s superior intelligence, and a patch of moss transformed into a snake is apt to lie exactly where it is altered and act only if harmed or otherwise forced to react."
            },
            {
                "type": "paragraph",
                "text": "At this level, the mage must touch the target. With Life 5, he can cast this spell at sensory range."
...
const lifeFiveData = [
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The homunculus sputters to life on one or more successes, but, depending on the number of successes, may face such a traumatic transition from the realm of the inanimate that the homunculus gains one or more derangements and/or Flaws. The Storyteller chooses these either at random or based on the individual on whom the homunculus’ persona was modeled. If the model suffers from derangements or Flaws, the homunculus inherits one or more of them. If not, the Storyteller envisions an insanely exaggerated version of the model and picks derangements and Flaws to suit."
            },
            {
                "type": "paragraph",
                "text": "The weaver of the homunculus’ persona may have allocated successes to be able to personally select one or more of the derangements/Flaws."
            },
            {
                "type": "paragraph",
                "text": "The mix of defects suffered depends on the number of successes scored on the roll for this spell."
            },
            {
                "type": "table",
                "headers": [
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The target number of successes is determined by the creature’s Size (on a one-for-one basis) and Physical Attributes (also on a one-for-one basis)."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "While the animal’s form is changed, its mind is unaffected; it still thinks and behaves like an animal. The spell’s range is sensory."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The mage targets an existing animal from which to add and subtract various features. Each success allows the mage to exchange a single feature, although unnatural but theoretically possible features such as the ability to exhale fire might levy a –1 dice penalty per unnatural feature. Changes in Size (either up or down) require successes on a one-for one basis. The spell’s range is sensory."
            },
            {
                "type": "paragraph",
                "text": "In the case of creatures with unnatural features, Sleeper Disbelief can dispel the Fantasia spell, restoring the creature to its natural form."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "In addition to forcing a subject into a new shape, which must be a natural animal, including a human being, of Size 4–6, this spell inflicts one level of lethal damage on the subject per success of Potency."
            },
            {
                "type": "paragraph",
                "text": [
                    "This horrific display can easily require reflexive Resolve + Composure rolls from onlookers unfamiliar with this magic to resist gaining a temporary mild derangement. Similar to almost all other Life Arcanum spells, this spell cannot be given an indefinite Duration. If the subject is successfully transformed, she must check for becoming “lost” to her new form (per the Life Arcanum spell, “Shapechanging” on p. 190 of ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    "), but she retains her Awakened abilities, if any."
                ]
            },
            {
                "type": "paragraph",
                "text": "Sleepers subjected to the spell who do not manage to destroy it with Disbelief will probably later write the whole experience off as the result of drugs, a nightmare or a nervous breakdown."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The mage must deal with the same modifiers for Size as he does with lesser “Shapechanging” (p. 190). He may also cast the Life 3 “Transform Self” spell, p. 187, to add different features to the changed form, but he is not restricted to lesser life forms."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Unlike an animal, a human cannot be made to do anything that endangers his survival or that might harm him. Also, if he is made to do something that is radically against his beliefs (such as harm his lover), a fresh contested and reflexive Resolve + Gnosis roll is made to resist the command (his successes must exceed the spell’s Potency)."
            }
        ],
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": [
                    "Like the Life 5 spell “Greater Shapechanging” (see p. 192 of ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    "), the caster of this rote changes form without the possibility of becoming lost in his new shape. While in the shape of the swarm, the mass of the insects must stay within a 10-foot area of each other or the spell will unravel."
                ]
            },
            {
                "type": "paragraph",
                "text": "In combat situations, the swarm suffers little damage from conventional weaponry. Against stabbing, shooting or bashing types of attacks, the swarm is considered to have Armor 10 and any wounds suffered (regardless of source) are considered bashing. Only weapons that deal area damage (grenades, explosives, fire) have any chance of causing significant damage to the mage-swarm. Weapons of the area-effect variety deal normal damage for their type. The swarm has equal Health to that of the caster."
            },
            {
                "type": "paragraph",
                "text": "Offensively, attacks by the swarm ignore any mundane Defense or Armor ratings of living targets. The caster rolls Intelligence + Animal Ken + Gnosis for each attack, dealing 1 bashing damage per success."
            }
        ],
        "RoteName": "Tablets of U’mat Rote",
        "RoteDice": "Dice Pool: Intelligence + Animal Ken or Survival + Life",
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Lost limbs can be regrown and damaged or faulty organs can be restored to health. The number of successes needed depends on the limb or organ restored."
            },
            {
                "type": "table",
                "headers": [
            ...
            {
                "type": "paragraph",
                "text": "Once this spell has been cast, the restored body part does not immediately appear. It grows at a rate of one success per minute until the total successes required for that organ are achieved, at which point the organ is fully functional. For example, a person can have a new arm (four successes) in four minutes."
            },
            {
                "type": "paragraph",
                "text": "Obviously, a mage can only cast this spell upon a living target. The willworker cannot regenerate someone who has died (perhaps due to the loss of the body part concerned). This spell does not affect the target’s Health rating."
            },
            {
                "type": "paragraph",
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "This spell can be cast at sensory range. Successes can be allocated among the target’s Physical Attributes in any combination. The total by which each Attribute can be lowered is limited by the mage’s Life dots."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "This spell can be cast at sensory range. Successes can be allocated among the subject’s Physical Attributes in any combination. The total that each Attribute can be boosted is limited by the mage’s Life dots. The target can choose to resist; subtract its Resolve dots from the spellcasting dice pool."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "By precisely balancing the forces of life and death within the target’s body, the caster slows the rate by which the target ages by a factor equal to her level in the Death Arcanum + her Gnosis. A mage who has 4 dots in Death and a Gnosis of 3 who uses this spell on herself ages 1 day for every 7 (4 + 3) days that pass while she is under the influence of this spell. Mages who use this spell regularly often live for several centuries. Unless the mage learns 6 dots in the Life Arcanum, she cannot use the advanced prolongation table to cast this spell, and even then the maximum possible duration of this spell is only 1 week."
            },
            {
                "type": "paragraph",
                "text": "Rolling a Dramatic Failure on this spell causes the mage to automatically age 1 year, which serves as a great disincentive against attempting to prolong this spell without using ritual casting. Most mages use ritual casting to allow them to cast this spell with a duration of several days. In addition, many mages who regularly use this spell mark themselves with a small tattoo or scar in the shape of the appropriate Atlantean runes needed to prolong the spell. If the mage rolls an Exceptional Success when casting “Vital Balance” she does not age at all for the duration. There are rumors of mages many centuries old who manage to regularly manage this level of success with the “Vital Balance” spell."
            },
            {
                "type": "paragraph",
                "text": "The slowed aging due to this spell is compatible with the Death spell “Steal Lifespan.” It is also compatible with the “Body Mastery” spell described above, but the additional years granted by either of the aforementioned spells are not affected by the slowed aging provided by the “Vital Balance” spell; they are simply added to the mage’s lifespan. In addition, this spell cannot be cast by or on a Tremere Liche; attempts to do either automatically fail. All other mages can cast this spell on both themselves and others with equal ease."
            }
        ],
        "RoteDice": "Dice Pool: Intelligence + Occult + Life",
...
export { lifeOneData, lifeTwoData, lifeThreeData, lifeFourData, lifeFiveData };
