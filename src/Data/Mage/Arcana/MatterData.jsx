const matterOneData = [
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The number of objects that can be affected increases with each success."
            },
            {
                "type": "table",
                "headers": [
            ...
            {
                "type": "paragraph",
                "text": "Note that objects of up to Size 20 can be affected. The caster suffers dice penalties to affect larger objects. This includes such things as a concrete slab; unless additional Size factors are added, the mage affects a single slab of up to Size 20."
            }
        ],
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": [
                    "Each success of Potency assigned to this spell counts as an extra success of damage, solely for the purposes of overcoming the Durability of a piece of cover (see the ",
                    {
                        "type": "bold",
                        "text": "World of Darkness Rulebook"
                    },
                    ", pp. 162–163), making it that much easier for the willworker to cause harm to the target behind said cover with a ranged attack. Note that this cannot cause the attack afforded by successfully breaching the cover to benefit from more dice that would have been rolled were the cover not there in the first place."
                ]
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Success allows the mage to know what, if anything, is wrong with the object and roughly what would be involved in fixing it (within the limits of the mage’s Skills, such as Crafts and Science)."
            }
        ],
        ...
        "RoteDescrizione": [
            {
                "type": "paragraph",
                "text": [
                    "Often the most difficult part of effecting repairs is figuring out the problem. Whereas the “Diagnostic Scan” rote (see ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    ", p. 195) informs the caster of an object’s composition, this rote determines the object’s status. In particular, the mage learns whether or not a piece of technology is functional, how functional (if so) and how damaged (if not)."
                ]
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "See “Resonance,” pp. 277-280, for rules on scrutinizing magic with this spell. The mage gains a +1 dice bonus when studying dense/very dense resonance, but suffers a –1 dice bonus when reading refined/ very refined resonance."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "One success affects a one-yard radius. Additional successes extend the radius:"
            },
            {
                "type": "table",
                "headers": [
            ...
            {
                "type": "paragraph",
                "text": "The Storyteller levies penalties based on how much or how little of the substance is present. A guy carrying an arsenal of guns under his trench coat has a lot of gunpowder on his person: +2 or +3 bonus. Someone who is hiding a transmitter in his gold fillings has only a tiny amount of the copper wiring sought: –2 or –3."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneAlta": [
            {
                "type": "paragraph",
                "text": "The mage can perceive the fundamental makeup of material structures and discern their composition, determining their weight and density."
            },
            {
                "type": "paragraph",
                "text": "Most technologically minded willworkers tend to see Matter in much the same way as most modern people: a scientifically grounded, predictable phenomenon. Other mages see things in a different light. Some describe “threads” interwoven throughout a “Tapestry” (“This unique thread indicates the presence of gold,” for example), while some speak of the Classical Elements — Air (gas), Earth (solid) and Water (liquid)."
            }
        ],
        "Practice": "Knowing",
        "Action": "Instant",
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Success allows a mage to determine an object’s Durability, Size, and Structure ratings."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Through the use of this spell, a willworker gains the ability to ignore a single point of an inanimate object’s Durability when attempting to break it, or gains a single bonus die when making physical attacks against the reanimated dead."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Extremely well-designed hidden compartments or rooms might levy a –1 or –2 dice penalty, but usually only the most refined or precise of such misdirectional architecture imposes this penalty."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "A mage with Matter 2 and Life 2 can extend this spell’s benefits to another person."
            }
        ],
...
const matterTwoData = [
    {
        ...
        "DescrizioneMiddle": [
            ...
            {
                "type": "paragraph",
                "text": "Note that this spell does not affect a chance die, should the object wielder’s dice pool be reduced to one. Only a result of 10 is a success."
            }
        ],
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": [
                    "The Tamer of Stone assesses a building or similar structure and spots its weaknesses. Success means that the mage has isolated a single weak point, which can be exploited. If the mage concentrates an attack on this weak spot (for example, if he sets explosives right next to it), the mage can bring the structure crashing right down. The Size of the structure affects the caster’s dice pool (see ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "At this level, the mage must touch the targeted liquid (or vapor) to be able to affect its adjacent volume or area. With Matter 3, he can cast this spell at sensory range."
            },
            {
                "type": "paragraph",
                "text": "The mage can affect liquid vapor, like fog or mist, but not any substance whose single natural state is gaseous (like mustard gas or helium). He affects a volume of liquid or area of vapor based on successes rolled. He can also allocate successes to the density of the water, giving it Strength."
            },
            {
                "type": "paragraph",
                "text": "At the Storyteller’s discretion, a reflexive Dexterity + Crafts roll might need to be made for the caster to achieve a particularly complex shape, such as forming rain into the shape of a person. Exacting details such as facial features might even require an exceptional success on this roll. The liquid form is obvious for what it is. It cannot fool anyone into thinking it’s a real version of whatever solid object it mimics (at least, not without an accompanying Mind spell to make the viewer think otherwise)."
            },
            {
                "type": "table",
                "headers": [
            ...
            },
            {
                "type": "paragraph",
                "text": [
                    "The shaped liquid’s surface tension depends on its Strength. If no successes are allocated to Strength, it has only enough to keep its shape. It provides no barrier whatsoever to obstacles or attacks, although it retains its shape for the Duration of the spell even when it is pierced by bullets or fists. Dots of Strength act as Durability (as with cover; see pp. 162-163 in the ",
                    {
                        "type": "bold",
                        "text": "World of Darkness Rulebook"
                    },
                    ") against projectiles or other attacks that must first get past the shaped liquid to reach their target (unless the liquid is in vapor form, in which case it provides no protection)."
                ]
            },
            {
                "type": "paragraph",
                "text": [
                    "The caster can reflexively control and move the shaped liquid up to one yard per dot of Gnosis that he has per turn. If he uses Forces 3 in the casting of the spell, he can impart even greater motion to the water: 10 yards per dot of Gnosis per turn. People standing in the path of the onrushing water might be knocked over. If the water’s Strength exceeds an affected person’s Strength, a successful, reflexive Strength + Athletics roll must be made for that person or he is knocked down and swept along with the tide (as per the knockdown effect, p. 168 of the ",
                    {
                        "type": "bold",
                        "text": "World of Darkness Rulebook"
                    },
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "At this level, the mage must touch the targeted object (although he can do so using forceps or other tools). With Matter 3, he can cast this spell at sensory range."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "At this level, the mage must touch the targeted liquid (or vapor) to be able to affect its adjacent volume. With Matter 3, he can cast this spell at sensory range."
            },
            {
                "type": "paragraph",
                "text": "The mage can affect liquid vapor, like fog or mist, but not any substance whose single natural state is gaseous (like mustard gas or helium). He affects a volume of liquid or vapor based on his successes:"
            },
            {
                "type": "table",
                "headers": [
            ...
            {
                "type": "paragraph",
                "text": "With Matter 3, a volume of liquid composed of more than one liquid substance can be affected (although it must still be touched). Matter 4 is needed to transmute multiple liquid substances at sensory range."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The mage gains one point of armor per dot he possesses in the Matter Arcanum. By spending one Mana, the Duration can be made to last for one day. Most mages cast such a shielding spell at the beginning of the day, as part of their morning rituals. Successes are used to combat attempts to dispel the shield."
            },
            {
                "type": "paragraph",
...
const matterThreeData = [
        ...
        "DescrizioneAlta": [
            {
                "type": "paragraph",
                "text": [
                    "Whenever the skin of the mage is pierced, the spray of blood is transmuted mid-flight into a mild acid that deals Continuous Damage (see p. 167 of the ",
                    {
                        "type": "bold",
                        "text": "World of Darkness Rulebook"
                    },
                    ") to anyone the acid touches. The acid created by this spell isn’t powerful enough to threaten a well-armored opponent, but it can turn the tables in a fight with an unarmored foe."
                ]
            }
        ],
        "Practice": "Fraying",
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "A simple success affects an object of Size 5 or less."
            },
            {
                "type": "paragraph",
                "text": "Each +5 Size requires an extra Target factor. Additional successes are applied to the spell’s Potency, which is used to fend off attempts to control the object by other mages using this same spell."
            },
            {
                "type": "paragraph",
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": [
                    "The mage can cause any object or device, from a car to a handgun, to become temporarily conscious and animate. The willworker awakens the spirit within the object. Use the rules for the Spirit 3 “Rouse Spirit” spell (",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    ", pp. 250-251) to determine the rank and characteristics of this spirit. Also, the device can perform its designed function as well as if it was wielded by someone trained to use it. The object’s dice pool for performing actions is always Power + Finesse, with no penalty for lack of skill."
                ]
            },
            {
                "type": "paragraph",
                "text": "Because of the power of the Matter magics involved, the object can do more than simply perform its function. In addition to cars being able to turn themselves on and drive, guns being able to fire, and locks being able to lock and unlock, animated objects can also move on their own. Pieces of furniture can roll on their wheels or walk and run on their legs, knives and guns can hop around and even throw themselves at targets, and drawers can slide out with sufficient force to injure someone. When an object attacks, use the spirit’s Power as its Strength. Animated objects can bend and flex in various unnatural ways. Most of their more extreme types of movement, such as a chair running across a room, are subject to Disbelief."
            },
            {
                "type": "paragraph",
                "text": "One limit on this spell is that unless the mage also uses Spirit magic like the “Control Spirit” spell, the object is free to act as it chooses. Objects owned by the mage will typically obey her commands, as will objects not asked to do anything self-destructive or against their inherent nature. (Guns normally attack people, drawers and chairs do not.) Objects that have been treated well by someone will not normally attack this person. Guns owned by a gun collector who takes excellent care of them will not attack the collector simply because the mage asks them to. In fact, the guns are more likely to fire at anyone attacking their owner, including the mage who cast this spell."
            },
            {
                "type": "paragraph",
                "text": "This spell can be used to animate any object of size 20 or less, +10 per additional Target factor. If the mage animates a large object like a house or car, all fixtures both inside and outside the object are under the spirit’s control. While affected by this spell, an object also exists in Twilight and can both sense and affect beings and objects there."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            ...
            {
                "type": "paragraph",
                "text": "Armor piercing also applies against an attacked object’s Durability. The amount of armor points the object can ignore depends on the caster’s Matter proficiency:"
            },
            {
                "type": "table",
                "headers": [
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": [
                    "Other than the use of Matter to impress the rote’s pattern into an object rather than a written form, this spell works the same as Inscribe Grimoire (see ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
    ...
    },
    {
        ...
        "DescrizioneAlta": [
            {
                "type": "paragraph",
                "text": "After casting more than one of the Matter-based finishing spells on a single item, the willworker bundles them together, so that they are treated as a single omnibus spell. They count as one spell against the limit of spells the mage can actively maintain, and as one spell when the mage relinquishes them. The relinquishment cost may be the standard Willpower dot, or any alternative cost, such as those listed in this section."
            },
            {
                "type": "paragraph",
                "text": "The Matter-based finishing spells are “Alter Integrity,” “Alter Efficiency” and “Alter Size.”"
            }
        ],
        "Practice": "Weaving",
        "Action": "Instant",
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Each success assigned to this spell’s Potency increases a poison’s Toxicity by 1. Note that biological poisons and venoms may be enhanced by way of this spell, though not while still within the creature that produces them, unless the mage adds Life 3 to the casting."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The imprinted spell takes effect immediately after the drop is placed in the eye or ear."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Pills are swallowed, and take effect after a time delay based on the user’s Stamina."
            },
            {
                "type": "table",
                "headers": [
            ...
            {
                "type": "paragraph",
                "text": "By scoring additional successes during the creation process, the alchemist may exactly specify the length of delay between ingestion and effect, regardless of the user’s Stamina. The greater the number of successes, the longer the maximum possible delay."
            },
            {
                "type": "table",
                "headers": [
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The effect of the imprinted spell is triggered when the oil or jelly is rubbed onto the target object."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The powder is typically placed in an explosive device, most often a flash grenade. This may be detonated in the time-honored pull-pin method or via a timer device. When the powder ignites, the imprinted spell is triggered, with the location of the grenade as the center of the spell’s radius."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The effect of the imprinted spell is triggered when the salve is rubbed on the beneficiary’s body. The salve can be applied by the beneficiary or by another individual."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "No key or application of the Larceny Skill can open the Perfectly Locked door. The spell will not prevent the door (or window, etc.) from being smashed or broken through, though some mages combine this with the Matter 3 spell “Alter Integrity” to ensure just that."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneAlta": [
            {
                "type": "paragraph",
                "text": "Through the use of this spell, it is possible to render any reasonably homogeneous material malleable for a time, even materials that are normally completely inflexible (such as ice, coal or lead crystal)."
            },
            {
                "type": "paragraph",
                "text": "While a substance is under the effects of this spell, the material can be molded by hand (or with magic, if the willworker chooses), creating truly fantastic shapes. The mage could, for example, draw amber like taffy and work it into a spiderweb or push an enemy’s hands and feet into concrete, knead any gaps shut and leave her trapped there, as though the concrete had originally been cast that way."
            }
        ],
        "Practice": "Weaving",
        "Action": "Instant",
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "At this level, the mage must touch the targeted object (although he can do so using forceps or other tools). With Matter 4, he can cast this spell at sensory range."
            },
            {
                "type": "paragraph",
                "text": "The spell renders hard materials about as soft as very stiff clay, and as easy to sculpt by hand as a mass of butter. The object’s Durability determines the ease of the spell, levying penalties on the roll on a one-for-one basis. Wood (Durability 1) is easier to warp than reinforced steel (Durability 4 or higher). In the case of objects with mixed materials, use the highest Durability. Once cast, the effect takes place in the subsequent turn. If the mage attempts to create something complex or artful from the substance, an instant Dexterity + Crafts roll might be called for."
            },
            {
                "type": "paragraph",
                "text": "Once the Duration expires, the object returns to its original solid state, but retains whatever shape it is currently in. This spell does not alter an object’s Durability or Structure. While a bank vault door can be made to bend inward, it cannot be broken any more easily than before."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Successes repair Structure points on a one-for-one basis."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            ...
            {
                "type": "paragraph",
                "text": "Radical transmutations might levy spellcasting penalties. Changing rock to metal has no penalty, but changing rock to paper might be –1."
            },
            {
                "type": "paragraph",
                "text": "Note that this spell does not alter the shape or Size of the object, just its material substance. Its weight becomes heavier or lighter by whatever degree is most appropriate for the new substance."
            },
            {
                "type": "paragraph",
                "text": [
                    "With Matter 4, a solid object composed of more than one material can be affected with a single casting (although it must still be touched; Matter 5 is needed to transmute multiple solid substances at sensory range). The mage can affect multiple kinds of materials at once (such as the different parts of a revolver) or just one piece or sort of material. (Thus, she could transform the bullets, which are made of a number of substances, or just the hammer, or the entire weapon according to her wishes.) This ability also allows the mage to transform complex materials into simple ones. The willworker is capable of turning a diamond into a small lump of clay, or a priceless centuries-old Japanese metal ",
                    {
                        "type": "italic",
                        "text": "tachi"
                    },
                    " into a sword made entirely of wood."
                ]
            }
        ],
...
const matterFourData = [
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Equipment modifiers can be increased or decreased by one die per success (to a maximum limit of plus or minus five dice). A vehicle’s maximum speed can be increased or decreased by 10 mph per success (max: plus or minus 50 mph), or its acceleration can be increased or decreased by five per success (max: plus or minus 25)."
            },
            {
                "type": "paragraph",
                "text": "At this level, the mage must touch the targeted object. With Matter 5, he can cast this spell at sensory range."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "As with Matter 2 “Transmute Water” (p. 197) and Matter 3 “Transmute Earth” (p. 200), except that now the mage can mix and match liquid and solid states, turning water into stone or wood into ink. (This spell cannot turn objects into impossible substances, such as wood into “liquid wood.”)"
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "A simple or complex object can be transformed into a different simple or complex object. Its Durability, Structure, and Size are not changed, however. If the caster combines this effect with 'Transmute Earth' (p. 200), he can change a subject’s material composition with the same casting. (See 'Combining Spells,' p. 128.)"
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            ...
            {
                "type": "paragraph",
                "text": "The spell hollows out a chamber in an object by converting the matter inside. This reduces the object’s Durability and Structure. If the mage puts the compartment inside a machine, the compartment could wreck the machine by disintegrating key components to make room."
            },
            {
                "type": "paragraph",
                "text": "The mage opens the compartment hatch by applying pressure in specific places and patterns. This is a mechanical effect, so she can teach another person how to open a given hatch. There’s also a slight chance that a passerby might stumble upon the method."
            },
            {
                "type": "paragraph",
                "text": "Observers can’t see or feel the hatch without magic or supernaturally enhanced senses. They can, however guess at the existence of a hidden chamber by the object’s weight or the sound the object gives off when struck."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The mage affects a volume of air or gas based on his successes. When applied to air, successes are allocated between the volume affected and the increase or decrease in pressure (the density of air molecules), measured in Strength."
            },
            {
                "type": "table",
                "headers": [
            ...
            },
            {
                "type": "paragraph",
                "text": [
                    "When shaping air or gas, a Dexterity + Crafts roll might be required to achieve a particularly complex shape, such as forming air into the form of a person. Exacting details such as facial features might even require an exceptional success on this roll (although the air is invisible unless someone throws paint or mud onto it). Dots of Strength act as Durability against projectiles or other attacks that must first get past the shaped air to reach their target (see the rules for cover, pp. 162164 of the ",
                    {
                        "type": "bold",
                        "text": "World of Darkness Rulebook"
                    },
            ...
            {
                "type": "paragraph",
                "text": "When moving air, the Storyteller assigns a Strength rating to an existing force of wind. The caster can increase or decrease that trait by the amount of Strength allocated with his successes. A normal day might have only Strength 0, while a very blustery day might be Strength 1. A hurricane might be Strength 2 or even 3."
            },
            {
                "type": "paragraph",
                "text": [
                    "The caster can reflexively control and move the affected area of air up to one yard per dot of Gnosis that he has per turn. If he uses Forces 3 in the casting of the spell, he can impart even greater motion to the air: 10 yards per dots of Gnosis per turn. People standing in the path of the wind might be knocked over. If the wind’s Strength exceeds an affected person’s Strength, a successful, reflexive Strength + Athletics roll must be made or he is knocked down (as per the knockdown effect, p. 168 of the ",
                    {
                        "type": "bold",
                        "text": "World of Darkness Rulebook"
                    },
            ...
            {
                "type": "paragraph",
                "text": "When applied to gas, the mage can control the vapor’s flow, preventing it from dispersing into certain areas and even reflexively moving it at a rate of one yard per dot of Gnosis per turn (or 10 yards per Gnosis per turn with Forces 3)."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The servant’s base Strength, Durability and Size are equal to the lesser of the mage’s Matter or Gnosis. The servant possesses no Stamina rating, and has one dot in Dexterity, as well as all of the Mental and Social Attributes. Successes of Potency may be assigned to any of the factors above (excluding Stamina; for effects that test against such, substitute the servant’s Durability) on a one-for-one basis. The construct cannot possess Skills or Merits. The servant weighs about 50 pounds at Size 1 and each dot of Size thereafter doubles the previous weight (100 pounds at size 2, 200 pounds at Size 3 and so on)."
            },
            {
                "type": "paragraph",
                "text": "Since the servant’s consciousness dissipates at the end of the Duration of the spell, creating the servant without an inherent acceptance of the inevitability of its own end can easily constitute a sin against Wisdom. (This spell, however, may be re-cast before its Duration ends, enabling the Duration to be extended; this is an exception to normal spellcasting rules.) As stone, the construct can be modified by the Matter Arcanum in all the same ways as ordinary rock."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Note that this spell does not alter the dispersion of the gas, just its substance."
            }
        ],
...
const matterFiveData = [
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "One point of Size can be altered per success, within the limits of the caster’s Matter dots."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Each success inflicts one point of damage on an object, without the need to overcome that object’s Durability."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "This spell functions similarly to “Chimerical Manifestation,” but the effect is permanent."
            },
            {
                "type": "paragraph",
                "text": "The spell’s target number is equal to the chimerical item’s imbued item or Artifact rating (minimum 3). Casting this spell is an act of hubris, requiring a mage with a Wisdom higher than four dots to make a degeneration roll."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            ...
            {
                "type": "paragraph",
                "text": "*Add an additional two successes for each extra 25 years of life"
            },
            {
                "type": "paragraph",
                "text": "When selecting tissue donors, proto builders must also be aware that their personality traits may reappear, in exaggerated form, in the finished homunculus."
            },
            {
                "type": "paragraph",
                "text": "Next the alchemist infuses the proto with its Physical Attributes, at a rate of one success per dot, to a limit of five dots per Trait."
            },
            {
                "type": "paragraph",
                "text": "The alchemist may gift the proto with any number of Physical Skills, at one success per dot, to a limit of five dots per Trait."
            },
            {
                "type": "paragraph",
                "text": "The homunculus’ outer surfaces may then be armored. As Armor increases, the homunculus’ outward appearance becomes increasingly bizarre. At one point of Armor, its skin seems hard and woody. At two points, it gains a waxy sheen. At three points, studs of bone appear across the surface of the skin. At four points, a thick, horny plates, reminiscent of a dinosaur, manifest. At five points, the surface takes on a stony quality. At six and above, the homunculus becomes metallic. Highly armored homunculi are sometimes referred to as golems."
            },
            {
                "type": "table",
                "headers": [
            ...
            {
                "type": "paragraph",
                "text": "Rare alchemical texts may include instructions for even more exotic bodily features, from wings to secret compartments. The success cost for such embellishments is left as an exercise for the indulgent Storyteller."
            },
            {
                "type": "paragraph",
                "text": [
                    "Creatures of inhuman appearance are subject to the same damage from Disbelief as fanciful beings created with the “Hereditary Change” spell (see ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    ", p. 192). They take Disbelief successes as bashing damage, once per scene, per witnessing Sleeper."
                ]
            },
            {
                "type": "paragraph",
                "text": "Failures on the casting roll to create a homunculus do not destroy a proto, but do deform it. With each failure, a small but noticeable visible imperfection appears on the proto’s body. Examples include scars, blemishes, drooping eyelids, gnarls of flesh and malformed or missing teeth."
            },
            {
                "type": "paragraph",
                "text": "With each dramatic failure, the spell must be started over. If the same gross material is used on a later attempt, weird physical features manifest, even if the next spell is cast without failures. A notably horrific physical feature appears: a withered arm, shark-like teeth, a useless third eye, a second face on the back of the head, tentacle-like growths or whatever other unpleasantries strike the Storyteller’s fancy."
            },
            {
                "type": "paragraph",
                "text": "Some mages deliberately handicap themselves for at least one casting, to ensure that their creation will be in some way imperfect. They thereby render the creation process less of an act of hubris — see the sidebar, below."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            ...
            },
            {
                ...
                "text": {
                    "type": "italic",
                    "text": "Example: Crucible creates a thaumium ring. It has Size 1, Durability 4, a Mana capacity of five points, and an indefinite Duration. It requires 14 successes to make. One success provides Size 1, Durability 1 and a Mana-capacity of one point, while three successes boost the Durability to 4. Four successes boost the Mana-capacity to five, and six successes are needed to make its Duration indefinite."
                }
            },
            {
                "type": "paragraph",
                "text": "Once made, the thaumium must be charged with Mana points. Each time it shields against magic (a reflexive action unless the wearer does not want it to), it uses up one of these points. If it runs out of points, it cannot shield magic until it is recharged. This shielding takes the form of a reflexive counterspell, effective against any Arcana and both vulgar and covert magic. The protection’s dice pool is equal to the thaumium maker’s Gnosis + Matter."
            },
            {
                "type": "paragraph",
                "text": "The wielder of a thaumium weapon can use the item’s stored Mana to make the weapon’s damage aggravated. This is a reflexive action requiring one Mana from the thaumium weapon’s stores. Thaumium must be Size 3 or more to act as effective armor."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "As the Matter 4 “Lesser Transmogrification” spell (p. 201), except that now the mage can freely interchange liquid, solid and gaseous states, including precious or rare substances (as described with the “Transmute Gold” spell, p. 202)."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            ...
            {
                "type": "paragraph",
                "text": "The victim becomes extremely hard, gaining Durability 3 as if he were an object; this Durability must be exceeded by any attack before his Health can be damaged. He’s impervious to fire and electricity while made of stone, and inert (and so immune to acid)."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Each success allows the object to automatically recover Structure points of damage at a rate of one point per 15 minutes."
            }
        ],
