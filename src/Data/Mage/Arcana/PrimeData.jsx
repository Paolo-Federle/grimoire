const primeOneData = [
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "See “Resonance,” pp. 277-280, for rules on scrutinizing items. With an exceptional success, the mage can tell if the enchanted item is cursed or has other exceptional circumstances (deleterious or benign) connected to its ownership or use."
            },
            {
                "type": "paragraph",
                "text": "The effect lasts for one scene, during which extended Intelligence + Occult rolls can be made to examine the enchanted item. Ten minutes’ time per roll; target number is equal to twice the enchanted item’s Merit dots. See the following Merits for more details on each type of item: “Artifact” (p. 80), “Enchanted Item” (p. 82), “Imbued Item” (p. 84)."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "This spell’s Potency is used to determine how far back the mage can look, as well as to contest any temporal or Resonance occlusion that might have been used in the mage’s immediate vicinity."
            },
            {
                "type": "table",
                "headers": [
            ...
            {
                "type": "paragraph",
                "text": "*Each additional success adds three month to how far back the mage can look."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneAlta": [
            {
                "type": "paragraph",
                "text": "The mage can copy an existing grimoire without knowing the rotes it contains or even how to properly read the text. The mage must have unimpeded physical access to the original grimoire for the duration of the spell. The basic threshold is one success per Arcanum dot, but the Storyteller may add additional difficulty if the grimoire is especially difficult to copy due to complex diagrams, confusing organization or even blurry text. In the case of some grimoires (such as the Corpus Mysteriorum), this makes it impossible to properly judge the difficulty and number of spells within."
            },
            {
                "type": "paragraph",
                "text": "The caster can’t alter the language, organization or basic appearance of the copy from the original except for a few minor deviations in materials and penmanship."
            },
            {
                "type": "paragraph",
                "text": "Once the caster is finished, the new grimoire contains all of the rotes of the original. The copy even retains any magical curses or safeguards contained in the original as long as those were part of a combined spell that created the original (or in the case of a copy of a copy, ultimately descends from an original work of this type). The copy functions just as a standard grimoire (described in “Inscribe Grimoire”), though it should be noted that this spell is often used to reproduce books that are difficult to understand."
            },
            {
                "type": "paragraph",
                "text": "This spell can’t copy a daimonomicon (see p. 81) unless it incorporates the master-ranked Arcanum used to create that work in the first place."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Banishers, for whatever reason, have magical signatures that are slightly different from those of other mages. While some Banishers refuse to work together, and are just as willing to kill each other as their foes, others long for companionship and backup. This spell allows a mage to see the cracks in a Banisher’s aura and feel the chill from the Abyss within."
            },
            {
                "type": "paragraph",
                "text": "Non-Banisher mages can use this spell as well, but they suffer a –2 penalty on the attempt. Use of this spell is also believed to make mages more susceptible to becoming Banishers, though this might just be a paranoid rumor."
            },
            {
                "type": "paragraph",
                "text": "Any use of this spell adds the target’s Abyssal Resonance Merit dots, if any, to the attempt (making mages with this Merit easier to detect). Note, though, that casting this spell upon a target with Abyssal Resonance •• makes the spell vulgar in aspect (see p. 39)."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The phantasm’s Potency levies dice penalties on the roll."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Inscribing a grimoire is a bold act, for the mage puts part of his magic into the book by removing it from himself. In doing so, the mage forgets how to cast a rote. He can later re-learn it by studying his own grimoire (or learning from another mage who knows the rote) and with the expenditure of the proper experience points, but until he does he cannot cast that rote on his own again (although he can use the grimoire to cast it; see below). Recording would seem at first to be a selfless or foolish thing to do, but orders are hungry for grimoires with which to teach young mages, and pay for them in favors. Also, certain Mind spells or creatures can take knowledge from a mage’s mind, leaving a void in its place. In case rotes are lost in this way, it’s good to have them “backed up” in a book."
            },
            {
                "type": "paragraph",
                "text": "The spell’s target number equals one success per Arcanum dot used in the rote to be recorded. For example, a Life 3, Mind 2 rote requires five successes. The grimoire’s Duration is lasting; it cannot be dispelled and does not expire unless the grimoire itself is destroyed."
            },
            {
                "type": "paragraph",
                "text": "Grimoires allow mages to learn their contents without requiring a teacher, although the experience point cost is the same. Additionally, the mage can cast a grimoire’s rotes even if he does not personally know the rotes, as long as he references the book during casting. Doing so requires one turn of reference, during which the mage can do nothing but read the book and move up to his Speed. In the following turn, he can cast the rote. If he is interrupted before casting, he must reference the book all over again. If he already knows the rote, referencing the grimoire gives a +1 bonus to casting it."
            },
            {
                "type": "paragraph",
                "text": "Grimoires cannot be copied without going through the same spellcasting process used to create them. Only the original is enchanted; mundane copies produce only a mess of meaningless words. Despite the name, grimoires don’t have to be books. They can be computer programs or databases, or anything used to store knowledge."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneAlta": [
            {
                "type": "paragraph",
                "text": "The mage gains the Mage Sight (see “Mage Sight,” p. 110). This is the most potent of the resonance-detecting senses and the Storyteller should be lavish with its details, explaining intricacies of any given source of resonance that would likely be invisible to one using another Arcanum. Some details, however, are best analyzed with other Arcana (in the way that Matter is best suited to “thick” or “ponderous” resonances), or better still in conjunction with Prime. Many mages describe this sense as sight, though some claim to “smell” or “taste” lingering sorcery on a person or place."
            },
            {
                "type": "paragraph",
                "text": "Others simply speak of a sixth sense or other esoteric perception that defies ordinary categorization."
            }
        ],
        "Practice": "Unveiling",
        "Action": "Instant",
...
const primeTwoData = [
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The mage can activate the item’s trigger at will anytime within this spell’s Duration. See the following Merits for more details on each type of item: “Artifact” (p. 80), “Enchanted Item” (p. 82), “Imbued Item” (p. 84)."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The Storyteller rates the strength of the auric marks, generally from 1 to 5, although radical supernatural taint might be rated even higher. This strength must be matched by spellcasting successes for the cleansing to be effective."
            },
            {
                "type": "paragraph",
                "text": "While one success on the casting of this spell removes any sign of the mark from cursory perception, more intense scrutiny and examination (by others using Mage Sight) will still reveal lingering taint."
            },
            {
                "type": "paragraph",
                "text": "A Prime 3 version of this spell can be cast upon others."
            },
            {
                "type": "paragraph",
                "text": "By adding Life 2 to the spell, the mage can use this against auric taints that have some root in organic processes, such as the corruption caused by the practice of Sinister Organ qigong."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "As the rules for “Counterspell,” p. 123, but the mage can now counter spells from any Arcanum (he does not need one dot in at least one of the spell’s Arcana) and he can counter covert spells even if he has not had time to identify their components."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Successes apply to the spell’s duration factors. While the spell is active, the mage can make instant-action Wits + Occult perception rolls to scrutinize the immediate area’s Resonance (within sensory range) for the tell-tale signs of a node, where two or more ley lines meet."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The mage gains one point of armor per dot he possesses in the Prime Arcanum. By spending one Mana, the Duration can be made to last for one day."
            },
            {
                "type": "paragraph",
                "text": "This armor works only against spells that target the mage. It does not shield against magic that is not directly cast at the mage. A bolt of electricity thrown at him is shielded, while damage suffered by falling through a floor rotted through by magic is not. This shield functions against spells such as mind control or soul theft that do not directly inflict damage."
            },
            {
                "type": "paragraph",
                "text": "A magical shield requires one Mana each time it contends with an incoming spell. If the mage does not (or cannot) spend the Mana, the shield provides no armor against the attacking spell, although the shield remains until its Duration expires, so it can be activated later. Among other things, this spell allows a mage to use his magical shield selectively, blocking hostile spells but allowing friendly ones through. Mages often invest their shields with multiple charges, spending Mana during casting so that each charge already stores its own energy."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "With a single success on the casting roll, the character sees ley lines as streams of bright greenish-blue power flowing through the earth. If no ley line is within the immediate line of sight of the mage, he can sense the direction of the nearest as a reflexive action."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "If the target is unwilling, he may resist with a reflexive contested Resolve + Gnosis roll."
            }
        ],
        ...
        "DescrizioneAlta": [
            {
                "type": "paragraph",
                "text": [
                    "Adding Spirit 3 (or 5) to the technique of “Squaring the Circle” (see ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    ", p. 223) focuses the duelists’ magical power into animate forms: spirits that fight for the duelists. Some mages prefer “Shadow Chess” to the standard Duel Arcane."
                ]
            }
        ],
        "Practice": "Ruling",
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": [
                    "Duelists within the “Shadow Chess” dueling circle prepare a dueling sword and shield, just as if they were fighting the standard Duel Arcane (see ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    ", p. 286). Unlike a duel fought using “Squaring the Circle,” participants fight using spirit proxies called Dueling Pawns. The Pawns attack each other and the enemy mage."
                ]
            },
            {
                "type": "paragraph",
                "text": [
                    "Each success a mage scores with her dueling sword does not (and cannot) inflict damage to her enemy’s Willpower. Instead, each success temporarily generates a spirit out of the mage’s raw, emotionally charged magical power. This spirit accumulates traits just as if it had been created using the spell “Goetic Evocation” (see ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    ", p. 325). The spirit resembles a cross between the mage’s sword, a spirit common to the local Shadow and the mage herself."
                ]
            },
            {
                "type": "paragraph",
                "text": "A Dueling Pawn serves the mage that created it faithfully. It cannot survive outside of a dueling circle, and dissipates the moment that the spell ceases. Dueling Pawns created with the Spirit 3 version of the spell are insubstantial to everyone but the duelists. There is, however, a Spirit 5 version of the spell where the Pawns are substantial to everyone inside the dueling circle."
            },
            {
                "type": "paragraph",
                "text": "Each turn, a dueling mage may use her sword to stack additional successes upon an existing Dueling Pawn, create a new Pawn or order her Pawns to attack or defend any other entity within the dueling circle. A mage can direct any number of Dueling Pawns by mental command as an instant action, but cannot create or enhance more Pawns or cast a spell in the same turn."
            },
            {
                "type": "paragraph",
                "text": "Pawns inflict damage on non-spirits using their own dice pools, but to Willpower first, then Health. They may injure other spirits normally. Any Numina they might acquire that would allow them to inflict direct Health damage conforms to the above rule, instead. A shield Arcanum subtracts dice from attacking Pawns’ dice pools as if it was Armor, but unlike a standard duel, mages may move about the local Shadow to “physically” evade attacks, and gain the benefits of Defense where applicable."
            },
            {
                "type": "paragraph",
                "text": "As they are inextricably linked to the sorcerer’s will, Dueling Pawns can provide energy to stave off psychic defeat. As a reflexive action, a mage can divert Willpower damage that he suffered to the Resistance of a Pawn. If this knocks a Pawn’s Resistance to zero, the mage suffers any excess damage and the Pawn is destroyed. Mages cannot sacrifice Pawns to stave off Health injuries however, so deadly Shadow duels often end in a quick, lethal “checkmate.”"
            },
            {
                "type": "paragraph",
                "text": "There are “Sanguine” versions of this spell that allow Dueling Pawns to inflict lethal or aggravated damage. These require Prime 3 (to let Pawns inflict lethal damage) and Prime 5 (to let them inflict aggravated damage)."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Successes are applied to the sigil’s Duration:"
            },
            {
                "type": "table",
                "headers": [
            ...
            {
                "type": "paragraph",
                "text": "This magical aura does not extinguish the object’s own resonance, but the aura does make it harder to scrutinize the object: anyone studying the object with Mage Sight must first collect a number of successes equal to this spell’s Potency before the natural resonance can be discerned past the mage’s imposed aura."
            },
            {
                "type": "paragraph",
                "text": "If this spell is cast as a group ritual, the auras of all the mages involved are imposed upon the target object. In this manner, cabals can mark items with their own group sigil."
            },
            {
                "type": "paragraph",
                "text": "With Prime 3, the mage can sigilize his aura upon living creatures, covering up their natural auras with his own. Some mages have been known to do this to “brand” their servants or even their apprentices."
            },
            {
                "type": "paragraph",
                "text": [
                    "When cast in combination with the Prime 2 “Transform Aura” effect, this spell can sigilize items with an aura other than the mage’s own. It is not easy counterfeiting other mage’s auras, however. The mage first has to examine the aura to be copied, using Mage Sight and the rules for scrutinizing resonance (see p. 277279 in ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    "). If he’s trying to copy a cabal’s sigil, he must do this for every aura involved in the sigil. Once he’s done this and made the fake sigil, his copy can be scrutinized to see if it’s a forgery. Examiners make an extended action Intelligence + Occult roll (10 minutes per roll) with a target number equal to the concealing spell’s Potency."
                ]
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneAlta": [
            {
                "type": "paragraph",
                "text": "A mage with Prime 2 can add a cloaking effect to his spells when he casts them, making them invisible to a mage’s Unseen Senses and making it harder for those with Mage Sight to notice the spell. He spends one Mana upon casting (in addition to any other Mana required for the spell)."
            },
            {
                "type": "paragraph",
                "text": "Those with Mage Sight can make reflexive Wits + Occult rolls to notice the spell; otherwise, it remains undetected. Targets suffer a –1 dice penalty to this roll per point of Potency of the cloaked spell. If they have some reason to believe there is a cloaked spell nearby, or are scouring the area for supernatural clues anyway, they can see through the spell cloak by exceeding twice its Potency with their scrutiny successes."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Only by overcoming the Potency of this spell (with a spell such as “Supernal Vision”) can a mage detect the true aura."
            },
            {
                "type": "paragraph",
                "text": "See “Aura Signifiers,” p. 206, for a list of some aura natures. If this spell is cast conjunctionally with Mind 2, the mage can alter the appearance of his aura’s mental and emotional state, as per the Mind 2 “Alter Aura” spell, p. 207."
            },
            {
                "type": "paragraph",
                "text": "This spell cannot be detected except by a “Supernal Vision” (p. 221) Mage Sight spell with a higher Potency. Even once this spell is detected, the true nature of the mage cannot be perceived until the Transform Aura spell expires or is dispelled."
            }
        ],
...
const primeThreeData = [
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The mage flings a ball of glowing, fiery energy at a target. This projectile is large enough that targets gain their Defense against it. One point of bashing damage is inflicted per success. (Note that “celestial fire” is not the same thing as mundane fire; vampires are not especially susceptible to it and it does not induce Rötschreck.)"
            },
            {
                "type": "paragraph",
                "text": "This spell affects beings or objects in the Twilight state (although the mage needs “Supernal Vision,” p. 221, or some other magical sense that allows him to see Twilight beings to be able to target such creatures, or else he fires blind)."
            },
            {
                "type": "paragraph",
                "text": "With Prime 4, damage is lethal and the mage can choose to directly attack a target’s Pattern instead of casting it as an aimed spell (the target resists, subtracting Stamina from the caster’s roll). With Prime 5, one Mana can be spent to make the damage aggravated."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Each success allows the mage to channel one Mana point from a source to his own Mana pool, up to a maximum of his Prime dots. The mage must touch the source (with Prime 4, he can channel within sensory range, and with Prime 5 he can use Space 2 for sympathetic range)."
            },
            {
                "type": "paragraph",
                "text": "Tass can be drawn upon for its Mana with this spell, meaning that it can potentially serve as a form of currency. The mage must touch the tass to channel from it (with Prime 4, he can channel from it at sensory range). For each point of Mana siphoned out of tass, subtract one point from the tass’ Mana and its Structure. If it is siphoned to zero Mana or Structure, the tass collapses back into the Tapestry. See “Create Tass,” below, for more information."
            },
            {
                "type": "paragraph",
                "text": "An enchanted item that holds its own Mana stores (such as certain imbued items and Artifacts) can also be channeled. The subject must be touched, and one Mana is channeled per success, up to a maximum of the caster’s Prime dots."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Successes are allocated between the tass’ Size and Durability. At least one Mana must be channeled into the tass. This Mana can be siphoned out of the tass using the “Channel Mana” spell, above."
            },
            {
                "type": "paragraph",
            ...
            {
                "type": "paragraph",
                "text": "Tass dissolves into the Tapestry at the end of the spell’s Duration."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Even spirits, who rely on certain qualities of resonance for feeding, can be fooled by this spell. Each success also masks one level of a Hallow’s power. For example, two successes make a 3-dot Hallow look like a 1-dot Hallow. Or she could make it appear to be a greater place than it is, making a 3dot Hallow appear to be a 5-dot Hallow with two successes."
            },
            {
                "type": "paragraph",
                "text": "This spell cannot be detected except by a Mage Sight spell with a higher Potency. Even once this spell is detected, the true resonance of the area cannot be perceived until the Disguise Resonance spell expires or is dispelled."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "A basic success completely disguises the identity, Gnosis rating and mastery of the caster. The caster can create fictional Traits to stand in for these, or he can try to replicate those of another mage. The caster must be familiar with the resonance signature of the mage to be mimicked and might need to make an instant Intelligence + Occult roll to get it right (the Storyteller should roll, keeping the result secret)."
            },
            {
                "type": "paragraph",
            ...
            {
                "type": "paragraph",
                "text": "This spell cannot be detected except by a Mage Sight spell with a higher Potency. Even once Disguise Spell is detected, the true resonance of the spell cannot be perceived until it expires."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Each success dissolves one point of the tass’ Mana and Structure."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Successes are allocated between Size and Potency. The Potency of the spell determines how complex the phenomenon created can be."
            },
            {
                "type": "table",
                "headers": [
            ...
            },
            {
                "type": "paragraph",
                "text": [
                    "Mana must be channeled into the tass, and can be withdrawn by a mage skilled in the Prime Arcanum, as normal (see the “Create Tass” spell on pp. 224–225 of ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    "). This energetic tass can inflict only bashing damage, and then only if in the form of electricity or fire. With Forces 4, and by adding an extra success to the spell’s Potency, however, the tass can be made to inflict lethal damage when in such forms."
                ]
            },
            {
                "type": "paragraph",
                "text": "Note that fire created by this spell does not automatically burn flammable items. Such fire must be made to inflict lethal damage, and the mage must will it to burn like a normal fire. The tass will then burn as normal for as long as the mage actively concentrates on making it do so."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "If the weapon is a gun, all the bullets within its magazine, cylinder and/or chamber are enchanted. To enchant extra magazines or ammunition, additional Target factors must be added to the casting."
            },
            {
                "type": "paragraph",
                "text": "With Prime 5, the object can be given the power to inflict aggravated damage (one Mana must be spent for the caster or user with each aggravated strike)."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Mages using Mage Sight are allowed a reflexive Wits + Occult roll to notice the true nature of a spell’s Arcanum. Targets suffer a –1 penalty to this roll per point of Potency of the altered spell."
            }
        ],
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": [
                    "Successes accrued during the casting of this spell add to the equipment bonus granted by non-weapon objects made out of tass. (For weapons crafted through the use of the Prime Arcanum, see the “Phantasmal Weapon” spell on pp. 228–229 of ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
    ...
    },
    {
        ...
        "RoteDescrizione": [
            {
                "type": "paragraph",
                "text": "The journals of the Templars indicate that this spell was most commonly used in preparation for a physical conflict with otherworldly enemies, when the knights would face hostile “angels” or entities from beyond most realms of perception. Tales of knights in shining armor, whether among actual military accounts, or even folkloric legends such as Beowulf or the Volsung Saga might have involved kennings related to this spell’s function, even though those sources clearly predate the Templar order."
            },
            {
                "type": "paragraph",
                "text": "While it works fine as a standard armor spell, most mages would likely eschew it as such, since it’s not as effective as the armor rotes of many other Arcana (o vulgar. On the other hand, the protection it offers from aggravated supernatural damage is certainly a boon."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The casting of this extended action spell can only begin at the time of day in which the Hallow normally produces its daily allotment of Mana. The mage must be present, within the vicinity of the Hallow’s center (five-yard radius per dot). He needs one success per dot rating of the Hallow."
            },
            {
                "type": "paragraph",
                "text": "The mage’s aura cannot conflict with the Hallow’s quality of resonance. For example, if his aura is generally angry, he cannot marry a peacefully-aspected Hallow."
            },
            {
                "type": "paragraph",
                "text": "A dramatic failure at any point during the casting means that the land has rejected the mage. He cannot continue the spell and may not try again for at least a month, during which time he suffers a –2 dice penalty on all spellcasting attempts to channel Mana from that Hallow. Animistic mages believe that the Hallow has a consciousness and it has denied the supplicant; more scientific-minded mages believe that the mage is allergic to something in the Hallow’s mystical composition."
            },
            {
                "type": "paragraph",
                "text": "If the spell succeeds, its effects are lasting — so long as the mage properly maintains a relationship with the Hallow. He must perform at least one oblation per month per dot rating of the Hallow (i.e., a 3-dot Hallow needs three oblations per month), based not on his Path’s preferences but on those of the Hallow, determined by its resonance. A resonance of pain or fear might require oblations featuring torture, maiming or death. Tranquility resonance might need meditative oblations or the tending of a garden within the Hallow’s vicinity. Anxiety might be best served through rushed ceremonies and rituals, taut with emotional conflict. The mage — called the spouse — knows which oblations will appease the Hallow."
            },
            {
                "type": "paragraph",
                "text": "If the mage misses one of these oblations, the spell’s effects are dampened temporarily, until he can perform the rite. If more than three months pass without an oblation on the mage’s part, the spell expires. That mage cannot attempt to marry the same Hallow again for at least the next three months thereafter."
            },
            {
                "type": "paragraph",
                "text": "So long as the spell lasts, the mage can choose who can harvest Mana from the Hallow. Mages without permission cannot forcibly harvest the Hallow, except masters with a Prime 5 version of the “Channel Mana” spell, and, even then, they suffer a dice penalty equal to the spouse’s Resolve."
            },
            {
                "type": "paragraph",
                "text": "With Prime 4, this spell can be cast upon a willing target, bonding her to the Hallow instead of the mage."
            },
            {
                "type": "paragraph",
                "text": "Only one mage can be bonded to the same Hallow at the same time. For another to bond to it, the current spouse must either cancel his spell or die — or else his Hallow Bond spell can be dispelled."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Imbued items are granted one or more magical powers. In effect, whoever wields the imbued item gains the benefits of its spells, even though he did not necessarily cast them. See the “Imbued Item” Merit, p. 84."
            },
            {
                "type": "paragraph",
                "text": "The target number is equal to the successes required for all the spells imbued into the item. The mage must be able to cast each spell he wants to imbue, and each spell’s target number is determined as if he were casting that spell as an extended action. The target numbers of all spells to be imbued are combined to find the successes needed for the Imbue Item casting."
            },
            {
                "type": "paragraph",
                "text": "Each spell remains imbued for as long as its Duration. Most imbued items are made with spells of indefinite Duration, and the caster usually relinquishes such an item from his control so it no longer applies to his maximum spell limit. Doing so costs one Willpower dot. See “Relinquishing Control of Spells,” p. 220. One Mana point must be spent per spell imbued, in addition to any Mana normally required for the casting of each spell."
            },
            {
                "type": "paragraph",
                "text": "The caster decides whether each spell imbued into the item is persistent (always active) or contingent (triggered by a word, gesture or condition). Even contingent spells imbued into an item must be made indefinite, or they disappear from the item when their Duration expires. The caster can give the item the capacity to hold Mana points. Doing so requires three successes and the item has a capacity of 10 points plus one per spell imbued. Mana must be spent for the caster to actually fill the capacity of points, or else someone with the “Channel Mana” spell (p. 224) can do so later. The aspect of casting (covert or vulgar) depends on the spells imbued into the item."
            },
            {
                "type": "paragraph",
                "text": "If the item is imbued with vulgar spells, it risks a Paradox whenever these powers are used. The Paradox dice pool is based on the Gnosis of the imbued item?s creator at the time of the item?s creation (if his Gnosis later rises, the item?s Paradox dice pool does not also rise)."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Unauthorized users may still be targeted by the item’s other defensive enchantments, if any."
            },
            {
                "type": "paragraph",
                "text": "The mage may, at the time of casting, exempt any of the item’s magical properties from the purview of this spell. An item’s enhancements are often exempted; exclusiveness would otherwise make the item less durable when handled by enemies intent on destroying it."
            },
            {
                "type": "paragraph",
                "text": "A spell that has not yet been cast on the item at the time Instill Exclusiveness is woven into it is automatically exempted from its effect."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "One success is added to the target number per imbued spell that is to be protected from unauthorized users."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "A rightful owner of this item may designate a number of heirs equal to the spell’s Potency. The owner names them in order, so that if the first heir fails to take possession of the item after a specified period, the next in line is then cleared to step up and attune to the item."
            },
            {
                "type": "paragraph",
                "text": "If all specified heirs are dead when the owner dies, the item becomes generally available. As with any item bearing an authorization-based spell, any mage may now attune to it."
            },
            {
                "type": "paragraph",
                "text": "Owners can alter their list of heirs at any time. Owners also may specify an interval of neglect, after which their heirs may claim the item as theirs. If an entire interval passes during which the owner has not used or handled the item, the first-named heir becomes the item’s designated owner."
            },
            {
                "type": "paragraph",
                "text": "Mages inheriting an item in this way will likely wish to specify their own new heirs, rather than allowing the item to pass to the previous owner’s second-named beneficiary."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "This spell bestows upon the mage a source of perpetual energy, a node from which ley energy wells up. The mage determines the form of the node, whether it is the source of a pure spring, the center of a tranquil valley or a mountain peak, for example."
            },
            {
                "type": "paragraph",
                "text": "The effect is lasting — the energy of the earth replenishes itself, unless something later disrupts the ley lines. Such disruption can be done by altering the architecture or geography of the node, perhaps by simply damming its spring or flooding its valley."
            },
            {
                "type": "paragraph",
                "text": "The target number depends on how much power the node generates per day. One success makes enough energy per day to power a small room, such as a home office (for its usual day-to-day energy needs in mild temperatures). Three successes can power a small home. Five can power a large home or mansion. Seven successes can power an office building. The power is generated from a single node, so these buildings must have a central hook-up that is placed within the node. For example, a circuit box can be placed in the node, powering anything that leads to it, such as an electrical socket in an upstairs bedroom."
            },
            {
                "type": "paragraph",
                "text": "This spell does have a couple of drawbacks. First, the mage can create a ley-energy node only at a point at which energies actually converge. Such spots occur at the Storyteller’s discretion, but it is said that ancient cultures knew these places. Following old Roman roads or exploring the ruins of ancient villages might lead a mage to such a nexus. Most of the best and most accessible of these junctures have already been claimed. Second, this magic can be dispelled just as any other, causing all that is being powered by the subtle energies to cease functioning until the spell is cast anew (or an alternate power source is arranged)."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Shifting a ley line is a three-stage process. First, the mage must mystically “grab” the conduit while reaching out into the air from the appropriate direction. (She needs some form of Mage Sight to see it.) If the mage wants to move it laterally, she reaches straight out so that pulling into her body moves the line in the desired direction. If she wants to pull the line closer to the surface, she reaches down toward her feet. Similarly, pulling the line down requires reaching up to the sky. Sleepers would perceive this as extremely odd behavior, but nothing that causes Disbelief."
            },
            {
                "type": "paragraph",
                "text": "Once she has a grip on the line, she next pulls on the line as if dragging a large steel cable. Onlookers see the mage straining against an invisible resistance. She can drag the line five yards for each success. The spell’s target number is thus determined by the total distance the mage wants to move the line."
            },
            {
                "type": "paragraph",
                "text": "As soon as the mage reaches the desired distance, she must finally anchor the line into its new position by investing one Mana to “peg” the line down. Imagine a tent spike that keeps a rope in place, and you have an idea what the mystical peg does to the conduit."
            },
            {
                "type": "paragraph",
                "text": "Once the spell expires, the ley line snaps back into its natural shape."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "See “Magic Shield,” p. 222, for the effects. If the target does not have his own Mana, the caster must incorporate Mana during casting to allow it a number of charges. The subject can choose when a charge is activated."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Whenever a mage wearing or carrying the item casts a spell with a Mana cost, that cost increases by one. This item requires 20 successes to create."
            }
        ],
    ...
    },
    {
        ...
        "RoteDescrizione": [
            {
                "type": "paragraph",
                "text": "A cabal in Philadelphia brought a strange story to the notice of the local Consilium, shortly before the disappearance of the entire cabal. The mages had noticed an unusual quality about the Mana stored in their Patterns. Further investigation by the Consilium eventually uncovered evidence that the cabal had been attacked by a cell of Banishers calling themselves Children of Liberty."
            },
            {
                "type": "paragraph",
                "text": "When one of the Children of Liberty was apprehended, magically reinforced questioning revealed the Banishers had used this spell (in conjunction with more mundane forms of intelligence-gathering) to spy on the cabal and track the members’ movements. Appalled by this information, the Hierarch of Philadelphia ordered a full-scale seek-and-destroy attack on the remaining Children of Liberty."
            },
            {
                "type": "paragraph",
                "text": "To date, however, no further Banishers have been found in the city."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "For every five successes added to the target number of the spell, the mage specifies one Arcanum. Any mage casting a spell from any of the specified Arcana while wearing or carrying the cursed item suffers a dice penalty equal to the Mana spent during its creation."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The spell creates an object of Size 5 or less. The phantasm has one point of Durability. It is fragile and breaks easily. The mage cannot create functional tools, weapons or armor at this level."
            },
            {
                "type": "paragraph",
                "text": "To create a convincing illusion, a reflexive Intelligence + appropriate Skill roll is required, and excess successes on the casting add one die each to this roll. To simulate an animal, use Animal Ken. For an object, use Crafts. For a person, use Medicine or perhaps Empathy."
            },
            {
                "type": "paragraph",
                "text": "At the Storyteller’s discretion, magically “dead” areas may not contain enough ambient Mana to fabricate such an object without the expenditure of a point of Mana, but this should be the case only rarely."
            }
        ],
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": [
                    "This spell follows the same rules as Counterspell (see p. 123 of ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    ") except that if the Potency of the “Price of Hubris” casting is equal to, or greater than, the potency of the targeted spell, the hostile spell is redirected to its source. Any redirected spell becomes an Aimed spell, requiring a single success on a Wits + Occult + Prime roll to hit the target (normal modifiers apply). The effects of a redirected spell are equal to successes rolled on the original casting of that spell."
                ]
            },
            {
                "type": "paragraph",
                "text": "The mage must be the direct target of a hostile spell to redirect that spell. Spells that include the mage in an area of effect, or that have an indirect effect on the mage cannot be redirected."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "“Reset Platonic Exemplar” usually removes all spells from an item. On a dramatic success, the mage can choose which spells stay and which ones go. The mage must touch the item during casting."
            },
            {
                "type": "paragraph",
                "text": "Note that the normal rules preventing the permanent dispellation of Enchanted Items do not apply to Platonic exemplars, which by definition are vessels used to contain an ever-changing roster of spells."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "A single casting of Subvert Ownership targets any and all spells woven into an item that depend on such designations."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "When enchanting the item, add three successes to the target number for each of the target spell’s dots to allow the spell to target and trigger against interlopers. So, to allow the item to trigger the four-dot spell “Trigger the Lizard Brain,” 12 successes would be required."
            },
            {
                "type": "paragraph",
                "text": "Upon successful casting of this spell, the mage then rolls her usual dice pool for an improvised casting of the subject spell. The defensive spell gains one Potency per success. If the subject spell requires Mana, the item must be infused with it, per the usual “Imbue Item” process, and the item must have Mana to spend when triggered by an interloper. Without sufficient Mana, the effect is not activated."
            }
        ],
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": [
                    "This spell duplicates the Prime 3 “Phantasm” spell (see ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    ", p. 227) with the following exceptions: first, the created object must copy an object the mage has perceived in a vision of the past, as the Time 2 “Postcognition” spell (",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    ", p. 260). Because of this limitation, the item is automatically convincing, since it physically duplicates the original object’s external properties in every detail, down to the last nick, scratch, marking and resonance imprint. This makes books and other forms of writing particularly attractive targets for the spell, allowing a mage to peruse the contents of manuscripts otherwise lost to time. Once the spell’s Duration elapses, the object dissolves back into the flow of continuity."
                ]
            },
            {
                "type": "paragraph",
                "text": [
                    "With Prime 4, mages can summon more durable and mechanically functional constructs per the “Phantasmal Weapon” spell (see ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    ", p. 228), though such objects cannot have any properties superior to the original object. Therefore, these items are more limited than conventional phantasms, though there is a certain hubristic panache to stabbing someone with Brutus’s knife still hot with Caesar’s blood instead of wielding a plain dagger."
                ]
            }
        ],
        ...
        "RoteDescription": [
            {
                "type": "paragraph",
                "text": [
                    "Modern santeros are loath to use this spell often, because it requires another human being to die by metal (though it does not require the caster to kill the victim himself). The santero must taste the blood of the dead or dying. If the spell is successful, the mage can gain ash? (Mana) as if he had performed a blood sacrifice (see p. 78 of ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    "). Casting this spell by itself doesn?t cause degeneration, though killing someone to facilitate it certainly does."
                ]
            },
            {
                "type": "paragraph",
                "text": "The casting mage must carry or wear a piece of metal, but no Ogg?n would ever be without such a focus anyway. Many mages using this spell dip a blade in the victim?s blood and lick it off while casting, but this isn?t necessary."
            }
        ],
...
const primeFourData = [
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": [
                    "Mages are fragile beings, but given every second that a mage isn’t dead is another opportunity for him to turn the tables on his Banisher assailant. This spell allows the Banisher to strip away a mage’s preexisting advantages: armor spells, hung spells, even Mage Sight. The Banisher uses Time to turn the “clock” ahead on an existing spell, and Prime to unravel it, much as Supernal Dispellation (see p. 229 of ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    "). Unlike that spell, however, the mage doesn’t need to beat the spell’s Potency, as he is attacking the spell as it will exist in the future (that is, as it starts to fade and lose its Potency)."
                ]
            },
            {
                "type": "paragraph",
                "text": "The Banisher must touch the mage to use this spell, but at Prime 5, he can cast it at sensory range. The mage can also work in target factors at this level, affecting several targets at once."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The target number is equal to the original level of the Hallow before it became dormant."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "On the turn after this spell is cast, the next spell cast by the target is redirected to strike the caster of this spell. The mage may redirect any one spell with a Potency no higher than the number of successes gained on the casting roll."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            ...
            },
            {
                "type": "paragraph",
                "text": [
                    "Note that this spell ",
                    {
                        "type": "italic",
                        "text": "may not"
                    },
                    " be cast on another, whether willingly or otherwise."
                ]
            }
        ],
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": [
                    "Mages are able to cast covert spells by working within the established rules for what is considered possible in the Fallen World. This spell forces magic used by the mage to manifest itself visibly and audibly. An “Alter Integrity” spell (see ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    ", p. 198) used to weaken a lock might cause the lock to shriek with the sound of bending metal and glow red (for example)."
                ]
            },
            {
                "type": "paragraph",
                "text": "With a successful casting, every spell cast by the targeted mage is considered vulgar for the remainder of the scene. Additionally, every casting uncloaks the cursed mage’s nimbus in an enhanced state, making the nimbus stronger in effect than is usual. The summation of all this excess magical energy results in the addition of +1 die to each Paradox check made by the cursed mage during the scene."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "This spell targets the Mana of an opponent, allowing it to flow more easily from the target for a limited time. For the Duration of the spell, the target mage may spend one Mana more per turn than would normally be allowed by his Gnosis rating. Excited by the feeling of the Mana surging within them, mages usually give in to the temptation of spending more Mana than is necessary, but this newfound power comes at a price. While the mage is under the effect of this spell, any Mana expenditure is doubled in cost."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The mage must have at least one dot in each Arcanum used in the targeted spell."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Before casting, the mage must decide whether to adjust the strength of the line’s flow or alter its direction. He could, however, cast this spell twice, once to lower the strength and again to alter its flow or vice-versa."
            },
            {
                "type": "paragraph",
                "text": "Strength of Flow: When adjusting the flow’s Strength, the mage manages to raise or lower the Strength by one dot per success. Most ley lines have an existing Strength of 2. To raise a Strength 2 ley flow to Strength 4 would require a target number of two successes. The mage could reduce the Strength to zero, in which case the line ceases to flow. The higher the Strength, the more dramatic and quick are the effects of its resonance on people, places and things in the ley line’s path."
            },
            {
                "type": "paragraph",
                "text": "Direction of Flow: When reversing the line’s direction of flow, making it go upstream rather than down, the mage needs one success per Strength dot of the line’s flow. It is easier to reverse the flow of a weak line than a strong one. A line with a Strength of 2 would require a target number of two successes."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            ...
            {
                "type": "paragraph",
                "text": "Note that the same sorts of “magic dead areas” that necessitate spending a point of Mana to create a static phantasm with the “Phantasm” spell (p. 227) require the same for this spell."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "As with Prime 3 'Phantasm,' p. 227 except the object has a Durability equal to the caster’s Prime dots. Successes can be allocated to create an equipment dice modifier or armor points for the object, or even to increase the Size above five points (on a one-for-one basis)."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Each level of Potency allows the mage to ignore one point of magical armor when he attacks targets that possess it. This benefit is exclusive to the caster and affects any targets he attacks during the spell’s Duration."
            },
            {
                "type": "paragraph",
                "text": "This spell affects only Awakened Shielding spells. It does not affect mundane armor or armor granted by other supernatural powers."
            },
            {
                "type": "paragraph",
                "text": "A mage with Prime 5 can grant this spell’s benefit to another."
            }
        ],
        ...
        "RoteDescrizione": [
            {
                "type": "paragraph",
                "text": "Simplicius was a theologian, not a warrior, but in one desperate moment he had to defend himself from a seemingly unstoppable gang of mages. They shrugged off his son’s bullets before they killed the boy. They chased Simplicius to an old quarry. That’s when he prayed that God would forgive him for dabbling in the occult. He gave his magic up to God, and in seeming response, a stone dropped right into his open hand, jostled from above by a witch crawling down to ambush him."
            },
            {
                "type": "paragraph",
                "text": "With perfect faith he looked up, threw the stone and knocked the formerly bulletproof enemy unconscious. Simplicius managed to frighten off the rest with a few handfuls of rocks, got away and shared his revelation with other Banishers."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The spell taints a number of points of Mana equal to the spell’s Potency. The spell can be cast on a Hallow, where it affects the first Mana drawn until its Potency in points has been withdrawn. Once a mage internalizes the Mana, the poisoned Mana stays inert until it’s transferred to another receptacle, expended on a spell or used on another action. When that happens, the Mana performs its normal functions, but each point spent also inflicts a point of lethal damage."
            },
            {
                "type": "paragraph",
                "text": "A Prime 5 version of this spell can be used to poison Mana to such an extent that it inflicts aggravated damage."
            }
        ],
        ...
        "RoteDescrizione": [
            {
                "type": "paragraph",
                "text": "Famous “cult awareness researcher” Isaiah Pickens conducts regular sermons at places he says are hotbeds of cult activity. He does the same thing for fellow Banishers when they bring him objects that stink of excess Mana. The theme of every sermon is that Satan has no real power and his promises and payments are always empty."
            },
            {
                "type": "paragraph",
                "text": "He says, “That rush you feel, exploring witchcraft and playing with the dark side can never profit you — Satan has nothing to give! Even when he looks like he’s giving you the power he has to take something away to keep the balance of his gifts — a balance of zero. Those are the wages of sin, my friends.” And, for mages who draw from Hallows and items he’s preached around, that turns out to be true."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneAlta": [
            {
                "type": "paragraph",
                "text": [
                    "The mage can scour another person’s Pattern just as she can scour her own, changing flesh and blood into Mana. This causes Resistant Damage to the target (see p. 124 of ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The mage must touch her target (with Prime 5, this spell can be cast at sensory range). The target experiences searing pain as flesh boils away into magical energy. Each success inflicts one point of lethal Resistant Damage and gives the caster one point of Mana."
            },
            {
                "type": "paragraph",
                "text": "If Scour Other’s Pattern is cast upon a mage, however, the target can reap one benefit from this attack. The mage can attempt to take the Mana freed by the attack into her pool. The target makes a reflexive Stamina + Gnosis roll. If this roll succeeds, the target mage adds one point of Mana to her pool per two successes, up to her usual maximum. The caster is thus denied these points."
            },
            {
                "type": "paragraph",
                "text": "This spell cannot be successfully cast more than once on the same target per scene. Use of the spell requires a degeneration roll for mages of Wisdom 4 or more (roll three dice)."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Each success siphons one Essence from the targeted spirit, ghost or locus. See Werewolf: The Forsaken for more information on loci."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Each success gives the mage one Mana and inflicts one point of Structure damage to the object, making it brittle. (This damage circumvents the object’s Durability.) Only one point of Mana may be gleaned per three points of Size (rounding down); mundane objects smaller than Size 3 simply do not have enough material substance and presence to hold a full point of Mana."
            },
            {
                "type": "paragraph",
                "text": "The caster can replenish his own Mana reserves with this spell only once every 24 hours. The frayed Mana from successive castings cannot be integrated into the mage’s Pattern during that time, although he could use the “Channel Mana” spell, p. 224, to divert it elsewhere."
            },
            {
                "type": "paragraph",
                "text": "Enchanted items cannot be siphoned with this spell."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "This effect works like “Dispel Magic,” p. 220, but the mage does not need to possess all the Arcana involved."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "One dot of the Hallow’s rating is diminished per success."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The total number of successes gained during the casting represents the amount of Mana that will be tainted when it is drawn from the Hallow."
            },
            {
                "type": "table",
                "headers": [
            ...
            },
            {
                "type": "paragraph",
                "text": [
                    "Tainted Mana is sluggish in the body of a mage, and responds more slowly when called upon. While a mage retains any tainted Mana in his pool, he can spend only one Mana per turn, regardless of his Gnosis rating. Additionally, tainted Mana cannot be used for Pattern Restoration (see p. 77 of ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
            ...
            {
                "type": "paragraph",
                "text": "Mages viewing a Hallow with Mage Sight may notice the Hallow has been tainted with a single success on a Composure + Occult roll. The simplest way to cleanse a Hallow of its taint is to simply draw out the tainted Mana, but mages theorize there must be other ways of accomplishing the cleansing."
            },
            {
                "type": "paragraph",
                "text": "Use of this rote is an act of hubris requiring a degeneration check for mages of Wisdom 4 or higher (roll three dice)."
            }
        ],
...
const primeFiveData = [
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "A phantasmal person appears to possess the same Mental and Social Attributes as the caster (or fewer, if he wishes it) and can speak if compelled to by the mage, but has no individual initiative and collapses into a lifeless heap if the willworker doesn’t actively pay attention to it."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The target number equals the dots of the Hallow. The Hallow immediately yields up its rating in Mana, which can be harvested through normal means (by performing an oblation, p. 77, or casting “Channel Mana,” p. 224)."
            },
            {
                "type": "paragraph",
                "text": "The effect lasts for one hour, but if it is made to last longer, the Hallow does not yield up more Mana until the same hour as its creation on each day for as long as the spell lasts. The spell uses the following Duration factors, but cannot be made to last indefinitely."
            },
            {
                "type": "table",
                "headers": [
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "A weak Gauntlet levies a –1 penalty on the spellcasting roll. Successes determine the Dead Zone’s radius or volume (the mage chooses which during casting)."
            },
            {
                "type": "table",
                "headers": [
            ...
            {
                "type": "paragraph",
                "text": "*Add an extra x2 radius or x2 volume per additional success"
            },
            {
                "type": "paragraph",
                "text": "While a mage can spend his own Mana within a dead zone, he cannot use the “Channel Mana” spell, p. XX, to draw them from another source."
            },
            {
                "type": "paragraph",
                "text": "Small animals, children and the elderly may sicken and even die in places devoid of a natural flow of Mana energies."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The caster cannot increase his pool beyond the maximum he can have (for example, an individual with a Strength 3 can only increase his Strength to 5 and cannot exceed the amount of Mana he can hold according to his Gnosis rating). Similar to the spell “Siphon Mana” (Prime •••••), successive castings against the same target within the same scene suffer a cumulative –2 dice penalty."
            },
            {
                "type": "paragraph",
                "text": "If an Attribute or Health is reduced to 0, the caster has the option of returning a portion of the siphoned energy to bring the Attribute or Health rating up to 1. Otherwise, the victim dies."
            },
            {
                "type": "paragraph",
                "text": "An Awakened target can attempt to resist through a contested roll: Willpower versus the caster’s successes. A Sleeper has no defense unless otherwise protected by a mage. Protective spells apply."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            ...
            {
                "type": "paragraph",
                "text": "Familiars, spirits and most other supernatural entities will not willingly enter an area of Scorched Earth, and even non-sapient entities will avoid the area instinctively."
            },
            {
                "type": "paragraph",
                "text": "Casting this spell is an act of hubris requiring a degeneration roll for mages of Wisdom 4 or higher (roll three dice)."
            }
        ],
        ...
        "RoteDescrizione": [
            {
                "type": "paragraph",
                "text": "Banishers create “Safe Houses,” the ultimate expression of their fear and hatred of magic, whenever possible. Banisher allies of the Sleeper variety frequently use such places as headquarters for their cults and sometimes as refuges from the terrors of the Fallen World."
            },
            {
                "type": "paragraph",
                "text": "This rote was first developed by the notorious Banisher named Elizabeth Reedy. Elizabeth worked as a web designer before her Awakening and has used her technical skills to spread instruction of how to cast this rote across the Internet. The information is disguised in the form of the eccentric ramblings of fantasy fansites and in mass email spamming."
            }
        ],
...
export { primeOneData, primeTwoData, primeThreeData, primeFourData, primeFiveData };
