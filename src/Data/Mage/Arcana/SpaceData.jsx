const spaceOneData = [
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "This sense is sometimes modified by the strength of the bond (the Storyteller might award a bonus for a strong bond, or levy a penalty for a weak one). If the sympathetic bond has been concealed (see 'Conceal Sympathy,' p. 234), this spell’s successes must exceed the disguise spell’s Potency."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The mage chooses a specific object as the target of this spell, such as a weapon, idol, or even a ballpoint pen. By means of this spell, no matter where a targeted object goes within the mage’s vicinity, she knows its movements. While this effect applies only within a mage’s sensory range, with Space 2 she can cast this as a sympathetic spell and track the item anywhere."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The spell extends the mage’s vision around him. As long as he can see (i.e., the area isn’t dark), he can perceive in 360 degrees with a reflexive Wits + Composure roll. It is almost impossible to surprise the mage by sneaking up from behind (a person would need to be well camouflaged, and the mage might need to be heavily distracted by something in another direction)."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "This sense is modified by the degree of the distortion/manipulation (the Storyteller might award a bonus for an extreme distortion or levy a penalty for a subtle one). See “Resonance,” pp. 277-280, for rules on scrutinizing magic with this spell."
            }
        ],
...
const spaceTwoData = [
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The target number depends on the “depth” of the Astral plane in which the beacon is set:"
            },
            {
                "type": "table",
                "headers": [
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "If the target is unwilling, he may resist with a reflexive contested Resolve + Gnosis roll. The effect lasts for one hour."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneAlta": [
            {
                "type": "paragraph",
                "text": "The mage can step through a nearby spatial doorway (such as one created with the 'Portal' spell, p. 238) to its point of destination. He can follow such a doorway only to its original terminus."
            },
            {
                "type": "paragraph",
                "text": "In other words, the mage using this spell has no choice but to go exactly where the previous spatial door went. This limitation can obviously prove to be quite problematic if the passage leads to, say, a room full of heavily armed men or an active volcano."
            }
        ],
        "Practice": "Ruling",
        "Action": "Instant",
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The mage suffers penalties based on distance as if he were scrying (below). Successes apply to the Duration factor (p. 118), which must equal or exceed the time elapsed since the door was opened. For example, the spell requires a Duration factor of four successes to open a portal that has been closed for 24 hours (with Space 3, four successes covers doors that were opened up to one month ago)."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "When performing this spell as an extended action, the caster usually sets out a map and draws on it. When this spell is performed as an instant spell, the caster can either look at or visualize a map and the target’s movements will appear on it. In all cases, the target’s current location lies at the end of this path."
            },
            {
                "type": "paragraph",
                "text": "This spell does not allow the caster to see what the target is doing. For that, the caster needs to cast Space 2 'Scrying,' to open a scrying window. This spell merely allows him to track the target’s location and movements, and, if Prime is used, to know just where he uses or encounters magic."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The spell watches a sympathetic connection (usually targeted after the use of Interconnections or similar spells) for “activity”, defined as the target being in the presence of, thinking about or otherwise acting on the relationship defined by the connection."
            },
            {
                "type": "paragraph",
                "text": "The strength of the sympathetic connection being targeted determines the number of successes required:"
            },
            {
                "type": "table",
                "headers": [
            ...
            {
                "type": "paragraph",
                "text": "On successful casting, the mage becomes aware when any activity occurs but does not know exactly what is occurring — for that; they must cast “Scrying”."
            },
            {
                "type": "paragraph",
                "text": "This spell is detectable by anyone using Spatial Awareness on the target."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The mage gains one point of armor per dot he possesses in the Space Arcanum. By spending one Mana, the Duration can be made to last for one day. Most mages cast such a shielding spell at the beginning of the day, as part of their morning rituals. Successes are used to combat attempts to dispel the shield."
            },
            {
                "type": "paragraph",
                "text": "Note that this magical armor applies against attempts to grapple the caster (both his Defense and Untouchable armor are subtracted from the grappler’s dice pool when he attempts to achieve a hold on the mage), but it does not protect against attempts by an opponent to overpower and/or inflict damage once he has managed to grapple the mage."
            }
        ],
...
const spaceThreeData = [
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The target gains one point of armor per dot the caster possesses in the Space Arcanum. By spending one Mana, the Duration can be made to last for one day."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Each success destroys one degree of sympathetic connection that a target holds for a single person, place or thing, as per the chart on pp. 114-115. For example, this spell can be cast upon a mage to erode the Intimate sympathetic connection he has to his best friend. It does not affect his mental or social feelings or interactions with his friend, but does make it harder for him to connect with that friend using sympathetic magic."
            },
            {
                "type": "paragraph",
                "text": "A living creature unconsciously resists this spell’s attempts to alter its connections with its Composure. These threads can be re-established normally over time in the usual fashion (i.e., through physical contact or even repeated mental and/or emotional association)."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Aside from the convenience of carrying the two-in-one item, this spell allows both objects to benefit equally from any further curses, defenses or enhancements subsequently woven into the combined device."
            },
            {
                "type": "paragraph",
                "text": "Additional castings of the spell allow for additional items to be added to the mix. Only one item exists in the Material Realm; all additional forms also go to the pocket dimension when not in use."
            },
            {
                "type": "paragraph",
                "text": "Switching an object between forms evokes Disbelief in Sleeper witnesses."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            ...
            {
                "type": "paragraph",
                "text": "Upon successful completion of the spell, the recipient gains a “Described” connection to the same thing as the connection being duplicated, which lasts for the Duration of the spell. Most casters then cast “New Threads” to increase the level of the new connection on a Lasting basis."
            }
        ],
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": [
                    "Each success adds an amount equal to the containers’ original volume to the total, so one success doubles its volume, two successes triples it, etc. When the spell expires, any contents of the container in excess of the original volume are expelled to the outside of the container, starting with what was at the “bottom.” Anyone standing near the container may be subject to Knockdown (see “Knockdown,” p. 168 in the ",
                    {
                        "type": "bold",
                        "text": "World of Darkness Rulebook"
                    },
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": [
                    "The mage can cast this spell while standing inside any building with which she has at least an Intimate sympathetic connection (see ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    ", p. 114), such as her home, her sanctum or a building she designed or built herself. If she succeeds, the mage is aware of anything that happens in the building. She can see any movement and recognize faces, but cannot see close enough to ascertain fine details (for example, written text on a letter or in a book). The mage can eavesdrop on conversations, but can only listen to one conversation at a time, unless she uses the Mind 3 “Multi-Tasking” spell (see ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    ", p. 211) in a combined casting with this spell."
                ]
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The item’s range of movement depends on the Mana spent on the original enchantment:"
            },
            {
                "type": "table",
                "headers": [
            ...
            {
                "type": "paragraph",
                "text": "The target number is increased by five successes per point of Mana spent."
            },
            {
                "type": "paragraph",
                "text": "The teleportation effect evokes Disbelief in Sleeper witnesses."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneAlta": [
            {
                "type": "paragraph",
                "text": [
                    "This spell enchants an item so that it returns reliably to its owner’s possession, even when the item’s present location is unknown to her. The item moves of its own volition through a gateway in space, as if by 'Apportation' (see ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The Apportation effect triggers when the item has been out of the owner’s possession for a period of time determined by the spell’s Potency."
            },
            {
                "type": "table",
                "headers": [
            ...
            {
                "type": "paragraph",
                "text": "Disbelief is triggered in Sleepers who witness the Apportation effect."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneAlta": [
            {
                "type": "paragraph",
                "text": "This spell creates a spatial warp through which the caster (and anyone else who uses it) can move from one point in Creation to another without traversing the intervening space. The mage steps forward and “vanishes” from one place to arrive at another, “appearing” instantaneously. For those who hold to such tales, it is believed that many Awakened survived the fall of Atlantis through use of this spell, opening portals in space to flee to distant sanctums to lick their wounds."
            },
            {
                "type": "paragraph",
                "text": "Naturally, the wise mage takes some time to scry the layout of the place to which he teleports (even if it is familiar to him), just to be certain that no unwelcome surprises await."
            }
        ],
        "Practice": "Weaving",
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The target number is determined by the caster’s sympathetic connection to the destination."
            },
            {
                "type": "paragraph",
                "text": "One person of Size 5 or less can pass through the portal per turn (larger people can spend two turns squeezing through). Each success added to the target number allows the mage to widen the portal so that one additional person can pass through per turn."
            },
            {
                "type": "paragraph",
                "text": "A Portal’s entrance and exit can be placed anywhere that allows a person of Size 5 or less enough freedom of movement to enter or exit it in a single turn. Most Portals are used like doors, with the entrance and exit perpendicular to the ground, but the caster can be creative. The entrance and exit, however, must mirror each other on the same plane. For example, the entrance could be placed below a falling person, but the exit cannot be set to eject the falling person sideways. It must face down (as its opposite faces up)."
            },
            {
                "type": "paragraph",
                "text": [
                    "Note that, without applying the “Portal Key” spell, p. 240, the caster cannot limit who can use the Portal. Nearby enemies can attempt to step through it, too. A person can be thrown through a portal forcibly. A hold must first be achieved in a grapple action (see “Unarmed Combat,” pp. 157-159 of the ",
                    {
                        "type": "bold",
                        "text": "World of Darkness Rulebook"
                    },
                    "), after which the grappler can shove the person through the Portal as an overpower maneuver."
                ]
            },
            {
                "type": "paragraph",
                "text": "With Space 4, this spell can be cast with a prolonged Duration. With Space 5, it can be cast as an instant action (and with advanced prolonged Duration factors)."
            },
            {
                "type": "paragraph",
                "text": "Cast conjunctionally with Spirit 4, the portal can lead to locations on the other side of the Gauntlet. See the “Road Master” spell."
            }
        ],
        ...
        "DescrizioneAlta": [
            {
                "type": "paragraph",
                "text": [
                    "Similar to the “Ban” spell (see p. 237 of ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    ") except the mage creates a small area that moves with the caster in which the specified phenomenon may not enter."
                ]
            }
        ],
        "Practice": "Weaving",
        ...
        "DescrizioneAlta": [
            {
                "type": "paragraph",
                "text": [
                    "This spell is an exception to the normal spell-control rules (see “spell control”, ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    ", p. 128), allowing the mage to add a “Wall” to a pre-existing Ward. He can also combine this spell with a Ward during casting (see “Combining Spell”, ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
            ...
            },
            {
                "type": "paragraph",
                "text": [
                    "When combined with another spell (which can be provided by a separate caster), this gives the Ward offensive capabilities. For instance, it could be combined with “Evil Eye” (",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    ", p. 151) to cause those who passed through it to suffer penalties per that spell."
                ]
            },
            {
                "type": "paragraph",
                "text": "A Ward altered in this manner uses the casting pool for the supplementary spell when it activates. The Wall has one charge of this spell, but additional charges may be applied without additional rolls if done at the time of casting, at a cost of one Mana each (in addition to the normal Mana cost for that spell). These additional charges do not go off all at once; they activate one at a time, as people come in contact with the Ward."
            },
            {
                "type": "paragraph",
                "text": "Homever this kind of warding is very fragile. Dispelling either the Ward of the encased spell will eliminate both, with the encased spell having an effective Potency equal to the remaining charges."
            },
            {
                "type": "paragraph",
                "text": [
                    {
                        "type": "italic",
                        "text": "Exemple: Pardy has cast Walls of the Labyrinth with four charges of “Celestial Fire” (Prime 4 version) built in. This cost him a total of four mana (one for the first casting, and three more for the additional charges). While his Ward has a Potency of 6, the Walls portion has only an effective potency of 4."
                    }
                ]
            },
            {
...
const spaceFourData = [
    {
        ...
        "DescrizioneAlta": [
            {
                "type": "paragraph",
                "text": [
                    "The mage can cast up to three portals (see ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    ", p. 238), each to a different destination. As with 'Portal,' the more familiar the casting mage is with each location to which he creates a doorway, the easier it is to successfully cast the spell."
                ]
            }
        ],
        "Practice": "Weaving",
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The target number is determined by the caster’s sympathetic connection to the most difficult destination to connect to."
            },
            {
                "type": "table",
                "headers": [
            ...
            {
                "type": "paragraph",
                "text": "This spell is an all-or-nothing proposition, with the total number of successes determined by the least-known destination. For example, if the caster is acquainted with two of the destinations but has only encountered the third, he must accrue 12 successes to cast the spell. If he rolls eight successes, and is then halted, the spell doesn’t take effect."
            },
            {
                "type": "paragraph",
                "text": "Each portal of the “Arcade” spell can accommodate one person of Size 5 or less per turn (larger people can spend two turns squeezing through). Each success added to the target number allows the mage to widen all portals so that one additional person can pass through per turn."
            },
            {
                "type": "paragraph",
                "text": [
                    "All “Arcade” doorway entrances and exits can be placed anywhere that allows a person of Size 5 or less enough freedom of movement to enter or exit in a single turn. Note that, without applying the “Portal Key” spell described in ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    " (p. 240), the caster cannot limit who can use the “Arcade” doorways. Nearby enemies can attempt to step through, too. Additionally, people can be forcibly thrown into any of the doorways as long as a hold is first achieved in a grapple action (see “Unarmed Combat,” p. 157 of the ",
                    {
                        "type": "bold",
                        "text": "World of Darkness Rulebook"
                    },
                    "), after which the grappler can shove the person through a doorway as an overpower maneuver."
                ]
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": [
                    "Success enables a willworker to create an identical duplicate of herself on the opposite side of the Gauntlet from her present location. Both copies of the mage must perform exactly the same actions at all times (as per the “Co-Location” spell; ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    ", p. 239), though adding Mind 3 to the casting removes this restriction. With a reflexive action, the mage may switch places with her duplicate from turn to turn. As with Co-Location, only the willworker’s real self may be targeted by attacks, as the duplicates possess no substance."
                ]
            },
            {
                "type": "paragraph",
                "text": "With Space 5, this spell may be cast with prolonged Duration."
            }
        ],
        ...
        "RoteDescrizione": [
            {
                "type": "paragraph",
                "text": "In late June of 1967, a Mastigos Arrow by the name of Anaïs happened upon the scene of a Shadow Realm summoning gone horribly awry. The three Guardians of the Veil responsible for the act were already unconscious by the time the Warlock arrived and she knew that time was of the essence. The spirit’s trail moved back and forth through the Gauntlet and Anaïs, also a Disciple of the Spirit Arcanum, formulated this spell on the spot as a means of keeping track of it, no matter how it attempted to flee its pursuer."
            },
            {
                "type": "paragraph",
                "text": "Later, when the entity was contained, the mess cleaned up, and the three Guardians properly chastised for their ill-conceived plan, Anaïs codified the spell into a rote at the request of the Hierarch, who offered it as a good-faith gesture to a number of Consilii elsewhere in the world."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Successful casting of this spell enables a mage to look within the metaphysical fabric of the local Gauntlet."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Unlike the normal rules for spell control (see “Spell Control,” p. 128), the mage can cast this on a pre-existing portal of his own or he can combine it with the creation of a portal."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The item’s Size cannot exceed the pocket universe’s own Size. The Pocket Realm must be pre-existing or cast in combination with this spell."
            },
            {
                "type": "paragraph",
                "text": [
                    "The effect of this spell is lasting, but if the Pocket Realm spell expires, the item appears in space exactly where it was before being placed into the Pocket Realm. It and anyone (or anything) within the same space in which the reappearing item arrives must contend with Knockdown (see “Knockdown,” p. 168 of the ",
                    {
                        "type": "bold",
                        "text": "World of Darkness Rulebook"
                    },
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": [
                    "With one success, the spell effects a five-cubic yard area, and can affect a greater area with each additional success; see the “Area-Affecting” chart on p. 118 of ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    ". This area is sectioned off into cells by the caster; he can create one division per dot of his Intelligence."
                ]
            },
            {
                "type": "paragraph",
                "text": "Fortunately, this effect cannot cut objects or living things into pieces when it sections them off into cells. It may, however, wreak indirect havoc with people and objects outside of the spell’s area, as they no longer have any spatial relationship with objects inside the spell’s area. This might cause buildings to lean (but not collapse), vehicles to make strange detours and other chaotic events (most of which are left to player cleverness and Storyteller discretion)."
            },
            {
                "type": "paragraph",
                "text": "A target can leave his or her cell by stepping into another, randomly selected cell, even if it is not geographically contiguous. The caster can designate cells in three dimensions, so that a target may step from ground level to a cell in the air. He will then fall, but he might not suffer injury: as he falls from his cell into another, his destination is again randomly determined; if the new cell is on the ground level, he’ll only suffer a short fall of a few feet at best. The targets’ movements are not hindered, so he might move through several cells of space in a single turn."
            },
            {
                "type": "paragraph",
                "text": "In addition, a cell’s orientation is randomly shifted, so that a person running forward might suddenly find himself in a cell in which he is running in the opposite or a sideways direction. He can control his orientation and movement within a cell, but has no control over the orientation of his randomly chosen destination cell."
            },
            {
                "type": "paragraph",
                "text": "In all cases, the Storyteller determines where each cell leads, either randomly (roll dice or use some other method based on the number of cells) or to fit the course of the story."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneAlta": [
            ...
            {
                "type": "paragraph",
                "text": "As with creating a Portal, the wise mage first scrys his destination. Sometimes there is no time for such caution, however, and the willworker must simply hope that wherever he’s going is better than where he is."
            }
        ],
        "Practice": "Patterning",
        "Action": "Instant",
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The mage must have a sympathetic connection to his destination. The weaker the sympathetic connection, the more penalties his spellcasting roll suffers (see “Sympathetic Spells,” p. 114)."
            },
            {
                "type": "paragraph",
                "text": "A location that he is currently scrying is a Known sympathetic connection (–4). He can teleport himself, his familiar (if he has one) and anything he wears or carries (provided it’s not too large; he needs one extra success per Size rating above 3). Cast conjunctionally with Spirit 4, this spell can teleport the user across the Gauntlet."
            }
        ],
...
const spaceFiveData = [
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The target number is one success per overlapping location. Navigating through these stacked locations can be confusing, especially when trying to pick up one object that rests in the same space as three others. A reflexive Intelligence + Investigation roll must be made for a person to interact with the intended space. Needless to say, such an Escheresque locale invokes Sleeper Disbelief."
            },
            {
                "type": "paragraph",
                "text": "The caster can extend the Duration factors for this spell using the advanced prolonged factors; see p. 119."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneAlta": [
            {
                "type": "paragraph",
                "text": "In many stories, the abodes of wizards are hidden from the eyes of ordinary people and can be accessed only through special paths unknown to most. This spell enables a mage to create just such a sanctum, spinning complex barriers of space to guard against unwanted intrusion. In effect, the chosen area exists only partway inside the conventional concept of a place, hidden within a convoluted knot of twisted paths through which a would-be visitor must travel in very specific ways."
            },
            {
                "type": "paragraph",
                "text": [
                    "Thus, while logic might dictate that walking straight for a mile from the north bank of the river gets one to a destination, in practice, 10 miles of twists and turns, which seem to lead through much more terrain than could be possible, intervene. Taking any wrong turns waylays the journey, meaning that the traveler must find his way out (by no means a guarantee) and start over. Therefore, unless an individual is ",
                    {
                        "type": "italic",
                        "text": "extremely"
                    },
                    " lucky, he must know the way to reach his intended destination."
                ]
            }
        ],
        "Practice": "Making",
    ...
    },
    {
        ...
        "DescrizioneAlta": [
            {
                "type": "paragraph",
                "text": "On occasion, the most effective way to deal with a foe is to break her mind. Some mages favor psychic intrusions, others use threats, while still others favor old-fashioned torture. A willworker armed with this magic need not resort to such indelicate methods. The spell banishes a person into a pocket of looped space in which the victim sees herself reflected, as though in some especially deranged funhouse."
            },
            {
                "type": "paragraph",
                "text": "Images created through both the Forces and Time Arcana allow her to see herself in various states of disarray: maddened, starving, dying of self-inflicted wounds, and the like. No matter where she flees, she hears her own voice, screaming at her, and hears what she believes to be her own desperate thoughts, echoing back to her from across gulfs of space and time. Implanted suggestions and false memories make moments feel like days."
            },
            {
                "type": "paragraph",
                "text": "Needless to say, use of this magic can easily lead a mage astray from the path of Wisdom."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Upon casting this spell, the Arrow is capable of simply disregarding an enemy’s physical armor (that is, armor not granted by a spell of the Practice of Shielding or other directly supernatural form of protection, upon which this spell has no effect), irrespective of its type, provided he himself is wielding a weapon made of inert matter — the weapon simply passes through the armor as though it wasn’t there."
            },
            {
                "type": "paragraph",
                "text": "This is not an armor-piercing effect. If both the weapon and the armor in question are mundane, non-precious materials, Matter 3 is used in the casting of the spell. If the weapon and/or armor in question are made of mundane precious materials, matter 4 is instead used. And, if the wapon and/or armor in question are made of extraordinary materials, matter 5 is used."
            },
            {
                "type": "paragraph",
                "text": "Note that, for the purposes of this spell, a suit of armor that is also an Enhanced or Imbued Item defaults to whatever sort of material of which it is actually composed, while an Artifact — being of Supernal origin — counts as extraordinary material."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "One subject per Target factor can be affected. If even a single target succeeds in the contested resistance roll, none of the targets are co-located."
            },
            {
                "type": "paragraph",
                "text": [
                    "The spell inflicts one point of aggravated damage per success. Once the targets contact one another, they are immediately repulsed (see “Knockdown,” p. 168 of the ",
                    {
                        "type": "bold",
                        "text": "World of Darkness Rulebook"
                    },
                    "). They do not remain fused."
                ]
            }
        ],
...
export { spaceOneData, spaceTwoData, spaceThreeData, spaceFourData, spaceFiveData };
