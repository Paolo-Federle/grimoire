const spiritOneData = [
        ...
        "DescrizioneMiddle": [
            ...
            },
            {
                ...
                "text": [
                    {
                        "type": "italic",
                        "text": "Example: Harbinger has coaxed the spirit of his Chevy convertible to help him maneuver a hairpin curve coming up in the road. He gets three successes on the casting, which gives him +3 dice on a single roll for controlling the car."
                    }
                ]
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "If a spirit has the ability to hide and wishes to do so, it may use such a power and pit its own successes directly against this spell’s successes (the spell’s Potency) in an attempt to remain hidden."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "See “Resonance,” pp. 277-280, for rules on scrutinizing magic with this spell. The caster gains a +1 dice bonus (regardless of the number of casting success) on perception and scrutiny rolls to sense spirit Numina and werewolf Gifts and rituals, as well as loci."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "This spell’s successes must exceed the Potency of any power (if any) used to conceal the spirit."
            }
        ],
...
const spiritTwoData = [
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Each success of Potency assigned to this spell reduces an item’s equipment bonus by one, to a minimum of zero. All other qualities of the item, however, remain unaffected."
            }
        ],
    ...
    },
    {
        ...
        "RoteDescrizione": [
            {
                "type": "paragraph",
                "text": "The mage dances a bembe, and he must be accompanied by ritual drums. Often, other santeros dance with him, and this ritual usually follows an ebbó. The mage continues to dance until his mind and body are overwhelmed by the exertion of the bembe and the drums, and the orisha enters him. In game terms, the player must accumulate a number of successes equal to the mage’s Stamina + Resolve, and if the character possesses the Iron Stamina Merit, those dots are also added to the target number of successes. Each roll equates one minute of dancing, and the player can only make a number of rolls equal to the mage’s Stamina + Athletics (after which the mage is too exhausted to dance properly)."
            },
            {
                "type": "paragraph",
                "text": "Once the player has accumulated the proper number of successes, the orisha possesses the mage. At this point, the mage begins to behave like the orisha in question. Osain limps and leans on a walking stick. Changó is lusty and belligerent, while Oshún is flirtatious. The orishas demand their tribute — many of them try to take bites of the raw flesh of the ritual sacrifice, and all must have their special foods and items (see Foci), or else they depart and the spell ends."
            },
            {
                "type": "paragraph",
                "text": "While the mage is being possessed, the orisha speaks and acts through him. The other santeros present can ask the orisha for advice or intercession. If any are Awakened, they can ask the orisha for magical understanding (this can be used to justify an increase in Gnosis or Arcana ratings), even learning rotes from the orisha. Occasionally, a mage channels one of the warlike orishas (Changó, Oggún, Elegguá, Ochosi, or Oyá) to help him fight in an upcoming battle."
            },
            {
                "type": "paragraph",
                "text": "The game effects of this possession vary depending on the Storyteller’s decision of what the orishas are and what role they fulfill in the chronicle. In general, this spell allows an effect similar to Coaxing the Spirits (Spirit 1), but with farther-reaching effects. The mage receives a number of bonus dice to a given task based on how satisfied the orisha is with the sacrifice, the items offered to it, and the bembe the mage performed (the Storyteller should take all of this into consideration and then make a roll for the player, probably Manipulation + Socialize, and use the successes for the bonus dice). These dice can be used on any roll that the task involves, but the player does not know how many he has to work with (just as the mage doesn’t know how far the orisha’s influence will carry him). At some point, the capricious orisha’s attention fades, and the mage is on his own again."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "A curious spirit usually answers a general call or personal summons, but a reflexive and contested roll is made if it does not wish to respond. This spell does not allow the mage to command the spirit or force it to manifest (see the Spirit 3 “Control Spirit” spell, p. 248). The summoned spirit must remain near the summoning mage for the rest of the scene, unless the caster allows it to leave."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Each success modifies the local Gauntlet’s Strength by one point in either direction up or down by a limit equal to the Hallow’s rating, although at this level the Gauntlet’s Strength cannot be reduced to zero. With the Spirit 5 “Control Gauntlet” spell, p. 254, the Gauntlet can be made to fade, creating a Verge where any being may step over instantly without using a spell."
            }
        ],
        ...
        "DescrizioneAlta": [
            {
                "type": "paragraph",
                "text": [
                    "Every spirit has a ban that prohibits the spirit from certain types of behavior or activities (see p. 320 of ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
    ...
    },
    {
        ...
        "DescrizioneAlta": [
            {
                "type": "paragraph",
                "text": "The mage engages in a transfer of ephemeral energy with a willing spirit of Rank 3 or higher. The spirit sacrifices a Willpower dot on the willworker’s behalf, which the willworker then uses to relinquish control of an indefinite duration spell. The Willpower point cannot be used for any other purpose."
            },
            {
                "type": "paragraph",
                "text": "Before casting the spell the willworker must make contact with the spirit; “Spirit Pact” does not call or summon the entity."
            }
        ],
        "Practice": "Ruling",
        "Action": "Instant",
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The willworker subtracts one die per dot she possesses in the Spirit Arcanum from all non-attack-based Numina (such as 'Possession' or 'Terrify') targeting her. By spending one point of Mana, the Duration can be made to last for one day."
            }
        ],
...
const spiritThreeData = [
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "A minimum of one success is necessary to open the road where the Gauntlet is weakest; a dramatic failure sucks the caster himself into a gaping rift that closes immediately, depositing the luckless caster in one of four places (see above) with no immediate egress."
            },
            {
                "type": "paragraph",
                "text": [
                    "The caster’s intent is more often to force another individual through the opening, in which case the caster must successfully grapple the victim and use an overpower maneuver to cast him into the road. (See the Spirit 3 spell “Spirit Road,” ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    ", p. 251, for more details.)"
                ]
            },
            {
                "type": "paragraph",
                "text": "Naturally, if the road opens onto space or the Abyss, the person who crosses onto the road usually meets his death unless he is prepared to withstand the rigors of those places."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Complex commands require multiple successes. For example, 'Go to the Contessa’s mansion and steal the Borgia Diamond!' might require three successes. If the spirit has not completed the action by the time the Duration expires, it does not have to finish the job."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The target number equals the ghost or spirit’s Willpower. The ghost or spirit gets a contested roll using Power + Resistance. If the possession or haunting is caused by an Awakened spell (using 'Spirit Possession,' p. 253, 'Bind Spirit,' p. 251, or the Death 4 'Haunting' spell, p. 143), the mage must dispel it instead."
            },
            {
                "type": "paragraph",
                "text": "Note that in the case of the Ridden (see Werewolf: The Forsaken, pp. 242-244), the mage can drive the spirit out of a Spirit-Urged host but not out of the Spirit-Claimed. (He can, however, use the Spirit 5 'Shape Spirit' spell, p. 255, to separate the merged spirits)."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The spirit must be manifested in the material realm or exist within Twilight (in which case the mage must be able to see it, using a spell such as 'Gossamer Touch,' p. 247). The caster must have Spirit 4 to attack a spirit across the Gauntlet (and his spellcasting dice pool is penalized by the Gauntlet’s Strength). One point of lethal damage is inflicted per success."
            },
            {
                "type": "paragraph",
                "text": "With Spirit 4, the damage may be made aggravated with the expenditure of one Mana."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The mage affects all targets of the same species within a defined area based on the number of successes scored. The spell must affect at least 2 targets or a swarm to work at all."
            },
            {
                "type": "table",
                "headers": [
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": [
                    "When successfully cast, this spell temporarily negates the influence of Shadow upon a physical location within the mage’s sensory range. Effectively, the resonance of the area (see ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
                    ", p. 277) becomes perfectly neutral, exerting no influence over Sleepers, one way or the other, and making the place seem spiritually inert. Mages can discern this unusual “dead air” through any of the normal means of perceiving or scrutinizing resonance, and even Sleepers sometimes get a sense that such a place is somehow off; like something brand-new from the store, it has no individual character."
                ]
            },
            {
                "type": "paragraph",
                "text": "Note that this rote has no impact upon Twilight, the Gauntlet, or the powers of spirits (or others in the Shadow Realm) to interact with the material world."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The mage gains one point of armor per dot he possesses in the Spirit Arcanum. By spending one Mana, the Duration can be made to last for one day. This armor works against only spirit powers, such as Numina and werewolf Gifts and rituals."
            },
            {
                "type": "paragraph",
                "text": "A Numinous Shield requires one Mana each time it contends with an incoming power. If the mage does not (or cannot) allocate the Mana, the shield provides no armor against the attacking power, although the shield remains until its Duration expires, so it can be activated later. Among other things, this spell allows a mage to use a Numinous Shield selectively, blocking hostile powers but allowing friendly powers through. Mages often invest their shields with charges, spending Mana during casting so that each charge already stores its own energy."
            },
            {
                "type": "paragraph",
                "text": [
                    "In addition, the mage can use a counterspell to prevent a spirit power from taking effect. See 'Counterspell' (",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "During the spell’s Duration, the mage can reflexively reach across the Gauntlet as he desires. He must have some means of seeing what he interacts with (such as the “Peer Across the Gauntlet” spell, p. 247), or he acts blindly."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The target number is one success per week the soul has been gone, but the spell’s effect is lasting. If the stolen soul has been attached to a new body, the mage must first use the Fate 4 “Destroy Bindings” spell, p. 156, to detach it before he can restore it to its rightful owner."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "An awakened object begins as a Rank 1 spirit (see pp. 317-318), but can grow more powerful over time. It can be used to affect Twilight beings, and can be coaxed into using its Numina for the mage’s benefit. Unless it grows to become at least rank 3, it acts only in accordance with its simple nature and does not usually do anything that is not directly related to its Influence. A baseball bat wants to be used to hit things and a bomb shelter wants to protect people."
            },
            {
                "type": "paragraph",
                "text": "An object can be interviewed about its former owner, although its knowledge may be limited to only those times it was actually used for its purpose (a knife used to cut, a hammer to drive nails)."
            },
            {
                "type": "paragraph",
                "text": "A roused object has an ephemeral presence in Twilight. If it is destroyed in the material world, its ephemeral presence is thrust across the Gauntlet into the Shadow Realm, where it continues to linger for a while before it goes dormant again."
            },
            {
                "type": "paragraph",
                "text": "Most mages assign extra Duration factors to castings, giving roused spirits time to grow in Rank."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The target number is equal to the local Gauntlet’s Strength (p. 282; minimum one success even with a weak Gauntlet). A dramatic failure on the casting means the mage may not attempt to create a Spirit Road again for another day (24 hours), which may leave him in a precarious position if he’s currently in the Shadow Realm trying to get back to the material realm (although he may be brought across by another mage’s spell). When stepping from the material realm into the Shadow Realm, the mage appears in the Shadow Realm location contiguous with the place he just left in the material realm. One person or spirit of Size 5 or less can walk the road per turn (larger beings can spend two turns walking it). Each success added to the target number allows the mage to widen the road so that one additional person can walk it per turn. The road remains for one hour."
            },
            {
                "type": "paragraph",
                "text": [
                    "Note that the caster cannot limit who can use the road; nearby enemies can attempt to walk it. A person can be thrown forcibly through the Gauntlet onto the road. He must first be grabbed in a grapple action (see “Unarmed Combat,” pp. 157-159 of the ",
                    {
                        "type": "bold",
                        "text": "World of Darkness Rulebook"
                    },
                    "), after which the grappler can shove him onto the road as an overpower maneuver."
                ]
            },
            {
                "type": "paragraph",
                "text": "With Spirit 4, this spell can be cast with a prolonged Duration. With Spirit 5, it can be cast as an instant action (and with advanced prolonged Duration factors)."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The willworker must be physically present at the site of the Verge or other “impossible space” that contains or encompasses the cryptid’s personal domain in order to cast this spell. Summon Cryptid may not be cast at sympathetic range, even if the mage otherwise possesses a sympathetic connection to the creature that she is attempting to summon."
            },
            {
                "type": "paragraph",
                "text": "Success in casting this spell summons a cryptid out of its hiding place and compels it to present itself before the caster. The creature may or may not be peaceful; the spell offers no protections of its own against a hostile cryptid. A cryptid may willingly forego its roll to contest this spell if it actually desires to make contact (out of curiosity, loneliness, or even hunger)."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The spirit called is generally unknown, and is drawn from the local area Shadow Realm’s past and future (unless the mage uses Space 2 to extend his senses). The time period by which the spirit is called is also unknown – it may be summoned from the recent future or the distant past."
            },
            {
                "type": "paragraph",
                "text": "The mood of the spirit is often confused and maddened, though usually the dizzying effect upon the spirit keeps it from being outright hostile. That being said, the spell does not provide any kind of protection against the spirit; if it chooses to bring harm in some way to the participants, the spell offers no bulwarks against such an action."
            },
            {
                "type": "paragraph",
                "text": "The spirit summoned remains near the mage for the spell’s Duration, unless the sorcerer allows it to leave."
            }
        ],
...
const spiritFourData = [
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "By channeling a point of Mana into a spirit, a mage may use one of its Numina or its Influences to achieve the desired result. This does not constitute the spirit’s action for the turn, and the dice pool for this spell is penalized by the spirit’s rank. Using a Numen or Influence in this way does not generate Paradox for the mage, even if the casting of this spell does."
            },
            {
                "type": "paragraph",
                "text": "Note that spirits almost invariably resent having this sort of magic cast upon them; it is, in a very real way, a violation of the spirit’s personal sovereignty, as the mage reaches into the entity’s fundamental nature and, metaphysically speaking, starts pushing buttons to achieve the desired result."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The target number is one success per Rank of the spirit."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The spirit must be bound into a material object. The spell’s target number equals the spirit’s Rank."
            },
            {
                "type": "paragraph",
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The ephemeral demon has the following traits: Rank 1; Attributes: Power 2, Finesse 2, Resistance 2; Essence: 10 (10 max); Influence: Sin 2 (choose one Vice, derangement or Flaw); Numina: Materialize, Possession."
            },
            {
                "type": "paragraph",
                "text": "Each additional success added to the target number provides one of the following benefits (choose which it is as the target number is determined, before casting commences):"
            },
            {
                "type": "list",
                "items": [
            ...
            {
                "type": "paragraph",
                "text": "The demon’s ephemeral form remains for one hour."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "See “Familiar Pact,” p. 249. The subject pays the Merit cost. This spell uses the advanced prolonged Duration factors. The familiar bond cannot be forced onto a mage and a spirit; both parties must be willing."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            ...
            {
                "type": "paragraph",
                "text": "The mage determines when and how each person experiences the effects of the spell. He can also spend extra levels of Potency to modify an additional roll for 1 set of allies or 1 set of enemies within the spell’s area of effect and duration."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Any object can serve as a Medicine Bag (it doesn’t even have to be a bag — it could be a rock or a knife), but those made from organic materials (leather, bone, plant fiber) are best. Plastics and metals impose a –1 dice penalty on the casting. The target number is one success per point of Essence the bag can hold, up to a maximum equal to the caster’s Gnosis + Spirit."
            },
            {
                "type": "paragraph",
                "text": "Note that the bag does not have any Essence points until some are placed in it. Any mage can use the Medicine Bag by casting the 'Sacramental Chain' spell, below, using it to store Essence or take it out of the bag."
            }
        ],
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": [
                    "This does not work like summoning a spirit normally does (p. 249, ",
                    {
                        "type": "bold",
                        "text": "Mage: The Awakening"
                    },
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The mage can approve who can walk his Spirit Roads. This is an ability he simply has. He does not need to cast this spell to have power over any Spirit Road he creates."
            },
            {
                "type": "paragraph",
                "text": "He does cast this spell to 'step sideways' across the Gauntlet without the need for a Spirit Road. Doing so costs one Mana and the roll is modified by the Gauntlet’s Strength."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "One Essence point is channeled per success."
            },
            {
                "type": "paragraph",
                "text": "With Prime 4, the caster can convert the Essence into Mana for his own use or channel it to another mage or source that can hold it."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The target number is one success per Rank of the spirit. Undertaking this spell with an indefinite Duration (using Spirit 5) may provoke the everlasting enmity of an unwilling spirit that is bound to duty."
            }
        ],
    ...
    },
    {
        ...
        "RoteDescrizione": [
            {
                "type": "paragraph",
                "text": "This spell works like the Forces spell “Fiery Transformation,” save that instead of turning the caster into a creature of fire, it allows the caster to turn his physical body into spiritual ephemera. Unlike with the spell “Spirit Road” or similar magics, this is not simply transferring the body into Twilight or Shadow. This actually changes the form into spiritual essence."
            },
            {
                "type": "paragraph",
                "text": "At Life •••••, this spell can be used on other physical creatures by touch, and was most often used by Gaolers to transform Abyssal intrusions with physical bodies into spiritual entities in order to imprison them within the Codex."
            }
        ],
...
const spiritFiveData = [
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The target number of successes is determined as follows. The base is 10 successes. Add one success for every point of the Hallow’s rating below five (so a one-dot Hallow adds four successes to the required total). Add one success if the resonance of the Hallow is directly opposed to the Realm that the mage is trying to reach (Storyteller’s discretion). Add one success if the character is trying to call on a specific dragon. Add one success if the dragon in question is unlikely to be found in the Realm that the mage is trying to reach (again, Storyteller’s discretion)."
            },
            {
                "type": "paragraph",
                "text": "This spell costs 10 Mana to cast. The mage can draw the Mana from the Hallow, from his own pool, or he can add any Mana he does not wish to pay as successes to the target number."
            },
            {
                "type": "paragraph",
                "text": "If the spell succeeds, the Hallow splits open and a dragon appears. Thus far, no dragon thus summoned has ever attacked the summoner, though Llana maintains that it could happen if the spell were cast improperly. The dragon can give the character information about whatever topic she might desire, especially news and descriptions of the Supernal Realms, new rotes, or weaknesses and powers of Abyssal creatures. The dragon always tells the cast to “find the World Dragon,” however."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The base target number for the extended roll is four."
            },
            {
                "type": "paragraph",
                "text": "Each point of dice penalty to the Spirit Arcanum increases the target number by one; each point of bonus decreases the target number by one."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "If creating a spirit, successes buy dots of Rank, Attributes, Influence, and Numina for the being on a one-for-one basis. Similarly, changing a spirit (adding to, altering or subtracting from its Attributes) requires the mage to devote one success per dot to the trait to be added or changed. A mage cannot create a spirit of a greater Rank than the lesser of his Spirit Arcanum or Gnosis. Nor can he advance an extant spirit beyond such a degree or alter one of a Rank greater than the lesser of his Spirit Arcanum or Gnosis."
            },
            {
                "type": "paragraph",
                "text": "Example: Nine Jade Thunder creates a spirit. Since she creates one from scratch, rather than altering an existing spirit, she does not have to worry about it contesting her efforts. She decides to make a tree spirit for her garden sanctum, and wants it to have the following traits:"
            },
            {
                "type": "paragraph",
                "text": [
                    ...
                    "Influence: Wood 3 (three successes) Numina: Wilds Sense (one success) The total target number for the spell is 16 successes. She wants her special creation to last for more than one hour, so she increases the Duration to indefinite, adding six successes to the target number for a total of 22."
                ]
            },
            {
                "type": "paragraph",
                "text": "The mage must be familiar with the powers with which he works. That is, he must have studied a spirit who already has those powers before he can imbue them into a spirit. At the Storyteller’s discretion, an occult library might hold enough information to allow a mage an Intelligence + Academics roll to understand the forces before he begins casting."
            },
            {
                "type": "paragraph",
                "text": "When the spell’s Duration expires, the spirit ceases to exist (if it was created) or reverts back to its natural state (if it was modified). Note that familiars cannot be affected by this spell."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The target number of successes is based on the volume of the manse. See the “Area-Affecting” chart for extended spellcasting, p. 120. The caster also adds one success to the target number per point of Durability of the outer wall (on a one-point-per-success basis). Ordinary features (a normal chair or a bookshelf) are woven out of ephemera and require no successes to create. Exceptional features (an elaborate pair of golden double doors or a fountain or glittering crystal) require one or more successes, depending on their size."
            },
            {
                "type": "paragraph",
                "text": [
                    {
                        "type": "italic",
                        "text": "Example: Nine Fox Thunder creates a Spirit Manse to host a meeting with a spirit from which she desires to learn some gossip. She wants it to cover a volume of 20 cubic yards, which costs two successes. Since she doesn’t expect trouble, she decides that the walls don’t need to be very strong (Durability 1, for one success). Finally, she wants it to have a luminously glowing reflecting pond at the center, which costs one success. Since her meeting will only last a few hours, but she doesn’t want the manse disappearing prematurely, she extends the Duration to 12 hours for two successes. The total target number is six successes."
                    }
                ]
            },
            {
                "type": "paragraph",
                "text": "The mage can control who comes or goes from his manse. All others must forcibly breach the walls to get in. The mage can increase Duration using the advanced prolonged Duration factors."
            }
        ],
