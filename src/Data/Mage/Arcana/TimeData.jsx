const timeOneData = [
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Each success grants the mage a single extra die in the next roll that has to — or is chosen to — be made. This does not include spellcasting rolls. If the next roll is for a spell (perhaps the mage needs to quickly cast a countermagic), the character loses the benefit."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "For objects more than a decade old, a single success on this roll allows the mage to know the date within a month. For more recent objects, one success determines the date within a day. Each additional success narrows the time down further, in the progression listed below. If the object reached its final state very recently, then use the time listed below that as the starting point for the chart. For example, if someone died within the past hour, then one success allows the time of death to be dated to the correct minute, and two successes allow the time of death to be dated to the correct second."
            },
            {
                "type": "table",
                "headers": [
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "During this spell’s Duration, a reflexive Wits + Investigation roll can be made for the mage to detect a temporal disturbance that occurs within his sensory range. She can also examine such phenomena."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            ...
            {
                "type": "paragraph",
                "text": "If the target is a mage with Time 1 or greater, he makes a reflexive Wits + Composure roll to sense that he’s a victim of Time magic."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "This spell is cast during item creation. The Storyteller secretly makes the spell roll for the character, noting the interval on the following chart."
            },
            {
                "type": "table",
                "headers": [
            ...
            {
                "type": "paragraph",
                "text": "At the end of the interval, all of the item’s magical properties — not only the spell to which “Time Limit” originally applied — cease to function for the item’s current owner. After a transfer of ownership, the item again functions for its inherent interval, then shuts down again. Previous owners may never again access the item’s powers. If multiple instances of Time Limit are cast on the same item, the lowest interval applies."
            }
        ],
...
const timeTwoData = [
    {
        ...
        "DescrizioneMiddle": [
            ...
            {
                "type": "paragraph",
                "text": "Improper questions get no answers. Examples of improper questions include: “How much money will that lottery ticket win me? (Too specific; try instead: “Is this the winning ticket?”) “Will my son be a good man?” (“Good” is too relative a term — good to whom, exactly?)"
            },
            {
                "type": "paragraph",
                "text": "The Storyteller decides what the future holds for the target, knowing that knowledge of the future is often enough to change that future. A woman who is told she will be a store clerk for the rest of her life might then quit her job to go back to school. Some mages don’t even need to cast this spell to effect change. Their reputations for prophecy can be used to make others think they have read the future by means of magic. In this way, a mage might influence a friend’s behavior in hopes of turning her toward a more productive life by scaring her with predictions of just where her current path will lead."
            },
            {
                "type": "paragraph",
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Success allows the player to roll twice for a single instant action his character performs in the following turn, taking the better of the two results."
            },
            {
                "type": "paragraph",
                "text": "With Time 3, this spell can be cast reflexively, applying to an instant action taken in the same turn in which the magic is cast."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Each success allows the caster to make one Research roll per 15 minutes for extended action research (see 'Research,' pp. 55–56, the World of Darkness Rulebook), instead of the usual 30 minutes per roll."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The mage becomes invisible to prophecy, divination and other forms of temporal scrying unless the caster overcomes the Potency of the occluded mage’s spell."
            },
            {
                "type": "paragraph",
                "text": "By spending one Mana, the Duration can be made to last for one day."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The mage gains one point of armor per dot she possesses in the Time Arcanum. By spending one Mana, the Duration can be made to last for one day. Most mages cast such a shielding spell at the beginning of the day, as part of their morning rituals. Successes are used to combat attempts to dispel the shield."
            },
            {
                "type": "paragraph",
                "text": "Note that this magical armor applies against attempts to grapple the caster (both his Defense and Temporal Dodge armor are subtracted from the grappler’s dice pool when he attempts to achieve a hold on the mage), but it does not protect against attempts by an opponent to overpower and/or inflict damage once he has managed to grapple the mage."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            ...
            {
                "type": "paragraph",
                "text": "The effect lasts for one hour."
            }
        ],
...
const timeThreeData = [
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "This spell boosts the mage’s ability to avoid attacks, her Initiative, and Speed. Although the spell’s Duration lasts for one hour, the mage gains its benefits only in those turns in which she spends one Mana reflexively, and the benefits last for that turn. "
            },
            {
                "type": "paragraph",
                "text": "The benefits are as follows:"
            },
            {
                "type": "list",
                "items": [
                    " For each Time dot the mage possesses, one die is subtracted from any and all attackers’ dice pools (including ranged attacks), as the mage moves much more quickly than normal and is harder to hit.",
                    " Adds one to the mage’s Initiative per dot of Time.",
                    " Each dot of Time allows the caster’s Speed to be added again to his total Speed rating."
                ]
            },
            {
                "type": "paragraph",
                "text": "With Time 4, the mage can cast this spell on others."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "For every five successes added to the target number, the user of the item can borrow one success per roll on any action to which the item contributes an equipment bonus. The Storyteller takes note of the situation, type of action, and number of successes borrowed. In a subsequent scene, when the user undertakes a similar action, the same number of successes is subtracted as dice from that roll, even if this means reducing the dice pool to a chance die. This occurs whether or not the user employs the item in that attempt. The Storyteller times this settling of temporal accounts so that the failure carries negative consequences roughly equal to what the character would have suffered in the original incident."
            },
            {
                "type": "paragraph",
                "text": "Example: A user borrows successes from his magic gun during a firefight with members of a drug gang. He can’t erase his debt with a mere trip to the range to pop off a few failed shots. It will instead catch up with him the next time he finds himself in life-or-death combat."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "As with the Augury spell, the mage must declare a target. (Temporal sympathy modifies the casting roll; see p. 259.) One success allows the mage to ask one question about the target’s future and get an answer. Additional successes allow follow-up questions, allowing the mage to get more specific details."
            },
            {
                "type": "paragraph",
                "text": "Example: Arethusa gets three successes on her Divination roll, so she can ask one lead question and two follow-up questions. She’s trying to find out if a rival mage named Garrik is planning on attacking her. Her first question is: “Will Garrick attack us tonight?” She gets a vision of Garrick standing in her foyer, readying a spell. Her first follow-up question is “When will Garrick attack?” The image changes “camera” angles, and she can see the large grandfather clock in the foyer past Garrick, showing 10 minutes until midnight. Her final follow-up question is “Is he working alone?” She sees a new image, this one showing her a number of stealthy, black-clad figures sneaking through the bushes outside her home."
            },
            {
                "type": "paragraph",
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "For this spell’s Duration, the caster’s history and future reflect whatever she wishes when glimpsed by anyone using prophecy, divination or any other form of temporal Scrying to read either, unless the caster overcomes the Potency of this spell."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            ...
            {
                "type": "paragraph",
                "text": "Mages with one more dot in the spell’s required Arcana than listed above can cast a variant of this spell to suspend another’s body with an enchanted touch."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The subject simply knows that she is experiencing (and has experienced) a dream about the future, though she might choose to disregard this awareness if she is morally or intellectually opposed to the idea of divinations, psychic phenomena or magic. (This spell does not, however, invoke Disbelief under any circumstances.) "
            },
            {
                "type": "paragraph",
                "text": "Note that the mage does not have any control over what the subject perceives in such a dream, and he doesn’t possess any special insight into it, beyond that which might be gleaned through other uses of his Arcana. Subjects of this spell tend to experience visions based upon their own circumstances and experiences, though especially significant impending phenomena might take a subject outside of the cares and experiences of her own life."
            },
            {
                "type": "paragraph",
                "text": "The effects are similar to those of Time 3 “Divination,” centered on the dreamer herself."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The target gains one point of armor per dot the caster possesses in the Time Arcanum. The effect lasts for one hour, but the Duration can be made to last for a day by spending one Mana."
            }
        ],
...
const timeFourData = [
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The target suffers a –1 penalty to Defense per success on the casting roll. Additionally, the subject’s Speed is halved per success (rounding up), to a minimum of 1. When the victim of this spell attacks others with a ranged attack, her targets gain their Defense (even if the attack is not at point-blank range). The attacker moves slowly enough that others can anticipate her attack."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "As with “Divination,” p. 263, the mage can ask one question about a target or event per success. Instead of reading the future, however, he reads how things might be, provided some action or event comes to pass. Note that a target’s dots in the Destiny Merit (if any) levy penalties on the spellcasting roll — it is more difficult to find an alternate future when a person’s fate is ordained."
            },
            {
                "type": "paragraph",
                "text": "Example: Bahazid has learned that a certain boy is destined to become a great leader. She uses Prophecy to find out how she might avert that fate, for she does not want it to come to pass. She gains an image of somebody murdering the boy’s mother, and knows that if this comes to pass the boy shall become a tyrant."
            },
            {
                "type": "paragraph",
                "text": "Because of the vagueness of prophetic ability at this level, the mage learns only broad and sweeping details. Bahazid might not, for example, discover that saving the boy’s mother will lead to his sister becoming a great leader."
            },
            {
                "type": "paragraph",
                "text": "The same target can be targeted with this spell only once every 24 hours."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Successes are assigned to increasing the time that passes within the Pocket relative to what time passes without."
            },
            {
                "type": "table",
                "headers": [
            ...
            {
                "type": "paragraph",
                "text": "Example: One success allows two turns to pass within for every one turn that passes without, or two minutes within for one minute without, or two hours per one hour."
            },
            {
                "type": "paragraph",
                "text": "This spell affects only the mage."
            },
            {
                "type": "paragraph",
                "text": "The maximum target number the caster can aim for is equal to his Gnosis or Time, whichever is higher. Once the Duration expires (measured in time without), the Pocket ceases to exist and the mage returns to normal time."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "This spell affects only a living creature (and what he wears and carries), stuttering him forward for one turn per success. (If cast over an area, only people or objects that are wholly within the defined area are affected.)"
            },
            {
                "type": "paragraph",
                "text": "Onlookers simply see those affected disappear for up to several seconds, while those affected lurch forward in time (to find whatever changes having occurred outside of the spell’s area of effect during those seconds). Thus, reinforcements three turns away might, in the subjective time of those affected by the spell, arrive in one."
            },
            {
                "type": "paragraph",
                "text": "If, in the intervening turns, a person or object moves into the space occupied by one or more of the time-stuttering targets, a clash ensues when the time travelers arrive back in their places. Compare the Size of each person or thing who now shares the same space. Those with the smallest Size suffer a knockdown effect (see p. 168 of the World of Darkness Rulebook). If Sizes are equal, both must contend with a knockdown."
            },
            {
                "type": "paragraph",
                "text": "Example: Zeno, standing next to his motorbike, uses Temporal Stutter to shift forward in time for three turns (three successes were rolled for him). In the intervening turns, Arctos sees Zeno’s bike and walks over to check it out. In the fourth turn, Zeno reappears — exactly where Arctos is standing. Both mages are Size 5, so both must contend with knockdown. A reflexive Dexterity + Athletics roll is made for each. Zeno succeeds, but Arctos fails, so falls down, knocked aside by Zeno’s sudden appearance. "
            }
        ],
...
const timeFiveData = [
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "This spell acts like the “Temporal Pocket” spell, p. 265, except that the mage can now cast it upon an area. One success affects a five-foot square area and anything within it, and additional Target factors can be devoted to increasing this area."
            },
            {
                "type": "paragraph",
                "text": "The flow of time can also be reversed so that time within the Pocket moves more slowly than time without. For example, with one success the time within the pocket moves at half the rate as time without: one turn within for every two turns without. With three successes, four turns pass within for every one turn that passes without. A person who enters the area must succeed in a reflexive and contested Composure + Gnosis roll or be caught within the time flux."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "The number of successes determines how far into the future the object can be sent. The mage can opt to send it to any time between now and that allowed by his successes."
            },
            {
                "type": "table",
                "headers": [
            ...
            {
                "type": "paragraph",
                "text": "*add 10 years per additional success"
            },
            {
                "type": "paragraph",
                "text": "The object appears at the future time in the exact same space it occupies in the present, unless Space 2 is added to locate it elsewhere. (See “Apportation,” p. 234.)"
            },
            {
                "type": "paragraph",
                "text": "The drawback to this spell is that, once cast, the object cannot be retrieved, except at the point in the future in which it appears. It is said that archmasters of Time have the power to reach forward and snatch back objects that have been sent forward."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Each success allows the mage to shift one dot from a mundane trait (an Attribute, Skill or Merit, but not a magical trait such as Gnosis or an Arcanum) to another within the same trait category (dots of Social Attributes switch with other Social Attributes, etc.), up to his normal maximum within a given category (five dots for most humans). (Dots cannot be added directly to or subtracted directly from Advantages.) It is as if he had made different choices in the past, leading to different personal results. For example, in his newly rewritten past, a mage went to the gym rather than to the library he actually frequented in his real past, allowing him to shift traits from Mental Attributes to Physical Attributes."
            },
            {
                "type": "paragraph",
                "text": "Note that changing a number that has derived characteristics (Composure or Stamina, for example) alters any such derived characteristics appropriately (say, Willpower or Health)."
            },
            {
                "type": "paragraph",
                "text": "When the spell expires, the caster’s real history is restored and his traits return to their original distribution."
            }
        ],
    ...
    },
    {
        ...
        "DescrizioneMiddle": [
            {
                "type": "paragraph",
                "text": "Each success allows the subject to be frozen in time for one turn. The field of suspended time exists immediately around the target. If anyone or anything enters this field — that is, if the target is touched — the spell is broken and the target is restored to normal time."
            }
        ],
