export const psychicMeritsData = [
    {
        ...
        "FullPrerequisite": "None, but the character can have no other Merits that confer psychic powers.",
        "Content": [
            {
                "type": "paragraph",
                "text": [
            ...
            },
            {
                ...
                "text": [
                    ...
                    " Any character with this Merit also suffers from a severe derangement triggered by the presence of overt psychic phenomena. Whenever the character is confronted by another person claiming to have psychic powers, or by clear evidence of psychic phenomena, the Anti-Psi manifests an intense hostility toward the object of the offense. Exactly how this derangement plays out is for you to decide, but the character is likely obsessed with debunking the psychic’s claims and exposing him publicly as a fraud. Possible derangements include Hysteria, Megalomania, Paranoia and Anxiety (see the World of Darkness Rulebook, pp. 97-98)."
                ]
            }
        ],
        "Book": "SS 64",
    ...
    },
    {
        ...
        "FullPrerequisite": "Any Psychic Merit",
        "Content": [
            {
                "type": "paragraph",
                "text": [
        ...
        "Content": [
            ...
            },
            {
                ...
                "text": [
                    ...
                    "A Doubting Thomas also suffers from a mild derangement triggered by assertions of psychic phenomena. Precisely how this ailment manifests is determined by you, but a Doubting Thomas confronted by phenomena purported to be psychic is likely compelled to confront the performer and try to debunk her claims. Common derangements for Doubt- ing Thomases include Fixation, Suspicion and Irrationality (see the World of Darkness Rulebook, pp. 97-99)."
                ]
            }
        ],
        "Book": "SS 65",
    ...
    },
    {
        ...
        "FullPrerequisite": "Persuasion ••• or Science ••• (with a Specialty in Hypnotherapy or a related field)",
        "Content": [
            {
                "type": "paragraph",
                "text": [
            ...
            },
            {
                "type": "line",
                "label": "Dice Pool:",
                "text": "Manipulation + Persuasion or Science (Hypnotherapy Specialty), possibly contested by Composure + Supernatural Advantage"
            },
            {
                "type": "line",
                "label": "Action:",
                "text": "Extended (subject willing) or extended and contested (subject unwilling). The hypnotist must accumulate successes equal to the target’s Resolve x5, with each roll representing 10 seconds of speech."
            },
            {
                "type": "heading",
                "text": "Roll Results",
            ...
            },
            {
                ...
                "text": "The hypnotist fails to entrance his subject and loses any accumulated successes. If the subject was unwilling, she automatically knows that the hypnotist was attempting to hypnotize her and may react accordingly. Any subsequent attempts to hypnotize the subject (or indeed, anyone else who saw what happened) fail automatically."
            },
            {
                "type": "line",
                "label": "Failure:",
                "text": "The character gathers no successes at this time."
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "The character gets the required number of successes and the subject is placed in a light trance."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
                "text": "The character gathers five or more successes than required. The character gains a +2 bonus on any Social rolls against the subject for the remainder of the trance."
            },
            {
                "type": "table",
            ...
            },
            {
                "type": "line",
                "label": "Dice Pool:",
                "text": "Manipulation + Persuasion - subject’s Composure"
            },
            {
                "type": "line",
                "label": "Action:",
                "text": "Instant, although the roll can be made only after at least five minutes of induction"
            },
            {
                "type": "heading",
                "text": "Roll Results",
            ...
            },
            {
                "type": "line",
                "label": "Dramatic Failure:",
                "text": "The hypnotist fails to entrance the subject, who instantly awakens."
            },
            {
                "type": "line",
                "label": "Failure:",
                "text": "The character fails to induce the subject to enter a deep trance. Other attempts can be made if time permits."
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "The subject is placed in a deep trance. The character gains a +2 bonus on any Social rolls against the target for the remainder of the trance."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
                "text": "The subject is placed into an exceptionally deep trance. The character gains a +5 bonus on all Social rolls against the subject for the rest of the trance."
            },
            {
                "type": "table",
                "headers": ["Dice Modifiers", "Situation"],
            ...
            },
            {
                "type": "line",
                "label": "Dice Pool:",
                "text": "Manipulation + Persuasion versus the subject’s Resolve + Supernatural Advantage (resistance is reflexive)"
            },
            {
                "type": "line",
                "label": "Action:",
                "text": "Extended and contested, with each roll representing 30 minutes of hypnotherapy"
            },
            {
                "type": "heading",
                "text": "Roll Results",
            ...
            },
            {
                "type": "line",
                "label": "Dramatic Failure:",
                "text": "The hypnotist’s attempts to dredge up the lost memories traumatizes the subject, inflicting a mild derangement on him."
            },
            {
                "type": "line",
                "label": "Failure:",
            ...
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "The character gets the required number of successes. The subject is able to recall the lost memories while under a trance, but does not recall them while awake."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
                "text": "Five or more successes than required are accumulated. The subject recalls the lost memories after awakening."
            },
            {
                "type": "table",
...
export const psychicEspMeritsData = [
    {
        ...
        "Content": [
            ...
            {
                "type": "paragraph",
                "text": "Once at a desired location, a psychic can move around freely but is generally intangible and invisible. He can, however, be perceived through any appropriate psychic means (such as Aura Reading •••••). Other astral projectors or other beings existing in Twilight — an ephemeral state in the material world, such as a ghost’s — can perceive him normally. Returning to his body requires an instant action and a successful Wits + Composure roll, or the clairvoyant can return to his body reflexively with an exceptional success."
            },
            {
                "type": "paragraph",
                "text": "If the psychic’s physical body is tampered with while he is “gone,” the he may sense the intrusion with a successful Intelligence + Composure roll. The psychic always feels actual pain inflicted on his physical body and may react accordingly. However, an astral projector’s physical body may be subjected to a killing blow if the body is left unprotected (see the World of Darkness Rulebook, p. 168)."
            },
            {
                "type": "paragraph",
                "text": "If a psychic using Astral Projection uses the optional form of Clairvoyance that grants only one sense, he is able to use only that one sense while projected. A projector who has only clairaudience is at a severe disadvantage, as he arrives at a location and is functionally blind. Characters whose Clairvoyance grants only vision are slightly less handicapped, but are still effectively deaf. While astrally projecting, a psychic is free to use any other ESP or telepathic Merit he possesses. Thus, a “deaf” projector with Mind Reading can attempt to “ride the senses” of someone nearby, while one with Animal Empathy could do the same to a nearby animal."
            }
        ],
        "FullPrerequisite": "Clairvoyance. A clairvoyant who has the “Uncontrolled Clairvoyance” option cannot learn to project astrally.",
        "Cost": "1 Willpower to project. None to navigate.",
        "DicePool": "Stamina + Composure (to determine the duration of the projection). Wits + Composure (to navigate astrally to the desired location)",
        "Action": "Extended to enter the trance state. Instant to release the astral form and navigate to the desired location.",
        "RollResult": [
            {
                "type": "line",
                "label": "Dramatic Failure:",
                "text": "The psychic is rendered unable to use his Astral Projection power until he has rested for at least eight hours. A dramatic failure on a navigation roll means he is lost and has traveled to some unintended and possibly dangerous location."
            },
            {
                "type": "line",
                "label": "Failure:",
                "text": "The psychic fails to project, but can try again. A failure on the navigation roll means that the ESPer has missed his destination, but is close enough to try again."
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "The psychic can maintain his astral form for up to 10 minutes per success. A success on the navigation roll means that he finds the location he was seeking."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
                "text": "The psychic maintains his astral form for the duration of his trance. An exceptional success on a navigation roll gives the psychic a +2 bonus on all Perception rolls while at the desired location, as well as a +1 bonus on any other psychic powers used astrally."
            },
            {
                "type": "heading",
                "level": 2,
                "text": "Combat on the Astral Plane"
            },
            {
                "type": "paragraph",
                "text": "An astral traveler remains in the material world but is said to be in “Twilight,” which psychics generally interpret to mean out of phase with physical reality in a manner similar to ghosts. Generally, astrally projected beings are intangible and invisible with respect to anything and anyone in the physical plane, and are visible but still intangible to each other. Thus, an astrally projecting psychic could not, for example, get into a brawl with either a ghost or another astrally projecting psychic. Such beings could still use psychic powers or Numina against each other as normal, though."
            },
            {
                "type": "paragraph",
                "text": "An astrally projecting psychic who also possesses the Ghost-Calling Merit (see p. 45) can choose to become solid with reference to a ghost with the expenditure of a Willpower point. If the psychic does so, his normal Attributes are used for determining dice pools for any of his psychic powers. In direct combat against ghosts or spirits, assume that an astrally projecting psychic has a Power equal to the higher of her Intelligence or Presence, a Finesse equal to the higher of her Wits or Manipulation and a Resistance equal to the lower of her Resolve or Composure. In any event, astrally projecting psychics and vampires using the Auspex Discipline called Twilight Projection are never solid with reference to each other (see Vampire: The Requiem, p. 123). Although a vampire and a projector are capable of perceiving each other and communicating, the psychic can never affect or be affected by the vampire."
            }
        ],
        "Book": "SS 36",
    ...
    },
    {
        ...
        "FullPrerequisite": "",
        "Cost": "1 Willpower",
        "DicePool": "Wits + Composure",
        "Action": "Instant",
        "RollResult": [
            {
                "type": "line",
                "label": "Dramatic Failure:",
                "text": "The character receives erroneous or misleading information."
            },
            {
                "type": "line",
                "label": "Failure:",
                "text": "The character is unable to project her senses."
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "The character can perceive events at the location she wishes to observe for up to one scene."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
                "text": "The character can “move around,” changing the vantage point of her vision at will. She can even “pause” and “rewind” as needed, although she cannot see what happened before her vision began (see “Postcognition,” below)."
            },
            {
                "type": "table",
                ...
                "rows": [
                    [
                        "+2",
                        "The intended vision is of a person or place with which the clairvoyant has a strong emotional attachment, such as with a loved one or home."
                    ],
                    [
                        "+1",
                        "The intended vision is of a person or place with which the clairvoyant has some emotional attachment, such as with a friend or workplace."
                    ],
                    [
                        "+1",
                        "The clairvoyant holds some object or is in the presence of someone with a strong emotional attachment to the subject of the desired vision, or is in a location strongly resonant with the desired vision (such as the last place a missing person was seen)."
                    ],
                    [
                        "0",
                        "The clairvoyant attempts to perceive someone she knows personally and whose location is currently known."
                    ],
                    [
                        "-1",
                        "The clairvoyant either does not know the person whom she attempts to scry or she has no idea of the location she attempts to scry. If both situations apply, the penalty is -2."
                    ],
                    [
                        "-2",
            ...
            },
            {
                ...
                "text": [
                    {
                        "text": "Option [Crystal Gazer]:",
                        "bold": true
                    },
                    " The clairvoyant can perceive only the target location while focusing on some type of special surface such as a mirror or crystal."
                ]
            },
            {
                "type": "paragraph",
                "text": [
                    {
                        "text": "Option [Eyes of Another]:",
                        "bold": true
                    },
                    " The psychic can view a scene only through the eyes of someone witnessing that scene. Thus, the clairvoyant cannot scry a location if no one is present there. The clairvoyant can get a +1 bonus if she can simply choose any person to view through, or she can get a +2 dice bonus if she is limited to only seeing through the eyes of a certain class of individuals. For example, the title character in ",
                    {
                        "text": "The Eyes of Laura Mars",
                        "italic": true
                    },
                    " had the power to observe murders taking place, but only through the eyes of the murderer and only in an uncontrolled manner. A character with those options gains +4 bonus on all Clairvoyance rolls — +2 for the Eyes of Another option and +2 for the Uncontrolled option (see below)."
                ]
            },
            {
                "type": "paragraph",
                "text": [
                    {
                        "text": "Option [One Sense Only]:",
                        "bold": true
                    },
                    " The clairvoyant can perceive the target location with only one of his senses, most commonly vision or hearing (i.e., clairaudience)."
                ]
            },
            {
                "type": "paragraph",
                "text": [
                    {
                        "text": "Option [Trance Only]:",
                        "bold": true
                    },
                    " The psychic can use his clairvoyant powers only while in a trance state (see p. 35). While the psychic is using his powers, he suffers the -5 penalty for Perception rolls inflicted by trances, instead of the normal -2 penalty. A psychic with this option gains a +2 dice bonus to activate this power."
                ]
            },
            {
                "type": "paragraph",
            ...
            },
            {
                "type": "heading",
                "level": 2,
                "text": "Story Hook: The Vision Thing"
            },
            {
                "type": "paragraph",
                "text": [
                    "Many ESP Merits give Storytellers a chance to draw characters into stories automatically. If a character has the power of psychometry, any object he touches might provide clues to its past, motivating investigation. Precognition allows the Storyteller to give a player vital clues to some future event that must be prepared for — and apocalyptic visions if the character refuses to investigate. Clairvoyance might curse a character to know when an innocent person is in danger, and these visions of calamities (past or future) might compel him to intervene. Of course, the best example of using ESP as a story hook comes from Stephen King’s ",
                    {
                        "text": "The Dead Zone",
                        "italic": true
                    },
                    ". How will a character react when, upon casually shaking another person’s hand, he learns that this seemingly respectable public figure is poised to do something horrible, whether murder a child or declare World War III?"
                ]
            }
        ],
        "Book": "SS 37",
        ...
        "RollResult": [
            {
                "type": "line",
                "label": "Dramatic Failure:",
                "text": "The psychic is led on a wild-goose chase far from his desired goal. He also loses all accumulated successes."
            },
            {
                "type": "line",
                "label": "Failure:",
                "text": "The current dowsing attempt is unsuccessful, but more rolls may be made."
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "When the player has accumulated the number of successes required, the attempt succeeds."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
                "text": "The psychic might also gain insight into some other prize hidden nearby."
            }
        ],
        "Book": "SS 38",
    ...
    },
    {
        ...
        "FullPrerequisite": "Astral Projection, Mind Reading (either version) and Thought Projection (either version)",
        ...
        "DicePool": "Wits + Resolve to enter a sleeping person’s dream and to manipulate it. Prior to an entry effort, a psychic must successfully use Astral Projection in order to leave her body and travel to the target’s location; Astral Projection typically requires a character to enter a trance first.",
        "Action": "Instant",
        "RollResult": [
            {
                "type": "line",
                "label": "Dramatic Failure:",
                "text": "The psychic fails to enter the sleeper’s mind and cannot try again until the sleeper’s next REM cycle. In dream combat, the psychic inflicts one point of phantom damage on herself."
            },
            {
                "type": "line",
                "label": "Failure:",
                "text": "The psychic simply fails to enter the sleeper’s mind, or no damage is inflicted."
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "The psychic successfully enters the sleeper’s mind. Each success in dream combat inflicts a point of damage."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
                "text": "The psychic enters the sleeper’s mind and gains a +1 bonus die to all other rolls for the duration of her stay."
            },
            {
                "type": "heading",
                "level": 2,
                "text": "Story Hook: Nightmares Given Form"
            },
            {
                "type": "paragraph",
                "text": "Some psychics gifted with the power to travel the dreamscape claim to have encountered inhuman entities roaming the minds of subjects, beings that can track a projector back through astral space to her own body. According to such stories, a dream-traveling psychic generally encounters some sort of hostile entity within a subject’s mind, the being terrorizing the subject with nightmares. Unless the psychic can destroy the entity where she finds it, the creature can follow the psychic back to her own body. Thereafter, the entity, sometimes referred to as a “Freddie” by horror-movie aficionados, is a constant fixture in the psychic’s subconscious, able to manifest in any of her dreams and attack her in sleep through terrifying nightmares that sometimes cause real damage. Worse, a Freddie may become contagious, able infect anyone with whom a psychic has a strong emotional bond, inspiring deadly nightmares in that person. Opinion is divided on what these creatures are or from where they come, but whether they are alien entities or creatures from the id of the Universal Unconscious, they hunt their chosen prey with malefic"
            }
        ],
        "Book": "SS 38",
        ...
        "Content": [
            {
                ...
                "text": [
                    ...
                    " Your psychic has the ability to see into the past. If the roll to activate this power is successful, you are allowed to ask a variable number of questions about a past event based on your successes. The effort suffers a dice penalty based on temporal proximity, and the Storyteller should ",
                    {
                        "text": "always",
                        "italic": true
                    },
                    " roll for the player who uses Postcognition, since the player may be able to deduce when something might have occurred by noting the penalty applied, even if the roll is unsuccessful. Each success on the roll allows the player to ask one question about the past event viewed."
                ]
            },
            {
                "type": "table",
            ...
            },
            {
                ...
                "text": [
                    ...
                    " ",
                    {
                        "text": "Detective Halloran, who secretly uses his Postcognition abilities to help him solve crimes, examines a bloody knife used in a brutal homicide. The Storyteller rolls Halloran’s Wits + Occult, applying a -1 penalty (due to the fact that the murder took place more than a day but less than a week ago) and a -2 penalty (for not actually being at the crime scene, but simply holding the murder weapon). The roll yields three successes, and Halloran gets a brief glimpse of the murder itself. His player can ask three questions about the vision. Triggering the vision costs the player one Willpower point.",
                        "italic": true
                    }
                ]
            },
            {
                "type": "paragraph",
                "text": "Psychics with this Merit commonly possess the Precognition Merit, too. If the psychic does have the Precognition Merit, the cost of Postcognition is only one Merit dot. If the psychic acquires the three-dot version of this power, he does not need Precognition as a prerequisite."
            }
        ],
        "FullPrerequisite": "Precognition for the • version. None for the ••• version.",
        "Cost": "1 Willpower",
        "DicePool": "Wits + Occult",
        "Action": "Instant",
        "RollResult": [
            {
                "type": "line",
                "label": "Dramatic Failure:",
                "text": "The seer has a wildly false or misleading vision. Since the Storyteller makes the roll on the player’s behalf, allow the player to ask an arbitrary number of questions, say one to three, and invent erroneous or misleading information about the scene observed."
            },
            {
                "type": "line",
                "label": "Failure:",
                "text": "Failure indicates that the seer fails to produce a vision."
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "The character has a postcognitive vision. The player may ask one question about the vision per success. No more than one successful vision about a specific scene may be had every 24 hours."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
                "text": "Additional successes are their own reward. The Storyteller may point out significant details about which the player does not think to ask."
            }
        ],
        "Book": "SS 40",
    ...
    },
    {
        ...
        "Content": [
            ...
            },
            {
                "type": "paragraph",
                "text": [
                    "A precog can never predict the immediate future (i.e., what will happen next within the current scene). That is more the purview of the Danger Sense Merit (see the ",
                    {
                        "text": "World of Darkness Rulebook",
                        "bold": true
                    },
                    ", p. 108). A roll to see the future suffers a penalty based on temporal proximity, and the Storyteller should ",
                    {
                        "text": "always",
                        "italic": true
                    },
                    " roll for a character who uses Precognition, since the player may be able to deduce when something might occur from noting the penalty applied, even if the roll is unsuccessful. Each success on the roll allows the player to ask one question about the future event."
                ]
            },
            {
                "type": "table",
        ...
        "RollResult": [
            {
                "type": "line",
                "label": "Dramatic Failure:",
                "text": "The seer has a wildly false or misleading vision. Since the Storyteller makes the roll on the player’s behalf, allow him to ask an arbitrary number of questions, say one to three, and invent erroneous or misleading information about the scene observed."
            },
            {
                "type": "line",
                "label": "Failure:",
                "text": "Failure indicates that the precog fails to produce a vision."
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "The character has a precognitive vision. The player may ask one question about the vision per success. No more than one successful vision about a specific scene may be had every 24 hours."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
            ...
            },
            {
                ...
                "text": [
                    {
                        "text": "Option [Precognitive Dreams]:",
                        "bold": true
                    },
                    " The psychic’s visions come to him in the form of dreams. Thus, he can trigger visions only after entering a trance state (see p. 35)."
                ]
            },
            {
                "type": "paragraph",
                "text": [
                    {
                        "text": "Option [Required Foci]:",
                        "bold": true
                    },
                    " The psychic requires some form of divination tool in order to predict the future. Common types of divinatory tools are listed in the “Tools of the Fortune-Teller” sidebar. The psychic can attempt to force a vision without using such tools, but doing so reduces the effort to a chance die."
                ]
            },
            {
                "type": "paragraph",
            ...
            },
            {
                ...
                "text": [
                    {
                        "text": "Option [Uncontrolled Precognition]:",
                        "bold": true
                    },
                    " A psychic whose powers are uncontrolled has precognitive visions only at times of the Storyteller’s choosing, although the psychic should generally have at least one vision per session."
                ]
            },
            {
                "type": "heading",
                "level": 2,
                "text": "Tools of the Fortune-Teller"
            },
            {
                "type": "paragraph",
                "text": [
                    "Professional and amateur fortune-tellers have employed a dazzling array of tools throughout history to aid them in their arts, from Tarot to the ",
                    {
                        "text": "I Ching",
                        "italic": true
                    },
                    " to the bloody entrails of barnyard animals. Characters who take a Specialty in Occult [specific divination technique] gain a +1 bonus on all Precognition rolls. A character who takes the Required Focus Option and who can predict the future only when using a particular divination tool gains an additional +1 bonus. The list below is just a sample."
                ]
            },
            {
                "type": "line",
                "label": "Arithmancy:",
                "text": "Divination through the interpretation of numbers."
            },
            {
                "type": "line",
                "label": "Astrology:",
                "text": "Divination through tracking the movements of heavenly bodies in relation to important dates in a subject’s life."
            },
            {
                "type": "line",
                "label": "Bibliomancy:",
                "text": "Divination by randomly choosing passages from a book, most commonly the Bible."
            },
            {
                "type": "line",
                "label": "Carromancy:",
                "text": "Divination by interpreting melted wax poured into cold water."
            },
            {
                "type": "line",
                "label": "Cartomancy:",
                "text": "Divination using Tarot cards or modern playing cards."
            },
            {
                "type": "line",
                "label": "Crystalomancy:",
                "text": "Divination through scrying in a crystal sphere."
            },
            {
                "type": "line",
                "label": "Gyromancy:",
                "text": "Divination through spinning about until the psychic enters an ecstatic state, as performed by dervishes."
            },
            {
                "type": "line",
                "label": "Hepatomancy:",
                "text": "Divination through the entrails of sacrificed animals."
            },
            {
                "type": "line",
                "label": "Oneiromancy:",
                "text": "Divination through dreams."
            },
            {
                "type": "line",
                "label": "Palmistry:",
                "text": "Divination through examining the shape of lines on a person’s hand."
            },
            {
                "type": "line",
                "label": "Pyromancy:",
                "text": "Divination by interpretation of fire, smoke or burning objects."
            },
            {
                "type": "line",
                "label": "Sortilege:",
                "text": [
                    "Divination through the casting of lots, bones or ",
                    {
                        "text": "I Ching",
                        "italic": true
                    },
        ...
        "RollResult": [
            {
                "type": "line",
                "label": "Dramatic Failure:",
                "text": "The psychic gets a “mixed message” or a very believable but entirely false impression. The Storyteller should always make chance-die rolls on behalf of players whose characters use this power."
            },
            {
                "type": "line",
                "label": "Failure:",
                "text": "Failure indicates that no impressions come through."
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "Success yields a sense of the most emotionally charged event or person connected with the object read, as well as a reliable vision or sense of the memory in question. Only one successful reading of an object is allowed every 24 hours in order to see more events."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
                "text": "An exceptional success provides a comprehensive or extended chronological understanding of an object and its past, such as an entire slideshow of images."
            },
            {
                "type": "table",
                "title": "Suggested Modifiers",
                ...
                "rows": [
                    [
                        "+1",
                        "The character has drawn a psychic impression from the object before."
                    ],
                    [
                        "—",
                    ...
                    [
                        "-3",
                        "Object read during a fight or other stressful circumstance"
                    ]
                ]
            },
            {
...
export const psychicMediumistMeritsData = [
    {
        ...
        "FullPrerequisite": "",
        "Cost": "None",
        "DicePool": "Composure + Craft",
        "Action": "Instant; although the psychic must first enter a trance state",
        "RollResult": [
            {
                "type": "line",
                "label": "Dramatic Failure:",
                "text": "The psychic’s drawings contain false or misleading information. The Storyteller should make any chance-die rolls for the player."
            },
            {
                "type": "line",
                "label": "Failure:",
                "text": "The automatic drawing attempt is unsuccessful."
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "The psychic’s drawings contain vital clues to whatever mystery she seeks to solve."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
                "text": "The drawings are particularly clear, giving a +1 modifier to any subsequent Investigation rolls pertaining to the drawings’ subject matter."
            },
            {
                "type": "line",
                "label": "Suggested Equipment:",
                "text": "Any item that has a strong connection to the subject about which the psychic seeks information (+1 to +3, depending on the strength of the connection)."
            },
            {
                "type": "heading",
                "level": 2,
                "text": "Story Hook: Messages from Beyond"
            },
            {
                "type": "paragraph",
                "text": "A psychic capable of automatic writing must usually enter a trance in order to draw. Daydreams sometimes duplicate the effect of a trance, though, and a bored character doodling in a college classroom might be startled to see what she has written in the margins of her notes. Such random messages spawned by the psychic’s power might include the secret thoughts of the professor teaching the class, a quick sketch of one of the other students lying murdered in his dorm room or perhaps just a brief message from persons unknown: “This time tomorrow, I’ll kill you all!”"
            }
        ],
        "Book": "SS 43",
    ...
    },
    {
        ...
        "FullPrerequisite": "Ghost-Calling for Spirit Channeling. None for Cayce Channeling or Past-Life Channeling.",
        "Cost": "1 Willpower",
        ...
        "RollResult": [
            {
                "type": "line",
                "label": "Dramatic Failure:",
                "text": "The psychic is trapped in his trance state for hours as he contemplates the infinite mysteries of the Universal Unconscious. Waking requires a number of successes on an extended Intelligence + Resolve roll equal to the psychic’s combined Stamina + Composure, with each roll taking one hour. Alternatively, the psychic is unable to access this Merit again until 24 hours pass."
            },
            {
                "type": "line",
                "label": "Failure:",
                "text": "The effort is unsuccessful."
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "Each success is converted into one dot of a single Mental or Social Skill selected by the player. The number of successes must exceed the character’s current Skill dots, if any, in order for him to gain any benefit from the power. The new rating lasts until the psychic next sleeps or until he next uses this power."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
                "text": "In addition to the normal benefit of extra successes, the psychic receives one bit of useful knowledge that he randomly comes across in the infinite Universal Unconscious, although the true significance of this nugget might not be immediately clear. If the successes exceed five, any more can be assigned to another single Mental or Social Skill of the character’s choosing."
            },
            {
                "type": "paragraph",
                "text": [
                    {
                        "text": "Past-Life Channeling:",
                        "bold": true
                    },
            ...
            },
            {
                "type": "line",
                "label": "Dice Pool:",
                "text": "Composure + Occult"
            },
            {
                "type": "line",
                "label": "Action:",
                "text": "Instant; although the psychic must first enter a trance"
            },
            {
                "type": "line",
                "label": "Dramatic Failure:",
                "text": "The psychic assumes a personality from a previous life. He manifests a new Storyteller-assigned personality and background for the duration of the scene, including a new Virtue and Vice. He may (or may not) retain the ability to speak his normal languages, and has no knowledge of any friends, his current situation or, indeed, anything about modern life, viewing everything through the lens of a Roman centurion, a courtesan from the era of Louis XIV, a Mississippi plantation owner on the eve of the Civil War or anything else of which the Storyteller can think."
            },
            {
                "type": "line",
                "label": "Failure:",
                "text": "The past-life regression was unsuccessful."
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "Each success is converted into one dot of a single Physical or Social Skill selected by the player. The number of successes must exceed the character’s current Skill dots, if any, in order for him to gain any benefit from the power. The new rating lasts until the psychic next sleeps or until he next uses this power."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
                "text": "In addition to the normal benefit of extra successes, the psychic can access the personal memories of the past life sharing his body. These new memories are lost when the power’s effect ends. If the successes exceed five, any more may be assigned to another single Physical or Social Skill of the character’s choosing."
            },
            {
                "type": "paragraph",
                "text": [
                    {
                        "text": "Spirit Channeling:",
                        "bold": true
                    },
            ...
            },
            {
                "type": "line",
                "label": "Dramatic Failure:",
                "text": "The ghost summoned is instinctively hostile toward the psychic or the effect summons a different and more malevolent entity than intended. The hostile spirit can automatically succeed on a roll to possess the psychic (see the World of Darkness Rulebook, p. 212)."
            },
            {
                "type": "line",
                "label": "Failure:",
                "text": "The medium was unsuccessful."
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "Each success is converted into one dot of a single Physical or Mental Skill selected by the player. The number of successes must exceed the character’s current Skill dots, if any, in order for him to gain any benefit from the power. The new rating lasts until the psychic next sleeps or until he next uses this power."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
                "text": "In addition to the normal benefit of extra successes, the psychic can access the personal memories of the ghost who shares the psychic’s body. If the successes exceed five, any more can be assigned to another single Physical or Mental Skill of the character’s choosing."
            }
        ],
        "Book": "SS 44",
    ...
    },
    {
        ...
        "Content": [
            ...
            {
                "type": "paragraph",
                "text": "A character who possesses the Ghost Ally Merit can acquire a limited version of Death Sight capable of letting her see and communicate with his ally by increasing the normal cost of the Ghost Ally Merit. (See “Ghost Ally,” p. 65.)"
            }
        ],
        "FullPrerequisite": "",
        ...
        "RollResult": [
            {
                "type": "line",
                "label": "Dramatic Failure:",
                "text": "The medium is unable to use this Merit for the rest of the scene. Alternately, she may suffer horrific visions of some hellish underworld, inflicting a -2 penalty on all actions for the remainder of the scene."
            },
            {
                "type": "line",
                "label": "Failure:",
                "text": "The attempt to activate Death Sight is unsuccessful."
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "Your character can perceive and communicate with any ghost in her vicinity for the remainder of the scene. Such ghosts remain intangible to her, however."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
                "text": "The medium may gain a +2 bonus on all rolls made in dealing with ghosts during the scene."
            },
            {
                "type": "paragraph",
                "text": [
                    {
                        "text": "Option [Permanent Death Sight]:",
                        "bold": true
                    },
                    " The medium’s ability to see the dead is always active. The stress of constantly being surrounded by spectral beings inflicts a mild derangement, such as Depression, Phobia, Irrationality or Avoidance. The player must still roll Wits + Composure in order to communicate with ghosts, but with this option, such rolls gain a +3 bonus."
                ]
            },
            {
                "type": "heading",
                "level": 2,
                "text": "Story Hook: I See Dead People — and Do Stuff for Them"
            },
            {
                "type": "paragraph",
                "text": [
                    ...
                    ", depict the problems faced by psychics who can see the restless dead. Such entities are tied to the material world by powerful emotional anchors, unable to move on to the afterlife until the ghosts resolve whatever lingering issues tie them to the land of the living. When such a ghost encounters a psychic with the power to see her and even understand her entreaties, the ghost typically begs for aid in resolving her ties. If the psychic is initially unwilling to help, the ghost might become ",
                    {
                        "text": "insistent",
                        "italic": true
                    },
                    ", actively haunting him until he complies with her wishes, some of which may be immoral, illegal or potentially deadly. How is a psychic, whose only power is to perceive nearby ghosts, supposed to avenge a spook’s death by killing the Mafia don — or worse, the vampire elder — who murdered her?"
                ]
            }
        ],
        "Book": "SS 45",
    ...
    },
    {
        ...
        "Content": [
            ...
            {
                "type": "paragraph",
                "text": "Roll Wits + Occult for your character to make spiritual contact with an existing ghost. Not all deceased persons continue to exist as ghosts, and few ghosts persist more than a few decades after their demise. If a ghost is still in existence, the medium can potentially contact the ghost wherever it roams. Once the connection is formed, the medium is considered to be a temporary anchor for the ghost, and it can instantly come to his vicinity from wherever it may be. If the ghost is unwilling to come to the medium, he can attempt to compel its attendance with a successful Presence + Occult roll versus the ghost’s Resistance in a contested action. Whether the ghost comes willingly or not, a Willpower point need not be spent for the ghost to travel to its new anchor. A medium cannot control a ghost in any meaningful way. A character with this Merit cannot automatically detect ghosts unless he also has the Death Sight Merit. If he does have that Merit, he receives a +2 bonus on all Ghost-Calling rolls."
            },
            {
                "type": "paragraph",
                "text": "When a medium forms a psychic connection with a ghost, the medium continues to serve as the ghost’s anchor for the duration of the scene. If the medium attempts to sever the connection early, a successful Wits + Occult roll must be made versus the ghost’s Power in a contested action, unless the ghost consents to the severing. When a medium no longer serves as an anchor, a ghost returns instantly to wherever it was prior to the summoning. Severing the psychic connection does not harm the ghost in any way."
            },
            {
                "type": "paragraph",
                "text": "While a connection is in force, a medium is considered an anchor for all purposes. Thus, the ghost can manifest in the psychic’s vicinity without need for a roll. A medium may place himself in grave danger if he does not know with what sort of ghost he deals."
            }
        ],
        "FullPrerequisite": "",
        "Cost": "1 Willpower",
        "DicePool": "Wits + Occult versus an unwilling ghost’s Resistance to become a temporary anchor to a ghost (resistance is reflexive). Presence + Occult versus an unwilling ghost’s Resistance to forcefully summon one to the medium’s vicinity.",
        "Action": "Contested",
        "RollResult": [
            {
                "type": "line",
                "label": "Dramatic Failure:",
                "text": "A psychic connection is forged with some entity other than the one the medium sought. The medium may be unable to sever the connection or may even become a permanent anchor to a hostile ghost."
            },
            {
                "type": "line",
                "label": "Failure:",
                "text": "You fail to get more successes than the ghost. The attempt to contact or summon is unsuccessful."
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "On a contact roll, more successes are rolled for the medium than for the ghost. The medium is considered an anchor for the remainder of the scene unless the effect is ended early. On a summoning roll, the ghost is compelled to come to the medium’s vicinity."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
                "text": "On a contact roll, the player gets five or more successes, more than rolled for the ghost. The medium gains a +2 bonus on all rolls made in dealing with the ghost during the scene."
            },
            {
                "type": "table",
                "headers": [
                ...
                "rows": [
                    [
                        "+1 per extra person (max +3)",
                        "The medium attempts to summon a ghost during a séance in which he is assisted by believers (see “Believers,” on p. 64). During a séance, a ghost’s loved ones are considered to be believers unless they categorically reject the possibility of life after death."
                    ],
                    [
                        "+1",
                        "The medium has summoned this particular ghost before."
                    ],
                    [
                        "+1",
                        "The medium has some object or person (other than an anchor) important to the ghost during its life."
                    ],
                    [
                        "+3",
                        "The medium possesses another anchor of the ghost to be summoned."
                    ],
                    [
                        "-1",
                        "Per 50 years that the ghost has been dead."
                    ]
                ]
            },
            {
                ...
                "text": [
                    {
                        "text": "Option [Spiritualist Medium]:",
                        "bold": true
                    },
                    " The medium can interact with the dead only in the context of a séance. In order to utilize this power, she must be assisted by one or more people. The medium gains a die bonus equal to the total number of believers in the séance up to a maximum of +5."
                ]
            }
        ],
        "Book": "SS 46",
...
export const psychicPsychokineticMeritsData = [
        ...
        "Content": [
            {
                ...
                "text": [
                    ...
                    " Biokinesis governs a psychic’s ability to manipulate the biological processes of living things. The scientific explanation for biokinesis eludes most parapsychologists. The most commonly accepted explanation relies on Wilhelm Reich’s theories regarding orgone energy, which are consistent with biokinetics’ claims that they can perceive and manipulate some form of ambient “life energy.” Biokinesis permits a psychic to manipulate his own personal life force to alter his body in three ways."
                ]
            },
            {
                "type": "paragraph",
                "text": [
                    "First, Biokinesis is a prerequisite for a number of other powers that allow a psychic to manipulate life energy. Second, the power can aid a psychic in attempts to control his own mind and body. Each dot in Biokinesis is added as a bonus die to all attempts to either meditate (see the ",
                    {
                        "text": "World of Darkness Rulebook",
                        "bold": true
                    },
                    ", p. 51) or to enter a trance state (see p. 35)."
                ]
            },
            {
                "type": "paragraph",
                "text": [
                    "Finally, Biokinesis allows a psychic to make minor alterations to his own physical body, temporarily affording him the benefit of certain Physical or Mental Merits, including some from the ",
                    {
                        "text": "World of Darkness Rulebook",
                        "bold": true
                    },
                    " and others listed here. Each Merit gained this way has a “success cost” equivalent to the Merit’s normal rating. The player must make an extended Intelligence + Composure roll with each roll representing a number of minutes equal to the success cost of the desired Trait. A Merit gained through Biokinesis lasts for the duration of a scene unless stated otherwise. Normally, the psychic can gain only a single Merit with a roll, but a biokinetic’s successes can be spent on multiple Merits with an exceptional success. In order to be able to use a Merit, the psychic must meet any prerequisites for that trait, and the psychic must have Biokinesis dots equal to [the success cost of the Merit +1]. The Merits that can be acquired through this power include the following:"
                ]
            },
            {
                "type": "line",
                "label": "Eidetic Memory (Two successes):",
                "text": [
                    "See the ",
                    {
                        "text": "World of Darkness Rulebook",
                    ...
                    ", p. 108. This Merit lasts for one scene."
                ]
            },
            {
                "type": "line",
                "label": "Fast Reflexes (One or two successes):",
                "text": [
                    "See the ",
                    {
                        "text": "World of Darkness Rulebook",
                    ...
                    ", p. 110. This Merit lasts for one scene."
                ]
            },
            {
                "type": "line",
                "label": "Fleet of Foot (One to three successes):",
                "text": [
                    "See the ",
                    {
                        "text": "World of Darkness Rulebook",
                    ...
                    ", p. 112. This Merit lasts for one scene."
                ]
            },
            {
                "type": "line",
                "label": "Fresh Start (One success):",
                "text": [
                    "See the ",
                    {
                        "text": "World of Darkness Rulebook",
            ...
            },
            {
                ...
                "text": [
                    ...
                    ", p. 113. This Merit lasts for one scene."
                ]
            },
            {
                "type": "line",
                "label": "Iron Stomach (Two successes):",
                "text": [
                    "See the ",
                    {
                        "text": "World of Darkness Rulebook",
            ...
            {
                "type": "line",
                "label": "Natural Immunity (One success):",
                "text": [
                    "See the ",
                    {
                        "text": "World of Darkness Rulebook",
                    ...
                    ", p. 113. This Merit lasts for one day per dot of Biokinesis or until the psychic uses his Biokinesis again, whichever comes first."
                ]
            },
            {
                "type": "line",
                "label": "Pain Resistance (Three successes):",
                "text": "The psychic becomes extraordinarily resistant to the physical side effects of pain and injury. Wound penalties are reduced by one, and the character gains a +1 bonus on rolls to stay conscious after all Health boxes have been filled with bashing damage, all for the duration of the scene."
            },
            {
                "type": "line",
                "label": "Quick Healer (Four successes):",
                "text": [
                    "See the ",
                    {
                        "text": "World of Darkness Rulebook",
            ...
            {
                "type": "line",
                "label": "Strong Lungs (Three successes):",
                "text": [
                    "See the ",
                    {
                        "text": "World of Darkness Rulebook",
            ...
            {
                "type": "line",
                "label": "Toxin Resistance (Two successes):",
                "text": [
                    "See the ",
                    {
                        "text": "World of Darkness Rulebook",
                    ...
                    ", p. 113. This Merit lasts for one day per point of Biokinesis or until the psychic uses his Biokinesis again, whichever comes first."
                ]
            }
        ],
        "FullPrerequisite": "",
        "Cost": "1 Willpower",
        "DicePool": "Intelligence + Composure",
        "Action": "Extended",
        "RollResult": [
            {
                "type": "line",
                "label": "Dramatic Failure:",
                "text": "The psychic suffers one point of bashing damage due to painful psychic feedback. He cannot attempt to use his Biokinesis powers for the remainder of the scene."
            },
            {
                "type": "line",
                "label": "Failure:",
                "text": "The psychic fails to accumulate any successes for now, but may keep trying, or utterly fails to manifest any biokinetic benefits."
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "Accumulated successes can be used to temporarily acquire a single desired Merit, provided the psychic meets any prerequisites and his Biokinesis dots equal or exceed the desired Merit’s success cost, plus one."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
                "text": "Accumulated successes can be used to acquire multiple Merits temporarily, with successes allocated for dots as the player chooses."
            }
        ],
        "Book": "SS 46",
    ...
    },
    {
        ...
        "RollResult": [
            ...
            },
            {
                ...
                "text": [
                    {
                        "text": "Option [Emotional Cryokinesis]:",
                        "bold": true
                    },
        ...
        "Content": [
            {
                "type": "paragraph",
                "text": [
                    "The inverse of Psychic Healing, Psychic Vampirism allows a psychic to take life as well as restore it, draining orgone energy from victims to replenish one’s own Willpower. There are two versions of this Merit, both of which require physical contact with the victim. (See “Touching an Opponent,” the ",
                    {
                        "text": "World of Darkness Rulebook",
                        "bold": true
                    },
                    ", p. 157.) The four-dot version allows a psychic to drain a target of temporary Willpower points. The Willpower is lost. With the five-dot version, the psychic regains one point of Willpower for every two points of Willpower stolen. The psychic cannot gain more Willpower points than he has permanent Willpower dots."
                ]
            },
            {
                "type": "paragraph",
                "text": "Both versions of this power automatically fail when used against mages, werewolves or vampires. Storytellers should be cautious that players of characters with the five-dot version do not rely on it to regain Willpower to the exclusion of their own Morality."
            }
        ],
        "FullPrerequisite": "Biokinesis •••• for the four-dot version. Biokinesis ••••• for the five-dot version.",
        "Cost": "None",
        "DicePool": "Wits + Resolve (— the target’s Resolve). The psychic vampire must also successfully touch a victim.",
        "Action": "Instant",
        "RollResult": [
            {
                "type": "line",
                "label": "Dramatic Failure:",
                "text": "The psychic fails to steal any Willpower points and actually loses one Willpower point instead."
            },
            {
                "type": "line",
                "label": "Failure:",
                "text": "The psychic’s attempt fails."
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "The psychic drains the victim of one temporary Willpower per success."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
            ...
            },
            {
                "type": "heading",
                "level": 2,
                "text": "Story Hook: The Angel of Death"
            },
            {
                "type": "paragraph",
                "text": [
                    "Mercy Cross Hospital has a rather unusual reputation. On one hand, the hospital has a terrible track record with elderly patients who are brought in from local nursing homes. No fewer than 10 such patients have died within a day of admission within the last two years. On the other hand, the hospital’s burn and pediatric wards have been sites for what can only be considered miracles, as dozens of burned people and dying children have made astonishing recoveries. The connection between the situations is a woman named Maria Delgado, a Nicaraguan immigrant working as a night janitor. A powerful psychic healer, Maria has cured dozens of people as they have slept. Unfortunately, such healing takes prodigious Willpower, and Maria has reluctantly replenished herself the only way she can — by using her Psychic Vampirism to drain the life from elderly patients. Maria believes that she is justified in taking life from those at the end of their lives to heal those at the beginning, but the strain of deciding who lives and who dies frays her sanity. The numerous deaths of elderly patients also attracts attention, and Maria considers finding some other source of people who need to die so that ",
                    {
                        "text": "los niños",
                        "italic": true
                    },
    ...
    },
    {
        ...
        "Content": [
            ...
            {
                "type": "paragraph",
                "text": "A character with Pyrokinesis must overcome three difficulties in starting a fire: the size of the fire to be set, the desired heat level of the flame and the relative flammability of the material to be ignited. The modifiers applied to attack roll for each of these criteria are listed below."
            },
            {
                "type": "table",
                "headers": [
                ...
                "rows": [
                    [
                        "0",
                        "A candle wick or match. About a three-inch radius."
                    ],
                    [
                        "-1",
                        "A torch. About a six-inch radius (+1 lethal damage)."
                    ],
                    [
                        "-2",
                        "A small campfire. About a one-foot radius or a Size 1 object."
                    ],
                    [
                        "-3",
                        "A large campfire. About a two-foot radius or a Size 2 object."
                    ],
                    [
                        "-4",
                        "Roughly the size of a man. About a four-foot radius or a Size 5 object."
                    ],
                    [
                        "-5",
                        "A bonfire. About an eight-foot radius or a Size 10 object (+2 lethal damage)."
                    ]
                ]
            },
            {
                "type": "paragraph",
                "text": "* A pyrokinetic cannot create a fire larger than a bonfire with a single application of this power."
            },
            {
                "type": "table",
                "headers": [
                ...
                "rows": [
                    [
                        "0",
                        "Candle heat sufficient to cause a first degree burn."
                    ],
                    [
                        "-1",
                        "Torch heat sufficient to cause a second degree burn (+1 lethal damage)."
                    ],
                    [
                        "-2",
                        "Bunsen burner heat sufficient to cause a third degree burn (+2 lethal damage)."
                    ]
                ]
            },
            {
                "type": "paragraph",
                "text": "* Thermokinesis is required to create temperatures hotter than a Bunsen burner, such as a chemical fire or molten metal."
            },
            {
                "type": "table",
                "headers": [
                ...
                "rows": [
                    [
                        "+2",
                        "A flammable gas (butane, hydrogen, pure oxygen)"
                    ],
                    [
                        "+1",
                        "A flammable liquid (gasoline, kerosene)"
                    ],
                    [
                        "0",
                        "An easily flammable solid (match heads, oily rags, wax, fireworks)"
                    ],
                    [
                        "-1",
                        "Dry and lightweight flammable materials (paper, dry leaves, cotton)"
                    ],
                    [
                        "-2",
                        "Wood, cardboard, most clothing, vampires"
                    ],
                    [
                        "-3",
                        "Wet wood or clothing, hair"
                    ],
                    [
                        "-4",
                        "Plastic, fire retardant cloth, human flesh"
                    ]
                ]
            },
            {
                "type": "paragraph",
                "text": "* Igniting anything more flame resistant than this requires Thermokinesis."
            },
            {
                "type": "paragraph",
                "text": "The roll to start a fire involves Wits + Resolve. When the pyrokinetic seeks to ignite a person or some other target capable of movement, the attempt is treated as a ranged attack. Defense does not apply, but the pyrokinetic suffers a -2 penalty when attempting to ignite a moving target. Short range for a pyrokinetic attack is equal to a psychic’s Intelligence + Wits + Pyrokinesis dots in yards. Medium range is twice that distance and imposes a -2 penalty on an attack dice pool. Long range is up to twice medium range and imposes a -4 penalty on an attack dice pool."
            },
            {
                "type": "paragraph",
                "text": "The damage inflicted with a successful pyrokinetic attack is equal to one point of lethal damage for each success. This damage pool (minus the benefits of any heat-resistant armor) is inflicted every turn on anyone set ablaze until the fire is put out."
            },
            {
                "type": "paragraph",
                "text": "Once a fire is set, it can be put out normally or extinguished instantly with another application of Pyrokinesis. Putting out an existing fire requires an extended Stamina + Resolve roll with the number of successes required equal to the Size of the blaze +1, with each roll taking one turn’s action."
            }
        ],
        "FullPrerequisite": "",
        "Cost": "1 Willpower",
        "DicePool": "Wits + Resolve to start a fire. Stamina + Resolve to snuff one out.",
        "Action": "Instant to start a fire. Extended to snuff out a fire, with each roll representing one turn.",
        "RollResult": [
            {
                "type": "line",
                "label": "Dramatic Failure:",
                "text": "The psychic suffers one point of lethal damage due to painful psychic feedback. Alternately, the psychic might produce a flame of the desired intensity but not where he wants it to combust. A pyrokinetic attempting to snuff a flame might make it larger instead."
            },
            {
                "type": "line",
                "label": "Failure:",
                "text": "The attempt to start or extinguish a fire is unsuccessful."
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "The pyrokinetic ignites his target. If attempting to snuff out a flame, the pyrokinetic accumulates a number of successes equal to the Size of the fire +1."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
            ...
            },
            {
                ...
                "text": [
                    {
                        "text": "Option [Emotional Pyrokinesis]:",
                        "bold": true
                    },
                    " Whenever a pyrokinetic is in the grip of strong emotion, the Storyteller may direct the player to roll Resolve + Composure with a dice penalty equal to the intensity of the emotion as described by the Emotional Response table on p. 60. If the roll is unsuccessful, the pyrokinetic’s powers function randomly, igniting small, nearby flammable objects. A dramatic failure means that this pyrokinetic activity might flare up at random intervals over the next several days whenever the pyrokinetic is agitated. Such wild phenomena do not require the expenditure of a Willpower point. A pyrokinetic with this option gains a +2 bonus on all deliberate uses of this power."
                ]
            }
        ],
        "Book": "SS 50",
        ...
        "Content": [
            {
                ...
                "text": [
                    ...
                    " Your pyrokinetic is highly resistant if not completely immune to fire. With the two-dot version, make a reflexive Stamina + Resolve roll when your character is exposed to mundane fire, with each success providing one point of armor that protects against only fire damage. With the four-dot version, you need only spend one Willpower point to render your character totally immune to fire damage. If any Doubting Thomas (see p. 65) is present when the four-dot version of this Trait is invoked, a successful Stamina + Resolve roll subject to normal penalties is required for unilateral protection to activate."
                ]
            },
            {
                "type": "paragraph",
                "text": "The effects of either version last for one scene, although clothes and possessions are not protected. No protection is provided against supernaturally induced fires or flames."
            }
        ],
        "FullPrerequisite": "Pyrokinesis",
        "Cost": "1 Willpower",
        "DicePool": "Stamina + Resolve for the two-dot version. None for the four-dot version, unless a Doubting Thomas is present.",
        "Action": "Reflexive",
        "RollResult": [
            {
                "type": "line",
                "label": "Dramatic Failure:",
                "text": "The psychic is not protected from the flames, and fire damage is increased by one."
            },
            {
                "type": "line",
                "label": "Failure:",
                "text": "The psychic is not protected from the flames, but she can try again in the next turn as a subsequent attempt."
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "Each success provides one dot of armor with the two-dot version. With the four-dot version, total immunity is conferred despite the presence of a Doubting Thomas."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
                "text": "With the two-dot version, additional successes are their own reward. With the four-dot version, any Doubting Thomases present are treated as ordinary people for the duration of the scene and do not inflict any further dice penalties on the psychic during that time."
            }
        ],
        "Book": "SS 52",
    ...
    },
    {
        ...
        "DicePool": "Wits + Crafts to shape flames. Wits + Crafts (— target’s Defense) to attack with a flame.",
        "Action": "Instant",
        "RollResult": [
            {
                "type": "line",
                "label": "Dramatic Failure:",
                "text": "The psychic suffers one point of lethal damage due to painful psychic feedback. Alternately, the psychic might send the flames to a different location than intended."
            },
            {
                "type": "line",
                "label": "Failure:",
                "text": "The attempt to shape the fire is unsuccessful."
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "The pyrokinetic manipulates the fire to his desires, determining the direction in which it spreads and perhaps even shaping it into simple forms. If used as an attack, the flames inflict one point of lethal damage per success."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
                "text": "In addition to damage inflicted, the target is set ablaze and continues to take lethal damage per turn until the fire is extinguished."
            },
            {
                "type": "table",
                ...
                "rows": [
                    [
                        "+1",
                        "The pyrokinetic created the flames with his Pyrokinesis Merit, and they are now manipulated."
                    ],
                    [
                        "0",
                        "The flames being manipulated are natural fire."
                    ],
                    [
                        "-1",
                        "The flames being manipulated were created by another pyrokinetic."
                    ],
                    [
                        "-3",
                        "The intended manipulation is something wholly unnatural to fire, such as shaping it into a face or into the form of an animal."
                    ]
                ]
            }
        ],
    ...
    },
    {
        ...
        "Content": [
            ...
            },
            {
                "type": "paragraph",
                "text": [
                    "The simplest use of Telekinesis is to lift objects. The player must first spend a Willpower point to activate the power. Each dot gives a character one dot of Strength that can be applied to move any physical object within the telekinetic’s direct line of sight, pursuant to the lifting/moving objects chart in the ",
                    {
                        "text": "World of Darkness Rulebook",
                        "bold": true
                    },
            ...
            {
                "type": "paragraph",
                "text": "Telekinesis is both physically and mentally taxing; a character can hold up an object for a number of turns equal to the lesser of his Stamina or Resolve. After that, he must either drop the object or another Willpower point must be spent to retain control. A telekinetic can lift objects smaller than Size 1, but he must still be able to see the object directly."
            }
        ],
        "FullPrerequisite": "A telekinetic can possess but cannot use more dots in this Merit at one time than he has Resolve.",
        "Cost": "1 Willpower + 1 additional Willpower after every [lesser of Stamina or Resolve] turns",
        "DicePool": "No roll is required to lift an object, provided that the psychic’s Telekinesis Merit dots are sufficient to do so. If the object is too big, a Resolve + Composure roll is required.",
        "Action": "Reflexive",
        "RollResult": [
            {
                "type": "line",
                "label": "Dramatic Failure:",
                "text": "The item is dropped and/or the telekinetic suffers one point of bashing damage due to psychic feedback from the effort."
            },
            {
                "type": "line",
                "label": "Failure:",
                "text": "The telekinesis attempt is unsuccessful."
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "Telekinesis dots increase by one per success."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
                "text": [
                    "The telekinetic increases his Merit dots by five or more and gains a +1 bonus on any attempt to manipulate the item, such as throwing it. Also, the telekinetic can continue to manipulate the object for a number of turns equal to the ",
                    {
                        "text": "greater",
                        "italic": true
                    },
                    " of his Stamina or Resolve before needing to set the object down or spend another Willpower."
                ]
            },
            {
                "type": "heading",
                "level": 3,
                "text": "Throwing an Object"
            },
            {
                "type": "paragraph",
                "text": "If the telekinetic wishes to hurl an object at a target, he must first lift it. An object can be lifted and thrown as part of the same instant action, provided the character’s total Telekinesis dots exceed those required to lift the item. A non-aerodynamic object (such as a clay pot or tire) can be thrown a distance in yards equal to Wits + Resolve + total Telekinesis dots, minus the object’s Size. This distance is considered short range. Medium range is double that, and long range is twice medium range. So, a character with 4 Wits, 3 Resolve and an unmodified 2 Telekinesis can throw a tire with 2 Size a short distance of 7 yards, a medium range of 14 yards and a long range of 28 yards. Aerodynamic objects can be thrown double those distances, but an object whose Size exceeds the psychic’s modified Telekinesis dots cannot be thrown no matter how aerodynamic it is."
            },
            {
                "type": "paragraph",
                "text": "Hitting a target requires you to roll Wits + Resolve, -2 for medium range and -4 for long range. The Damage of the object thrown (usually the lesser of its Size or Durability) is added to the dice pool, and the target’s Defense applies. A character can hurl an object up to twice long range, but is automatically reduced to a chance die."
            },
            {
                "type": "line",
                "label": "Cost:",
                "text": "None, although 1 Willpower is required to lift the object"
            },
            {
                "type": "line",
                "label": "Dice Pool:",
                "text": "Wits + Resolve + Damage bonus of thrown object (- target’s Defense)"
            },
            {
                "type": "line",
                "label": "Action:",
            ...
            },
            {
                "type": "line",
                "label": "Dramatic Failure:",
                "text": "The character loses control of the item. If it is large or heavy (Size 4+), he loses his telekinetic grip and drops it, possibly hurting himself or others. Smaller objects land wildly off the mark."
            },
            {
                "type": "line",
                "label": "Failure:",
                "text": "The telekinetic attack misses its target."
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "The telekinetic hits his target, inflicting one point of damage per success."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
                "text": "The telekinetic hits his target with great accuracy and force."
            },
            {
                "type": "line",
                "label": "Suggested Equipment:",
                "text": [
                    "See the Damage ratings of possible thrown objects on p. 150 of the ",
                    {
                        "text": "World of Darkness Rulebook",
                        "bold": true
                    },
            ...
            },
            {
                "type": "line",
                "label": "Dice Pool:",
                "text": "Stamina + Resolve (- the target’s Strength)"
            },
            {
                "type": "line",
                "label": "Dramatic Failure:",
                "text": "The grappling attempt is unsuccessful, and the telekinetic suffers one point of bashing damage due to psychic feedback from the failed effort."
            },
            {
                "type": "line",
                "label": "Failure:",
            ...
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "The telekinetic successfully grapples the target, pinning her or lifting her off the ground. The telekinetic can keep the target immobilized for a number of turns equal to the lesser of his Stamina or Resolve, unless the subject escapes earlier. Spending Willpower extends the period in which a victim may be held."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
                "text": [
                    "The telekinetic can restrain his target for a number of turns equal to the ",
                    {
                        "text": "greater",
                        "italic": true
                    },
                    " of his Stamina or Resolve."
                ]
            },
            {
                "type": "heading",
                "level": 3,
                "text": "Telekinetic Blow (Telekinesis •••••)"
            },
            {
                "type": "paragraph",
            ...
            },
            {
                "type": "line",
                "label": "Dramatic Failure:",
                "text": "The attack is unsuccessful and the telekinetic suffers one point of bashing damage due to psychic feedback from the failed effort. Alternately, the telekinetic might inadvertently hit someone or something other than his intended target."
            },
            {
                "type": "line",
                "label": "Failure:",
                "text": "The telekinesis attack is unsuccessful."
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "The telekinetic strikes his target with a blast of pure kinetic force, inflicting one point of bashing damage per success."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
                "text": [
                    "In addition to bashing damage inflicted, the target must also roll to avoid knockdown (see the ",
                    {
                        "text": "World of Darkness Rulebook",
                        "bold": true
                    },
    ...
    },
    {
        ...
        "Content": [
            ...
            {
                "type": "paragraph",
                "text": "Thermokinetics also have an improved resistance to environmental temperature extremes. A psychic with this power is automatically immune to natural temperature extremes ranging from zero to 100 degrees, plus an additional temperature range equal to plus or minus [Merit dots x20] degrees. A thermokinetic is immune to high-temperature attacks unless the attacker’s Thermokinesis dots exceed his own."
            }
        ],
        "FullPrerequisite": "A character’s dots in this Merit cannot exceed the lesser of her Resolve or Stamina.",
        "Cost": "1 Willpower per roll to affect temperature. None to resist temperature.",
        "DicePool": "Intelligence + Resolve (- Size of the area to be affected) to increase temperature. No roll to resist temperature extremes.",
        "Action": "Instant",
        "RollResult": [
            {
                "type": "line",
                "label": "Dramatic Failure:",
                "text": "The psychic fails to affect ambient temperature and suffers one point of bashing damage as his own internal body temperature goes haywire."
            },
            {
                "type": "line",
                "label": "Failure:",
                "text": "The psychic fails to affect the ambient temperature."
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "Each success raises the ambient temperature as described above."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
...
export const psychicTelepathicMeritsData = [
    {
        ...
        "DicePool": "Wits + Animal Ken to communicate. Manipulation + Animal Ken (versus animal’s Resolve rolled reflexively) to control.",
        "Action": "Instant or contested",
        "RollResult": [
            {
                "type": "line",
                "label": "Dramatic Failure:",
                "text": "The character triggers psychic feedback in the animal, making it immediately hostile. Further attempts to use Animal Empathy against the animal fail automatically for the remainder of the scene."
            },
            {
                "type": "line",
                "label": "Failure:",
                "text": "The character fails to influence the animal in any way."
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "The psychic can intuitively understand the animal’s mood and thought processes. Although true communication is not yet possible, the psychic can intuit crude impressions such as “I’m hungry,” “I want to play” or “That man beats me.” With Manipulation, the psychic can command the animal to follow simple instructions such as “Heel,” “Fetch” or “Tear him apart!” Animals that were previously hostile become docile, and trained guard dogs let an intruder walk right by."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
                "text": "The psychic can freely communicate with the animal, almost to the point of sharing its senses. The psychic can also give relatively complex instructions and expect them to be obeyed, such as “Go fetch Timmy! He’s in town at the movie theater, in the third row!”"
            },
            {
                "type": "table",
                "title": "Dice Modifiers",
                ...
                "rows": [
                    [
                        "+1",
                        "The psychic has previously used this power successfully on the same animal(s)."
                    ],
                    [
                        "0",
                    ...
                    [
                        "-1",
                        "The animal is a common fish or a group of up to three mammals."
                    ],
                    [
                        "-3",
                        "The animal is a single insect, a school/swarm of up to 25 fish or vermin or a group of up to 10 larger mammals."
                    ],
                    [
                        "-5",
                        "The animal is a swarm of insects with a hive mentality, or a collective group of up to 100 small creatures or up to 25 larger mammals."
                    ]
                ]
            }
        ],
        ...
        "Content": [
            {
                ...
                "text": [
                    ...
                    ", p. 168) in the duration of the possession. If the character’s physical body is killed while possessing an animal, her mind dies as well. If the animal is killed during the possession, the psychic’s mind is immediately sent back to her body."
                ]
            },
            {
                "type": "paragraph",
                "text": "This power requires the animal to be possessed to have at least the intelligence of a small rodent or fish. Simpler creatures such as insects cannot be possessed. Possession lasts for one scene, but can be extended at the cost of one Willpower point per scene. Under no circumstances can the time of possession last beyond a number of hours equal to the lesser of the psychic’s Stamina or Resolve. This power cannot be used against sentient creatures, including mages, vampires or werewolves who have simply assumed the forms of animals. The psychic can never possess more than one animal at a time. The psychic also cannot possess an animal smaller than a mouse. Animals larger than Size 5 confer a penalty on the roll."
            }
        ],
        "FullPrerequisite": "Animal Empathy •• or ••••. If the psychic has only the two-dot version of Animal Empathy, he is limited to possessing the type of animal with which he is attuned. The four-dot version allows possession of any type of animal.",
        "Cost": "1 Willpower",
        "DicePool": "Presence + Animal Ken versus animal’s Resolve; resistance is reflexive",
        "Action": "Contested",
        "RollResult": [
            {
                "type": "line",
                "label": "Dramatic Failure:",
                "text": "The character triggers psychic feedback in the animal, making it immediately hostile. Further attempts to use Animal Possession against the animal fail automatically for the remainder of the scene."
            },
            {
                "type": "line",
                "label": "Failure:",
                "text": "The character fails to possess the animal."
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "The psychic projects his own consciousness into the animal, totally controlling its body and replacing its Mental (but not Social) Attributes with his own. The psychic cannot use any other psychic powers while possessing the animal, although he can end the possession at any time. The animal’s Physical Traits prevail."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
                "text": "The psychic can maintain the possession for up to the lesser of his Stamina or Resolve in hours without paying any additional Willpower."
            },
            {
                "type": "table",
                "title": "Dice Modifiers",
                ...
                "rows": [
                    [
                        "+1",
                        "The psychic has previously used the Animal Possession power on the animal to be possessed."
                    ],
                    [
                        "—",
                        "The animal is a mammal or bird."
                    ...
                    [
                        "-1",
                        "Per point of the animal’s Size in excess of 5."
                    ],
                    [
                        "-2",
                        "The animal is a reptile or sophisticated aquatic life form such as a dolphin or shark."
                    ],
                    [
                        "-4",
    ...
    },
    {
        ...
        "Content": [
            ...
            {
                "type": "paragraph",
                "text": "No roll is ever required for verbal communication, but the character does not have the capacity to control the creature outright. If he wishes it to do something that the animal might consider dangerous, you must win a contested roll against the animal, which, while generally loyal, does not normally commit suicide on its master’s behalf. Resolve or Composure is rolled reflexively for the animal, while Manipulation or Presence + an appropriate Skill is rolled for the character."
            },
            {
                "type": "paragraph",
                "text": "The animal with which the character has a bond is a normal example of its species, but a side effect of the rapport permanently increases the animal’s Intelligence by one. If the character seriously mistreats his pet, it is capable of turning, at the Storyteller’s discretion. The character must be within line of sight to communicate freely with the animal, but if the animal can hear the character even at great distance (such as Timmy yelling from down a well a half-mile away), the animal likely travels as quickly as it can to its master’s location."
            },
            {
                "type": "paragraph",
                "text": "If the animal is ever lost or killed, experience spent or dots assigned to this Merit may be lost or reassigned at the Storyteller’s discretion. The character may even forge a bond with another such amazing animal, assuming one can be found."
            }
        ],
        "FullPrerequisite": "Animal Ken ••+",
        "Cost": "",
        "DicePool": "",
        "Action": "",
        "RollResult": [""],
    ...
    },
    {
        ...
        "FullPrerequisite": "Thought Projection ••••",
        ...
        "DicePool": "Presence + Intimidation - subject’s Stamina",
        "Action": "Instant",
        "RollResult": [
            {
                "type": "line",
                "label": "Dramatic Failure:",
                "text": "The character suffers one point of bashing damage from psychic feedback and is unable to use the power for the remainder of the scene."
            },
            {
                "type": "line",
                "label": "Failure:",
                "text": "The character fails to inflict any damage."
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "The character inflicts damage as noted above."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
                "text": [
                    "Additional successes are their own reward. Also, the target must roll her Stamina to avoid knockout (see the ",
                    {
                        "text": "World of Darkness Rulebook",
                        "bold": true
                    },
    ...
    },
    {
        ...
        "FullPrerequisite": "Thought Projection ••••",
        "Cost": "1 Willpower",
        "DicePool": "Presence + Empathy versus the subject’s Resolve + Supernatural Advantage. Intelligence + Science may be rolled instead for characters with specialized training in psychology or something similar, with a successful roll permitting a telepath to tailor the derangement to his desire.",
        "Action": "Contested",
        "RollResult": [
            {
                "type": "line",
                "label": "Dramatic Failure:",
                "text": "The character suffers one Storyteller-chosen derangement for the remainder of the scene."
            },
            {
                "type": "line",
                "label": "Failure:",
                "text": "The character fails to inflict madness on his target."
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "The character gets more successes than the target, who suffers one mild derangement for the remainder of the scene."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
                "text": "The character gets at least five successes and exceeds those of the target. If the psychic wishes, the derangement inflicted may be severe instead of mild. Alternatively, the target can be subjected to a permanent mild derangement that can be removed through only roleplaying."
            }
        ],
        "Book": "SS 58",
    ...
    },
    {
        ...
        "Content": [
            ...
            {
                "type": "paragraph",
                "text": "Commands that force a subject to violate deeply held beliefs, to act against Virtues, or to harm loved ones impose a penalty to the roll made for the psychic. Mind Control is effective only against ordinary people and other psychics. A Mind Control attempt automatically fails against anyone who is the subject of a supernatural template (such as mages, vampires and werewolves). However, ghouls, wolf-blooded and similar beings may be affected, although they may gain bonus dice to resist in some circumstances (such as when a ghoul is mentally controlled to betray his undead master)."
            },
            {
                "type": "paragraph",
                "text": [
                    "The benefits of the Striking Looks Merit (see the ",
                    {
                        "text": "World of Darkness Rulebook",
                        "bold": true
                    },
                    ", p. 117) apply to Mind Control attempts, and psychics with the Hypnotic Voice Merit (see p. 66) gain a +2 bonus on all uses of this power. The psychic must concentrate fully on his subject while conveying his instructions, suffering all the normal penalties for concentration. How long this effort takes depends on the complexity of the instructions, and may last for several turns. Once the command is issued, the psychic does not need to continue concentrating. The telepath’s command must be something that can be completed within the scene or the attempt fails, ",
                    {
                        "text": "unless",
                        "italic": true
                    },
                    " the telepath achieves an exceptional success."
                ]
            }
        ],
        "FullPrerequisite": "The psychic must deliver his instructions verbally unless he is capable of projecting his thoughts.",
        "Cost": "1 Willpower",
        "DicePool": "Manipulation + Persuasion versus subject’s Resolve (resistance is reflexive)",
        "Action": "Contested; requires concentration while instructions are conveyed",
        "RollResult": [
            {
                "type": "line",
                "label": "Dramatic Failure:",
                "text": "The character triggers psychic feedback in the target, making him instinctively withdraw or distrust her. The target is also rendered immune to further Mind Control attempts by the psychic for the next day."
            },
            {
                "type": "line",
                "label": "Failure:",
                "text": "The target ignores the character’s command."
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "The target obeys the character’s command, provided that the order can be fulfilled within one scene."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
                "text": "The player gets five or more successes and they exceed those of the target. There is no time limit on how long the command can take to be executed."
            },
            {
                "type": "table",
                "title": "Dice Modifiers",
                ...
                "rows": [
                    [
                        "+1",
                        "The psychic has successfully used Mind Control on the subject within the last week."
                    ],
                    [
                        "-1",
                        "The command forces the subject to act against a loved one or to violate deeply held personal beliefs."
                    ],
                    [
                        "-2",
                        "The command forces the subject to harm a loved one or to act against a Virtue."
                    ],
                    [
                        "-4",
                        "The command forces the subject to kill a loved one or perform an action that might cause her to lose Morality."
                    ],
                    [
                        "-5",
                        "The command is clearly suicidal."
                    ]
                ]
            }
        ],
    ...
    },
    {
        ...
        "FullPrerequisite": "",
        "Cost": "1 Willpower",
        "DicePool": "Intelligence + Empathy versus the subject’s Composure + Supernatural Advantage (resistance is reflexive)",
        "Action": "Contested",
        "RollResult": [
            {
                "type": "line",
                "label": "Dramatic Failure:",
                "text": "The character triggers psychic feedback in his target, making her instinctively withdraw or distrust him. The target can also automatically resist any use of Telepathic Merits by the psychic for the next day."
            },
            {
                "type": "line",
                "label": "Failure:",
                "text": "The character fails to read the target’s mind."
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "The character can perceive the target’s thoughts, and the player is allowed to ask one question about them per success. Surface scans are limited to what a subject currently thinks about, although a telepath can attempt to manipulate a subject into thinking about something in particular with a successful Manipulation + Subterfuge roll (contested by Wits + Subterfuge if the subject is aware of the telepath’s capabilities). If the psychic is capable of deep scans, the player can ask questions about any topic, including questions about a subject’s buried memories or even subconscious thoughts of which the subject is not even aware."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
                "text": "Extra successes are their own reward. Also, the Storyteller may rule that the telepath discovers some useful tidbit of information in the subject’s mind for which he wasn’t even searching."
            },
            {
                "type": "table",
                "title": "Dice Modifiers",
                ...
                "rows": [
                    [
                        "+1",
                        "The psychic has successfully used Mind Reading on the subject within the last week."
                    ],
                    [
                        "+1",
                        "The psychic touches the subject."
                    ],
                    [
                        "+1",
                        "The subject willingly consents to a telepathic probe."
                    ],
                    [
                        "+2",
                        "The subject willingly consents to a telepathic probe and also has this Merit, or, at the Storyteller’s discretion, has some other supernatural or psychic power that conveys telepathic abilities."
                    ],
                    [
                        "-1",
                        "The subject actively resists the telepathic probe and also has this Merit, or at the Storyteller’s discretion has some other supernatural or psychic power that conveys telepathic abilities."
                    ]
                ]
            }
        ],
    ...
    },
    {
        ...
        "Content": [
            ...
            },
            {
                ...
                "rows": [
                    [
                        "0",
                        "No discernable signs of the emotional state."
                    ],
                    [
                        "-1",
                        "Noticeable signs of the emotional state."
                    ],
                    [
                        "-2",
                        "Obvious signs of the emotional state. A Resolve + Composure roll for the subject must succeed to avoid acting on the emotion in minor ways (snide comments toward someone he dislikes, flirting with the person for whom he now feels sexual attraction) every time he has an opportunity to do so."
                    ],
                    [
                        "-3",
                        "Unambiguous signs of the emotional state. As with the previous entry, except that the target must get at least as many successes on the Resolve + Composure as the empath does on the Psychic Empathy roll to avoid acting out on the emotion in a very obvious way (picking a fight with a person he now hates, acting in a subservient manner toward a person he now loves)."
                    ],
                    [
                        "-4",
                        "Overwhelming signs of the emotional state. The emotional state approaches or even exceeds the level of a derangement (homicidal rage, suicidal depression, obsessive stalking). A Willpower point must be spent for the subject to even attempt a Resolve + Composure roll to contest the emotional compulsion, and he must still get as many successes as the empath does on the activation roll. The target seeks out opportunities to act on the emotion in obvious ways, and any attempt to conceal his state is automatically reduced to a chance die."
                    ]
                ]
            },
            {
                "type": "paragraph",
                "text": [
                    "Any attempt to manipulate a subject’s emotional state is penalized by the intensity of the emotion to be created or suppressed. Thus, if an empath wanted to make a total stranger fall in love with her (i.e., moving from ",
                    {
                        "text": "no discernable signs",
                        "italic": true
                    },
                    " (0) of love to ",
                    {
                    ...
                    " (-3) signs of love), the dice pool suffers a -3 penalty. Or if an empath wants to totally suppress an enemy’s ",
                    {
                        "text": "overwhelming",
                        "italic": true
                    },
                    " (-4) hatred of her in order to allow for peaceful interaction, the dice pool suffers a -4 penalty. Often, an empath seeks to produce an emotion that is the opposite of one a target currently feels, such as causing a man to hate his beloved wife, or when she wants a suicidal person to suddenly feel happy about his life. In such cases, the penalty is the total associated with the previous emotion, plus the new one. Thus, converting a subject’s ",
                    {
                        "text": "unambiguous",
                        "italic": true
                    },
                    " (-3) love for his wife into ",
                    {
                        "text": "unambiguous",
                        "italic": true
                    },
                    " (-3) hate inflicts a total -6 penalty."
                ]
            },
            {
                "type": "paragraph",
                "text": "Emotions produced with the four-dot version of this power last while the empath concentrates, or for the duration of an entire scene if the empath achieves an exceptional success. The five-dot version automatically lasts for at least a scene, and applies for a day with an exceptional success. With either version, the dice pool for affecting emotions is Manipulation + Empathy, contested by the subject’s Resolve + Composure. The five-dot version is capable of affecting a being with a supernatural template, but the four-dot version automatically fails against such beings."
            },
            {
                "type": "paragraph",
                "text": "Any emotion can be affected by this power, and its parameters are limited mainly by the Storyteller’s discretion and a player’s innovation. A few of the more commonly affected emotions include anger, happiness or sadness, love, sexual libido, possessiveness (for an object or a person) and compassion. Only one successful attempt can be made to alter a subject’s emotions per scene."
            }
        ],
        "FullPrerequisite": "Aura Reading and Thought Projection (either version)",
        ...
        "DicePool": "The psychic must first successfully use Aura Reading on the subject (see “Aura Reading” on p. 57). The roll to alter emotions is Manipulation + Empathy versus Resolve + Composure (resistance is reflexive).",
        "Action": "Contested",
        "RollResult": [
            {
                "type": "line",
                "label": "Dramatic Failure:",
                "text": "The character triggers psychic feedback in the target, making him instinctively withdraw or distrust her. The subject is also immune to the psychic’s Psychic Empathy for the rest of the scene."
            },
            {
                "type": "line",
                "label": "Failure:",
                "text": "The character fails to influence the target’s emotions."
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "The subject’s emotions change according to the empath’s desires."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
                "text": "The emotional change lasts for a longer period of time. With the four-dot version, the effect persists for a scene without concentration. With the five-dot version, the effect lasts for a day."
            },
            {
                "type": "paragraph",
                "text": [
                    {
                        "text": "Option [Limited Empath]:",
                        "bold": true
                    },
            ...
            },
            {
                ...
                "text": [
                    {
                        "text": "Option [Touch Only]:",
                        "bold": true
                    },
                    " With this option, the empath can affect another’s emotional state only while physically touching the target, (although concentration is all that’s required after contact is made). See “Touching an Opponent,” the ",
                    {
                        "text": "World of Darkness Rulebook",
                        "bold": true
                    },
    ...
    },
    {
        ...
        "DicePool": "Manipulation + Persuasion versus the target’s Composure + Supernatural Advantage to create illusions (resistance is reflexive). Wits + Persuasion to manipulate existing illusions.",
        "Action": "Contested to activate; instant to manipulate",
        "RollResult": [
            {
                "type": "line",
                "label": "Dramatic Failure:",
                "text": "The character triggers psychic feedback, making every potential observer in the vicinity instinctively withdraw or distrust her. Also, the illusionist is unable to use this power again for the remainder of the scene."
            },
            {
                "type": "line",
                "label": "Failure:",
                "text": "The psychic fails to create any illusion at all."
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "Any affected targets perceive whatever sensory effect the psychic desires."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
                "text": "The illusions created are highly realistic. The psychic no longer needs to maintain concentration, although a Wits + Persuasion roll must still be made to cause the illusion to move or react in any way."
            }
        ],
        "Book": "SS 61",
    ...
    },
    {
        ...
        "Content": [
            {
                "type": "paragraph",
                "text": "As the name suggests, Psychic Invisibility represents a psychic’s ability to “cloud men’s minds” so that onlookers cannot perceive him. The character is not truly invisible; cameras are not affected by this power and anyone sufficiently perceptive can see through the deception. The psychic cannot disappear from view if he has already been seen, but any witnesses he encounters after the power is activated are typically unable to see him unless he does something to call attention to himself. If the psychic affects any physical object while a potential observer is looking, or he makes any particularly loud sound, the invisibility ends automatically for observers. Also, the character must maintain concentration for the duration of the power’s use. He loses his Defense and can take no actions other than moving up to Speed in a turn."
            }
        ],
        "FullPrerequisite": "Mind Control and Thought Projection (either version)",
        "Cost": "1 Willpower",
        "DicePool": "Intelligence + Stealth versus an observer’s Resolve + Supernatural Advantage (resistance is reflexive). If a mob is affected, make one roll for the group using the highest dice pool of its members.",
        "Action": "Contested, and requires concentration",
        "RollResult": [
            {
                "type": "line",
                "label": "Dramatic Failure:",
                "text": "The psychic is convinced that she is invisible and acts accordingly, even though any onlookers are able to see her."
            },
            {
                "type": "line",
                "label": "Failure:",
                "text": "The psychic fails to hide her appearance."
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "The psychic activates her psychic invisibility power. If anyone in a group points the character out, all onlookers can see her."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
                "text": "The psychic no longer needs to concentrate to maintain invisibility and can take other actions (although any interaction with her environment may end the effect). If she performs no actions, the effect lasts for the remainder of the scene."
            }
        ],
        "Book": "SS 62",
        ...
        "RollResult": [
            {
                "type": "line",
                "label": "Dramatic Failure:",
                "text": "The character triggers psychic feedback in the subject, making her instinctively withdraw or distrust him. Also, the character might transmit his thoughts to a different party than he intends, or even send thoughts that he did not intend."
            },
            {
                "type": "line",
                "label": "Failure:",
                "text": "The character fails to initiate communication, but can try again."
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "The character successfully initiates psychic communication with his target. He can freely send thoughts to the other party, and he can freely hear whatever thought messages the other party wishes to send back."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
                "text": "The character gains a +2 bonus on any subsequent use of a telepathic Merit in regard to the other party for the remainder of the scene."
            }
        ],
        "Book": "SS 63",
        ...
        "Content": [
            {
                ...
                "text": [
                    ...
                    " The telepath can move beyond simple mind reading to actually projecting his thoughts into the mind of another. A telepath cannot usually transmit thoughts beyond his line of sight. With the four-dot version, however, he can communicate with individuals outside his line of sight at a penalty determined by his degree of psychic connection to a target. Even with the three-dot version, a telepath can communicate with someone in a distant location if he is able to perceive the subject through clairvoyance. If the psychic also wishes to read the thoughts of the person to whom he sends, he must also activate his Mind Reading Merit (p. 60), which normally requires the expenditure of a second Willpower point in a subsequent turn."
                ]
            }
        ],
        "FullPrerequisite": "Mind Reading •••••",
        "Cost": "1 Willpower to allow thought transmission to a single subject for the rest of the scene. If thoughts are to be sent to someone else in that time, the first connection must be broken. The new connection costs another Willpower point. If the first connection is to be re-established, yet another Willpower must be spent.",
        "DicePool": "Presence + Empathy [versus Resolve + Supernatural Advantage if the subject is unwilling (resistance is reflexive)]",
        "Action": "Instant if the subject is willing; resisted is he’s unwilling",
        "RollResult": [
            {
                "type": "line",
                "label": "Dramatic Failure:",
                "text": "The character triggers psychic feedback in the subject, making her instinctively withdraw or distrust him. Also, the character might transmit his thoughts to a different party than he intended, or even send thoughts that he did not intend to send."
            },
            {
                "type": "line",
                "label": "Failure:",
                "text": "The character fails to transmit his thoughts, but can try again."
            },
            {
                "type": "line",
                "label": "Success:",
                "text": "The character successfully transmits his thoughts to his target. He can continue to send thoughts for the rest of the scene."
            },
            {
                "type": "line",
                "label": "Exceptional Success:",
                "text": "The gains a +2 bonus on any subsequent use of a telepathic Merit against the other party for the remainder of the scene."
            },
            {
                "type": "table",
                "headers": [
                    ...
                    [
                        "-1",
                        {
                            ...
                            "text": [
                                ...
                                " The target is a longtime friend or close family member."
                            ]
                        }
                    ],
                    [
                        "-3",
                        {
                            ...
                            "text": [
                                ...
                                " The target is a friend or co-worker about whom a great deal is known."
                            ]
                        }
                    ],
                    [
                        "-5",
                        {
                            ...
                            "text": [
                                ...
                                " The telepath has met the target several times. This is the weakest level of connection that allows long-range telepathic communication."
                            ]
                        }
                    ]
                ]
