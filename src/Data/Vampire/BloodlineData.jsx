export const genericBloodlineData = [
    {
...
export const daevaBloodlineData = [
    {
        "Name": "Amara Havana",
        "Nickname": "Guardians",
...
export const gangrelBloodlineData = [
    {
        "Name": "Abhi Dhvana",
        "Nickname": "-",
...
export const mekhetBloodlineData = [
    {
        "Name": "Agonistes",
...
export const nosferatuBloodlineData = [
    {
        "Name": "Acteius",
        "Nickname": "-",
        "Description": "-",
...
export const ventrueBloodlineData = [
    {
        "Name": "Adrestoi",
...
export const juliiBloodlineData = [
    {
        "Name": "Licinii*",
        "Nickname": "Pretenders",
        "Description": "A primarily Julii bloodline, known for its infirmity and weakness, who are outcasts from that clan due to their sordid and pathetic reputation.",
...
export const unknownBloodlineData = [
    {
        "Name": "Moirai",
        "Nickname": "-",
