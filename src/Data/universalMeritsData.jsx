const uniMeritsMentalData = [
    ...
    },
    {
        ...
        "LongDescription": [
            ...
            "<table class='spacing-table' style='min-width: 600px;'><tr class='table-row'><th>Dice modifiers</th><th>Situation</th></tr class={`alternating-row table-clickable`}><tr><td>+2</td><td>The subject is intoxicated, drugged or otherwise mentally impaired.</td></tr><tr class={`alternating-row table-clickable`}><td>+1</td><td>The subject is under peer pressure to submit to hypnosis, most commonly during a stage-hypnotist show.</td></tr></table>",
            ...
            "<table class='spacing-table' style='min-width: 600px;'><tr class='table-row'><th>Dice Modifier</th><th>Lost Memories</th></tr><tr class={`alternating-row table-clickable`}><td>—</td><td>Non-traumatic events that have simply been forgotten.</td></tr><tr class={`alternating-row table-clickable`}><td>–2</td><td>Traumatic but mundane events such as childhood circumstances or a sexual assault.</td></tr><tr class={`alternating-row table-clickable`}><td>-4</td><td>“Unintentional” supernatural influences that have affected the subject’s memories, such as Disbelief triggered by the actions of a mage or Lunacy triggered by a werewolf.</td></tr><tr class={`alternating-row table-clickable`}><td>-5</td><td>“Deliberate” supernatural effects intended to alter the subject’s memories, such as vampiric Disciplines or effects created with the Mind Arcana.</td></tr></table>"
...
const uniMeritsSupernaturalData = [
    ...
    },
    {
        ...
        "LongDescription": [
            ...
            "<table class='spacing-table' style='min-width: 600px;'><tr class='table-row'><th>Condition</th><th>Cost in Merit Dots</th></tr><tr class={`alternating-row table-clickable`}><td>Powers</td><td>+1 per Power dot</td></tr><tr class={`alternating-row table-clickable`}><td>Durability</td><td>+1 per dot</td></tr><tr class={`alternating-row table-clickable`}><td>Equipment Bonus</td><td>+1 per dot (maximum of +5 above what such an item would normally confer)</td></tr><tr class={`alternating-row table-clickable`}><td>Bonded (the item only works for this character)</td><td>+1</td></tr><tr class={`alternating-row table-clickable`}><td>Cost</td><td>-1 per dot of Cost (see Reliquary p. 116-117)</td></tr><tr class={`alternating-row table-clickable`}><td>Curses/Drawbacks</td><td>-2 per Curse (see Reliquary p. 113-116)</td></tr></table>",
