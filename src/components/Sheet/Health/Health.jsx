                ...
                <div className="grid grid-cols-5 gap-3">
                    {Array.from({ length: maxHealth }).map((_, i) => (
                        <div key={i} className="relative flex items-center">
                            <div
                                className={`health-box relative flex h-[24px] w-[24px] cursor-pointer items-center justify-center rounded-lg border-2 transition-all duration-300 ${i >= maxHealth - healthMod
                            ...
                            <div
                                className="absolute bottom-5 left-6 h-2 w-2 rounded-full border border-solid border-gray-600 cursor-pointer transition-all duration-200"
                                style={{ backgroundColor: resistantDamage[i] ? "black" : "transparent" }}
