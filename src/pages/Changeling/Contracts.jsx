...
export default function Contracts() {
    ...
    const universalContHeader = ['Rank', 'Benefit', 'Drawback', 'Catch', 'Cost', 'Dice Pool', 'Book']
    const seemingContHeader = ['Rank', 'Benefit', 'Drawback', 'Catch', 'Cost', 'Dice Pool', 'Book']
    const courtContHeader = ['Rank', 'Benefit', 'Drawback', 'Catch', 'Cost', 'Dice Pool', 'Book']
    ...
    return (
        <div className='grid-container'>
            ...
            <ManyHeadersTable table={seemingContractData} title={'Seeming Contracts'} headers={seemingContHeader} headerCheckFields={headerCheckFields} alternateData={contractData} />
