...
export default function Spells(props) {
    ...
    const selectedArcanaData = arcanaData[arcanaIndex];
    const selectedArcanaHeaders = arcanaHeaders[arcanaIndex];

    const renderedArcanaTables = (
        <MultipleTables
            key={arcanaIndex}
            listOfRows={selectedArcanaData}
            title={arcanaSets[arcanaIndex]}
            activeRowLink={true}
            displayHeaders={selectedArcanaHeaders}
